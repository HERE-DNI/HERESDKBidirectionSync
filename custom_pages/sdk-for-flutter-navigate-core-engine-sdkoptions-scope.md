...
slug: "sdk-for-flutter-navigate-core-engine-sdkoptions-scope"
---
...
<li class="self-crumb">scope property</li>
</ol>
<div class="self-name">scope</div>
...
<pre class="language-dart"><code class="language-dart">String scope;</code></pre>
</section>
</div>
