...
slug: "sdk-for-ios-navigate-weightrestriction"
---
...
<html lang="en">
  <head>
    <title>WeightRestriction Structure Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Struct/WeightRestriction" class="dashAnchor"></a>
    <a title="WeightRestriction Structure Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        WeightRestriction Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk17WeightRestrictionV16valueInKilogramss5Int32Vvp"></a>
                    <a name="//apple_ref/swift/Property/valueInKilograms" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk17WeightRestrictionV16valueInKilogramss5Int32Vvp">valueInKilograms</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>The maximum allowed weight.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk17WeightRestrictionV4typeAA0bC4TypeOvp"></a>
                    <a name="//apple_ref/swift/Property/type" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk17WeightRestrictionV4typeAA0bC4TypeOvp">type</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The type of the weight restriction.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">type</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-weightrestrictiontype">WeightRestrictionType</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk17WeightRestrictionV16valueInKilograms4typeACs5Int32V_AA0bC4TypeOtcfc"></a>
                    <a name="//apple_ref/swift/Method/init(valueInKilograms:type:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk17WeightRestrictionV16valueInKilograms4typeACs5Int32V_AA0bC4TypeOtcfc">init(valueInKilograms:<wbr>type:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">valueInKilograms</span><span class="p">:</span> <span class="kt">Int32</span><span class="p">,</span> <span class="nv">type</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-weightrestrictiontype">WeightRestrictionType</a></span><span class="p">)</span></code></pre>
