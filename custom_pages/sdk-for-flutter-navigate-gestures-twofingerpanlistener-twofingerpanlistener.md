...
1.  <span id="sdk-for-flutter-navigate-param-onTwoFingerPanLambda" class="parameter"><span class="type-annotation">void</span> <span class="parameter-name">onTwoFingerPanLambda</span>(</span>
