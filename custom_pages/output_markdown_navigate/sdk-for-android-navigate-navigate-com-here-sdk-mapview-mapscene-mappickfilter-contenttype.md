...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-mapview-mapscene-mappickfilter-contenttype"
---
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#CUSTOM_LAYER_DATA">CUSTOM_LAYER_DATA</a></code></div>
<div class="col-last even-row-color">
<div class="block">Custom user map content added using custom datasources e.g.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#MAP_CONTENT">MAP_CONTENT</a></code></div>
...
<div class="block"><p>Custom user map content added using custom datasources e.g. <a href="sdk-for-android-navigate-datasource-linedatasource" title="class in com.here.sdk.mapview.datasource"><code>LineDataSource</code></a>,
 <a href="sdk-for-android-navigate-datasource-polygondatasource" title="class in com.here.sdk.mapview.datasource"><code>PolygonDataSource</code></a> and layers.</p></div>
</section>
</li>
</ul>
</section>
