...
<html lang="en">
  ...
  <body>
    <a name="//apple_ref/swift/Section/EV" class="dashAnchor"></a>
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <a href="sdk-for-ios-explore-evchargingconnectorformat" class="slightly-smaller">See more</a>
                      </div>
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <a href="sdk-for-ios-explore-evchargingconnectortype" class="slightly-smaller">See more</a>
                      </div>
                      <div class="declaration">
                        <h4>Declaration</h4>
                        <div class="language">
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Enum/EVSECapability" class="dashAnchor"></a>
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <a href="sdk-for-ios-explore-evsecapability" class="slightly-smaller">See more</a>
                      </div>
                      <div class="declaration">
                        <h4>Declaration</h4>
                        <div class="language">
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <a href="sdk-for-ios-explore-evsepaymentsupport" class="slightly-smaller">See more</a>
                      </div>
                      <div class="declaration">
                        <h4>Declaration</h4>
                        <div class="language">
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Enum/EVSEState" class="dashAnchor"></a>
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <a href="sdk-for-ios-explore-evsestate" class="slightly-smaller">See more</a>
                      </div>
                      <div class="declaration">
                        <h4>Declaration</h4>
                        <div class="language">
