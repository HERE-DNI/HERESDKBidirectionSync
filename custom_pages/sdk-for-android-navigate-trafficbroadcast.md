...
<title>TrafficBroadcast (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.trafficbroadcast, class: TrafficBroadcast">
...
<!-- ======== START OF CLASS DATA ======== -->
<div class="header">
<div class="sub-title"><span class="package-label-in-type">Package</span>&nbsp;<a href="sdk-for-android-explore-package-summary">com.here.sdk.trafficbroadcast</a></div>
<h1 title="Class TrafficBroadcast" class="title">Class TrafficBroadcast</h1>
</div>
...
<div class="block"><p>A <code>TrafficBroadcast</code> is expecting the <a href="https://en.wikipedia.org/wiki/Traffic_message_channel">RDS-TMC</a>
 ...
 <a href="sdk-for-android-explore-locationlistener" title="interface in com.here.sdk.core"><code>LocationListener</code></a>. The location must be updated regardless of calling <a href="#activate()"><code>activate()</code></a>.
...
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.core.engine.SDKNativeEngine,com.here.sdk.trafficbroadcast.TrafficBroadcastParameters)" class="member-name-link">TrafficBroadcast</a><wbr>(<a href="sdk-for-android-explore-sdknativeengine" title="class in com.here.sdk.core.engine">SDKNativeEngine</a>&nbsp;sdkEngine,
 <a href="sdk-for-android-explore-trafficbroadcastparameters" title="class in com.here.sdk.trafficbroadcast">TrafficBroadcastParameters</a>&nbsp;parameters)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a new instance of this class.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.trafficbroadcast.TrafficBroadcastParameters)" class="member-name-link">TrafficBroadcast</a><wbr>(<a href="sdk-for-android-explore-trafficbroadcastparameters" title="class in com.here.sdk.trafficbroadcast">TrafficBroadcastParameters</a>&nbsp;parameters)</code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#onTMCDataUpdated(com.here.sdk.trafficbroadcast.TMCData)" class="member-name-link">onTMCDataUpdated</a><wbr>(<a href="sdk-for-android-explore-tmcdata" title="class in com.here.sdk.trafficbroadcast">TMCData</a>&nbsp;tmcData)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Must be called on every TMC data update.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#onTMCServiceProviderInfoUpdated(com.here.sdk.trafficbroadcast.TMCServiceProviderInfo)" class="member-name-link">onTMCServiceProviderInfoUpdated</a><wbr>(<a href="sdk-for-android-explore-tmcserviceproviderinfo" title="class in com.here.sdk.trafficbroadcast">TMCServiceProviderInfo</a>&nbsp;tmcServiceProdiverInfo)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">TrafficBroadcast</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-trafficbroadcastparameters" title="class in com.here.sdk.trafficbroadcast">TrafficBroadcastParameters</a>&nbsp;parameters)</span>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>parameters</code> - <p>The necessary parameters to start traffic broadcast.</dd>
<dt>Throws:</dt>
<dd><code><a href="sdk-for-android-explore-instantiationerrorexception" title="class in com.here.sdk.core.errors">InstantiationErrorException</a></code> - <p>when the object was not initialized properly.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Activates the reception of traffic data over the radio channel.
 ...
 When activation is done, requestTMCService is called from TMCServiceInterface</div>
</section>
</li>
<li>
...
<div class="block"><p>Deactivates the reception of traffic data over the radio channel.
 ...
 With special case of countryCode parameter = 0</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="return-type">void</span>&nbsp;<span class="element-name">onTMCServiceProviderInfoUpdated</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-tmcserviceproviderinfo" title="class in com.here.sdk.trafficbroadcast">TMCServiceProviderInfo</a>&nbsp;tmcServiceProdiverInfo)</span></div>
<div class="block"><p>Must be called on every TMC service prodiver info update.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>tmcServiceProdiverInfo</code> - <p>Contains service prodiver info in RDS-TMC format.</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="return-type">void</span>&nbsp;<span class="element-name">onTMCDataUpdated</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-tmcdata" title="class in com.here.sdk.trafficbroadcast">TMCData</a>&nbsp;tmcData)</span></div>
<div class="block"><p>Must be called on every TMC data update.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>tmcData</code> - <p>Contains the traffic events in RDS-TMC format.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Returns:</dt>
<dd><p>The traffic data provider that provides the traffic information.</dd>
</dl>
</section>
</li>
<li>
