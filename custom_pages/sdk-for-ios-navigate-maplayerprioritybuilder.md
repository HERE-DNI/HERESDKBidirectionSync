...
slug: "sdk-for-ios-navigate-maplayerprioritybuilder"
---
...
<html lang="en">
  <head>
    <title>MapLayerPriorityBuilder Class Reference</title>
              ...
              <ul>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/withCategory(_:)" class="dashAnchor"></a>
...
is cleared and the builder refers again to the layer itself.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/inGroup(_:)" class="dashAnchor"></a>
...
inside this group. The references (i.e. &lsquo;referenceLayer&rsquo; and &lsquo;referenceCategory&rsquo;) of the priority
...
Note that a group needs to exist when the built <code><a href="sdk-for-ios-explore-maps#/s:7heresdk16MapLayerPriorityC">MapLayerPriority</a></code> is used during a
<code><a href="sdk-for-ios-explore-maplayerbuilder#/s:7heresdk15MapLayerBuilderC5buildAA0bC0CyKF">MapLayerBuilder.build(...)</a></code> or <code><a href="sdk-for-ios-explore-maplayer#/s:7heresdk8MapLayerC11setPriorityyyAA0bcE0CF">MapLayer.setPriority(...)</a></code>, otherwise the priority
...
Related APIs may change for new releases without a deprecation process.</p>
                        ...
                        <table class="graybox">
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div>
                                  <p>The name of the group. For instance the name of a <code><a href="sdk-for-ios-explore-translucentmaplayergroup">TranslucentMapLayerGroup</a></code>.</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedFirst()" class="dashAnchor"></a>
...
category pointed to by the preceding call to <code><a href="sdk-for-ios-explore-maplayerprioritybuilder#/s:7heresdk23MapLayerPriorityBuilderC12withCategoryyACSSF">MapLayerPriorityBuilder.withCategory(...)</a></code>.
...
render layer category &lsquo;C&rsquo; after layer &lsquo;L&rsquo; would be overridden by the priority to
render layer category &lsquo;C&rsquo; before layer &lsquo;L&rsquo; when building something like</p>

<p>withCategory(&ldquo;C&rdquo;).renderedAfterLayer(&ldquo;L&rdquo;).withCategory(&ldquo;C&rdquo;).renderedBeforeLayer(&ldquo;L&rdquo;)
...
The previously defined and prioritised categories can be used as reference.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedLast()" class="dashAnchor"></a>
...
The previously defined and prioritised categories can be used as reference.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedBeforeLayer(named:)" class="dashAnchor"></a>
...
<code><a href="sdk-for-ios-explore-maplayerprioritybuilder#/s:7heresdk23MapLayerPriorityBuilderC12withCategoryyACSSF">MapLayerPriorityBuilder.withCategory(...)</a></code>.
Notice that the order of calls to the functions
<code>renderedFirst|Last|Before|After</code>
matters, and that after such a call the builder clears the current category and refers again to
the layer itself. Further, only one priority for each layer and layer category should be set
...
before all layers and categories.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedBeforeLayer(named:categoryName:)" class="dashAnchor"></a>
...
the priority as rendered before all layers and categories.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedAfterLayer(named:)" class="dashAnchor"></a>
...
after all layers and categories.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/renderedAfterLayer(named:categoryName:)" class="dashAnchor"></a>
...
MapLayerPriority.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="kd">func</span> <span class="nf">build</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="kt"><a href="sdk-for-ios-explore-maps#/s:7heresdk16MapLayerPriorityC">MapLayerPriority</a></span></code></pre>
