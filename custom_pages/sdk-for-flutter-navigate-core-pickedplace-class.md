...
<li><a href="core/PickedPlace/offlineSearchId.html">offlineSearchId</a></li>
...
/sdk-for-flutter-navigate-core-pickedplace-pickedplace(String name, /sdk-for-flutter-navigate-core-geocoordinates-class coordinates, String placeCategoryId)
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-core-pickedplace-coordinates
...
/sdk-for-flutter-navigate-core-pickedplace-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-pickedplace-name
↔ String
</dt>
<dd>
...
<dt class="property" id="offlineSearchId">
/sdk-for-flutter-navigate-core-pickedplace-offlinesearchid
↔ String
</dt>
<dd>
  The place ID to query an offline search to obtain additional data about this POI with
the <code>OfflineSearchEngine</code>. Note that not all editions include the <code>OfflineSearchEngine</code>.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="placeCategoryId">
/sdk-for-flutter-navigate-core-pickedplace-placecategoryid
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-pickedplace-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-pickedplace-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-core-pickedplace-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-core-pickedplace-operator-equals(<wbr/>Object other)
    → bool
