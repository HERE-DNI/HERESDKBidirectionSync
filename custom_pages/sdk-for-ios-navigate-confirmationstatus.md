...
slug: "sdk-for-ios-navigate-confirmationstatus"
---
...
<html lang="en">
  <head>
    <title>ConfirmationStatus Enumeration Reference</title>
  ...
  <body>
    ...
    <a title="ConfirmationStatus Enumeration Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        ConfirmationStatus Enumeration Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk18ConfirmationStatusO2okyA2CmF"></a>
                    <a name="//apple_ref/swift/Element/ok" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk18ConfirmationStatusO2okyA2CmF">ok</a>
                    </code>
                  </div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk18ConfirmationStatusO7pendingyA2CmF"></a>
                    <a name="//apple_ref/swift/Element/pending" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk18ConfirmationStatusO7pendingyA2CmF">pending</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Action is still in progress. While in this state, Location Engine can be used normally.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk18ConfirmationStatusO10notAllowedyA2CmF"></a>
                    <a name="//apple_ref/swift/Element/notAllowed" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk18ConfirmationStatusO10notAllowedyA2CmF">notAllowed</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Action is not allowed. Contact HERE support if you believe this action should be allowed.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk18ConfirmationStatusO12notSupportedyA2CmF"></a>
                    <a name="//apple_ref/swift/Element/notSupported" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk18ConfirmationStatusO12notSupportedyA2CmF">notSupported</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
