...
<span class="returntype"><a href="sdk-for-flutter-explore-core-anglerange-class">AngleRange</a></span> <span class="name">fromDirectionDegreesClockwise</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-explore-fromDirectionDegreesClockwise-param-center" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">center</span>, </span>
2.  <span id="sdk-for-flutter-explore-fromDirectionDegreesClockwise-param-extent" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">extent</span></span>
...
Returns <a href="sdk-for-flutter-explore-core-anglerange-class">AngleRange</a>. Created AngleRange from the provided center angle and the range's extent.
