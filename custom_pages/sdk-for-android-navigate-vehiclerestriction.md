...
<title>VehicleRestriction (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.transport, class: VehicleRestriction">
...
<h1 title="Class VehicleRestriction" class="title">Class VehicleRestriction</h1>
</div>
...
<div class="col-second even-row-color"><code><a href="#appliesToDelivery" class="member-name-link">appliesToDelivery</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#axleCount" class="member-name-link">axleCount</a></code></div>
...
<div class="col-second even-row-color"><code><a href="#axleCountInGroup" class="member-name-link">axleCountInGroup</a></code></div>
<div class="col-last even-row-color">
<div class="block">Number of axles in a group for which the current restriction applies.</div>
</div>
<div class="col-first odd-row-color"><code><a href="sdk-for-android-explore-hazardousmaterialrestriction" title="class in com.here.sdk.transport">HazardousMaterialRestriction</a></code></div>
<div class="col-second odd-row-color"><code><a href="#hazmatRestriction" class="member-name-link">hazmatRestriction</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Restriction on transport of hazardous materials and max allowed tunnel category.</div>
</div>
<div class="col-first even-row-color"><code><a href="sdk-for-android-explore-specificrestriction" title="class in com.here.sdk.transport">SpecificRestriction</a></code></div>
<div class="col-second even-row-color"><code><a href="#restriction" class="member-name-link">restriction</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code><a href="sdk-for-android-explore-timerestriction" title="class in com.here.sdk.transport">TimeRestriction</a></code></div>
<div class="col-second odd-row-color"><code><a href="#timeRestriction" class="member-name-link">timeRestriction</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code><a href="sdk-for-android-explore-weathertype" title="enum class in com.here.sdk.navigation">WeatherType</a></code></div>
<div class="col-second even-row-color"><code><a href="#weather" class="member-name-link">weather</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.transport.SpecificRestriction)" class="member-name-link">VehicleRestriction</a><wbr>(<a href="sdk-for-android-explore-specificrestriction" title="class in com.here.sdk.transport">SpecificRestriction</a>&nbsp;restriction)</code></div>
<div class="col-last odd-row-color">
...
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-specificrestriction" title="class in com.here.sdk.transport">SpecificRestriction</a></span>&nbsp;<span class="element-name">restriction</span></div>
...
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-hazardousmaterialrestriction" title="class in com.here.sdk.transport">HazardousMaterialRestriction</a></span>&nbsp;<span class="element-name">hazmatRestriction</span></div>
<div class="block"><p>Restriction on transport of hazardous materials and max allowed tunnel category.
 ...
 (TunnelCategory.B and TunnelCategory.C allowed).</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-timerestriction" title="class in com.here.sdk.transport">TimeRestriction</a></span>&nbsp;<span class="element-name">timeRestriction</span></div>
<div class="block"><p>Restriction applies during specific time.</div>
</section>
</li>
<li>
...
<h3>weather</h3>
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-weathertype" title="enum class in com.here.sdk.navigation">WeatherType</a></span>&nbsp;<span class="element-name">weather</span></div>
<div class="block"><p>Type of weather in which restriction applies.</div>
</section>
</li>
<li>
...
<div class="block"><p>Restriction applies to a specific truck category.</div>
</section>
</li>
<li>
...
<div class="block"><p>Number of trailers for which the restriction applies.</div>
</section>
</li>
<li>
...
<div class="block"><p>The axle count for which the current restriction applies.
 Can be used in conjunction with <a href="sdk-for-android-explore-restrictiontype#WEIGHT_PER_AXLE_COUNT"><code>RestrictionType.WEIGHT_PER_AXLE_COUNT</code></a>
...
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-integerrange" title="class in com.here.sdk.core">IntegerRange</a></span>&nbsp;<span class="element-name">axleCountInGroup</span></div>
<div class="block"><p>Number of axles in a group for which the current restriction applies.
 ...
 Can be used in conjunction with <a href="sdk-for-android-explore-restrictiontype#WEIGHT_PER_AXLE_GROUP"><code>RestrictionType.WEIGHT_PER_AXLE_GROUP</code></a>
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">VehicleRestriction</span><wbr><span class="parameters">(@Nullable
 <a href="sdk-for-android-explore-specificrestriction" title="class in com.here.sdk.transport">SpecificRestriction</a>&nbsp;restriction)</span></div>
<div class="block"><p>Creates an unconditional restriction.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>restriction</code> - <p>A <code>SpecificRestriction</code> defines what type of restriction applies (weight, height, etc.)
 and the range of allowed values.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Creates an uncoditional general restriction.</div>
</section>
</li>
</ul>
</section>
