...
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-mapview-datasource-data-attributes-base"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.mapview.datasource/DataAttributesBase///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.mapview.datasource</a><span class="delimiter">/</span><span class="current">DataAttributesBase</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Data</span><wbr></wbr><span>Attributes</span><wbr></wbr><span><span>Base</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">interface </span><a href="index.html">DataAttributesBase</a></div><p class="paragraph">Interface for a collection of data attributes.</p><p class="paragraph">Note: This is a beta release of this feature, so there could be a few bugs and unexpected behavior. Related APIs may change for new releases without a deprecation process.</p><h4 class="">Inheritors</h4><div class="table"><div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release"><div class="main-subrow keyValue "><div class=""><span class="inline-flex"><div><a href="../-data-attributes/index.html">DataAttributes</a></div></span></div><div></div></div></div><div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release"><div class="main-subrow keyValue "><div class=""><span class="inline-flex"><div><a href="../-data-attributes-accessor/index.html">DataAttributesAccessor</a></div></span></div><div></div></div></div></div></div></div>
  </div>
