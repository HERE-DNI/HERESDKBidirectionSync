...
slug: "sdk-for-ios-navigate-sslclientcredentialsoptions"
---
...
<html lang="en">
  <head>
    <title>SslClientCredentialsOptions Structure Reference</title>
              ...
              <ul>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/pemPrivateKey" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The client&rsquo;s private key in PEM format.
It must be non-empty for mutual TLS. Else must be set to empty string.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/pemCertChain" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The client&rsquo;s certificate chain in PEM format.
It must be non-empty for mutual TLS. Else must be set to empty string.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(pemRootCerts:pemPrivateKey:pemCertChain:)" class="dashAnchor"></a>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(pemRootCerts:)" class="dashAnchor"></a>
