...
RouteOptions([<ol class="parameter-list"> <li><a href="/sdk-for-flutter-explore-routing-optimizationmode">OptimizationMode</a> optimizationMode = OptimizationMode.fastest, </li>
...
<li><a href="/sdk-for-flutter-explore-routing-trafficoptimizationmode">TrafficOptimizationMode</a> trafficOptimizationMode = TrafficOptimizationMode.timeDependent, </li>
...
<ul>
<li><code>optimizationMode</code> The optimization mode to be used for route calculation. By default, it is <a href="/sdk-for-flutter-explore-routing-optimizationmode">OptimizationMode.fastest</a>.</li>
...
<li><code>enableRouteHandle</code> A flag that indicates whether the resulting route should contain a <a href="/sdk-for-flutter-explore-routing-routehandle-class">RouteHandle</a>.
...
<li><code>trafficOptimizationMode</code> The traffic optimization mode to be used for route calculation. By default, it is <a href="/sdk-for-flutter-explore-routing-trafficoptimizationmode">TrafficOptimizationMode.timeDependent</a>, which enables traffic-aware routing.</li>
<li><code>enableTolls</code> A flag that indicates whether the resulting route <a href="/sdk-for-flutter-explore-routing-section-tolls">Section.tolls</a> properties should contain
