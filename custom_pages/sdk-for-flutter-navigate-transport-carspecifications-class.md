...
/sdk-for-flutter-navigate-transport-carspecifications-carspecifications([int? grossWeightInKilograms = null, int? heightInCentimeters = null, int? widthInCentimeters = null, int? lengthInCentimeters = null, int? axleCount = null, int? trailerCount = null, int? trailerAxleCount = null])
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="CarSpecifications.withDefaults">
/sdk-for-flutter-navigate-transport-carspecifications-carspecifications-withdefaults()
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-axlecount
↔ int?
</dt>
<dd>
...
When specifying /sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount, then /sdk-for-flutter-navigate-transport-carspecifications-axlecount is required and must be greater than /sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="grossWeightInKilograms">
/sdk-for-flutter-navigate-transport-carspecifications-grossweightinkilograms
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-heightincentimeters
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-lengthincentimeters
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount
↔ int?
</dt>
<dd>
  Defines total number of axles across all the trailers attached to the vehicle.
This number is included in /sdk-for-flutter-navigate-transport-carspecifications-axlecount, hence /sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount must be less than /sdk-for-flutter-navigate-transport-carspecifications-axlecount
and greater than or equal to 1. /sdk-for-flutter-navigate-transport-carspecifications-axlecount and /sdk-for-flutter-navigate-transport-carspecifications-trailercount are required to specify /sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount.
By default, it is not set.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="trailerCount">
/sdk-for-flutter-navigate-transport-carspecifications-trailercount
↔ int?
</dt>
<dd>
  Defines number of trailers attached to the vehicle. The provided value must be in the range
[0, 1]. By default, it is not set.
When specifying /sdk-for-flutter-navigate-transport-carspecifications-traileraxlecount, then /sdk-for-flutter-navigate-transport-carspecifications-trailercount is required and must be greater than 0.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="widthInCentimeters">
/sdk-for-flutter-navigate-transport-carspecifications-widthincentimeters
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-transport-carspecifications-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-transport-carspecifications-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-transport-carspecifications-operator-equals(<wbr/>Object other)
    → bool
