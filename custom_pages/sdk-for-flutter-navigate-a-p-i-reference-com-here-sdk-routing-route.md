---
title: "Route"
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-routing-route"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.routing/Route///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.routing</a><span class="delimiter">/</span><span class="current">Route</span></div>
  <div class="cover ">
    <h1 class="cover"><span><span>Route</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">Route</a> : <a href="../../com.here/-native-base/index.html">NativeBase</a></div><p class="paragraph">A route is a path through a road network over which someone travels.</p><p class="paragraph"><strong>Note:</strong> Each <a href="../-section/index.html">com.here.sdk.routing.Section</a> of a route contains a list of <a href="../-section-notice/index.html">com.here.sdk.routing.SectionNotice</a> objects that describe <i>potential issues</i> after the route was calculated. If the list is non-empty, it is recommended to evaluate possible violations against the requested route options and reject the route if deemed necessary.</p></div></div>
  </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1875961809%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="language.html">language</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-language-code/index.html">LanguageCode</a></div><div class="brief "><p class="paragraph">Indicates the language requested for all textual information related to this route.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1208140153%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="optimization-mode.html">optimizationMode</a><span class="token operator">: </span><a href="../-optimization-mode/index.html">OptimizationMode</a></div><div class="brief "><p class="paragraph">The optimization mode requested for route calculation.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="1610450251%2FProperties%2F1617540583" anchor-label="requestedTransportMode" id="1610450251%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="requested-transport-mode.html"><span>requested</span><wbr></wbr><span>Transport</span><wbr></wbr><span><span>Mode</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1610450251%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="requested-transport-mode.html">requestedTransportMode</a><span class="token operator">: </span><a href="../../com.here.sdk.transport/-transport-mode/index.html">TransportMode</a></div><div class="brief "><p class="paragraph">The transport mode requested for route calculation.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-906697952%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="route-handle.html">routeHandle</a><span class="token operator">: </span><a href="../-route-handle/index.html">RouteHandle</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">The route handle of this route. Note that it is provided only if <a href="../-route-options/enable-route-handle.html">com.here.sdk.routing.RouteOptions.enableRouteHandle</a> is set before route calculation.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-295576783%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="routing-options.html">routingOptions</a><span class="token operator">: </span><a href="../-routing-options/index.html">RoutingOptions</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">The set of options used to calculate the route.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="184932795%2FProperties%2F1617540583" anchor-label="sections" id="184932795%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sections.html"><span><span>sections</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="184932795%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="sections.html">sections</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="token operator">&lt;</span><a href="../-section/index.html">Section</a><span class="token operator">&gt;</span></div><div class="brief "><p class="paragraph">The sections that make up this route.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
