...
<li class="self-crumb">RepairPersistentMapCallback typedef</li>
</ol>
<div class="self-name">RepairPersistentMapCallback</div>
...
<p>A method which is called on the main thread when /sdk-for-flutter-navigate-maploader-mapdownloader-repairpersistentmap has been completed.</p>
