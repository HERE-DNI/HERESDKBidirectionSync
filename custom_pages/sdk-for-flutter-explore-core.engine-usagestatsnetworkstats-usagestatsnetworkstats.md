...
1.  <span id="sdk-for-flutter-explore-param-sentBytes" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">sentBytes</span>, </span>
2.  <span id="sdk-for-flutter-explore-param-receivedBytes" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">receivedBytes</span>, </span>
3.  <span id="sdk-for-flutter-explore-param-methodCall" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">methodCall</span>, </span>
4.  <span id="sdk-for-flutter-explore-param-requestCounter" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">requestCounter</span>, </span>
