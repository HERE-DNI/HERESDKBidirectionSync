...
<li class="self-crumb">roadSignWarningListener property</li>
</ol>
...
<section class="multi-line-signature">
void
roadSignWarningListener=(<wbr/>/sdk-for-flutter-navigate-navigation-roadsignwarninglistener-class? value)
</section>
<section class="desc markdown">
<p>Object to receive notifications about road signs on the current road.
Setting <code>null</code> value to the listener will unset the listener.
