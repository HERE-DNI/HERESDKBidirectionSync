...
<div id="sdk-for-flutter-navigate-dartdoc-main-content" class="main-content" data-above-sidebar="core.engine/core.engine-library-sidebar.html" data-below-sidebar="core.engine/LayerConfigurationFeature-enum-sidebar.html">
...
See <a href="sdk-for-flutter-navigate-core-engine-sdkoptions-layerconfiguration">SDKOptions.layerConfiguration</a>

Following features are enabled by default:

- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.detailRendering</a>
- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.landmarks3d</a>
- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.navigation</a>
- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.offlineSearch</a>
- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.offlineRouting</a>
- <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.rendering</a>
...
Feature might have more than one layer group predefined to enable full experience. For example, <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.navigation</a> requires routing attributes, visual-friendly street names, maneuvers data and ability to interconnect those data sets.

The same map data is useful for different features, for example <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.rendering</a> uses Places data to present it on the MapView, while <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature.offlineSearch</a> uses the same data to enable discoverability by name or category. Hence, features might have overlapping sets of enabled layer groups.

</div>

## Values

<span class="name">detailRendering</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">navigation</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">offlineSearch</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">offlineSearchGlobal</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
- `OFFLINE_SEARCH_GLOBAL` is included in <a href="sdk-for-flutter-navigate-core-engine-layerconfiguration-enabledfeatures">LayerConfiguration.enabledFeatures</a> and
...
- `OFFLINE_SEARCH_GLOBAL` is included in <a href="sdk-for-flutter-navigate-core-engine-layerconfiguration-implicitlyprefetchedfeatures">LayerConfiguration.implicitlyPrefetchedFeatures</a> and
...
1.  Fall back to the stable offline search if `OFFLINE_SEARCH` is still included in <a href="sdk-for-flutter-navigate-core-engine-layerconfiguration-enabledfeatures">LayerConfiguration.enabledFeatures</a>, or
...
- Downloaded map region size by ~11–16% when enabled via <a href="sdk-for-flutter-navigate-core-engine-layerconfiguration-enabledfeatures">LayerConfiguration.enabledFeatures</a>.
- Map cache size by ~40–140% when enabled via <a href="sdk-for-flutter-navigate-core-engine-layerconfiguration-implicitlyprefetchedfeatures">LayerConfiguration.implicitlyPrefetchedFeatures</a> (upper bound occurs for long routes, e.g., Paris → Rome).
...
<span class="name">offlineRouting</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">rendering</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">truck</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">landmarks3d</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">ev</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">truckServiceAttributes</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">fuelStationAttributes</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">offlineBusRouting</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionView3x4</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionView16x9</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionSign3x4</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionSign3x5</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionSign4x3</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionSign5x3</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">junctionSign16x9</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">terrain</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">detailedTerrain</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">adas</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">ehorizon</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name">rdsTraffic</span> <span class="signature">→ const <a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-hashcode">hashCode</a></span> <span class="signature">→ int</span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-index">index</a></span> <span class="signature">→ int</span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-runtimetype">runtimeType</a></span> <span class="signature">→ Type</span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-nosuchmethod">noSuchMethod</a></span><span class="signature">(<wbr></wbr><span id="sdk-for-flutter-navigate-noSuchMethod-param-invocation" class="parameter"><span class="type-annotation">Invocation</span> <span class="parameter-name">invocation</span></span>) <span class="returntype parameter">→ dynamic</span> </span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-tostring">toString</a></span><span class="signature">(<wbr></wbr>) <span class="returntype parameter">→ String</span> </span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-operator_equals">operator ==</a></span><span class="signature">(<wbr></wbr><span id="sdk-for-flutter-navigate-param-other" class="parameter"><span class="type-annotation">Object</span> <span class="parameter-name">other</span></span>) <span class="returntype parameter">→ bool</span> </span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature-values-constant">values</a></span> <span class="signature">→ const List<span class="signature">\<<wbr></wbr><span class="type-parameter"><a href="sdk-for-flutter-navigate-core-engine-layerconfigurationfeature">LayerConfigurationFeature</a></span>\></span></span>  
