...
IsolineRoutingEngine.withConnectionSettings(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-explore-routing-routingconnectionsettings-class connectionSettings</li>
</ol>)
    </section>
