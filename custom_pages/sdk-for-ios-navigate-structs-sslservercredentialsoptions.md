...
<div class="language">
<p class="aside-title">Swift</p>
<pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">pemKeyCertPairs</span><span class="p">:</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-navigate-structs-pemkeycertpair">PemKeyCertPair</a></span><span class="p">]</span></code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">clientCertificateRequest</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-navigate-enums-clientcertificaterequesttype">ClientCertificateRequestType</a></span></code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">pemRootCerts</span><span class="p">:</span> <span class="kt">String</span><span class="p">,</span> <span class="nv">pemKeyCertPairs</span><span class="p">:</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-navigate-structs-pemkeycertpair">PemKeyCertPair</a></span><span class="p">],</span> <span class="nv">clientCertificateRequest</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-navigate-enums-clientcertificaterequesttype">ClientCertificateRequestType</a></span><span class="p">)</span></code></pre>
</div>
</div>
</section>
</div>
