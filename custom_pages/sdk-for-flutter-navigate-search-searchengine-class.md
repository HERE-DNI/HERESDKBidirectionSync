...
<p>It also allows to search along a given /sdk-for-flutter-navigate-core-geopolyline-class set inside a /sdk-for-flutter-navigate-core-geocorridor-class
as part of a /sdk-for-flutter-navigate-search-textquery-class.</p>
<p>The SearchEngine API requires an online connection to execute the requests.</p>
<p><strong>Note:</strong> All methods are provided in two flavors. One uses a /sdk-for-flutter-navigate-search-searchcallback and the
other uses a /sdk-for-flutter-navigate-search-searchcallbackextended: The later adds a <code>ResponseDetails</code> result type
...
/sdk-for-flutter-navigate-search-searchengine-searchengine()
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-searchengine-searchengine-withsdkengine(/sdk-for-flutter-navigate-core-engine-sdknativeengine-class sdkEngine)
</dt>
<dd>
          Creates a new instance of this class.
            <div class="constructor-modifier features">factory</div>
...
/sdk-for-flutter-navigate-search-searchengine-searchbyaddressextended(<wbr/>/sdk-for-flutter-navigate-search-addressquery-class query, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-searchbycategoryextended(<wbr/>/sdk-for-flutter-navigate-search-categoryquery-class query, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class

</dt>
<dd>
  Performs an asynchronous request to do a category search for /sdk-for-flutter-navigate-search-place-class instances.
...
/sdk-for-flutter-navigate-search-searchengine-searchbycoordinatesextended(<wbr/>/sdk-for-flutter-navigate-core-geocoordinates-class coordinates, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-searchbycoordinateswithradius(<wbr/>/sdk-for-flutter-navigate-core-geocircle-class circle, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallback callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-searchbycoordinateswithradiusextended(<wbr/>/sdk-for-flutter-navigate-core-geocircle-class circle, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-searchbyplaceidwithlanguagecodeextended(<wbr/>/sdk-for-flutter-navigate-search-placeidquery-class query, /sdk-for-flutter-navigate-core-languagecode? languageCode, /sdk-for-flutter-navigate-search-placeidsearchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class

</dt>
<dd>
  Performs an asynchronous request to search for a /sdk-for-flutter-navigate-search-place-class based on its ID and
/sdk-for-flutter-navigate-core-languagecode.
...
/sdk-for-flutter-navigate-search-searchengine-searchbytextextended(<wbr/>/sdk-for-flutter-navigate-search-textquery-class query, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class

</dt>
<dd>
  Performs an asynchronous request to do a text query search for /sdk-for-flutter-navigate-search-place-class instances.
  

</dd>
<dt class="callable" id="sendRequest">
/sdk-for-flutter-navigate-search-searchengine-sendrequest(<wbr/>String href, /sdk-for-flutter-navigate-search-searchcallback callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-sendrequestextended(<wbr/>String href, /sdk-for-flutter-navigate-search-searchcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
...
/sdk-for-flutter-navigate-search-searchengine-setcustomoption(<wbr/>String name, String value)
...
/sdk-for-flutter-navigate-search-searchengine-setevinterface(<wbr/>/sdk-for-flutter-navigate-search-evsearchinterface-class evcpInterface)
    → void
...
/sdk-for-flutter-navigate-search-searchengine-suggestextended(<wbr/>/sdk-for-flutter-navigate-search-textquery-class query, /sdk-for-flutter-navigate-search-searchoptions-class options, /sdk-for-flutter-navigate-search-suggestcallbackextended callback)
    → /sdk-for-flutter-navigate-core-threading-taskhandle-class
