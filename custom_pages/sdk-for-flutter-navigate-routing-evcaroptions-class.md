...
<p>At minimum, a valid /sdk-for-flutter-navigate-routing-evconsumptionmodel-class must be set or the route calculation will fail.
<br/>
Note: /sdk-for-flutter-navigate-routing-evcaroptions-ensurereachability must be <code>true</code> to make sure that all stopovers are reachable. For this,
charging stations may be added to the route. If /sdk-for-flutter-navigate-routing-evcaroptions-ensurereachability is true, you need to
specify the required route options and battery specifications that include the current charge level
of the battery (/sdk-for-flutter-navigate-routing-batteryspecifications-initialchargeinkilowatthours).
...
/sdk-for-flutter-navigate-routing-evcaroptions-evcaroptions()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-routing-evcaroptions-allowoptions
...
/sdk-for-flutter-navigate-routing-evcaroptions-avoidanceoptions
...
/sdk-for-flutter-navigate-routing-evcaroptions-batteryspecifications
...
/sdk-for-flutter-navigate-routing-evcaroptions-carspecifications
...
/sdk-for-flutter-navigate-routing-evcaroptions-consumptionmodel
...
/sdk-for-flutter-navigate-routing-evcaroptions-ensurereachability
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-evcaroptions-evmobilityserviceproviderpreferences
...
/sdk-for-flutter-navigate-routing-evcaroptions-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-evcaroptions-lastcharacteroflicenseplate
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-evcaroptions-maxspeedonsegments
...
/sdk-for-flutter-navigate-routing-evcaroptions-occupantsnumber
↔ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-evcaroptions-routeoptions
...
/sdk-for-flutter-navigate-routing-evcaroptions-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-evcaroptions-textoptions
...
/sdk-for-flutter-navigate-routing-evcaroptions-tolloptions
...
/sdk-for-flutter-navigate-routing-evcaroptions-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-evcaroptions-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-evcaroptions-operator-equals(<wbr/>Object other)
    → bool
