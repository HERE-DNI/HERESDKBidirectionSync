...
The valid range is [1, 70] meters per second. Note that it is valid only for <a href="sdk-for-flutter-explore-transport-transportmode">TransportMode.car</a>,
<a href="sdk-for-flutter-explore-transport-transportmode">TransportMode.truck</a> and <a href="sdk-for-flutter-explore-transport-transportmode">TransportMode.scooter</a> transport modes.
For car, truck and scooter transport modes, it will affect <a href="sdk-for-flutter-explore-routing-route-duration">Route.duration</a> of
