...
<span id="//apple_ref/swift/Struct/EVChargingOpeningHoursException" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-search">Search</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> EVChargingOpeningHoursException Structure Reference
...
- <div>
  ...
  ` `<span id="/s:7heresdk31EVChargingOpeningHoursExceptionV4date10Foundation4DateVvp"></span>` `<span id="//apple_ref/swift/Property/date" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-evchargingopeninghoursexception#/s:7heresdk31EVChargingOpeningHoursExceptionV4date10Foundation4DateVvp" class="token"><code>date</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk31EVChargingOpeningHoursExceptionV7periodsSayAA14TimeOfDayRangeVGvp"></span>` `<span id="//apple_ref/swift/Property/periods" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-evchargingopeninghoursexception#/s:7heresdk31EVChargingOpeningHoursExceptionV7periodsSayAA14TimeOfDayRangeVGvp" class="token"><code>periods</code></a>` `
  ...
  A list of time periods when the charging location is open on the specified date. The time periods are in the local time zone of the charging location, and are represented as a list of objects with <a href="sdk-for-ios-explore-structs-timeofdayrange#/s:7heresdk14TimeOfDayRangeV4fromSSvp">`TimeOfDayRange.from`</a> and <a href="sdk-for-ios-explore-structs-timeofdayrange#/s:7heresdk14TimeOfDayRangeV2toSSvp">`TimeOfDayRange.to`</a> properties.
...
- <div>
  ...
  ` `<span id="/s:7heresdk31EVChargingOpeningHoursExceptionV6closedSbvp"></span>` `<span id="//apple_ref/swift/Property/closed" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-evchargingopeninghoursexception#/s:7heresdk31EVChargingOpeningHoursExceptionV6closedSbvp" class="token"><code>closed</code></a>` `
  ...
  True if the charging location is closed on particular date, in which case <a href="sdk-for-ios-explore-structs-evchargingopeninghoursexception#/s:7heresdk31EVChargingOpeningHoursExceptionV7periodsSayAA14TimeOfDayRangeVGvp">`EVChargingOpeningHoursException.periods`</a> is empty.
