...
- <div>
  ...
  ` `<span id="/s:7heresdk16NavigabilityTypeO12nonNavigableyA2CmF"></span>` `<span id="//apple_ref/swift/Element/nonNavigable" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-enums-navigabilitytype#/s:7heresdk16NavigabilityTypeO12nonNavigableyA2CmF" class="token"><code>nonNavigable</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk16NavigabilityTypeO9navigableyA2CmF"></span>` `<span id="//apple_ref/swift/Element/navigable" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-enums-navigabilitytype#/s:7heresdk16NavigabilityTypeO9navigableyA2CmF" class="token"><code>navigable</code></a>` `
