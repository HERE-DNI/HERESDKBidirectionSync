...
1.  <span id="sdk-for-flutter-explore-setBearingRangeAtZoom-param-zoom" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-explore-mapview-mapmeasure-class">MapMeasure</a></span> <span class="parameter-name">zoom</span>, </span>
2.  <span id="sdk-for-flutter-explore-setBearingRangeAtZoom-param-bearingRange" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-explore-core-anglerange-class">AngleRange</a></span> <span class="parameter-name">bearingRange</span></span>
...
The resulting camera bearing at a zoom is an interpolated value of the ranges set for closest matching zoom values. When no bearing range is specified for <a href="sdk-for-flutter-explore-mapview-mapcameralimits-minzoomlevel">MapCameraLimits.minZoomLevel</a>, the bearing range set through <a href="sdk-for-flutter-explore-mapview-mapcameralimits-bearingrange">MapCameraLimits.bearingRange</a> is used for interpolation.
