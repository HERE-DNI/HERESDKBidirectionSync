---
title: "operator == method - EVChargingPool class - search library - Dart API"
slug: "sdk-for-flutter-explore-search-evchargingpool-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-explore-search-evchargingpool-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return DeepCollectionEquality().equals(chargingStations, _other.chargingStations) &&
      ...
      DeepCollectionEquality().equals(accessRestrictionReasons, _other.accessRestrictionReasons) &&
