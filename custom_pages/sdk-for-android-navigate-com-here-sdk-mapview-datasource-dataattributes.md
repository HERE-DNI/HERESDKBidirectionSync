...
<div className="inheritance">com.here.sdk.mapview.datasource.DataAttributes</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">DataAttributes</span>
...
<div className="block"><p>Data attributes collection.
