...
<div id="sdk-for-flutter-navigate-dartdoc-main-content" class="main-content" data-above-sidebar="core.engine/LockingProcess-class-sidebar.html" data-below-sidebar="">
...
1.  <span id="sdk-for-flutter-navigate-destroyLockingProcess-param-sdkOptions" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-core-engine-sdkoptions-class">SDKOptions</a></span> <span class="parameter-name">sdkOptions</span>, </span>
2.  <span id="sdk-for-flutter-navigate-destroyLockingProcess-param-maxTimeoutInMilliseconds" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">maxTimeoutInMilliseconds</span></span>
...
Does nothing if cache is not locked or locked by current process. If cache is locked by a different process then the HERE SDK makes a few attempts to kill the locking application during the specified timeout. If it fails to kill the application, it attempts to remove the cache at <a href="sdk-for-flutter-navigate-core-engine-sdkoptions-cachepath">SDKOptions.cachePath</a>. This function can be used before creating a SDKNativeEngine, i.e.
