...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-navigation-maneuverviewlaneassistance"
---
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#lanesForNextManeuver">lanesForNextManeuver</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#lanesForNextNextManeuver">lanesForNextNextManeuver</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.List,java.util.List)">ManeuverViewLaneAssistance</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="sdk-for-android-navigate-lane" title="class in com.here.sdk.navigation">Lane</a>&gt; lanesForNextManeuver,
...
<div class="block"><p>A list of lanes on the road that leads to the maneuver after the upcoming maneuver.
 ...
 Note: This notification is delivered at the same time as the <a href="#lanesForNextManeuver"><code>lanesForNextManeuver</code></a>.
