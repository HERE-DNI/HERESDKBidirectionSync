...
<div id="sdk-for-android-explore-dataExpiryTimestamp"
    ...
    <span class="annotations">@NonNull
    </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Date.html" class="external-link" title="class or interface in java.util">Date</a></span> <span class="element-name">dataExpiryTimestamp</span>
...
<div id="sdk-for-android-explore-<init>(com.here.sdk.mapview.datasource.TileSource.DataVersion,java.util.Date)"
    ...
    @NonNull <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Date.html" class="external-link" title="class or interface in java.util">Date</a> dataExpiryTimestamp)</span>
