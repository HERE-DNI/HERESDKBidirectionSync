...
- **eHorizon layer (`LayerConfiguration.Feature.EHORIZON`)**: Not enabled by default. It encodes segment geometries outside the rendering layer groups to reduce the amount of downloaded data. Use the eHorizon layer when:
  ...
  - No <a href="sdk-for-ios-navigate-classes-mapview">`MapView`</a> is used in your application.
...
1.  Turn on the `ADAS` layer via <a href="sdk-for-ios-navigate-structs-layerconfiguration#sdk-for-ios-navigate-s-7heresdk18LayerConfigurationV15enabledFeaturesSayAC7FeatureOGvp">`LayerConfiguration.enabledFeatures`</a> (it will increase data consumption).
...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk10MapMatcherCACyKcfc"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Method-init" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-classes-mapmatcher#sdk-for-ios-navigate-s-7heresdk10MapMatcherCACyKcfc" class="token"><code>init()</code></a> 
...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk10MapMatcherC9sdkEngineAcA09SDKNativeE0C_tKcfc"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Method-init-sdkEngine" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-classes-mapmatcher#sdk-for-ios-navigate-s-7heresdk10MapMatcherC9sdkEngineAcA09SDKNativeE0C_tKcfc" class="token"><code>init(sdkEngine:</code><wbr></wbr><code>)</code></a> 
...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk10MapMatcherC9sdkEngine18useRenderingLayersAcA09SDKNativeE0C_SbtKcfc"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Method-init-sdkEngine-useRenderingLayers" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-classes-mapmatcher#sdk-for-ios-navigate-s-7heresdk10MapMatcherC9sdkEngine18useRenderingLayersAcA09SDKNativeE0C_SbtKcfc" class="token"><code>init(sdkEngine:</code><wbr></wbr><code>useRenderingLayers:</code><wbr></wbr><code>)</code></a> 
  ...
  <td><div>
  <p>When set to true, <code>LayerConfiguration.Feature.RENDERING</code> is used; otherwise, <code>LayerConfiguration.Feature.EHORIZON</code> is used to retrieve segment geometry data from the OCM map. Note: Ensure the corresponding layer is properly enabled in your <a href="sdk-for-ios-navigate-structs-layerconfiguration"><code>LayerConfiguration</code></a> to avoid incorrect results.</p>
  </div></td>
  </tr>
  </tbody>
  </table>
...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk10MapMatcherC5match8locationAA0B15MatchedLocationVSgAA0G0V_tF"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Method-match-location" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-classes-mapmatcher#sdk-for-ios-navigate-s-7heresdk10MapMatcherC5match8locationAA0B15MatchedLocationVSgAA0G0V_tF" class="token"><code>match(location:</code><wbr></wbr><code>)</code></a> 
