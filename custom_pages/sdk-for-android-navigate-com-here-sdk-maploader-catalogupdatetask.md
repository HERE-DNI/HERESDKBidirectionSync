...
<div class="inheritance">com.here.sdk.maploader.CatalogUpdateTask</div>
</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public final class </span><span class="element-name type-name-label">CatalogUpdateTask</span>
...
<div class="block"><p>A class to control the catalog update process.</p></div>
</section>
...
<div class="block">Cancels the ongoing catalog update operation.</div>
</div>
...
<div class="block"><p>Cancels the ongoing catalog update operation. Operation cannot be resumed afterwards.
 It will do nothing if the task was already cancelled or has been completed.
 Status of the call will be reported via <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-catalogupdateprogresslistener#onComplete(com.here.sdk.maploader.MapLoaderError)"><code>CatalogUpdateProgressListener.onComplete(com.here.sdk.maploader.MapLoaderError)</code></a>.
...
<div class="block"><p>Pauses the ongoing map update operation. Operation can be resumed afterwards.
 ...
 Status of the call will be reported via <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-catalogupdateprogresslistener#onPause(com.here.sdk.maploader.MapLoaderError)"><code>CatalogUpdateProgressListener.onPause(com.here.sdk.maploader.MapLoaderError)</code></a>.</p></div>
</section>
</li>
<li>
