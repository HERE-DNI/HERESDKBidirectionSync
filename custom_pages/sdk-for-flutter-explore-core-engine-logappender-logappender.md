...
LogAppender(<ol class="parameter-list single-line"> <li>void logLambda(<ol class="parameter-list single-line"> <li><a href="/sdk-for-flutter-explore-core-engine-loglevel">LogLevel</a>, </li>
<li>String</li>
</ol>)</li>
</ol>)
