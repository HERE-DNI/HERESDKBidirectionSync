...
/sdk-for-flutter-navigate-routing-tollfare-tollfare(String currency, double price, List&lt;<wbr/>/sdk-for-flutter-navigate-routing-paymentmethod&gt; paymentMethods, [/sdk-for-flutter-navigate-core-timerule-class? timeRule = null, List&lt;<wbr/>String&gt; transponders = const [], /sdk-for-flutter-navigate-routing-tollfarepass-class? pass = null])
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-tollfare-currency
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-tollfare-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-tollfare-pass
↔ /sdk-for-flutter-navigate-routing-tollfarepass-class?
</dt>
<dd>
  Specifies whether this /sdk-for-flutter-navigate-routing-tollfare-class is a multi-travel pass, and its characteristics.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="paymentMethods">
/sdk-for-flutter-navigate-routing-tollfare-paymentmethods
...
/sdk-for-flutter-navigate-routing-tollfare-price
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-tollfare-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-tollfare-timerule
...
/sdk-for-flutter-navigate-routing-tollfare-transponders
↔ List&lt;<wbr/>String&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-tollfare-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-tollfare-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-tollfare-operator-equals(<wbr/>Object other)
    → bool
