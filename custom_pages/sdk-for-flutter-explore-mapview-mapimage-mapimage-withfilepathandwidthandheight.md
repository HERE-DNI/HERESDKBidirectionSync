...
1.  <span id="sdk-for-flutter-explore-withFilePathAndWidthAndHeight-param-filePath" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">filePath</span>, </span>
2.  <span id="sdk-for-flutter-explore-withFilePathAndWidthAndHeight-param-width" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">width</span>, </span>
3.  <span id="sdk-for-flutter-explore-withFilePathAndWidthAndHeight-param-height" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">height</span></span>
