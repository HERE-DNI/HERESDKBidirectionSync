...
<li class="self-crumb">isDynamicFrameRateEnabled property</li>
</ol>
<div class="self-name">isDynamicFrameRateEnabled</div>
...
<div>
<h1>isDynamicFrameRateEnabled property</h1></div>
<section id="getter">
...
<pre class="language-dart"><code class="language-dart">bool get isDynamicFrameRateEnabled;</code></pre>
</section>
</section>
<section id="setter">
<section class="multi-line-signature">
void
isDynamicFrameRateEnabled=(<wbr/>bool value)
</section>
<section class="desc markdown">
<p>Flag used to enable or disable the dynamic frame rate.
Controls whether the number of map updates is dynamically calculated based on
...
<section class="summary source-code" id="source">
<h2>Implementation</h2>
<pre class="language-dart"><code class="language-dart">set isDynamicFrameRateEnabled(bool value);</code></pre>
</section>
</section>
</div> 
