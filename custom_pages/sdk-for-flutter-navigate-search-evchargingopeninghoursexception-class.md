...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-evchargingopeninghoursexception()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-closed
↔ bool
</dt>
<dd>
  True if the charging location is closed on particular date, in which case
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-periods is empty.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="date">
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-date
↔ DateTime
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-periods
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-search-timeofdayrange-class&gt;
</dt>
<dd>
...
are represented as a list of objects with /sdk-for-flutter-navigate-search-timeofdayrange-from
and /sdk-for-flutter-navigate-search-timeofdayrange-to properties.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property inherited" id="runtimeType">
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-search-evchargingopeninghoursexception-operator-equals(<wbr/>Object other)
    → bool
