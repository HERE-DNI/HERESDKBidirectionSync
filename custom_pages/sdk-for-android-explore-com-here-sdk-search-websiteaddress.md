...
java.lang.Object → com.here.sdk.search.WebsiteAddress
...
</span><span class="element-name type-name-label">WebsiteAddress</span>
...
<div id="sdk-for-android-explore-field-summary"
  ...
  <a href="sdk-for-android-explore-com-here-sdk-search-websiteaddress#address" class="member-name-link"><code>address</code></a>
  ...
  <a href="sdk-for-android-explore-com-here-sdk-search-websiteaddress#categories" class="member-name-link"><code>categories</code></a>
...
<div id="sdk-for-android-explore-address" class="section detail">
    ...
    </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a></span> <span class="element-name">address</span>
...
<div id="sdk-for-android-explore-categories" class="section detail">
    ...
    Categories associated with website address. Note: In case categories
    are not empty, then address should be used according to given
    categories. Otherwise, address is meant for general use.
...
<div id="sdk-for-android-explore-<init>(java.lang.String,java.util.List)"
    ...
    <span class="modifiers">public</span> <span class="element-name">WebsiteAddress</span><span class="parameters">(@NonNull
    <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a> address,
    ...
    [`categories`](sdk-for-android-explore-com-here-sdk-search-websiteaddress#categories)
    are not empty, then
    [`address`](sdk-for-android-explore-com-here-sdk-search-websiteaddress#address)
