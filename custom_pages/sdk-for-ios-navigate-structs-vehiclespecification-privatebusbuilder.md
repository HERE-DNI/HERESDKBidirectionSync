...
- <div>
  ...
  Builds the <a href="sdk-for-ios-navigate-structs-vehiclespecification">`VehicleSpecification`</a> object for <a href="sdk-for-ios-navigate-enums-transportmode#/s:7heresdk13TransportModeO3busyA2CmF">`TransportMode.bus`</a> with the specifications taken from the `VehicleSpecification.PrivateBusBuilder` object.
