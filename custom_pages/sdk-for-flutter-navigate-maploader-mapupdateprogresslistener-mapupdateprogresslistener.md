...
<li class="self-crumb">MapUpdateProgressListener factory constructor</li>
</ol>
...
MapUpdateProgressListener(<wbr/><ol class="parameter-list"> <li>void onProgressLambda(<ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-maploader-regionid-class, </li>
<li>int</li>
</ol>), </li>
