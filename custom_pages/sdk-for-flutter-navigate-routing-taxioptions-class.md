...
<p>See, /sdk-for-flutter-navigate-transport-transportmode.</p>
<p><strong>Note:</strong> Specify the optional /sdk-for-flutter-navigate-routing-waypoint-sideofstreethint to indicate at which side of
...
/sdk-for-flutter-navigate-routing-taxioptions-taxioptions(/sdk-for-flutter-navigate-routing-routeoptions-class routeOptions, /sdk-for-flutter-navigate-routing-routetextoptions-class textOptions, /sdk-for-flutter-navigate-routing-avoidanceoptions-class avoidanceOptions)
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="TaxiOptions.withDefaults">
/sdk-for-flutter-navigate-routing-taxioptions-taxioptions-withdefaults()
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-routing-taxioptions-allowdrivethroughtaxiroads
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-taxioptions-avoidanceoptions
...
/sdk-for-flutter-navigate-routing-taxioptions-carspecifications
...
/sdk-for-flutter-navigate-routing-taxioptions-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-taxioptions-lastcharacteroflicenseplate
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-taxioptions-maxspeedonsegments
...
/sdk-for-flutter-navigate-routing-taxioptions-routeoptions
...
/sdk-for-flutter-navigate-routing-taxioptions-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-taxioptions-textoptions
...
/sdk-for-flutter-navigate-routing-taxioptions-tolloptions
...
/sdk-for-flutter-navigate-routing-taxioptions-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-taxioptions-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-taxioptions-operator-equals(<wbr/>Object other)
    → bool
