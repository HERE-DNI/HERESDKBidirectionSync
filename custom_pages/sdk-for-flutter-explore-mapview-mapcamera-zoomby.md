...
<p>This effectively changes the distance from the camera to the /sdk-for-flutter-explore-mapview-mapcamerastate-targetcoordinates
by the specified factor, which changes /sdk-for-flutter-explore-mapview-mapcamerastate-zoomlevel as well.</p>
<p>Values above 1.0 will zoom in and values below will zoom out.</p>
<p>The relation with /sdk-for-flutter-explore-mapview-mapcamerastate-distancetotargetinmeters is inversely linear,
