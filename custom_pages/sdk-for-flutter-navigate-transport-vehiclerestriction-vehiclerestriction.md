...
<li class="self-crumb">VehicleRestriction constructor</li>
</ol>
...
VehicleRestriction(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-transport-specificrestriction-class? restriction</li>
</ol>)
    </section>
