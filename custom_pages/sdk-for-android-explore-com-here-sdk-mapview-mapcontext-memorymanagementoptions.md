...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#memoryManagementStrategy">memoryManagementStrategy</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#tileCacheMemoryLimitInKiB">tileCacheMemoryLimitInKiB</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#videoMemoryLimitInKiB">videoMemoryLimitInKiB</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E()">MemoryManagementOptions</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>The default setting MemoryManagementStrategy.DYNAMIC is suitable for common cases. The map
 ...
 calculated internally or by using <a href="sdk-for-android-explore-index#tileCacheMemoryLimitInKiB"><code>tileCacheMemoryLimitInKiB</code></a> option.
