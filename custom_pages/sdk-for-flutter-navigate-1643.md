...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.navigation/GPXTrackWriter///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="sdk-for-flutter-explore-index">API Reference</a><span class="delimiter">/</span><a href="sdk-for-flutter-explore-index">com.here.sdk.navigation</a><span class="delimiter">/</span><span class="current">GPXTrackWriter</span></div>
  <div class="cover ">
    <h1 class="cover"><span>GPXTrack</span><wbr></wbr><span><span>Writer</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="sdk-for-flutter-explore-index">GPXTrackWriter</a> : <a href="sdk-for-flutter-explore-index">NativeBase</a>, <a href="sdk-for-flutter-explore-index">LocationListener</a></div><p class="paragraph">Writes GPX track points to <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrack</a>. The instance of the class should be added as a listener to the <code class="lang-kotlin">LocationEngine</code> for GPX track recording. Appends the new location to the back segment of the track whenever the listener is called. The following data (if provided) can be recorded and inserted into the resulting <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrack</a>: <code class="lang-kotlin">latitude</code>, <code class="lang-kotlin">longitude</code>, <code class="lang-kotlin">altitude</code>, <code class="lang-kotlin">time</code>, <code class="lang-kotlin">bearingInDegrees</code>, <code class="lang-kotlin">pitchInDegrees</code>, <code class="lang-kotlin">speedInMetersPerSecond</code>, <code class="lang-kotlin">horizontalAccuracyInMeters</code>, <code class="lang-kotlin">verticalAccuracyInMeters</code>, <code class="lang-kotlin">bearingAccuracyInDegrees</code>, <code class="lang-kotlin">speedAccuracyInMetersPerSecond</code> and <code class="lang-kotlin">locationTechnology</code>.</p><p class="paragraph">Use case examples:</p><p class="paragraph">A user wants to create and save a new <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXDocument</a> with one <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrack</a>:</p><ul><li><p class="paragraph">create <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrackWriter</a> and add it as a location listener to <code class="lang-kotlin">LocationEngine</code>.</p></li><li><p class="paragraph">set user parameters to <a href="sdk-for-flutter-explore-track">com.here.sdk.navigation.GPXTrackWriter.track</a> (e.g. <a href="sdk-for-flutter-explore-name">com.here.sdk.navigation.GPXTrack.name</a> or <a href="sdk-for-flutter-explore-description">com.here.sdk.navigation.GPXTrack.description</a>).</p></li><li><p class="paragraph">when writing is completed, create a new <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXDocument</a> with a list of one <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrack</a> and save the document via <a href="sdk-for-flutter-explore-save">com.here.sdk.navigation.GPXDocument.save</a>.</p></li></ul><p class="paragraph">A user wants to modify and save <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrack</a> in the existing <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXDocument</a>:</p><ul><li><p class="paragraph">load <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXDocument</a> from a file by the relevant constructor.</p></li><li><p class="paragraph">create <a href="sdk-for-flutter-explore-index">com.here.sdk.navigation.GPXTrackWriter</a> with the required track in the list <a href="sdk-for-flutter-explore-tracks">com.here.sdk.navigation.GPXDocument.tracks</a>, add the created instance as a location listener to <code class="lang-kotlin">LocationEngine</code>.</p></li><li><p class="paragraph">when writing is completed, save the document via <a href="sdk-for-flutter-explore-save">com.here.sdk.navigation.GPXDocument.save</a>.</p></li></ul><p class="paragraph">The <code class="lang-kotlin">GPXDocument</code> including all tracks is saved in the <a href="https://www.topografix.com/gpx.asp">GPX</a> file format. Hence, once saved, it can be easily shared with other applications that understand the GPX file format.</p></div></div>
  </div>
          ...
          <div class="table-row" data-togglable="CONSTRUCTOR" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-g-p-x-track-writer"><span>GPXTrack</span><wbr></wbr><span><span>Writer</span></span></a></div>
      ...
      <div data-togglable="PROPERTY">
        ...
        <div class="table"><a data-name="1986802652%2FProperties%2F1617540583" anchor-label="track" id="1986802652%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-track"><span><span>track</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1986802652%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="sdk-for-flutter-explore-track">track</a><span class="token operator">: </span><a href="sdk-for-flutter-explore-index">GPXTrack</a></div><div class="brief "><p class="paragraph">GPX track into which GPX track points are written.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
