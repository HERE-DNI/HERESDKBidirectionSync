...
<title>TMCData (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.trafficbroadcast, class: TMCData">
...
<h1 title="Class TMCData" class="title">Class TMCData</h1>
</div>
...
<div class="block"><p>Represents the traffic events in RDS-TMC format.</div>
</section>
...
<div class="col-second even-row-color"><code><a href="#additionalEvents" class="member-name-link">additionalEvents</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#additionalLocations" class="member-name-link">additionalLocations</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#diversionAdvice" class="member-name-link">diversionAdvice</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Diversion advice.</div>
</div>
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a href="#durationPersistence" class="member-name-link">durationPersistence</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a href="#numberOfGroups" class="member-name-link">numberOfGroups</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(short,short,short,short,short,int,long,java.util.List,java.util.List)" class="member-name-link">TMCData</a><wbr>(short&nbsp;numberOfGroups,
 short&nbsp;extent,
 short&nbsp;direction,
 ...
 int&nbsp;event,
 long&nbsp;location,
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang" class="external-link">Integer</a>&gt;&nbsp;additionalEvents,
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" class="external-link">Long</a>&gt;&nbsp;additionalLocations)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Number of groups (1 to 5).</div>
</section>
</li>
<li>
...
<div class="block"><p>Street direction.</div>
</section>
</li>
<li>
...
<div class="block"><p>Diversion advice.</div>
</section>
</li>
<li>
...
<div class="block"><p>Duration persitence.</div>
</section>
</li>
<li>
...
<div class="block"><p>Traffic event data.</div>
</section>
</li>
<li>
...
<div class="block"><p>Traffic event location.</div>
</section>
</li>
<li>
...
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang" class="external-link">Integer</a>&gt;</span>&nbsp;<span class="element-name">additionalEvents</span></div>
<div class="block"><p>Additional traffic events.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="annotations">@NonNull
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" class="external-link">Long</a>&gt;</span>&nbsp;<span class="element-name">additionalLocations</span></div>
<div class="block"><p>Additional traffic locations.</div>
</section>
</li>
</ul>
</section>
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">TMCData</span><wbr><span class="parameters">(short&nbsp;numberOfGroups,
 ...
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang" class="external-link">Integer</a>&gt;&nbsp;additionalEvents,
 @NonNull
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html" title="class or interface in java.lang" class="external-link">Long</a>&gt;&nbsp;additionalLocations)</span></div>
<div class="block"><p>Creates a new instance.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>numberOfGroups</code> - <p>Number of groups (1 to 5).</dd>
<dd><code>extent</code> - <p>Extent.</dd>
<dd><code>direction</code> - <p>Street direction.</dd>
<dd><code>diversionAdvice</code> - <p>Diversion advice.</dd>
<dd><code>durationPersistence</code> - <p>Duration persitence.</dd>
<dd><code>event</code> - <p>Traffic event data.</dd>
<dd><code>location</code> - <p>Traffic event location.</dd>
<dd><code>additionalEvents</code> - <p>Additional traffic events.</dd>
<dd><code>additionalLocations</code> - <p>Additional traffic locations.</dd>
</dl>
</section>
</li>
</ul>
