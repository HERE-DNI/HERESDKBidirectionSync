...
<div className="inheritance">com.here.sdk.core.NameID</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">NameID</span>
<span className="extends-implements">extends <a className="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div className="block"><p>Structure to represent name-id pairs.</p></div>
</section>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-core-nameid#id">id</a></code></div>
<div className="col-last even-row-color">
<div className="block">The ID.</div>
</div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-core-nameid#name">name</a></code></div>
<div className="col-last odd-row-color">
<div className="block">The name.</div>
</div>
</div>
</section>
</li>
...
<div className="col-constructor-name even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-core-nameid#%3Cinit%3E()">NameID</a>()</code></div>
<div className="col-last even-row-color">
...
<div className="block"><p>The name.</p></div>
</section>
</li>
<li>
...
<div className="block"><p>The ID.</p></div>
</section>
</li>
</ul>
</section>
...
<h3>NameID</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="element-name">NameID</span>()</div>
