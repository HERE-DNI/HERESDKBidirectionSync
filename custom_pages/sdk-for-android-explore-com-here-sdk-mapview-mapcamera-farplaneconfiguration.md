...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#distanceFactor">distanceFactor</a></code></div>
<div class="col-last even-row-color">
<div class="block">Multiplier applied to the camera distance to target when calculating the far plane.</div>
</div>
<div class="col-first odd-row-color"><code>double</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#minDistanceInMeters">minDistanceInMeters</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E(double,double)">FarPlaneConfiguration</a><wbr/>(double distanceFactor,
