...
<div class="abstract">
<p>The distance in meters from current location until the end of the <code><a href="sdk-for-ios-navigate-classes-section">Section</a></code>.
...
<div class="pointer"></div>
<div class="abstract">
<p>The estimated time in seconds from current location until the end of the <code><a href="sdk-for-ios-navigate-classes-section">Section</a></code>
...
<code><a href="sdk-for-ios-navigate-classes-section">Section</a></code> is reached.
Note that the value is accumulated per section, and that the last section contains the overall
