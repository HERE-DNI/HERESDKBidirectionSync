...
1.  <span id="sdk-for-flutter-explore-param-path" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">path</span>, </span>
2.  <span id="sdk-for-flutter-explore-param-diskSize" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">diskSize</span></span>
