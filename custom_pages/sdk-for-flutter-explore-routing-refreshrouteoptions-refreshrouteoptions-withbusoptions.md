...
RefreshRouteOptions.withBusOptions(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-explore-routing-busoptions-class busOptions</li>
</ol>)
    </section>
<section class="desc markdown">
<p>Constructs a RefreshRouteOptions object with /sdk-for-flutter-explore-routing-busoptions-class.</p>
<ul>
