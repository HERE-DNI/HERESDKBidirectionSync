...
slug: "sdk-for-flutter-navigate-core-geobox-expandedby"
---
...
<span class="returntype"><a href="sdk-for-flutter-navigate-core-geobox-class">GeoBox</a></span> <span class="name">expandedBy</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-expandedBy-param-southMeters" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">southMeters</span>, </span>
2.  <span id="sdk-for-flutter-navigate-expandedBy-param-westMeters" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">westMeters</span>, </span>
3.  <span id="sdk-for-flutter-navigate-expandedBy-param-northMeters" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">northMeters</span>, </span>
4.  <span id="sdk-for-flutter-navigate-expandedBy-param-eastMeters" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">eastMeters</span>, </span>
...
Returns <a href="sdk-for-flutter-navigate-core-geobox-class">GeoBox</a>. The expanded `GeoBox`.
