...
<li class="self-crumb">DeletedRegionsCallback typedef</li>
</ol>
<div class="self-name">DeletedRegionsCallback</div>
...
<p>A method which is called on the main thread when /sdk-for-flutter-navigate-maploader-mapdownloader-deleteregions has been completed.</p>
<ul>
<li>
