...
<a href="/sdk-for-flutter-navigate-mapview-mapmeasurerange-class">MapMeasureRange</a>
zoomRange


<p>The zoom range that can be applied to the camera.
Gets the currently set camera zoom range.</p>
<p>By default, a <a href="/sdk-for-flutter-navigate-mapview-mapcameralimits-minzoomlevel">MapCameraLimits.minZoomLevel</a>-<a href="/sdk-for-flutter-navigate-mapview-mapcameralimits-maxzoomlevel">MapCameraLimits.maxZoomLevel</a> zoom range is set during initialization.</p>
...
void
zoomRange=(<a href="/sdk-for-flutter-navigate-mapview-mapmeasurerange-class">MapMeasureRange</a> value)


<p>The zoom range that can be applied to the camera.
Sets a new camera zoom range.</p>
<p>The supported values fall inside <a href="/sdk-for-flutter-navigate-mapview-mapcameralimits-minzoomlevel">MapCameraLimits.minZoomLevel</a>-<a href="/sdk-for-flutter-navigate-mapview-mapcameralimits-maxzoomlevel">MapCameraLimits.maxZoomLevel</a> range.
