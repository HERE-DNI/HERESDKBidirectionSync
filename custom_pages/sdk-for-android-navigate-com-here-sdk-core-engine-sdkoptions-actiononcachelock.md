...
java.lang.Object java.lang.Enum \< SDKOptions.ActionOnCacheLock \> com.here.sdk.core.engine.SDKOptions.ActionOnCacheLock → java.lang.Enum \< SDKOptions.ActionOnCacheLock \> com.here.sdk.core.engine.SDKOptions.ActionOnCacheLock → com.here.sdk.core.engine.SDKOptions.ActionOnCacheLock
...
<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html" class="external-link" title="class or interface in java.io"><code>Serializable</code></a>, <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html" class="external-link" title="class or interface in java.lang"><code>Comparable</code></a>`<`<a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">`SDKOptions.ActionOnCacheLock`</a>`>`, <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/constant/Constable.html" class="external-link" title="class or interface in java.lang.constant"><code>Constable</code></a>
...
<span class="modifiers">public static enum </span><span class="element-name type-name-label">SDKOptions.ActionOnCacheLock</span> <span class="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html" class="external-link" title="class or interface in java.lang">Enum</a>\<<a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a>\></span>
...
- <div id="sdk-for-android-navigate-enum-constant-summary" class="section constants-summary">
  ...
  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock#KILL_LOCKING_APP" class="member-name-link"><code>KILL_LOCKING_APP</code></a>
  ...
  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock#NO_ACTION" class="member-name-link"><code>NO_ACTION</code></a>
  ...
  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock#WAIT_LOCKING_APP_FINISH" class="member-name-link"><code>WAIT_LOCKING_APP_FINISH</code></a>
...
- <div id="sdk-for-android-navigate-method-summary" class="section method-summary">
  ...
  `static `<a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">`SDKOptions.ActionOnCacheLock`</a>
...
- <div id="sdk-for-android-navigate-enum-constant-detail" class="section constant-details">
  ...
  - <div id="sdk-for-android-navigate-NO_ACTION" class="section detail">

    ### NO_ACTION

    <div class="member-signature">

    <span class="modifiers">public static final</span> <span class="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a></span> <span class="element-name">NO_ACTION</span>
  ...
  - <div id="sdk-for-android-navigate-WAIT_LOCKING_APP_FINISH" class="section detail">

    ### WAIT_LOCKING_APP_FINISH

    <div class="member-signature">

    <span class="modifiers">public static final</span> <span class="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a></span> <span class="element-name">WAIT_LOCKING_APP_FINISH</span>
  ...
  - <div id="sdk-for-android-navigate-KILL_LOCKING_APP" class="section detail">

    ### KILL_LOCKING_APP

    <div class="member-signature">

    <span class="modifiers">public static final</span> <span class="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a></span> <span class="element-name">KILL_LOCKING_APP</span>
...
- <div id="sdk-for-android-navigate-method-detail" class="section method-details">
  ...
  - <div id="sdk-for-android-navigate-values" class="section detail">
    ...
    <span class="modifiers">public static</span> <span class="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a>\[\]</span> <span class="element-name">values</span>()
  ...
  - <div id="sdk-for-android-navigate-valueOf-java-lang-String" class="section detail">
    ...
    <span class="modifiers">public static</span> <span class="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-engine-sdkoptions-actiononcachelock" title="enum class in com.here.sdk.core.engine">SDKOptions.ActionOnCacheLock</a></span> <span class="element-name">valueOf</span><wbr></wbr><span class="parameters">(<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a> name)</span>
