...
parameters at runtime to initialize the /sdk-for-flutter-navigate-core-engine-sdknativeengine-class.</p>
</section>
<section class="summary offset-anchor" id="constructors">
<h2>Constructors</h2>
<dl class="constructor-summary-list">
<dt class="callable" id="SDKOptions.withAuthenticationMode">
/sdk-for-flutter-navigate-core-engine-sdkoptions-sdkoptions-withauthenticationmode(/sdk-for-flutter-navigate-core-engine-authenticationmode-class authenticationMode)
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-actiononcachelock
↔ /sdk-for-flutter-navigate-core-engine-sdkoptionsactiononcachelock
</dt>
<dd>
  Specifies action to perform when cache folder is locked by another process. Default value is /sdk-for-flutter-navigate-core-engine-sdkoptionsactiononcachelock.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="authenticationMode">
/sdk-for-flutter-navigate-core-engine-sdkoptions-authenticationmode
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-autoupdateofonlinecache
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-billingtag
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-cachepath
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-cachesizeinbytes
↔ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-catalogconfigurations
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-core-engine-catalogconfiguration-class&gt;
</dt>
<dd>
  This field specifies how the /sdk-for-flutter-navigate-core-engine-sdknativeengine-class should access, use and store
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-customengineoptions
↔ Map&lt;<wbr/>/sdk-for-flutter-navigate-core-engine-enginebaseurl, /sdk-for-flutter-navigate-core-engine-engineoptions-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-customoptions
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-datapath
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-layerconfiguration
↔ /sdk-for-flutter-navigate-core-engine-layerconfiguration-class
</dt>
<dd>
  Defines a list of data features that can be enabled / disabled. Once set to /sdk-for-flutter-navigate-core-engine-sdkoptions-class when
...
/sdk-for-flutter-navigate-core-engine-layerconfiguration-class. However, for new map data, it will be applied.
For offline maps, this /sdk-for-flutter-navigate-core-engine-layerconfiguration-class can reduce the download size of all regions.
Note that the /sdk-for-flutter-navigate-core-engine-layerconfiguration-class is applied globally to all regions that will be downloaded
in the future. It will not affect already downloaded regions. Updating a region will also
not update the /sdk-for-flutter-navigate-core-engine-layerconfiguration-class. Only the /sdk-for-flutter-navigate-core-engine-layerconfiguration-class will be used that was set
globally when a region was downloaded for the first time. If you want to update the
/sdk-for-flutter-navigate-core-engine-layerconfiguration-class for an already downloaded region, please delete the region and download it again.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="lowMemoryMode">
/sdk-for-flutter-navigate-core-engine-sdkoptions-lowmemorymode
↔ bool
</dt>
<dd>
...
In order to release memory occupied by internal caches see /sdk-for-flutter-navigate-core-engine-sdknativeengine-purgememorycaches.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="networkSettings">
/sdk-for-flutter-navigate-core-engine-sdkoptions-networksettings
...
The mode can be disabled or enabled again at any time via /sdk-for-flutter-navigate-core-engine-sdknativeengine-isofflinemode.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="persistentMapStoragePath">
/sdk-for-flutter-navigate-core-engine-sdkoptions-persistentmapstoragepath
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-politicalview
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-scope
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-core-engine-sdkoptions-operator-equals(<wbr/>Object other)
    → bool
