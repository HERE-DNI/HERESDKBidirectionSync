...
slug: "sdk-for-flutter-navigate-mapview-mapmarker3d-mapmarker3d-fromimage"
---
...
1.  <span id="sdk-for-flutter-navigate-fromImage-param-at" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-core-geocoordinates-class">GeoCoordinates</a></span> <span class="parameter-name">at</span>, </span>
2.  <span id="sdk-for-flutter-navigate-fromImage-param-image" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-mapview-mapimage-class">MapImage</a></span> <span class="parameter-name">image</span>, </span>
3.  <span id="sdk-for-flutter-navigate-fromImage-param-scale" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">scale</span>, </span>
4.  <span id="sdk-for-flutter-navigate-fromImage-param-unit" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-mapview-rendersizeunit">RenderSizeUnit</a></span> <span class="parameter-name">unit</span>, </span>
...
Only bitmap images are supported, using a <a href="sdk-for-flutter-navigate-mapview-mapimage-class">MapImage</a> created from SVG data will result in distorted rendering of the flat marker.
