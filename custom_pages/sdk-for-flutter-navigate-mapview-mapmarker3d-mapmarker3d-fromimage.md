...
MapMarker3D.fromImage(<wbr/><ol class="parameter-list"> <li>/sdk-for-flutter-navigate-core-geocoordinates-class at, </li>
...
<p>Only bitmap images are supported, using a /sdk-for-flutter-navigate-mapview-mapimage-class created from SVG data
...
<p>For /sdk-for-flutter-navigate-mapview-rendersizeunit, the flat marker will cover <code>MapMarker3D.fromImage.scale</code> * image's width pixels
...
<p>For /sdk-for-flutter-navigate-mapview-rendersizeunit the flat marker will cover <code>MapMarker3D.fromImage.scale</code> *
...
the screen.</p>
<p>For /sdk-for-flutter-navigate-mapview-rendersizeunit the flat marker will cover <code>MapMarker3D.fromImage.scale</code> * image's width meters
