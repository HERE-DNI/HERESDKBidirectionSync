...
<li>/sdk-for-flutter-navigate-mapview-translucentmaplayergroup-class</li>
...
<li>/sdk-for-flutter-navigate-mapview-heremapcontrollercore-class aMap, </li>
<li>/sdk-for-flutter-navigate-mapview-maplayerpriority-class priority</li>
</ol>)
    </section>
...
<ul>
<li>
<p><code>name</code> Name of the group. Must be unique across /sdk-for-flutter-navigate-mapview-maplayer-class and /sdk-for-flutter-navigate-mapview-translucentmaplayergroup-class.</p>
</li>
<li>
<p><code>aMap</code> The map to attach the group to.</p>
</li>
<li>
<p><code>priority</code> The /sdk-for-flutter-navigate-mapview-maplayerpriority-class which should be applied to position the group.
The /sdk-for-flutter-navigate-mapview-maplayerpriority-class must contain only one priority and this priority must have no
category and no group, i.e. /sdk-for-flutter-navigate-mapview-maplayerprioritybuilder-ingroup and
/sdk-for-flutter-navigate-mapview-maplayerprioritybuilder-withcategory should not be used when building the
...
<p>Throws /sdk-for-flutter-navigate-mapview-translucentmaplayergroupinstantiationexception-class. In case of invalid input parameters.</p>
</section>
