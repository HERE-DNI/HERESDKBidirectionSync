...
List&lt;<a href="sdk-for-flutter-explore-core-engine-usagestats-class">UsageStats</a>&gt;
sdkUsageStats


<p>Gets a list of usage statistics for all available HERE SDK features.
<a href="sdk-for-flutter-explore-core-engine-usagestats-class">UsageStats</a> has cache and persistent storage. Reads from the persistent storage happen on <code>SDKNativeEngine</code> creation step.
