...
<div className="inheritance">com.here.sdk.routing.RouteRailwayCrossingType</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public enum </span><span className="element-name type-name-label">RouteRailwayCrossingType</span>
...
<div className="block"><p>Identify possible type of route railway crossing.</p></div>
</section>
...
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype#PROTECTED_WITH_BARRIER">PROTECTED_WITH_BARRIER</a></code></div>
<div className="col-last even-row-color">
<div className="block">Railway crossing is protected with a barrier.</div>
</div>
<div className="col-first odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype#UNKNOWN">UNKNOWN</a></code></div>
<div className="col-last odd-row-color">
<div className="block">Information about railway crossing is not available.</div>
</div>
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype#UNPROTECTED_WITH_BARRIER">UNPROTECTED_WITH_BARRIER</a></code></div>
<div className="col-last even-row-color">
...
<h3>UNKNOWN</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype" title="enum class in com.here.sdk.routing">RouteRailwayCrossingType</a></span> <span className="element-name">UNKNOWN</span></div>
<div className="block"><p>Information about railway crossing is not available.</p></div>
</section>
</li>
<li>
<section className="detail" id="PROTECTED_WITH_BARRIER">
<h3>PROTECTED_WITH_BARRIER</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype" title="enum class in com.here.sdk.routing">RouteRailwayCrossingType</a></span> <span className="element-name">PROTECTED_WITH_BARRIER</span></div>
<div className="block"><p>Railway crossing is protected with a barrier.</p></div>
</section>
</li>
<li>
<section className="detail" id="UNPROTECTED_WITH_BARRIER">
<h3>UNPROTECTED_WITH_BARRIER</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype" title="enum class in com.here.sdk.routing">RouteRailwayCrossingType</a></span> <span className="element-name">UNPROTECTED_WITH_BARRIER</span></div>
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-routerailwaycrossingtype" title="enum class in com.here.sdk.routing">RouteRailwayCrossingType</a>[]</span> <span className="element-name">values</span>()</div>
