...
<title>RoadAttributes (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.navigation, class: RoadAttributes">
...
<h1 title="Class RoadAttributes" class="title">Class RoadAttributes</h1>
</div>
...
<div class="block"><p>Road attributes, including usage and physical characteristics.
 Note that a road can have more than one attribute at the same time.</div>
</section>
...
<div class="col-second even-row-color"><code><a href="#isBridge" class="member-name-link">isBridge</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#isBuiltUpArea" class="member-name-link">isBuiltUpArea</a></code></div>
...
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a href="#isDirtRoad" class="member-name-link">isDirtRoad</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates whether the navigable segment is paved.</div>
</div>
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a href="#isDividedRoad" class="member-name-link">isDividedRoad</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a href="#isNoThrough" class="member-name-link">isNoThrough</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Identifies a no through road.</div>
</div>
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a href="#isPrivate" class="member-name-link">isPrivate</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a href="#isRamp" class="member-name-link">isRamp</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Range is a ramp: connects roads that do not intersect at grade.</div>
</div>
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a href="#isRightDrivingSide" class="member-name-link">isRightDrivingSide</a></code></div>
<div class="col-last even-row-color">
<div class="block">Indicates if vehicles have to drive on the right-hand side of the road or the left-hand side.</div>
</div>
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a href="#isRoundabout" class="member-name-link">isRoundabout</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates the presence of a roundabout.</div>
</div>
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a href="#isTollway" class="member-name-link">isTollway</a></code></div>
<div class="col-last even-row-color">
<div class="block">Identifies a road for which a fee must be paid to use the road.</div>
</div>
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a href="#isTunnel" class="member-name-link">isTunnel</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">RoadAttributes</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Indicates whether the navigable segment is paved.
 ...
 Unpaved roads do not have a solid surface, e.g. are made of gravel, dirt or grass.</div>
</section>
</li>
<li>
...
<div class="block"><p>Identifies an enclosed (on all sides) passageway through or under an obstruction.
 This attribute can be used for display or route guidance.</div>
</section>
</li>
<li>
...
<div class="block"><p>Identifies a structure that allows a road, railway, or walkway
 ...
 bridges and/or overpasses; elevated roads are not published as bridge.</div>
</section>
</li>
<li>
...
<div class="block"><p>Range is a ramp: connects roads that do not intersect at grade.
 ...
 and for route guidance when determining if sign text should be used.</div>
</section>
</li>
<li>
...
<div class="block"><p>Controlled access roads are roads with limited entrances and exits
 ...
 publishing speed limits, and route guidance timing.</div>
</section>
</li>
<li>
...
<div class="block"><p>Private identifies roads that are not maintained by an organization
 ...
 May be used to avoid routing through a private road.</div>
</section>
</li>
<li>
...
<div class="block"><p>Identifies a no through road. This can also be a part of the route you can only enter or leave if it’s a waypoint.</div>
</section>
</li>
<li>
...
<div class="block"><p>Identifies a road for which a fee must be paid to use the road.
 ...
 Tollway is flagged on roads that require a fee for traversal.</div>
</section>
</li>
<li>
...
<div class="block"><p>Indicates if vehicles have to drive on the right-hand side of the road or the left-hand side.
 ...
 a left-hand driving country.</div>
</section>
</li>
<li>
...
<div class="block"><p>Indicates the presence of a roundabout.</div>
</section>
</li>
<li>
...
<div class="block"><p>Indicates if the navigable segment is a built up area.</div>
</section>
</li>
</ul>
</section>
