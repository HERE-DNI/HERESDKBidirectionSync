...
<li class="self-crumb">prefetcher.dart</li>
</ol>
<div class="self-name">prefetcher</div>
...
<main>
<div class="main-content" data-above-sidebar="" data-below-sidebar="prefetcher/prefetcher-library-sidebar.html" id="dartdoc-main-content">
<div>
<h1>prefetcher library</h1>
</div>
<section class="summary offset-anchor" id="classes">
<h2>Classes</h2>
<dl>
<dt id="MapDataSize">
/sdk-for-flutter-navigate-prefetcher-mapdatasize-class
</dt>
<dd>
  Represents map data size.
</dd>
<dt id="MapDataSizeListener">
/sdk-for-flutter-navigate-prefetcher-mapdatasizelistener-class
</dt>
<dd>
  Abstract class to get the result of map data size
estimation.
</dd>
<dt id="PolygonPrefetcher">
/sdk-for-flutter-navigate-prefetcher-polygonprefetcher-class
</dt>
<dd>
...
<dt id="PrefetchStatusListener">
/sdk-for-flutter-navigate-prefetcher-prefetchstatuslistener-class
</dt>
<dd>
  Abstract class to get notified on status updates
when prefetching map data.
</dd>
<dt id="RoutePrefetcher">
/sdk-for-flutter-navigate-prefetcher-routeprefetcher-class
</dt>
<dd>
  Supports downloading of map data - in advance - into the cache to optimize temporary offline
use cases that rely on cached map data.
