...
<p>Called when the map view to which this /sdk-for-flutter-navigate-mapview-mapviewlifecyclelistener-class is attached to gets paused
(usually when the app goes into background).</p>
<p>This should be used by components that
perform continuous updates to pause those updates until /sdk-for-flutter-navigate-mapview-mapviewlifecyclelistener-onresume
is called.</p>
</section>
