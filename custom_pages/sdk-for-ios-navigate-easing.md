...
slug: "sdk-for-ios-navigate-easing"
---
...
<html lang="en">
  <head>
    <title>Easing Class Reference</title>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">_</span> <span class="nv">easingFunction</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-easingfunction">EasingFunction</a></span><span class="p">)</span></code></pre>
...
<div class="aside aside-throws">
    ...
    <code><a href="sdk-for-ios-explore-easing#/s:7heresdk6EasingC18InstantiationErrora">Easing.InstantiationError</a></code> Instantiation error in case of invalid input parameters.
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">_</span> <span class="nv">points</span><span class="p">:</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-explore-point2d">Point2D</a></span><span class="p">])</span> <span class="k">throws</span></code></pre>
...
There must be at least 2 data points specified. The first point&rsquo;s X value must be 0, the last point&rsquo;s
X value must be 1.
During an animation run for any given time value X&rsquo; from the animation engine that
satisfies the relation X(i) &lt; X&rsquo; &lt; X(i+1) for the given X data points the corresponding
Y&rsquo; value will be calculated by linearly interpolating between Y(i) and Y(i+1) data points.
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Describes a reason for failing to create an <code><a href="sdk-for-ios-explore-easing">Easing</a></code>.</p>
...
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt"><a href="sdk-for-ios-explore-easing">Easing</a></span><span class="o">.</span><span class="kt">InstantiationErrorCode</span> <span class="p">:</span> <span class="kt">Error</span></code></pre>
