...
<title>DownloadRegionsStatusListener (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.maploader, interface: DownloadRegionsStatusListener">
...
<h1 title="Interface DownloadRegionsStatusListener" class="title">Interface DownloadRegionsStatusListener</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onDownloadRegionsComplete(com.here.sdk.maploader.MapLoaderError,java.util.List)" class="member-name-link">onDownloadRegionsComplete</a><wbr>(<a href="sdk-for-android-explore-maploadererror" title="enum class in com.here.sdk.maploader">MapLoaderError</a>&nbsp;error,
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-regionid" title="class in com.here.sdk.maploader">RegionId</a>&gt;&nbsp;regions)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onPause(com.here.sdk.maploader.MapLoaderError)" class="member-name-link">onPause</a><wbr>(<a href="sdk-for-android-explore-maploadererror" title="enum class in com.here.sdk.maploader">MapLoaderError</a>&nbsp;error)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Called when download is paused.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onProgress(com.here.sdk.maploader.RegionId,int)" class="member-name-link">onProgress</a><wbr>(<a href="sdk-for-android-explore-regionid" title="class in com.here.sdk.maploader">RegionId</a>&nbsp;region,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onResume()" class="member-name-link">onResume</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onDownloadRegionsComplete</span><wbr><span class="parameters">(@Nullable
 <a href="sdk-for-android-explore-maploadererror" title="enum class in com.here.sdk.maploader">MapLoaderError</a>&nbsp;error,
 @Nullable
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-regionid" title="class in com.here.sdk.maploader">RegionId</a>&gt;&nbsp;regions)</span></div>
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onProgress</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-regionid" title="class in com.here.sdk.maploader">RegionId</a>&nbsp;region,
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>region</code> - <p>Represents an id of region status update is related to.</dd>
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onPause</span><wbr><span class="parameters">(@Nullable
 <a href="sdk-for-android-explore-maploadererror" title="enum class in com.here.sdk.maploader">MapLoaderError</a>&nbsp;error)</span></div>
<div class="block"><p>Called when download is paused.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>error</code> - <p>Populated when retryable error is a reason of a pause. It is 'null' when pause
     is called by the user.</dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Called when paused download is resumed.</div>
</section>
</li>
</ul>
</section>
