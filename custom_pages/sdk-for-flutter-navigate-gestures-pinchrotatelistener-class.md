...
<main>
<div class="main-content" data-above-sidebar="gestures/gestures-library-sidebar.html" data-below-sidebar="gestures/PinchRotateListener-class-sidebar.html" id="dartdoc-main-content">
<div>
<h1>PinchRotateListener class abstract</h1></div>
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-pinchrotatelistener(void onPinchRotateLambda(/sdk-for-flutter-navigate-gestures-gesturestate, /sdk-for-flutter-navigate-core-point2d-class, /sdk-for-flutter-navigate-core-point2d-class, double, /sdk-for-flutter-navigate-core-angle-class))
</dt>
<dd>
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-onpinchrotate(<wbr/>/sdk-for-flutter-navigate-gestures-gesturestate state, /sdk-for-flutter-navigate-core-point2d-class pinchOrigin, /sdk-for-flutter-navigate-core-point2d-class rotationOrigin, double twoFingerDistance, /sdk-for-flutter-navigate-core-angle-class rotation)
    → void
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-gestures-pinchrotatelistener-operator-equals(<wbr/>Object other)
    → bool
