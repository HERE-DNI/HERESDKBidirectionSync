...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-mapdata-railwaycrossing"
---
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#endOffsetInMeters">endOffsetInMeters</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#railwayCrossingType">railwayCrossingType</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.mapdata.RailwayCrossingType)">RailwayCrossing</a><wbr/>(<a href="sdk-for-android-navigate-railwaycrossingtype" title="enum class in com.here.sdk.mapdata">RailwayCrossingType</a> railwayCrossingType)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>The start offset, in meters, from the beginning of the segment.
 </p><p>If <a href="#endOffsetInMeters"><code>endOffsetInMeters</code></a> = 0, then <a href="#startOffsetInMeters"><code>startOffsetInMeters</code></a> approximately indicates a middle of a railway crossing.
 If <a href="#endOffsetInMeters"><code>endOffsetInMeters</code></a> &gt; 0, it means crossing consists of several rails, and
 <a href="#startOffsetInMeters"><code>startOffsetInMeters</code></a> and <a href="#endOffsetInMeters"><code>endOffsetInMeters</code></a> indicates starting and ending points of the crossing respectively.
...
<div class="block"><p>The end offset, in meters, from the beginning of the segment.
 Could be 0. See <a href="#startOffsetInMeters"><code>startOffsetInMeters</code></a> description.
 Default value is 0.</p></div>
</section>
</li>
<li>
