...
<li class="self-crumb">SDKCacheCallback typedef</li>
</ol>
<div class="self-name">SDKCacheCallback</div>
...
<p>A method which is called on the main thread when /sdk-for-flutter-navigate-maploader-sdkcache-clearappcache has been completed.</p>
<ul>
<li><code>maploaderError</code> Represents an error in case of a failure. It is <code>null</code> for an operation that succeeds.
Please note, in case of failure, only /sdk-for-flutter-navigate-maploader-maploadererror error returned for now.</li>
</ul>
</section>
