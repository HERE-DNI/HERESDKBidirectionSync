...
<span id="//apple_ref/swift/Struct/TrafficIncidentsQueryOptions" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-traffic">Traffic</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> TrafficIncidentsQueryOptions Structure Reference
...
- <div>
  ...
  ` `<span id="/s:7heresdk28TrafficIncidentsQueryOptionsV10typeFilterSayAA0B12IncidentTypeOGvp"></span>` `<span id="//apple_ref/swift/Property/typeFilter" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-trafficincidentsqueryoptions#/s:7heresdk28TrafficIncidentsQueryOptionsV10typeFilterSayAA0B12IncidentTypeOGvp" class="token"><code>typeFilter</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk28TrafficIncidentsQueryOptionsV12impactFilterSayAA0B14IncidentImpactOGvp"></span>` `<span id="//apple_ref/swift/Property/impactFilter" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-trafficincidentsqueryoptions#/s:7heresdk28TrafficIncidentsQueryOptionsV12impactFilterSayAA0B14IncidentImpactOGvp" class="token"><code>impactFilter</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk28TrafficIncidentsQueryOptionsV17earliestStartTime10Foundation4DateVSgvp"></span>` `<span id="//apple_ref/swift/Property/earliestStartTime" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-trafficincidentsqueryoptions#/s:7heresdk28TrafficIncidentsQueryOptionsV17earliestStartTime10Foundation4DateVSgvp" class="token"><code>earliestStartTime</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk28TrafficIncidentsQueryOptionsV13latestEndTime10Foundation4DateVSgvp"></span>` `<span id="//apple_ref/swift/Property/latestEndTime" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-trafficincidentsqueryoptions#/s:7heresdk28TrafficIncidentsQueryOptionsV13latestEndTime10Foundation4DateVSgvp" class="token"><code>latestEndTime</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk28TrafficIncidentsQueryOptionsV12languageCodeAA08LanguageG0OSgvp"></span>` `<span id="//apple_ref/swift/Property/languageCode" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-trafficincidentsqueryoptions#/s:7heresdk28TrafficIncidentsQueryOptionsV12languageCodeAA08LanguageG0OSgvp" class="token"><code>languageCode</code></a>` `
  ...
  The language code of the query. It’s the expected language of fields `description` and <a href="sdk-for-ios-explore-classes-trafficincident#/s:7heresdk15TrafficIncidentC7summaryAA13LocalizedTextVvp">`TrafficIncident.summary`</a> in the relevant response. However, the language code doesn’t impact on <a href="sdk-for-ios-explore-structs-trafficlocation#/s:7heresdk15TrafficLocationV11descriptionSSvp">`TrafficLocation.description`</a>. If the language code is null or not supported then response fields are expected in the original language of the country that the incident belongs to.
