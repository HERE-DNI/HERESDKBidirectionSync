...
<p>A map layer can be created by using the /sdk-for-flutter-navigate-mapview-maplayerbuilder-class. At creation, the layer
...
/sdk-for-flutter-navigate-mapview-maplayer-maplayer()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-mapview-maplayer-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-maplayer-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-maplayer-destroy(<wbr/>)
    → void
...
/sdk-for-flutter-navigate-mapview-maplayer-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-maplayer-setenabled(<wbr/>bool enable)
    → void
...
/sdk-for-flutter-navigate-mapview-maplayer-setpriority(<wbr/>/sdk-for-flutter-navigate-mapview-maplayerpriority-class priority)
    → void
...
/sdk-for-flutter-navigate-mapview-maplayer-setstyle(<wbr/>/sdk-for-flutter-navigate-mapview-style-class style)
    → void
...
/sdk-for-flutter-navigate-mapview-maplayer-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-maplayer-operator-equals(<wbr/>Object other)
    → bool
