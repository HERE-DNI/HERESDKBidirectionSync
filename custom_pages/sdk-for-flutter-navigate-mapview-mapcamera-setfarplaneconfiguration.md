...
1.  <span id="sdk-for-flutter-navigate-setFarPlaneConfiguration-param-configs" class="parameter"><span class="type-annotation">Map<span class="signature">\<<wbr></wbr><span class="type-parameter">double</span>, <span class="type-parameter"><a href="sdk-for-flutter-navigate-mapview-mapcamerafarplaneconfiguration-class">MapCameraFarPlaneConfiguration</a></span>\></span></span> <span class="parameter-name">configs</span></span>
