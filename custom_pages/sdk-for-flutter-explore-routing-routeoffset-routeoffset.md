...
<ul>
<li><code>sectionIndex</code> Index of the corresponding route <a href="sdk-for-flutter-explore-routing-section-class">Section</a>. The start of the section indicates the start of the offset.</li>
<li><code>offsetInMeters</code> Offset from the start of the indexed <a href="sdk-for-flutter-explore-routing-section-class">Section</a> to the specified location along the route.
