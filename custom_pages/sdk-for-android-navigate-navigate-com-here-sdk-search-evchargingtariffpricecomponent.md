...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-search-evchargingtariffpricecomponent"
---
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#vat">vat</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">EVChargingTariffPriceComponent</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>The price per unit, excluding VAT. The units are defined by the <a href="#dimension"><code>dimension</code></a></p></div>
</section>
</li>
<li>
...
<div class="block"><p>Dimension quantity used as a unit of billing. Present for all other dimensions except
 <a href="sdk-for-android-navigate-evchargingtariffdimension#FLAT"><code>EVChargingTariffDimension.FLAT</code></a>. The customer is charged price for each full or partial
 step of the dimension consumed. For <a href="sdk-for-android-navigate-evchargingtariffdimension#ENERGY"><code>EVChargingTariffDimension.ENERGY</code></a>, the step size unit
 is 1 Wh, for <a href="sdk-for-android-navigate-evchargingtariffdimension#TIME"><code>EVChargingTariffDimension.TIME</code></a> and <a href="sdk-for-android-navigate-evchargingtariffdimension#PARKING_TIME"><code>EVChargingTariffDimension.PARKING_TIME</code></a>
