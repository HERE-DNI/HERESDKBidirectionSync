...
LogAppender(<wbr/><ol class="parameter-list single-line"> <li>void logLambda(<ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-core-engine-loglevel, </li>
<li>String</li>
</ol>)</li>
</ol>)
    </section>
