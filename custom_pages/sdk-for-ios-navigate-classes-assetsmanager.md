...
<pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">_</span> <span class="nv">context</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-mapcontext">MapContext</a></span><span class="p">)</span></code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<ul>
<li>the SVG <code>text</code> tag as <code>font-family</code> attribute parameter when creating a <code><a href="sdk-for-ios-navigate-classes-mapimage">MapImage</a></code> with <code>ImageFormat.SVG</code>.</li>
<li><code><a href="sdk-for-ios-navigate-classes-mapmarker-textstyle">MapMarker.TextStyle</a></code></li>
</ul>
