...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#closed">closed</a></code></div>
<div class="col-last even-row-color">
<div class="block">True if the charging location is closed on particular date, in which case
 <a href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#periods"><code>periods</code></a> is empty.</div>
</div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#date">date</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#%3Cinit%3E()">EVChargingOpeningHoursException</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#equals(java.lang.Object)">equals</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a> obj)</code></div>

<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>int</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#hashCode()">hashCode</a>()</code></div>
...
<div class="block"><p>A list of time periods when the charging location is open on the specified date.
 ...
 and <a href="sdk-for-android-explore-timeofdayrange#to"><code>TimeOfDayRange.to</code></a> properties.</p></div>
</section>
</li>
<li>
...
<div class="block"><p>True if the charging location is closed on particular date, in which case
 <a href="sdk-for-android-explore-com-here-sdk-search-evchargingopeninghoursexception#periods"><code>periods</code></a> is empty.</p></div>
</section>
</li>
</ul>
</section>
