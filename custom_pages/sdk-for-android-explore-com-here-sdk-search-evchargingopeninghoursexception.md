...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#closed">closed</a></code></div>
<div class="col-last even-row-color">
<div class="block">True if the charging location is closed on particular date, in which case
 <a href="sdk-for-android-explore-index#periods"><code>periods</code></a> is empty.</div>
</div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#date">date</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#periods">periods</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E()">EVChargingOpeningHoursException</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>True if the charging location is closed on particular date, in which case
 <a href="sdk-for-android-explore-index#periods"><code>periods</code></a> is empty.</p></div>
</section>
</li>
</ul>
</section>
