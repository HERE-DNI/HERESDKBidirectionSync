...
- <div>
  ...
  ` `<span id="/s:7heresdk18PolylineSimplifierC7OptionsV"></span>` `<span id="//apple_ref/swift/Struct/Options" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-classes-polylinesimplifier#/s:7heresdk18PolylineSimplifierC7OptionsV" class="token"><code>Options</code></a>` `
