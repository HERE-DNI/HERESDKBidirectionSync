---
title: "operator == method - RouteOptions class - routing library - Dart API"
slug: "sdk-for-flutter-navigate-routing-routeoptions-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-navigate-routing-routeoptions-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return optimizationMode == _other.optimizationMode &&
      ...
      enableRouteLabels == _other.enableRouteLabels;
}
```
