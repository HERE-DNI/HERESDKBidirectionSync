...
slug: "sdk-for-ios-navigate-landlinephone"
---
...
<html lang="en">
  <head>
    <title>LandlinePhone Structure Reference</title>
  ...
  <body>
    ...
    <a title="LandlinePhone Structure Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        LandlinePhone Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13LandlinePhoneV11phoneNumberSSvp"></a>
                    <a name="//apple_ref/swift/Property/phoneNumber" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp">phoneNumber</a>
                    </code>
                  </div>
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">phoneNumber</span><span class="p">:</span> <span class="kt">String</span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13LandlinePhoneV10categoriesSayAA13PlaceCategoryCGvp"></a>
                    <a name="//apple_ref/swift/Property/categories" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13LandlinePhoneV10categoriesSayAA13PlaceCategoryCGvp">categories</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Note: In case <code>LandlinePhone.categories</code> are not empty, then <code><a href="sdk-for-ios-explore-landlinephone#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp">LandlinePhone.phoneNumber</a></code> should be used according to given categories.
Otherwise, <code><a href="sdk-for-ios-explore-landlinephone#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp">LandlinePhone.phoneNumber</a></code> is meant for general use.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13LandlinePhoneVACycfc"></a>
                    <a name="//apple_ref/swift/Method/init()" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13LandlinePhoneVACycfc">init()</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13LandlinePhoneV11phoneNumber10categoriesACSS_SayAA13PlaceCategoryCGtcfc"></a>
                    <a name="//apple_ref/swift/Method/init(phoneNumber:categories:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13LandlinePhoneV11phoneNumber10categoriesACSS_SayAA13PlaceCategoryCGtcfc">init(phoneNumber:<wbr>categories:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">phoneNumber</span><span class="p">:</span> <span class="kt">String</span><span class="p">,</span> <span class="nv">categories</span><span class="p">:</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-explore-placecategory">PlaceCategory</a></span><span class="p">])</span></code></pre>
