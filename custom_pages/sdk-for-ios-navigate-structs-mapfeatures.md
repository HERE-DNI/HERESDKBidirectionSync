...
data is stored on disk, it might require updating using <code><a href="sdk-for-ios-navigate-classes-mapupdater">MapUpdater</a></code>.</p>
...
<p>A <code><a href="sdk-for-ios-navigate-enums-shadowquality">ShadowQuality</a></code> must be set on the MapContext through a MapView or the feature has no
effect.</p>
