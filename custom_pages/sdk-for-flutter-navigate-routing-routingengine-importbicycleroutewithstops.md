---
title: "importBicycleRouteWithStops abstract method"
...
<div>
<h1>importBicycleRouteWithStops abstract method</h1></div>
...
importBicycleRouteWithStops(<ol class="parameter-list"> <li>List&lt;<a href="/sdk-for-flutter-navigate-core-location-class">Location</a>&gt; locations, </li>
<li>List&lt;<a href="/sdk-for-flutter-navigate-routing-routestop-class">RouteStop</a>&gt; routeStops, </li>
<li><a class="deprecated" href="/sdk-for-flutter-navigate-routing-bicycleoptions-class">BicycleOptions</a> bicycleOptions, </li>
...
<p>Asynchronously creates a bicycle route from a sequence of geographic coordinates very close to each other.</p>
...
TaskHandle importBicycleRouteWithStops(List&lt;Location&gt; locations, List&lt;RouteStop&gt; routeStops, BicycleOptions bicycleOptions, CalculateRouteCallback callback);</code></pre>
