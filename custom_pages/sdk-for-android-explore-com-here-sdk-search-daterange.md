...
<div id="sdk-for-android-explore-from" class="section detail">
    ...
    </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Date.html" class="external-link" title="class or interface in java.util">Date</a></span> <span class="element-name">from</span>
...
<div id="sdk-for-android-explore-to" class="section detail">
    ...
    <span class="annotations">@Nullable
    </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Date.html" class="external-link" title="class or interface in java.util">Date</a></span> <span class="element-name">to</span>
...
<div id="sdk-for-android-explore-<init>()" class="section detail">
    ...
    <span class="modifiers">public</span> <span class="element-name">DateRange</span>()
