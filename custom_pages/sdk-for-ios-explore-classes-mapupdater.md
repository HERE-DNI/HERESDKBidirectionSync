...
<span id="//apple_ref/swift/Class/MapUpdater" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-maploader">MapLoader</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> MapUpdater Class Reference
...
- <div>
  ...
  ` `<span id="/s:7heresdk10MapUpdaterC9taskCounts6UInt32Vvp"></span>` `<span id="//apple_ref/swift/Property/taskCount" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-classes-mapupdater#/s:7heresdk10MapUpdaterC9taskCounts6UInt32Vvp" class="token"><code>taskCount</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk10MapUpdaterC16updateStatisticsAA06UpdateE0Vvp"></span>` `<span id="//apple_ref/swift/Property/updateStatistics" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-classes-mapupdater#/s:7heresdk10MapUpdaterC16updateStatisticsAA06UpdateE0Vvp" class="token"><code>updateStatistics</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk10MapUpdaterC0B25UpdateVersionCommitPolicyO"></span>` `<span id="//apple_ref/swift/Enum/MapUpdateVersionCommitPolicy" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-classes-mapupdater#/s:7heresdk10MapUpdaterC0B25UpdateVersionCommitPolicyO" class="token"><code>MapUpdateVersionCommitPolicy</code></a>` `
...
- <div>
  ...
  <a href="sdk-for-ios-explore-maploader#/s:7heresdk18MapLoaderExceptiona">`MapLoaderException`</a> Specifies reason, why current map version is not returned.
...
- <div>
  ...
  If no updates are available, <a href="sdk-for-ios-explore-maploader#/s:7heresdk26CatalogsUpdateInfoCallbacka">`CatalogsUpdateInfoCallback`</a> from
  ...
  to retrieve catalogs with newer versions. Individual catalogs can then be updated using this method. Ensure that the device has enough free disk space to perform a catalog update. Information about the required disk space is available in <a href="sdk-for-ios-explore-structs-catalogupdateinfo#/s:7heresdk17CatalogUpdateInfoV15diskSizeInBytess5Int64Vvp">`CatalogUpdateInfo.diskSizeInBytes`</a>.
  </p>
...
- <div>
  ...
  Sets the map update version policy. Defaults to <a href="sdk-for-ios-explore-classes-mapupdater-mapupdateversioncommitpolicy#/s:7heresdk10MapUpdaterC0B25UpdateVersionCommitPolicyO10onCompleteyA2EmF">`MapUpdater.MapUpdateVersionCommitPolicy.onComplete`</a>.
