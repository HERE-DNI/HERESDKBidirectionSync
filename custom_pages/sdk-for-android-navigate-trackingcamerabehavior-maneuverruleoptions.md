...
<title>TrackingCameraBehavior.ManeuverRuleOptions (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.navigation, class: TrackingCameraBehavior, class: ManeuverRuleOptions">
...
<h1 title="Class TrackingCameraBehavior.ManeuverRuleOptions" class="title">Class TrackingCameraBehavior.ManeuverRuleOptions</h1>
</div>
...
<div class="block"><p>Defines a set of configurations specific to a <a href="sdk-for-android-explore-trackingcamerabehavior-maneuverrule" title="class in com.here.sdk.navigation"><code>TrackingCameraBehavior.ManeuverRule</code></a>.</div>
</section>
...
<div class="col-second even-row-color"><code><a href="#earlyPreManeuverActivationThresholdInMeters" class="member-name-link">earlyPreManeuverActivationThresholdInMeters</a></code></div>
<div class="col-last even-row-color">
<div class="block">Distance in meters for early activation.</div>
</div>
<div class="col-first odd-row-color"><code>double</code></div>
<div class="col-second odd-row-color"><code><a href="#postManeuverActivationThresholdInMeters" class="member-name-link">postManeuverActivationThresholdInMeters</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Distance in meters after the previous maneuver point within which this rule remains
 active.</div>
</div>
<div class="col-first even-row-color"><code>double</code></div>
<div class="col-second even-row-color"><code><a href="#preManeuverActivationThresholdInMeters" class="member-name-link">preManeuverActivationThresholdInMeters</a></code></div>
<div class="col-last even-row-color">
<div class="block">Distance in meters before the next maneuver point within which this rule becomes active.</div>
</div>
<div class="col-first odd-row-color"><code><a href="sdk-for-android-explore-trackingcamerabehavior-maneuverzoomrange" title="class in com.here.sdk.navigation">TrackingCameraBehavior.ManeuverZoomRange</a></code></div>
<div class="col-second odd-row-color"><code><a href="#zoomRange" class="member-name-link">zoomRange</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">ManeuverRuleOptions</a>()</code></div>
<div class="col-last even-row-color">
...
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-trackingcamerabehavior-maneuverzoomrange" title="class in com.here.sdk.navigation">TrackingCameraBehavior.ManeuverZoomRange</a></span>&nbsp;<span class="element-name">zoomRange</span></div>
<div class="block"><p>The zoom range for this rule. Defines the minimum and maximum zoom levels.
 Defaults to a default-constructed <a href="sdk-for-android-explore-trackingcamerabehavior-maneuverzoomrange" title="class in com.here.sdk.navigation"><code>TrackingCameraBehavior.ManeuverZoomRange</code></a>.</div>
</section>
</li>
<li>
...
<div class="block"><p>Distance in meters for early activation. If the current position enters this threshold
 ...
 maneuver's pre-activation zone. Must be non-negative. Defaults to 0.0.</div>
</section>
</li>
<li>
...
<div class="block"><p>Distance in meters before the next maneuver point within which this rule becomes active.
 Must be non-negative. Defaults to 0.0.</div>
</section>
</li>
<li>
...
<div class="block"><p>Distance in meters after the previous maneuver point within which this rule remains
 active. Must be non-negative. Defaults to 0.0.</div>
</section>
</li>
</ul>
</section>
