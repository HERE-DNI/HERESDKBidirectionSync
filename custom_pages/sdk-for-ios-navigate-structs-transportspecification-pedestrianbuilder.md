...
- <div>
  ...
  Builds the <a href="sdk-for-ios-navigate-structs-transportspecification">`TransportSpecification`</a> object for a pedestrian profile with the specifications taken from the `TransportSpecification.PedestrianBuilder` object.
  ...
  The <a href="sdk-for-ios-navigate-structs-transportspecification">`TransportSpecification`</a> object created from the `TransportSpecification.PedestrianBuilder` object.
