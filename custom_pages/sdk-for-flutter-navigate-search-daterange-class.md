...
/sdk-for-flutter-navigate-search-daterange-daterange()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-search-daterange-from
↔ DateTime?
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-daterange-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-daterange-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-daterange-to
↔ DateTime?
</dt>
<dd>
  First date when the element is no longer valid, exclusive and later than /sdk-for-flutter-navigate-search-daterange-from.
...
/sdk-for-flutter-navigate-search-daterange-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-search-daterange-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-search-daterange-operator-equals(<wbr/>Object other)
    → bool
