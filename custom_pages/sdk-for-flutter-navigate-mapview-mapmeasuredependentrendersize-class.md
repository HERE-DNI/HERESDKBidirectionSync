...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-mapmeasuredependentrendersize(/sdk-for-flutter-navigate-mapview-mapmeasurekind measureKind, /sdk-for-flutter-navigate-mapview-rendersizeunit sizeUnit, Map&lt;<wbr/>double, double&gt; sizes)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-mapmeasuredependentrendersize-withsinglesize(/sdk-for-flutter-navigate-mapview-rendersizeunit sizeUnit, double size)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-measurekind
→ /sdk-for-flutter-navigate-mapview-mapmeasurekind
</dt>
<dd>
  The unit used for the key in /sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-sizes.
  <div class="features">final</div>
</dd>
<dt class="property inherited" id="runtimeType">
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-sizes
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-sizeunit
→ /sdk-for-flutter-navigate-mapview-rendersizeunit
</dt>
<dd>
  The unit used for the value in /sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-sizes.
  <div class="features">final</div>
</dd>
</dl>
</section>
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mapmeasuredependentrendersize-operator-equals(<wbr/>Object other)
    → bool
