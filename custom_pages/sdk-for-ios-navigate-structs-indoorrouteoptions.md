...
- <div>
  ...
  ` `<span id="/s:7heresdk18IndoorRouteOptionsV05routeD0AA0cD0Vvp"></span>` `<span id="//apple_ref/swift/Property/routeOptions" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-structs-indoorrouteoptions#/s:7heresdk18IndoorRouteOptionsV05routeD0AA0cD0Vvp" class="token"><code>routeOptions</code></a>` `
  ...
  **Note:** Currently, only <a href="sdk-for-ios-navigate-structs-routeoptions#/s:7heresdk12RouteOptionsV16optimizationModeAA012OptimizationE0Ovp">`RouteOptions.optimizationMode`</a> parameter is utilized for indoor route calculation.
...
- <div>
  ...
  **Note:** Indoor route sections of the resulting route will always be <a href="sdk-for-ios-navigate-enums-venuetransportmode#/s:7heresdk18VenueTransportModeO10pedestrianyA2CmF">`VenueTransportMode.pedestrian`</a> in the current implementation. This option will affect only outdoor route sections.
