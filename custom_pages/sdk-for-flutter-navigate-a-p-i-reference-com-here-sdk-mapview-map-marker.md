---
title: "MapMarker"
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-mapview-map-marker"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.mapview/MapMarker///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.mapview</a><span class="delimiter">/</span><span class="current">MapMarker</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Map</span><wbr></wbr><span><span>Marker</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">MapMarker</a> : <a href="../../com.here/-native-base/index.html">NativeBase</a></div><p class="paragraph"><code class="lang-kotlin">MapMarker</code> is used to draw images on the map, for example to mark a specific location. By default, the marker is centered on the given geographic coordinates. Markers keep their size regardless of the current zoom level of the map view.</p><p class="paragraph">The image to be displayed is represented by <a href="../-map-image/index.html">com.here.sdk.mapview.MapImage</a> object. For performance reasons, it is highly recommended to reuse a single instance of the image when creating multiple identical markers.</p><p class="paragraph">To display the map marker, it needs to be added to the scene using <a href="../-map-scene/add-map-marker.html">com.here.sdk.mapview.MapScene.addMapMarker</a>. To stop displaying it, remove it from the scene using <a href="../-map-scene/remove-map-marker.html">com.here.sdk.mapview.MapScene.removeMapMarker</a>.</p><p class="paragraph">The display of a map marker is only guaranteed in case its origin is within the viewport. At the moment, this is a known limitation that mostly affects map markers which are visually large and cover a sizeable part of the viewport.</p><p class="paragraph"><strong>Note:</strong> Due to technical limitations using the MapMarkers API to add a very large number of markers (several thousands, especially 10000+) is not recommended. Adding this many markers will have a negative impact on the performance leading to stuttering of the app and lower frame rates. To work around this limitation the following approach can be used: Register to map camera updates using <a href="../-map-camera/add-listener.html">com.here.sdk.mapview.MapCamera.addListener</a>. Query the bounding box of the camera viewport using <a href="../-map-camera/bounding-box.html">com.here.sdk.mapview.MapCamera.boundingBox</a> (it may be extended) and then use the method <a href="../../com.here.sdk.core/-geo-box/contains.html">com.here.sdk.core.GeoBox.contains</a> in combination with <a href="../-map-camera/-state/distance-to-target-in-meters.html">com.here.sdk.mapview.MapCamera.State.distanceToTargetInMeters</a> to determine which MapMarkers are actually visible to the user in the current camera viewport and thus need to be added to the map.</p></div></div>
  </div>
          ...
          <div class="table-row" data-togglable="CONSTRUCTOR" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="-map-marker.html"><span>Map</span><wbr></wbr><span><span>Marker</span></span></a></div>
...
<a data-name="2107546040%2FClasslikes%2F1617540583" anchor-label="TextStyle" id="2107546040%2FClasslikes%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="-text-style/index.html"><span>Text</span><wbr></wbr><span><span>Style</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="2107546040%2FClasslikes%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="-text-style/index.html">TextStyle</a> : <a href="../../com.here/-native-base/index.html">NativeBase</a></div><div class="brief "><p class="paragraph">Styling options for the text of a <a href="index.html">com.here.sdk.mapview.MapMarker</a>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div data-togglable="PROPERTY">
        ...
        <div class="table"><a data-name="651808508%2FProperties%2F1617540583" anchor-label="anchor" id="651808508%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="anchor.html"><span><span>anchor</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="651808508%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="anchor.html">anchor</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-anchor2-d/index.html">Anchor2D</a></div><div class="brief "><p class="paragraph">The anchor point for the marker image which specifies the position offset relative to the marker's coordinates.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-496843039%2FProperties%2F1617540583" anchor-label="fadeDuration" id="-496843039%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="fade-duration.html"><span>fade</span><wbr></wbr><span><span>Duration</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-496843039%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="fade-duration.html">fadeDuration</a><span class="token operator">: </span><a href="../../com.here.time/-duration/index.html">Duration</a></div><div class="brief "><p class="paragraph">Duration of a fade-in effect on marker addition to a scene or a fade-out effect on marker removal from a scene.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-1116314642%2FProperties%2F1617540583" anchor-label="image" id="-1116314642%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="image.html"><span><span>image</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1116314642%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="image.html">image</a><span class="token operator">: </span><a href="../-map-image/index.html">MapImage</a></div><div class="brief "><p class="paragraph">Image representing the marker on the screen.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-939902394%2FProperties%2F1617540583" anchor-label="isOverlapAllowed" id="-939902394%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="is-overlap-allowed.html"><span>is</span><wbr></wbr><span>Overlap</span><wbr></wbr><span><span>Allowed</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-939902394%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="is-overlap-allowed.html">isOverlapAllowed</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a></div><div class="brief "><p class="paragraph">Determines whether or not the marker can overlap other markers.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-786570758%2FProperties%2F1617540583" anchor-label="isTextOptional" id="-786570758%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="is-text-optional.html"><span>is</span><wbr></wbr><span>Text</span><wbr></wbr><span><span>Optional</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-786570758%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="is-text-optional.html">isTextOptional</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a></div><div class="brief "><p class="paragraph">Determines if the marker can be displayed with icon and without text.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1767999620%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="text.html">text</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a></div><div class="brief "><p class="paragraph">The text to be drawn on the map along with the image of the <code class="lang-kotlin">MapMarker</code>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1201853723%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">var </span><a href="text-style.html">textStyle</a><span class="token operator">: </span><a href="-text-style/index.html">MapMarker.TextStyle</a></div><div class="brief "><p class="paragraph">The <code class="lang-kotlin">TextStyle</code> applied to the text of the <code class="lang-kotlin">MapMarker</code>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
