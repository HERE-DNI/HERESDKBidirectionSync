...
<span id="//apple_ref/swift/Struct/EventText" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-navigation">Navigation</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> EventText Structure Reference
...
- <div>
  ...
  ` `<span id="/s:7heresdk9EventTextV4typeAA0C16NotificationTypeOvp"></span>` `<span id="//apple_ref/swift/Property/type" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-eventtext#/s:7heresdk9EventTextV4typeAA0C16NotificationTypeOvp" class="token"><code>type</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk9EventTextV16distanceInMetersSdvp"></span>` `<span id="//apple_ref/swift/Property/distanceInMeters" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-eventtext#/s:7heresdk9EventTextV16distanceInMetersSdvp" class="token"><code>distanceInMeters</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk9EventTextV4textSSvp"></span>` `<span id="//apple_ref/swift/Property/text" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-eventtext#/s:7heresdk9EventTextV4textSSvp" class="token"><code>text</code></a>` `
...
- <div>
  ...
  Information about the next maneuver. Is non-`nil` only for <a href="sdk-for-ios-explore-structs-eventtext#/s:7heresdk9EventTextV4typeAA0C16NotificationTypeOvp">`EventText.type`</a> equals to <a href="sdk-for-ios-explore-enums-textnotificationtype#/s:7heresdk20TextNotificationTypeO8maneuveryA2CmF">`TextNotificationType.maneuver`</a>.
...
- <div>
  ...
  ` `<span id="/s:7heresdk9EventTextV26spatialNotificationDetailsAA07SpatialeF0VSgvp"></span>` `<span id="//apple_ref/swift/Property/spatialNotificationDetails" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-eventtext#/s:7heresdk9EventTextV26spatialNotificationDetailsAA07SpatialeF0VSgvp" class="token"><code>spatialNotificationDetails</code></a>` `
  ...
  Information for a spatial text notifications. When <a href="sdk-for-ios-explore-structs-eventtextoptions#/s:7heresdk16EventTextOptionsV18enableSpatialAudioSbvp">`EventTextOptions.enableSpatialAudio`</a> is false, then this attribute will be `nil`.
...
- <div>
  ...
  - Parameters
    ...
    **Note:** During navigation, the text will be always empty when the <a href="sdk-for-ios-explore-classes-maneuver">`Maneuver`</a> is taken from the <a href="sdk-for-ios-explore-classes-navigator">`Navigator`</a> or <a href="sdk-for-ios-explore-classes-visualnavigator">`VisualNavigator`</a> instance via the provided index. The text instruction that can be accessed from the <a href="sdk-for-ios-explore-classes-route">`Route`</a> instance is meant as preview and it is not necessarily matching the more comprehensive maneuver information you can access during navigation. This information can be enhanced with real-time `ManeuverNotifications` texts that can be used for spoken text notifications during a trip.
    ...
    - spatialNotificationDetails: Information for a spatial text notifications. When <a href="sdk-for-ios-explore-structs-eventtextoptions#/s:7heresdk16EventTextOptionsV18enableSpatialAudioSbvp">`EventTextOptions.enableSpatialAudio`</a> is false, then this attribute will be `nil`.
