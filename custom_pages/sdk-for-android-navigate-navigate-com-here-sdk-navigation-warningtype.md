...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-navigation-warningtype"
---
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#BORDER_CROSSING">BORDER_CROSSING</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for border crossings.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#CUSTOM">CUSTOM</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Base type for all custom warnings.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#DANGER_ZONE">DANGER_ZONE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for danger zones.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#ENVIRONMENTAL_ZONE">ENVIRONMENTAL_ZONE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type of warning given for environmental zones.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#LANE_DECREASE">LANE_DECREASE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for lane decrease.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#LOW_SPEED_ZONE">LOW_SPEED_ZONE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type of warning given for low speed zones.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#RAILWAY_CROSSING">RAILWAY_CROSSING</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for railway crossings.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#REALISTIC_VIEW">REALISTIC_VIEW</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type of warning given for realistic views.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#ROAD_SIGN">ROAD_SIGN</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for road signs.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#SAFETY_CAMERA">SAFETY_CAMERA</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type of warning given for safety cameras.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#SCHOOL_ZONE">SCHOOL_ZONE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for school zones.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#TOLL_STOP">TOLL_STOP</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Type of warning given for toll stops.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#TRAFFIC_MERGE">TRAFFIC_MERGE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Type of warning given for merging traffic.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#TRUCK_RESTRICTION">TRUCK_RESTRICTION</a></code></div>
<div class="col-last odd-row-color">
