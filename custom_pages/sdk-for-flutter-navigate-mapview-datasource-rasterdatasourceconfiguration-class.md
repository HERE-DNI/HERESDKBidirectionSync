...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-rasterdatasourceconfiguration(String name, /sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-class provider, /sdk-for-flutter-navigate-mapview-datasource-rasterdatasourcecacheconfiguration-class cache, bool ignoreExpiredData)
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="RasterDataSourceConfiguration.withDefaults">
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-rasterdatasourceconfiguration-withdefaults(String name, /sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-class provider, /sdk-for-flutter-navigate-mapview-datasource-rasterdatasourcecacheconfiguration-class cache)
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-cache
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-ignoreexpireddata
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-name
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-provider
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceconfiguration-operator-equals(<wbr/>Object other)
    → bool
