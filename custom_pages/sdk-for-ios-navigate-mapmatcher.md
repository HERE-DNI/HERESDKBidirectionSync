...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk10MapMatcherC"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Class-MapMatcher" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-mapmatcher#sdk-for-ios-navigate-s-7heresdk10MapMatcherC" class="token"><code>MapMatcher</code></a> 
  ...
  **Important**: If `useRenderingLayers` is set to `false` without properly enabling the eHorizon layer, it may produce incorrect results. Layer configuration is especially important when prefetching or installing region data. Missing data will be downloaded online automatically as needed.
  ...
  <a href="sdk-for-ios-navigate-classes-mapmatcher" class="slightly-smaller">See more</a>
...
- <div>
   ...
   <span id="sdk-for-ios-navigate-s-7heresdk15MatchedLocationV"></span> <span id="sdk-for-ios-navigate-apple_ref-swift-Struct-MatchedLocation" class="dashAnchor"></span> <a href="sdk-for-ios-navigate-mapmatcher#sdk-for-ios-navigate-s-7heresdk15MatchedLocationV" class="token"><code>MatchedLocation</code></a> 
  ...
  <a href="sdk-for-ios-navigate-structs-matchedlocation" class="slightly-smaller">See more</a>
