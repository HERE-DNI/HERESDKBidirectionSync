...
Note that a group needs to exist when the built <a href="/sdk-for-flutter-navigate-mapview-maplayerpriority-class">MapLayerPriority</a> is used during a
<a href="/sdk-for-flutter-navigate-mapview-maplayerbuilder-build">MapLayerBuilder.build</a> or <a href="/sdk-for-flutter-navigate-mapview-maplayer-setpriority">MapLayer.setPriority</a>, otherwise the priority
...
<ul>
<li><code>group</code> The name of the group. For instance the name of a <a href="/sdk-for-flutter-navigate-mapview-translucentmaplayergroup-class">TranslucentMapLayerGroup</a>.</li>
</ul>
