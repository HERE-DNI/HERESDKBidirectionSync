---
title: "operator == method - RouteProgress class - navigation library - Dart API"
slug: "sdk-for-flutter-navigate-navigation-routeprogress-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-navigate-navigation-routeprogress-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return sectionIndex == _other.sectionIndex &&
      ...
      routeMatchedLocation == _other.routeMatchedLocation;
}
```
