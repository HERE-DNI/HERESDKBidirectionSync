...
- <div>
  ...
  <a href="sdk-for-ios-navigate-classes-mapcontext-memorymanagementstrategy" class="slightly-smaller">See more</a>
...
- <div>
  ...
  <a href="sdk-for-ios-navigate-classes-mapcontext-memorymanagementresultcode" class="slightly-smaller">See more</a>
...
- <div>
  ...
  Types of system resources used by <a href="sdk-for-ios-navigate-classes-mapcontext">`MapContext`</a> or any of the entities attached to it, like <a href="sdk-for-ios-navigate-classes-heremap">`HereMap`</a>.

  <a href="sdk-for-ios-navigate-classes-mapcontext-resourcetype" class="slightly-smaller">See more</a>
...
- <div>
  ...
  <a href="sdk-for-ios-navigate-classes-mapcontext-freeresourceseverity" class="slightly-smaller">See more</a>
...
- <div>
  ...
  <a href="sdk-for-ios-navigate-classes-mapcontext-memorymanagementresult" class="slightly-smaller">See more</a>
...
- <div>
  ...
  <a href="sdk-for-ios-navigate-classes-mapcontext-memorymanagementoptions" class="slightly-smaller">See more</a>
...
- <div>
  ...
  Frees a system resource held by the `MapContext` and all entities attached to it, like <a href="sdk-for-ios-navigate-classes-heremap">`HereMap`</a>. This function is intended for use when a system resource availability becomes low. For example, some memory can be freed when the application transitions to the background state.
...
- <div>
  ...
  Sets memory management options for controlling tile cache and video memory usage. In <a href="sdk-for-ios-navigate-classes-mapcontext-memorymanagementoptions">`MapContext.MemoryManagementOptions`</a> optional parameters with `nil` or non positive values will be ignored, preserving their existing settings.
