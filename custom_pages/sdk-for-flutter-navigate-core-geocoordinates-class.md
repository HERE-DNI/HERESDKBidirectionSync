...
/sdk-for-flutter-navigate-core-geocoordinates-geocoordinates(double latitude, double longitude)
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-geocoordinates-geocoordinates-withaltitude(double latitude, double longitude, double altitude)
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-geocoordinates-altitude
→ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-geocoordinates-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-geocoordinates-latitude
→ double
</dt>
<dd>
  Latitude in degrees.
...
/sdk-for-flutter-navigate-core-geocoordinates-longitude
→ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-geocoordinates-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-geocoordinates-distanceto(<wbr/>/sdk-for-flutter-navigate-core-geocoordinates-class point)
    → double
...
/sdk-for-flutter-navigate-core-geocoordinates-interpolate(<wbr/>/sdk-for-flutter-navigate-core-geocoordinates-class towardCoords, double factor)
...
/sdk-for-flutter-navigate-core-geocoordinates-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-core-geocoordinates-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-core-geocoordinates-operator-equals(<wbr/>Object other)
    → bool
...
/sdk-for-flutter-navigate-core-geocoordinates-fromstring(<wbr/>String input)
    → /sdk-for-flutter-navigate-core-geocoordinates-class?
