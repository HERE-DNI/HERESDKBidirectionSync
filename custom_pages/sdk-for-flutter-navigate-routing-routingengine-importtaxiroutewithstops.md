---
title: "importTaxiRouteWithStops abstract method"
...
<div>
<h1>importTaxiRouteWithStops abstract method</h1></div>
...
importTaxiRouteWithStops(<ol class="parameter-list"> <li>List&lt;<a href="/sdk-for-flutter-navigate-core-location-class">Location</a>&gt; locations, </li>
<li>List&lt;<a href="/sdk-for-flutter-navigate-routing-routestop-class">RouteStop</a>&gt; routeStops, </li>
<li><a class="deprecated" href="/sdk-for-flutter-navigate-routing-taxioptions-class">TaxiOptions</a> taxiOptions, </li>
...
<p>Asynchronously creates a taxi route from a sequence of geographic coordinates very close to each other.</p>
...
TaskHandle importTaxiRouteWithStops(List&lt;Location&gt; locations, List&lt;RouteStop&gt; routeStops, TaxiOptions taxiOptions, CalculateRouteCallback callback);</code></pre>
