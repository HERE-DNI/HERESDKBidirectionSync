...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-maploader-catalogupdatestate"
---
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#UNKNOWN_STATE">UNKNOWN_STATE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">State is not fetched, so unknown</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="#UPDATE_AVAILABLE">UPDATE_AVAILABLE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Previously downloaded catalog version can be updated to their latest version.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#UPDATE_BLOCKED_AS_ANOTHER_PENDING">UPDATE_BLOCKED_AS_ANOTHER_PENDING</a></code></div>
<div class="col-last odd-row-color">
