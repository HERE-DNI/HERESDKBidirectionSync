...
<li class="self-crumb">routeDeviationListener property</li>
</ol>
...
<section class="multi-line-signature">
void
routeDeviationListener=(<wbr/>/sdk-for-flutter-navigate-navigation-routedeviationlistener-class? value)
</section>
<section class="desc markdown">
<p>Object to receive notifications about deviations from the route if any occurs.
Route deviation notifications only occurs if a route has been set.
