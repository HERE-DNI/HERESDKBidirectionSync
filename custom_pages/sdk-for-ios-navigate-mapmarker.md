...
slug: "sdk-for-ios-navigate-mapmarker"
---
...
<html lang="en">
  <head>
    <title>MapMarker Class Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:image:)" class="dashAnchor"></a>
...
<p>The altitude component of the coordinates is ignored.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">at</span> <span class="nv">coordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">)</span></code></pre>
                        ...
                        <table class="graybox">
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div>
                                  <p>The marker&rsquo;s geographical coordinates.</p>
                                </div>
                              </td>
                            </tr>
                            <tr>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:image:text:)" class="dashAnchor"></a>
...
<p>The altitude component of the coordinates is ignored.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">at</span> <span class="nv">coordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">,</span> <span class="nv">text</span><span class="p">:</span> <span class="kt">String</span><span class="p">)</span></code></pre>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:image:anchor:)" class="dashAnchor"></a>
...
with anchor point specifying how the image is positioned relative to the marker&rsquo;s coordinates.</p>

<p>The anchor is a way of specifying position offset relative to image&rsquo;s dimensions on the screen.
For example, (0, 0) places the top-left corner of the image at the marker&rsquo;s coordinates.
(1, 1) would place the bottom-right corner of the image at the marker&rsquo;s coordinates.
(0.5, 0.5) which is the default value would center the image at the marker&rsquo;s coordinates.
Values outside the 0..1 range are also allowed, for example (0.5, 2) would display the image
centered horizontally with its bottom edge above the marker&rsquo;s coordinates at the distance
in pixels that is equal to the height of the image.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">at</span> <span class="nv">coordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">,</span> <span class="nv">anchor</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-anchor2d">Anchor2D</a></span><span class="p">)</span></code></pre>
...
to the marker&rsquo;s coordinates.</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
...
The altitude component of the coordinates is ignored.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">coordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span> <span class="p">{</span> <span class="k">get</span> <span class="k">set</span> <span class="p">}</span></code></pre>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The Metadata instance attached to this marker, see <code><a href="sdk-for-ios-explore-metadata">Metadata</a></code>.
This will be <code>nil</code> if nothing has been attached before.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/isOverlapAllowed" class="dashAnchor"></a>
...
Among markers that don&rsquo;t allow overlap, the one with the highest draw order has
...
<p>Defaults to <code>true</code>.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/isTextOptional" class="dashAnchor"></a>
...
Controls whenever <code>MapMarker</code> can be shown as icon only when <code><a href="sdk-for-ios-explore-mapmarker#/s:7heresdk9MapMarkerC16isOverlapAllowedSbvp">MapMarker.isOverlapAllowed</a></code>
...
<p>Allowed range is [0, 1023]. Values outside this range will be clamped. The default value is 0.</p>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span> <span class="p">{</span> <span class="k">get</span> <span class="k">set</span> <span class="p">}</span></code></pre>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/anchor" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>The anchor point for the marker image which specifies the position offset relative
to the marker&rsquo;s coordinates.
For example, (0, 0) places the top-left corner of the image at the marker&rsquo;s coordinates.
(1, 1) would place the bottom-right corner of the image at the marker&rsquo;s coordinates.
(0.5, 0.5) which is the default value would center the image at the marker&rsquo;s coordinates.
Values outside the 0..1 range are also allowed, for example (0.5, 2) would display the image
...
in pixels that is equal to the height of the image.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">anchor</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-anchor2d">Anchor2D</a></span> <span class="p">{</span> <span class="k">get</span> <span class="k">set</span> <span class="p">}</span></code></pre>
...
<p>Markers with opacity value set to 0.0 are still on map and are considered for picking.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/fadeDuration" class="dashAnchor"></a>
...
the marker immediately after may result in the new value being ignored for this removal.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/textStyle" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The <code><a href="sdk-for-ios-explore-textstyle">TextStyle</a></code> applied to the text of the <code>MapMarker</code>.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">textStyle</span><span class="p">:</span> <span class="kt">MapMarker</span><span class="o">.</span><span class="kt"><a href="sdk-for-ios-explore-textstyle">TextStyle</a></span> <span class="p">{</span> <span class="k">get</span> <span class="k">set</span> <span class="p">}</span></code></pre>
...
<code><a href="sdk-for-ios-explore-mapmeasurerange">MapMeasureRange</a></code>(s) of other unsupported types will be ignored.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Class/TextStyle" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Styling options for the text of a <code><a href="sdk-for-ios-explore-mapmarker">MapMarker</a></code>.</p>

                        <a href="sdk-for-ios-explore-textstyle" class="slightly-smaller">See more</a>
                      </div>
                      <div class="declaration">
                        <h4>Declaration</h4>
                        <div class="language">
...
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarker">MapMarker</a></span><span class="o">.</span><span class="kt">TextStyle</span><span class="p">:</span> <span class="kt">NativeBase</span></code></pre>
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarker">MapMarker</a></span><span class="o">.</span><span class="kt">TextStyle</span><span class="p">:</span> <span class="kt">Hashable</span></code></pre>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Starts animation of this map marker according to provided <code><a href="sdk-for-ios-explore-mapmarkeranimation">MapMarkerAnimation</a></code>.</p>

<p>The <code><a href="sdk-for-ios-explore-mapmarkeranimation">MapMarkerAnimation</a></code> may be shared between multiple instances of <code>MapMarker</code>.</p>
...
Any ongoing animation of this marker instance will get cancelled.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="kd">func</span> <span class="nf">startAnimation</span><span class="p">(</span><span class="n">_</span> <span class="nv">animation</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarkeranimation">MapMarkerAnimation</a></span><span class="p">,</span> <span class="nv">animationDelegate</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-animationdelegate">AnimationDelegate</a></span><span class="p">?)</span></code></pre>
...
<p>Does not cancel other animations if the same <code><a href="sdk-for-ios-explore-mapmarkeranimation">MapMarkerAnimation</a></code> object was applied to multiple <code>MapMarker</code>s.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="kd">func</span> <span class="nf">cancelAnimation</span><span class="p">(</span><span class="n">_</span> <span class="nv">animation</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarkeranimation">MapMarkerAnimation</a></span><span class="p">)</span></code></pre>
