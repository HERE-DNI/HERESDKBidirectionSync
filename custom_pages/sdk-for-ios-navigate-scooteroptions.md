...
slug: "sdk-for-ios-navigate-scooteroptions"
---
...
<html lang="en">
  <head>
    <title>ScooterOptions Structure Reference</title>
...
Shouldn&rsquo;t be less than 1 or greater than 255. Defaults to 1.
...
routing is performed without considering them.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/allowHighway" class="dashAnchor"></a>
...
Note that there is a similar parameter in <code><a href="sdk-for-ios-explore-avoidanceoptions">AvoidanceOptions</a></code>, to
disallow highway usage, see <code><a href="sdk-for-ios-explore-roadfeatures#/s:7heresdk12RoadFeaturesO23controlledAccessHighwayyA2CmF">RoadFeatures.controlledAccessHighway</a></code>.
...
In such a case, a <code><a href="sdk-for-ios-explore-sectionnotice">SectionNotice</a></code> will be provided in the related <code><a href="sdk-for-ios-explore-section">Section</a></code>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Engine size of the scooter in cubic centimeters. Shouldn&rsquo;t be less than 1 or greater than 65535. Default value
...
for Japan.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(routeOptions:textOptions:avoidanceOptions:tollOptions:occupantsNumber:lastCharacterOfLicensePlate:maxSpeedOnSegments:allowHighway:engineSizeInCubicCentimeters:)" class="dashAnchor"></a>
...
disallow highway usage, see <code><a href="sdk-for-ios-explore-roadfeatures#/s:7heresdk12RoadFeaturesO23controlledAccessHighwayyA2CmF">RoadFeatures.controlledAccessHighway</a></code>.
As the avoidance options takes precedence, if this parameter is also used, then
scooters are not allowed to use highways even if <code><a href="sdk-for-ios-explore-scooteroptions#/s:7heresdk14ScooterOptionsV12allowHighwaySbvp">allowHighway</a></code> is set to <code>true</code>.
However, if no alternative route is possible, the calculated route may use highways.
In such a case, a <code><a href="sdk-for-ios-explore-sectionnotice">SectionNotice</a></code> will be provided in the related <code><a href="sdk-for-ios-explore-section">Section</a></code>
to indicate that the highway usage restriction is violated on this route.
A few examples:</li>
...
<ul>
<li>engineSizeInCubicCentimeters: Engine size of the scooter in cubic centimeters. Shouldn&rsquo;t be less than 1 or greater than 65535. Default value
...
<p><strong>Note:</strong> For now, this option is only relevant in Japan and will be ignored
  ...
  for Japan.</p></li>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">routeOptions</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-routeoptions">RouteOptions</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-routeoptions">RouteOptions</a></span><span class="p">(),</span> <span class="nv">textOptions</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-routetextoptions">RouteTextOptions</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-routetextoptions">RouteTextOptions</a></span><span class="p">(),</span> <span class="nv">avoidanceOptions</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-avoidanceoptions">AvoidanceOptions</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-avoidanceoptions">AvoidanceOptions</a></span><span class="p">(),</span> <span class="nv">tollOptions</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-tolloptions">TollOptions</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-tolloptions">TollOptions</a></span><span class="p">(),</span> <span class="nv">occupantsNumber</span><span class="p">:</span> <span class="kt">Int32</span> <span class="o">=</span> <span class="mi">1</span><span class="p">,</span> <span class="nv">lastCharacterOfLicensePlate</span><span class="p">:</span> <span class="kt">String</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">maxSpeedOnSegments</span><span class="p">:</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-explore-maxspeedonsegment">MaxSpeedOnSegment</a></span><span class="p">]</span> <span class="o">=</span> <span class="p">[],</span> <span class="nv">allowHighway</span><span class="p">:</span> <span class="kt">Bool</span> <span class="o">=</span> <span class="kc">false</span><span class="p">,</span> <span class="nv">engineSizeInCubicCentimeters</span><span class="p">:</span> <span class="kt">Int32</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">)</span></code></pre>
