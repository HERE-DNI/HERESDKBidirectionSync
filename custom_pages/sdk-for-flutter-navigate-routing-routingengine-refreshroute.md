...
<li class="self-crumb">refreshRoute abstract method</li>
</ol>
<div class="self-name">refreshRoute</div>
...
refreshRoute(<wbr/><ol class="parameter-list"> <li>/sdk-for-flutter-navigate-routing-routehandle-class routeHandle, </li>
...
the starting point and route metadata based on /sdk-for-flutter-navigate-routing-refreshrouteoptions-class.</p>
...
consider using /sdk-for-flutter-navigate-routing-routingengine-calculatetrafficonroutewithcurrentcharge instead.</p>
...
was already travelled). Plus, /sdk-for-flutter-navigate-routing-route-lengthinmeters and /sdk-for-flutter-navigate-routing-route-duration
