---
title: "PointTileSourceLoadResultHandler class abstract"
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-pointtilesourceloadresulthandler(void loadedLambda(/sdk-for-flutter-navigate-mapview-datasource-tilekey-class, List&lt;<wbr/>/sdk-for-flutter-navigate-mapview-datasource-pointdata-class&gt;, /sdk-for-flutter-navigate-mapview-datasource-tilesourcetilemetadata-class), void failedLambda(/sdk-for-flutter-navigate-mapview-datasource-tilekey-class))
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-failed(<wbr/>/sdk-for-flutter-navigate-mapview-datasource-tilekey-class tileKey)
    → void
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-loaded(<wbr/>/sdk-for-flutter-navigate-mapview-datasource-tilekey-class tileKey, List&lt;<wbr/>/sdk-for-flutter-navigate-mapview-datasource-pointdata-class&gt; data, /sdk-for-flutter-navigate-mapview-datasource-tilesourcetilemetadata-class metadata)
    → void
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-datasource-pointtilesourceloadresulthandler-operator-equals(<wbr/>Object other)
    → bool
