...
/sdk-for-flutter-navigate-search-categoryquery-categoryquery-withcategoriesandfilterinarea(List&lt;<wbr/>/sdk-for-flutter-navigate-search-placecategory-class&gt; categories, String filter, /sdk-for-flutter-navigate-search-categoryqueryarea-class area)
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-categoryquery-withcategoriesinarea(List&lt;<wbr/>/sdk-for-flutter-navigate-search-placecategory-class&gt; categories, /sdk-for-flutter-navigate-search-categoryqueryarea-class area)
</dt>
<dd>
          Constructs a new instance of this class from provided parameters.
            <div class="constructor-modifier features">factory</div>
...
/sdk-for-flutter-navigate-search-categoryquery-categoryquery-withcategoryandfilterinarea(/sdk-for-flutter-navigate-search-placecategory-class category, String filter, /sdk-for-flutter-navigate-search-categoryqueryarea-class area)
</dt>
<dd>
          Constructs a new instance of this class from provided parameters.
            <div class="constructor-modifier features">factory</div>
...
/sdk-for-flutter-navigate-search-categoryquery-categoryquery-withcategoryinarea(/sdk-for-flutter-navigate-search-placecategory-class category, /sdk-for-flutter-navigate-search-categoryqueryarea-class area)
</dt>
<dd>
          Constructs a new instance of this class from provided parameters.
            <div class="constructor-modifier features">factory</div>
...
/sdk-for-flutter-navigate-search-categoryquery-area
...
/sdk-for-flutter-navigate-search-categoryquery-categories
...
/sdk-for-flutter-navigate-search-categoryquery-excludecategories
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-search-placecategory-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-excludechains
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-search-placechain-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-excludefoodtypes
...
/sdk-for-flutter-navigate-search-categoryquery-filter
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-includechains
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-search-placechain-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-includefoodtypes
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-search-placefoodtype-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-categoryquery-placefilter
...
/sdk-for-flutter-navigate-search-categoryquery-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-categoryquery-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-search-categoryquery-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-search-categoryquery-operator-equals(<wbr/>Object other)
    → bool
