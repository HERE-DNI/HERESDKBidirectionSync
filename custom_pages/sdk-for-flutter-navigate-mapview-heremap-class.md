...
Note: Before using this class, /sdk-for-flutter-navigate-core-engine-sdknativeengine-class must be already initialized.</p>
</section>
<section class="summary offset-anchor" id="constructors">
<h2>Constructors</h2>
<dl class="constructor-summary-list">
<dt class="callable" id="HereMap">
/sdk-for-flutter-navigate-mapview-heremap-heremap({Key? key, /sdk-for-flutter-navigate-mapview-heremapcreatedcallback? onMapCreated, Set&lt;<wbr/>Factory&lt;<wbr/>OneSequenceGestureRecognizer&gt;&gt;? gestureRecognizers, /sdk-for-flutter-navigate-mapview-nativeviewmode mode = NativeViewMode.virtualDisplay, dynamic options})
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-heremap-gesturerecognizers
...
/sdk-for-flutter-navigate-mapview-heremap-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-heremap-key
→ Key?
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-heremap-mode
→ /sdk-for-flutter-navigate-mapview-nativeviewmode
</dt>
<dd>
  Which method of hosting Android native view (the map) will be used.
Default value is /sdk-for-flutter-navigate-mapview-nativeviewmode.
  <div class="features">final</div>
</dd>
<dt class="property" id="onMapCreated">
/sdk-for-flutter-navigate-mapview-heremap-onmapcreated
...
/sdk-for-flutter-navigate-mapview-heremap-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-heremap-createelement(<wbr/>)
    → StatefulElement
...
/sdk-for-flutter-navigate-mapview-heremap-createstate(<wbr/>)
...
/sdk-for-flutter-navigate-mapview-heremap-debugdescribechildren(<wbr/>)
...
/sdk-for-flutter-navigate-mapview-heremap-debugfillproperties(<wbr/>DiagnosticPropertiesBuilder properties)
    → void
...
/sdk-for-flutter-navigate-mapview-heremap-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-heremap-todiagnosticsnode(<wbr/>{String? name, DiagnosticsTreeStyle? style})
    → DiagnosticsNode
...
/sdk-for-flutter-navigate-mapview-heremap-tostring(<wbr/>{DiagnosticLevel minLevel = DiagnosticLevel.info})
    → String
...
/sdk-for-flutter-navigate-mapview-heremap-tostringdeep(<wbr/>{String prefixLineOne = '', String? prefixOtherLines, DiagnosticLevel minLevel = DiagnosticLevel.debug, int wrapWidth = 65})
    → String
...
/sdk-for-flutter-navigate-mapview-heremap-tostringshallow(<wbr/>{String joiner = ', ', DiagnosticLevel minLevel = DiagnosticLevel.debug})
    → String
...
/sdk-for-flutter-navigate-mapview-heremap-tostringshort(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-heremap-operator-equals(<wbr/>Object other)
    → bool
