...
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-transport-vehicle-profile"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.transport/VehicleProfile///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.transport</a><span class="delimiter">/</span><span class="current">VehicleProfile</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Vehicle</span><wbr></wbr><span><span>Profile</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html"><strike>VehicleProfile</strike></a></div><div class="deprecation-content"><h3 class="">Deprecated</h3><p class="paragraph">Will be removed in v4.28.0. Use `sdk.transport.TransportSpecification` instead.</p></div><p class="paragraph">A vehicle profile describes the vehicle being used with the HSDK.</p><p class="paragraph">The profile is planned to be used as single source of information describing the vehicle.</p><p class="paragraph">Current modules that use this profile:</p><ul><li><p class="paragraph">Navigation: Tracking mode for truck related vehicle restrictions.</p></li></ul><p class="paragraph"><strong>Note:</strong> This is a beta release of this vehicle profile, so there could be a few bugs and unexpected behaviors. Related APIs may change for new releases or even become unsupported, without a deprecation process.</p></div></div>
  </div>
          ...
          <div class="table-row" data-togglable="CONSTRUCTOR" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="-vehicle-profile.html"><span>Vehicle</span><wbr></wbr><span><span>Profile</span></span></a></div>
...
<a data-name="-1431456834%2FProperties%2F1617540583" anchor-label="vehicleType" id="-1431456834%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="vehicle-type.html"><span>vehicle</span><wbr></wbr><span><span>Type</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1431456834%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="vehicle-type.html">vehicleType</a><span class="token operator">: </span><a href="../-vehicle-type/index.html">VehicleType</a></div><div class="brief "><p class="paragraph">Defines the vehicle type.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
