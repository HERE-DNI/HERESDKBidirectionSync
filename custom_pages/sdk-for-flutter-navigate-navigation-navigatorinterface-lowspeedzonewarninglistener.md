...
<li class="self-crumb">lowSpeedZoneWarningListener property</li>
</ol>
...
<section class="multi-line-signature">
void
lowSpeedZoneWarningListener=(<wbr/>/sdk-for-flutter-navigate-navigation-lowspeedzonewarninglistener-class? value)
</section>
<section class="desc markdown">
<p>Object to receive notifications about low speed zones on the current road.
Low speed zone notifications are given regardless if a route is set. This listener is currently
