...
<div className="inheritance">com.here.sdk.transport.ScooterSpecification</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">ScooterSpecification</span>
<span className="extends-implements">extends <a className="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div className="block"><p>Scooter specific settings.</p></div>
</section>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-transport-scooterspecification#allowScooterOnHighway">allowScooterOnHighway</a></code></div>
...
<div className="col-constructor-name even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-transport-scooterspecification#%3Cinit%3E()">ScooterSpecification</a>()</code></div>
<div className="col-last even-row-color">
...
<li>
<section className="detail" id="allowScooterOnHighway">
<h3>allowScooterOnHighway</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">boolean</span> <span className="element-name">allowScooterOnHighway</span></div>
...
<div className="member-signature"><span className="modifiers">public</span> <span className="element-name">ScooterSpecification</span>()</div>
