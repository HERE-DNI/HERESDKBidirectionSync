...
searchByTextExtended(<ol class="parameter-list single-line"> <li><a href="/sdk-for-flutter-explore-search-textquery-class">TextQuery</a> query, </li>
...
<p>Performs an asynchronous request to do a text query search for <a href="/sdk-for-flutter-explore-search-place-class">Place</a> instances.</p>
<p>Optionally, search along a polyline, such as a route, by specifying a <a href="/sdk-for-flutter-explore-core-geocorridor-class">GeoCorridor</a>.
