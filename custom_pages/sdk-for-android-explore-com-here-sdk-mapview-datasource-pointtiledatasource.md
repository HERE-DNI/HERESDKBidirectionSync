...
java.lang.Object →
com.here.NativeBasecom.here.sdk.mapview.datasource.PointTileDataSource →
com.here.NativeBase →
...
</span><span class="element-name type-name-label">PointTileDataSource</span>
...
a PointTileSource . Note: This is a beta release of this feature, so
...
- <div id="method-summary" class="section method-summary">
  ...
  title="class in com.here.sdk.mapview.datasource"><code>PointTileDataSource</code></a></td>
  <td><pre><code>create(MapContext context,
   String name,
   PointTileSource tileSource)</code></pre></td>
  <td><div class="block">
  Creates a named PointTileDataSource in the given context over a given
  PointTileSource .
  </div></td>
  </tr>
  <tr>
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="create(com.here.sdk.mapview.MapContext,java.lang.String,com.here.sdk.mapview.datasource.PointTileSource)"
    ...
    static</span> <span class="return-type">[PointTileDataSource](sdk-for-android-explore-com-here-sdk-mapview-datasource-pointtiledatasource "class in com.here.sdk.mapview.datasource")</span> <span class="element-name">create</span><span class="parameters">(@NonNull
    ...
    @NonNull
    [PointTileSource](sdk-for-android-explore-com-here-sdk-mapview-datasource-pointtilesource "interface in com.here.sdk.mapview.datasource") tileSource)</span>

    </div>

    <div class="block">

    Creates a named PointTileDataSource in the given context over a
    given PointTileSource .
