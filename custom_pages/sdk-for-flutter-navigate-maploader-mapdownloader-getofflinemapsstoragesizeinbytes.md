...
<li class="self-crumb">getOfflineMapsStorageSizeInBytes abstract method</li>
</ol>
<div class="self-name">getOfflineMapsStorageSizeInBytes</div>
...
int
getOfflineMapsStorageSizeInBytes(<wbr/>)
...
<p>Throws /sdk-for-flutter-navigate-maploader-maploaderexceptionexception-class. Specifies reason, why current map size is not returned.</p>
</section>
