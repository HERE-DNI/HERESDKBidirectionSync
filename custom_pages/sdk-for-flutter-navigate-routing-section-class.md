...
<p><strong>Note:</strong> A section contains a list of /sdk-for-flutter-navigate-routing-sectionnotice-class objects that describe
...
/sdk-for-flutter-navigate-routing-section-section()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-routing-section-arrivallocationtime
...
/sdk-for-flutter-navigate-routing-section-arrivalplace
...
/sdk-for-flutter-navigate-routing-section-boundingbox
...
/sdk-for-flutter-navigate-routing-section-consumptioninkilowatthours
→ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-departurelocationtime
→ /sdk-for-flutter-navigate-core-locationtime-class?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-departureplace
→ /sdk-for-flutter-navigate-routing-routeplace-class
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-duration
→ Duration
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-geometry
→ /sdk-for-flutter-navigate-core-geopolyline-class
</dt>
<dd>
  The /sdk-for-flutter-navigate-core-geopolyline-class object representing the polyline of this section.
Gets the /sdk-for-flutter-navigate-core-geopolyline-class object representing the polyline of this section.
  <div class="features">no setter</div>
</dd>
<dt class="property inherited" id="hashCode">
/sdk-for-flutter-navigate-routing-section-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-section-indoorsectiondetails
...
/sdk-for-flutter-navigate-routing-section-lengthinmeters
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-maneuvers
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-maneuver-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-nothroughrestrictions
...
/sdk-for-flutter-navigate-routing-section-passthroughwaypoints
...
/sdk-for-flutter-navigate-routing-section-postactions
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-postaction-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-preactions
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-preaction-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-section-sectionnotices
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-sectionnotice-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-sectiontransportmode
...
/sdk-for-flutter-navigate-routing-section-spans
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-span-class&gt;
</dt>
<dd>
  The /sdk-for-flutter-navigate-routing-span-class's that constitute this section.
Gets the /sdk-for-flutter-navigate-routing-span-class's that constitute this section.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="tolls">
/sdk-for-flutter-navigate-routing-section-tolls
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-toll-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-trafficdelay
→ Duration
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-trafficincidents
→ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-trafficincidentonroute-class&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-section-transitdetails
...
/sdk-for-flutter-navigate-routing-section-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-section-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-section-operator-equals(<wbr/>Object other)
    → bool
