---
title: "Maneuver"
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-routing-maneuver"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.routing/Maneuver///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.routing</a><span class="delimiter">/</span><span class="current">Maneuver</span></div>
  <div class="cover ">
    <h1 class="cover"><span><span>Maneuver</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">Maneuver</a> : <a href="../../com.here/-native-base/index.html">NativeBase</a></div><p class="paragraph">This class provides all the information for a maneuver. The directional information (e.g. road names, road numbers and signpost direction) is stored in <a href="road-texts.html">com.here.sdk.routing.Maneuver.roadTexts</a> and <a href="next-road-texts.html">com.here.sdk.routing.Maneuver.nextRoadTexts</a> attributes. As for the motorway exit information, it can be obtained from <a href="exit-sign-texts.html">com.here.sdk.routing.Maneuver.exitSignTexts</a> attribute.</p></div></div>
  </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1618925514%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="coordinates.html">coordinates</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-geo-coordinates/index.html">GeoCoordinates</a></div><div class="brief "><p class="paragraph">Geographic coordinates where the maneuver is located.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-1903959014%2FProperties%2F1617540583" anchor-label="exitSignTexts" id="-1903959014%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="exit-sign-texts.html"><span>exit</span><wbr></wbr><span>Sign</span><wbr></wbr><span><span>Texts</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1903959014%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="exit-sign-texts.html">exitSignTexts</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-localized-texts/index.html">LocalizedTexts</a></div><div class="brief "><p class="paragraph">The textual attributes of the exit sign. These might contain exit number(s) and/or name(s). These attributes are only available for the Navigate license. Otherwise, the attributes are always empty.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-1863426554%2FProperties%2F1617540583" anchor-label="intersectionNames" id="-1863426554%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="intersection-names.html"><span>intersection</span><wbr></wbr><span><span>Names</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1863426554%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="intersection-names.html">intersectionNames</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-localized-texts/index.html">LocalizedTexts</a></div><div class="brief "><p class="paragraph">The textual attributes of the intersection. These attributes are only available for the Navigate license. Otherwise, the attributes are always empty. <strong>Note:</strong> Routes calculated with OfflineRoutingEngine are not supported.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="140530386%2FProperties%2F1617540583" anchor-label="nextRoadTexts" id="140530386%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="next-road-texts.html"><span>next</span><wbr></wbr><span>Road</span><wbr></wbr><span><span>Texts</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="140530386%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="next-road-texts.html">nextRoadTexts</a><span class="token operator">: </span><a href="../-road-texts/index.html">RoadTexts</a></div><div class="brief "><p class="paragraph">The textual attributes of the next road containing the corresponding road name(s) and road number(s) after the maneuver point. These attributes are only available for the Navigate license. Otherwise, the attributes are always empty.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-2115117953%2FProperties%2F1617540583" anchor-label="roadTexts" id="-2115117953%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="road-texts.html"><span>road</span><wbr></wbr><span><span>Texts</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-2115117953%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="road-texts.html">roadTexts</a><span class="token operator">: </span><a href="../-road-texts/index.html">RoadTexts</a></div><div class="brief "><p class="paragraph">The textual attributes of the current road containing road names, road numbers and signpost direction (towards) information. <strong>Note:</strong> These attributes are only available for the Navigate license. Otherwise, the attributes are always empty.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="1998539224%2FProperties%2F1617540583" anchor-label="signpost" id="1998539224%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="signpost.html"><span><span>signpost</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1998539224%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="signpost.html">signpost</a><span class="token operator">: </span><a href="../-signpost/index.html">Signpost</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Gets the <a href="../-signpost/index.html">com.here.sdk.routing.Signpost</a> object.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1468721341%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="span-index.html">spanIndex</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html">Int</a></div><div class="brief "><p class="paragraph">Index over <a href="../-section/spans.html">com.here.sdk.routing.Section.spans</a> indicating the first span after the maneuver point. <strong>Note:</strong> The span index for the last maneuvers (those maneuvers with maneuver action set to <a href="../-maneuver-action/-a-r-r-i-v-e/index.html">com.here.sdk.routing.ManeuverAction.ARRIVE</a>) cannot be used, since these maneuvers are placed after the last span of the route and the span index for them would be greater than the span list size.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-774153592%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="text.html">text</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-string/index.html">String</a></div><div class="brief "><p class="paragraph">The maneuver instruction. The text is formatted and localized as specified via <a href="../-route-text-options/index.html">com.here.sdk.routing.RouteTextOptions</a>. <strong>Note for users of the Navigate license:</strong> This text is meant to be displayed in a preview context, whereas real-time <code class="lang-kotlin">EventTextListener</code> texts are meant to be used for spoken voice announcements during a trip.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
