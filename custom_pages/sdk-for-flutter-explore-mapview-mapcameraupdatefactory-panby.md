...
<span class="returntype"><a href="sdk-for-flutter-explore-mapview-mapcameraupdate-class">MapCameraUpdate</a></span> <span class="name">panBy</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-explore-panBy-param-xOffset" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">xOffset</span>, </span>
2.  <span id="sdk-for-flutter-explore-panBy-param-yOffset" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">yOffset</span></span>
