...
slug: "sdk-for-ios-navigate-enums-passthroughfeature"
---
...
- <div>
  ...
  When set, then the <a href="sdk-for-ios-navigate-classes-trafficengine">`TrafficEngine`</a> is not blocked from initiating online connections to search for traffic data such as incidents.
