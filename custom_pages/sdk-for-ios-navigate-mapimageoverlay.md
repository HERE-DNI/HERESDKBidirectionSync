...
slug: "sdk-for-ios-navigate-mapimageoverlay"
---
...
<html lang="en">
  <head>
    <title>MapImageOverlay Class Reference</title>
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">at</span> <span class="nv">viewCoordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-point2d">Point2D</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">)</span></code></pre>
                        ...
                        <table class="graybox">
                          <tbody>
                            <tr>
                              ...
                              <td>
                                <div>
                                  <p>The overlay&rsquo;s view coordinates in pixels.</p>
                                </div>
                              </td>
                            </tr>
                            <tr>
...
with anchor point specifying how the image is positioned relative to the overlay&rsquo;s view coordinates.</p>

<p>The anchor is a way of specifying position offset relative to image&rsquo;s dimensions on the view.
For example, (0, 0) places the top-left corner of the image at the overlay&rsquo;s view coordinates.
(1, 1) would place the bottom-right corner of the image at the overlay&rsquo;s view coordinates.
(0.5, 0.5) which is the default value would center the image at the overlay&rsquo;s view coordinates.</p>

<p>Values outside the 0..1 range are also allowed, for example (0.5, 2) would display the image
centered horizontally with its bottom edge above the overlay&rsquo;s view coordinates at the distance
in pixels that is equal to the height of the image.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">at</span> <span class="nv">viewCoordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-point2d">Point2D</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">,</span> <span class="nv">anchor</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-anchor2d">Anchor2D</a></span><span class="p">)</span></code></pre>
...
to the overlay&rsquo;s view coordinates.</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/viewCoordinates" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">viewCoordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-point2d">Point2D</a></span> <span class="p">{</span> <span class="k">get</span> <span class="k">set</span> <span class="p">}</span></code></pre>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>The anchor point for the overlay image which specifies the position offset relative
to the overlay&rsquo;s view coordinates.
For example, (0, 0) places the top-left corner of the image at the overlay&rsquo;s view coordinates.
(1, 1) would place the bottom-right corner of the image at the overlay&rsquo;s view coordinates.
(0.5, 0.5) which is the default value would center the image at the overlay&rsquo;s view coordinates.</p>
