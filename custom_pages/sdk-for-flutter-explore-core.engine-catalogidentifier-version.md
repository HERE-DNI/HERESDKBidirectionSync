...
- numerical `-1` corresponds to <a href="sdk-for-flutter-explore-core-engine-catalogversionhint-latestwithignoringcacheddata">CatalogVersionHint.latestWithIgnoringCachedData</a> with `ignoreCachedData` set to `true`;
- `null` corresponds to <a href="sdk-for-flutter-explore-core-engine-catalogversionhint-latestwithignoringcacheddata">CatalogVersionHint.latestWithIgnoringCachedData</a> with `ignoreCachedData` set to `false`;
- other numerical values correspond to `version` passed to <a href="sdk-for-flutter-explore-core-engine-catalogversionhint-specific">CatalogVersionHint.specific</a>.
