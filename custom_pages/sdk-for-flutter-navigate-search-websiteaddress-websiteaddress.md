...
- `categories` Categories associated with website address. Note: In case <a href="sdk-for-flutter-navigate-search-websiteaddress-categories">WebsiteAddress.categories</a> are not empty, then <a href="sdk-for-flutter-navigate-search-websiteaddress-address">WebsiteAddress.address</a> should be used according to given categories. Otherwise, <a href="sdk-for-flutter-navigate-search-websiteaddress-address">WebsiteAddress.address</a> is meant for general use.
