...
<li class="self-crumb">addLocationIssueListener method</li>
</ol>
...
<p>Adds a /sdk-for-flutter-navigate-location-locationissuelistener-class to the engine to get notified when a location issue has occurred
