...
<p>Controls whenever <code>MapMarker</code> can be shown as icon only when <a href="sdk-for-flutter-navigate-mapview-mapmarker-isoverlapallowed">MapMarker.isOverlapAllowed</a>
