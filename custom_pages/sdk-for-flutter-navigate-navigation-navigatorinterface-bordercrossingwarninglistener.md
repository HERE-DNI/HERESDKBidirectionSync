...
<li class="self-crumb">borderCrossingWarningListener property</li>
</ol>
...
<section class="multi-line-signature">
void
borderCrossingWarningListener=(<wbr/>/sdk-for-flutter-navigate-navigation-bordercrossingwarninglistener-class? value)
</section>
<section class="desc markdown">
<p>Object to receive notifications about border crossings on the current road.
Border crossing notifications are given only if a route is present.
