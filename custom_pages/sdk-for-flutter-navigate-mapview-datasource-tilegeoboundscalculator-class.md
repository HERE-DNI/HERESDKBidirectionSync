...
in a particular tiling scheme (/sdk-for-flutter-navigate-mapview-datasource-tilingscheme).</p>
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-tilegeoboundscalculator(/sdk-for-flutter-navigate-mapview-datasource-tilingscheme tilingScheme)
</dt>
<dd>
          Creates an instance of /sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-class.
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-boundsof(<wbr/>/sdk-for-flutter-navigate-mapview-datasource-tilekey-class tileKey)
    → /sdk-for-flutter-navigate-core-geobox-class

</dt>
<dd>
  Computes the geodetic bounds (as /sdk-for-flutter-navigate-core-geobox-class) for a tile identified by /sdk-for-flutter-navigate-mapview-datasource-tilekey-class.
  

</dd>
<dt class="callable inherited" id="noSuchMethod">
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-datasource-tilegeoboundscalculator-operator-equals(<wbr/>Object other)
    → bool
