...
<title>TMCServiceProviderInfo (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.trafficbroadcast, class: TMCServiceProviderInfo">
...
<h1 title="Class TMCServiceProviderInfo" class="title">Class TMCServiceProviderInfo</h1>
</div>
...
<div class="block"><p>Represents the service prodiver info in RDS-TMC format.</div>
</section>
...
<div class="col-second odd-row-color"><code><a href="#encryptionId" class="member-name-link">encryptionId</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Encryption key index.</div>
</div>
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a href="#encryptionTestMode" class="member-name-link">encryptionTestMode</a></code></div>
<div class="col-last even-row-color">
<div class="block">Encryption mode test flag.</div>
</div>
<div class="col-first odd-row-color"><code>short</code></div>
<div class="col-second odd-row-color"><code><a href="#ltnBeforeEncryption" class="member-name-link">ltnBeforeEncryption</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Location table number before encryption.</div>
</div>
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a href="#ltnNumber" class="member-name-link">ltnNumber</a></code></div>
<div class="col-last even-row-color">
<div class="block">Location table number.</div>
</div>
<div class="col-first odd-row-color"><code>short</code></div>
<div class="col-second odd-row-color"><code><a href="#sid" class="member-name-link">sid</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(short,short,short,short,short,short,short)" class="member-name-link">TMCServiceProviderInfo</a><wbr>(short&nbsp;status,
 short&nbsp;countryCode,
 short&nbsp;sid,
 short&nbsp;ltnNumber,
...
<div class="block"><p>Service provider status.</div>
</section>
</li>
<li>
...
<div class="block"><p>Service provider country code.</div>
</section>
</li>
<li>
...
<div class="block"><p>Service id.</div>
</section>
</li>
<li>
...
<div class="block"><p>Location table number.</div>
</section>
</li>
<li>
...
<div class="block"><p>Encryption mode test flag.</div>
</section>
</li>
<li>
...
<div class="block"><p>Encryption key index.</div>
</section>
</li>
<li>
...
<div class="block"><p>Location table number before encryption.</div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>status</code> - <p>Service provider status.</dd>
<dd><code>countryCode</code> - <p>Service provider country code.</dd>
<dd><code>sid</code> - <p>Service id.</dd>
<dd><code>ltnNumber</code> - <p>Location table number.</dd>
<dd><code>encryptionTestMode</code> - <p>Encryption mode test flag.</dd>
<dd><code>encryptionId</code> - <p>Encryption key index.</dd>
<dd><code>ltnBeforeEncryption</code> - <p>Location table number before encryption.</dd>
</dl>
</section>
</li>
</ul>
