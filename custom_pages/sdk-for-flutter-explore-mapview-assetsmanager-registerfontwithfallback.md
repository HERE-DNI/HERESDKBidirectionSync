...
1.  <span id="sdk-for-flutter-explore-registerFontWithFallback-param-fontName" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">fontName</span>, </span>
2.  <span id="sdk-for-flutter-explore-registerFontWithFallback-param-fontPath" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">fontPath</span>, </span>
3.  <span id="sdk-for-flutter-explore-registerFontWithFallback-param-fallbackFontFilePaths" class="parameter"><span class="type-annotation">List<span class="signature">\<<wbr></wbr><span class="type-parameter">String</span>\></span></span> <span class="parameter-name">fallbackFontFilePaths</span></span>
