...
/sdk-for-flutter-navigate-routing-batteryspecifications-batteryspecifications([double totalCapacityInKilowattHours = 0.0, double initialChargeInKilowattHours = 0.0, double targetChargeInKilowattHours = 0.0, Map&lt;<wbr/>double, double&gt; chargingCurve = const {}, List&lt;<wbr/>/sdk-for-flutter-navigate-routing-chargingconnectortype&gt; connectorTypes = const [], double minChargeAtChargingStationInKilowattHours = 0.0, double? minChargeAtFirstChargingStationInKilowattHours = null, double minChargeAtDestinationInKilowattHours = 0.0, double? maxChargingVoltageInVolts = null, double? maxChargingCurrentInAmperes = null, Duration chargingSetupDuration = const Duration(seconds: 0), double? maxPowerAtLowVoltageInKilowatts = null])
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="BatterySpecifications.withDefaults">
/sdk-for-flutter-navigate-routing-batteryspecifications-batteryspecifications-withdefaults()
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-chargingcurve
...
[0, /sdk-for-flutter-navigate-routing-batteryspecifications-targetchargeinkilowatthours],
...
<strong>Note:</strong>
For a user-planned /sdk-for-flutter-navigate-routing-chargingstop-class, this parameter is also required.
...
/sdk-for-flutter-navigate-routing-batteryspecifications-chargingsetupduration
↔ Duration
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-connectortypes
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-routing-chargingconnectortype&gt;
</dt>
<dd>
  List of available charging connector types.
It must be at least one charging connector type added, otherwise
the /sdk-for-flutter-navigate-routing-batteryspecifications-class instance is considered invalid.
Defaults to an empty container.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="hashCode">
/sdk-for-flutter-navigate-routing-batteryspecifications-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-initialchargeinkilowatthours
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-maxchargingcurrentinamperes
↔ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-maxchargingvoltageinvolts
↔ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-maxpoweratlowvoltageinkilowatts
↔ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-minchargeatchargingstationinkilowatthours
↔ double
</dt>
<dd>
  Minimum charge when arriving at a charging station in kWh.
It must be non-negative and less than the value of
/sdk-for-flutter-navigate-routing-batteryspecifications-targetchargeinkilowatthours,
otherwise the /sdk-for-flutter-navigate-routing-batteryspecifications-class instance is considered invalid.
Defaults to 0.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="minChargeAtDestinationInKilowattHours">
/sdk-for-flutter-navigate-routing-batteryspecifications-minchargeatdestinationinkilowatthours
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-batteryspecifications-minchargeatfirstchargingstationinkilowatthours
↔ double?
</dt>
<dd>
  Minimum charge when arriving at first charging station in kWh.
This overrides /sdk-for-flutter-navigate-routing-batteryspecifications-minchargeatchargingstationinkilowatthours for the first charging station.
If not specified, /sdk-for-flutter-navigate-routing-batteryspecifications-minchargeatchargingstationinkilowatthours will be used
...
/sdk-for-flutter-navigate-routing-batteryspecifications-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-batteryspecifications-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-batteryspecifications-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-batteryspecifications-operator-equals(<wbr/>Object other)
    → bool
