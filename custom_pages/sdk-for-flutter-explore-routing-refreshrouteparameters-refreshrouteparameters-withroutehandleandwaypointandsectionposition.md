...
RefreshRouteParameters.withRouteHandleAndWaypointAndSectionPosition(<ol class="parameter-list"> <li><a href="/sdk-for-flutter-explore-routing-routehandle-class">RouteHandle</a> routeHandle, </li>
...
<p>Create a new instance of <a href="/sdk-for-flutter-explore-routing-refreshrouteparameters-class">RefreshRouteParameters</a> with the new starting point and the section position on the route.</p>
<ul>
<li>
