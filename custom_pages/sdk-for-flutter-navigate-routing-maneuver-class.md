...
numbers and signpost direction) is stored in /sdk-for-flutter-navigate-routing-maneuver-roadtexts and /sdk-for-flutter-navigate-routing-maneuver-nextroadtexts attributes.
As for the motorway exit information, it can be obtained from /sdk-for-flutter-navigate-routing-maneuver-exitsigntexts attribute.</p>
</section>
<section class="summary offset-anchor" id="constructors">
<h2>Constructors</h2>
<dl class="constructor-summary-list">
<dt class="callable" id="Maneuver">
/sdk-for-flutter-navigate-routing-maneuver-maneuver()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-routing-maneuver-action
...
/sdk-for-flutter-navigate-routing-maneuver-coordinates
...
/sdk-for-flutter-navigate-routing-maneuver-countrycode
→ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-duration
→ Duration
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-exitsigntexts
...
/sdk-for-flutter-navigate-routing-maneuver-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-maneuver-intersectionnames
→ /sdk-for-flutter-navigate-core-localizedtexts-class
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-lengthinmeters
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-nextroadtexts
...
/sdk-for-flutter-navigate-routing-maneuver-offset
→ int
</dt>
<dd>
  Index over /sdk-for-flutter-navigate-routing-section-geometry where the maneuver is located.
Gets the index over /sdk-for-flutter-navigate-routing-section-geometry where the maneuver is located.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="roadTexts">
/sdk-for-flutter-navigate-routing-maneuver-roadtexts
→ /sdk-for-flutter-navigate-routing-roadtexts-class
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-roundaboutangleindegrees
→ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-maneuver-sectionindex
→ int
</dt>
<dd>
  Index over /sdk-for-flutter-navigate-routing-route-sections indicating the section to which the maneuver belongs to.
Gets the index over /sdk-for-flutter-navigate-routing-route-sections indicating the section to which the maneuver belongs to.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="signpost">
/sdk-for-flutter-navigate-routing-maneuver-signpost
→ /sdk-for-flutter-navigate-routing-signpost-class?
</dt>
<dd>
  Gets the /sdk-for-flutter-navigate-routing-signpost-class object.
Gets /sdk-for-flutter-navigate-routing-signpost-class object.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="spanIndex">
/sdk-for-flutter-navigate-routing-maneuver-spanindex
→ int
</dt>
<dd>
  Index over /sdk-for-flutter-navigate-routing-section-spans indicating the first span after the maneuver point.
<strong>Note:</strong> The span index for the last maneuvers (those maneuvers with maneuver action set to
/sdk-for-flutter-navigate-routing-maneuveraction) cannot be used, since these maneuvers are placed after the last span of the route and
the span index for them would be greater than the span list size.
Gets the index over /sdk-for-flutter-navigate-routing-section-spans indicating the first span after the maneuver point.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="text">
/sdk-for-flutter-navigate-routing-maneuver-text
→ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-turnangleindegrees
→ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-maneuver-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-maneuver-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-maneuver-operator-equals(<wbr/>Object other)
    → bool
