...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.mapmatcher/LocationManager///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="sdk-for-flutter-explore-index">API Reference</a><span class="delimiter">/</span><a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher</a><span class="delimiter">/</span><span class="current">LocationManager</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Location</span><wbr></wbr><span><span>Manager</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="sdk-for-flutter-explore-index">LocationManager</a> : <a href="sdk-for-flutter-explore-index">NativeBase</a>, <a href="sdk-for-flutter-explore-index">LocationListener</a></div><p class="paragraph">LocationManager listens to position updates and provides the map-matched location using the LocationManagerListener.</p><p class="paragraph"><strong>Note:</strong> This is a <strong>beta</strong> release of this feature. There may be bugs and unexpected behaviors. Related APIs may change in future releases without a deprecation process.</p></div></div>
  </div>
      ...
      <div data-togglable="FUNCTION">
        ...
        <div class="table"><a data-name="1406686722%2FFunctions%2F1617540583" anchor-label="addMatchedLocationListener" id="1406686722%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-add-matched-location-listener"><span>add</span><wbr></wbr><span>Matched</span><wbr></wbr><span>Location</span><wbr></wbr><span><span>Listener</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1406686722%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-add-matched-location-listener"><span class="token function">addMatchedLocationListener</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">matchedLocationListener<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">MatchedLocationListener</a></span></span><span class="token punctuation">)</span></div><div class="brief "><p class="paragraph">Adds the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MatchedLocationListener</a> to the subscribtion list.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-643119415%2FFunctions%2F1617540583" anchor-label="removeMatchedLocationListener" id="-643119415%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-remove-matched-location-listener"><span>remove</span><wbr></wbr><span>Matched</span><wbr></wbr><span>Location</span><wbr></wbr><span><span>Listener</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-643119415%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-remove-matched-location-listener"><span class="token function">removeMatchedLocationListener</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">matchedLocationListener<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">MatchedLocationListener</a></span></span><span class="token punctuation">)</span></div><div class="brief "><p class="paragraph">Removes the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MatchedLocationListener</a> from the subscribtion list.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="1581775068%2FFunctions%2F1617540583" anchor-label="setMapMatcher" id="1581775068%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-set-map-matcher"><span>set</span><wbr></wbr><span>Map</span><wbr></wbr><span><span>Matcher</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1581775068%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-set-map-matcher"><span class="token function">setMapMatcher</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">mapMatcher<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">MapMatcher</a><span class="token operator">?</span></span></span><span class="token punctuation">)</span></div><div class="brief "><p class="paragraph">Sets the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MapMatcher</a> for exclusive use by <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.LocationManager</a>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="1804101525%2FFunctions%2F1617540583" anchor-label="takeMapMatcher" id="1804101525%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-take-map-matcher"><span>take</span><wbr></wbr><span>Map</span><wbr></wbr><span><span>Matcher</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1804101525%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-take-map-matcher"><span class="token function">takeMapMatcher</span></a><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">: </span><a href="sdk-for-flutter-explore-index">MapMatcher</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Retrieves and removes the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MapMatcher</a> from <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.LocationManager</a>. <strong>Note:</strong> After calling this method, <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.LocationManager</a> will no longer use the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MapMatcher</a> at all. the caller regains full ownership and responsibility for the <a href="sdk-for-flutter-explore-index">com.here.sdk.mapmatcher.MapMatcher</a>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
