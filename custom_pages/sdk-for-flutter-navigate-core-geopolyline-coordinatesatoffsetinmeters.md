...
<li><a href="/sdk-for-flutter-navigate-core-geopolylinedirection">GeoPolylineDirection</a> direction</li>
</ol>)
...
<a href="/sdk-for-flutter-navigate-core-geocoordinates-distanceto">GeoCoordinates.distanceTo</a> function. Therefore, it computes the distance (in meters) along
...
is calculated using the <a href="/sdk-for-flutter-navigate-core-geocoordinates-interpolate">GeoCoordinates.interpolate</a> function.</p>
...
<p>Returns <a href="/sdk-for-flutter-navigate-core-geocoordinates-class">GeoCoordinates</a>. The coordinates of the point at the given distance</p>
