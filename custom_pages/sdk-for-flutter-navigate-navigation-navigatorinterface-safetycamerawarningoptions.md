---
title: "safetyCameraWarningOptions property - NavigatorInterface class - navigation library - Dart API"
...
# <span class="kind-property">safetyCameraWarningOptions</span> property
...
<span class="returntype"><a href="sdk-for-flutter-navigate-navigation-safetycamerawarningoptions-class">SafetyCameraWarningOptions</a></span> <span class="name">safetyCameraWarningOptions</span>
...
<span class="returntype">void</span> <span class="name">safetyCameraWarningOptions=</span><span class="signature">(<wbr></wbr><span id="sdk-for-flutter-navigate-safetyCameraWarningOptions-param-value" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-navigation-safetycamerawarningoptions-class">SafetyCameraWarningOptions</a></span> <span class="parameter-name">value</span></span>)</span>

</div>

<div class="section desc markdown">

Safety camera warning options to be passed to <a href="sdk-for-flutter-navigate-navigation-safetycamerawarninglistener-class">SafetyCameraWarningListener</a>. These options allow the enabling or disabling the text notification for the warner. Sets safety camera warning options to be passed to <a href="sdk-for-flutter-navigate-navigation-safetycamerawarninglistener-class">SafetyCameraWarningListener</a>.
