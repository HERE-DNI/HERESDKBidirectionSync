...
slug: "sdk-for-android-navigate-speedwarningstatus"
---
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#SPEED_LIMIT_EXCEEDED">SPEED_LIMIT_EXCEEDED</a></code></div>
...
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#SPEED_LIMIT_RESTORED">SPEED_LIMIT_RESTORED</a></code></div>
...
<div class="block"><p>Status when the current speed exceeded the speed limit (plus offset) for the current road segment.
 This status is followed by <a href="#SPEED_LIMIT_RESTORED"><code>SPEED_LIMIT_RESTORED</code></a> once the driving
 ...
 speed limit. See <code>SpeedLimitListener</code>.</p></p></div>
</section>
</li>
<li>
...
<div class="block"><p>Status where the current speed is again below the speed limit (plus offset) for the current road segment.
 ...
 <p><strong>Note:</strong>
 The speed limit used to check this condition does not take into account any temporary special
 speed limit. See `SpeedLimitListener.</p></p></div>
</section>
</li>
</ul>
</section>
