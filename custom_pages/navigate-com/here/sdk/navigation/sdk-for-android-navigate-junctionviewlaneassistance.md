...
slug: "sdk-for-android-navigate-junctionviewlaneassistance"
---
...
<div class="block"><p>A class that provides lane assistance information for the next complex junction
 ...
 <p>A junction is recognized as complex only if:
 <ul>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#distanceToJunctionInMeters">distanceToJunctionInMeters</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#lanesForNextJunction">lanesForNextJunction</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.List,double)">JunctionViewLaneAssistance</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="sdk-for-android-navigate-lane" title="class in com.here.sdk.navigation">Lane</a>&gt; lanesForNextJunction,
