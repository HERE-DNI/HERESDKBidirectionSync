...
slug: "sdk-for-android-navigate-speedwarninglistener"
---
...
<div class="block"><p>This interface should be implemented in order to receive notifications
 ...
 don't take into account any temporary special speed limits. See <code>SpeedLimitListener</code>.</p></p></div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#onSpeedWarningStatusChanged(com.here.sdk.navigation.SpeedWarningStatus)">onSpeedWarningStatusChanged</a><wbr/>(<a href="sdk-for-android-navigate-speedwarningstatus" title="enum class in com.here.sdk.navigation">SpeedWarningStatus</a> status)</code></div>
