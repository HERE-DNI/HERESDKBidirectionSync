...
slug: "sdk-for-android-navigate-maneuvernotificationtimingoptions"
---
...
<div class="block"><p>A class defining timing and distance thresholds for maneuver notifications.
 ...
 <p><strong>Note:</strong> By default, notification thresholds depend on <a href="sdk-for-android-navigate-timingprofile" title="enum class in com.here.sdk.navigation"><code>TimingProfile</code></a>. When custom values are set, then these rules will still apply.
...
<p>The timings follow a strict order:
 <ol>
...
<p>Therefore, it is crucial that the set values do not violate the order: range &gt; reminder &gt; distance &gt; action.
 ...
 If <a href="#rangeNotificationDistanceInMeters"><code>rangeNotificationDistanceInMeters</code></a> is smaller than <a href="#reminderNotificationDistanceInMeters"><code>reminderNotificationDistanceInMeters</code></a> the new options will be
 silently ignored and the previous values are kept.
 <p>You always have the choice to specify the thresholds for time or distance. For each <a href="sdk-for-android-navigate-maneuvernotificationtype" title="enum class in com.here.sdk.navigation"><code>ManeuverNotificationType</code></a> a
 ...
 and distance values.
 A configuration value of 0 is only allowed for <a href="#rangeNotificationDistanceInMeters"><code>rangeNotificationDistanceInMeters</code></a> and <a href="#rangeNotificationTimeInSeconds"><code>rangeNotificationTimeInSeconds</code></a>.
 ...
 <p>You can also specify the <a href="#doubleNotificationDistanceInMeters"><code>doubleNotificationDistanceInMeters</code></a> threshold that determines the distance between two maneuvers that
 ...
 <a href="sdk-for-android-navigate-transport-transportmode#CAR"><code>TransportMode.CAR</code></a>, <a href="sdk-for-android-navigate-transport-transportmode#BICYCLE"><code>TransportMode.BICYCLE</code></a>, <a href="sdk-for-android-navigate-transport-transportmode#TRUCK"><code>TransportMode.TRUCK</code></a>.
 <p>Attention: The default values for <a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a> on <a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a> are theoretical, as such
 ...
 </code></pre></p></p></p></p></p></p></p></p></p></p></p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#actionNotificationDistanceInMeters">actionNotificationDistanceInMeters</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#actionNotificationTimeInSeconds">actionNotificationTimeInSeconds</a></code></div>
...
<div class="col-first even-row-color"><code>int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#distanceNotificationDistanceInMeters">distanceNotificationDistanceInMeters</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code>int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#distanceNotificationTimeInSeconds">distanceNotificationTimeInSeconds</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code>int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#doubleNotificationDistanceInMeters">doubleNotificationDistanceInMeters</a></code></div>
<div class="col-last even-row-color">
<div class="block">The default distance setting for double notification.</div>
</div>
<div class="col-first odd-row-color"><code>int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#rangeNotificationDistanceInMeters">rangeNotificationDistanceInMeters</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code>int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#rangeNotificationTimeInSeconds">rangeNotificationTimeInSeconds</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code>int</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#reminderNotificationDistanceInMeters">reminderNotificationDistanceInMeters</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code>int</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#reminderNotificationTimeInSeconds">reminderNotificationTimeInSeconds</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(int,int,int,int,int,int,int,int,int)">ManeuverNotificationTimingOptions</a><wbr/>(int rangeNotificationDistanceInMeters,
...
<div class="block"><p>The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> notification. A configuration value of 0 is only allowed for
 <a href="#rangeNotificationDistanceInMeters"><code>rangeNotificationDistanceInMeters</code></a> and <a href="#rangeNotificationTimeInSeconds"><code>rangeNotificationTimeInSeconds</code></a>. It means that the maneuver notifications of type
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>0</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>0</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>0</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>500</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>500</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>500</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>40</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>40</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>40</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>100</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>100</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>100</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>18</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>18</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>18</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>10</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>10</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>10</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>5</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>5</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>5</td></tr>
...
<tbody>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#FAST_SPEED"><code>TimingProfile.FAST_SPEED</code></a></td><td>20</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#REGULAR_SPEED"><code>TimingProfile.REGULAR_SPEED</code></a></td><td>20</td></tr>
<tr><td><a href="sdk-for-android-navigate-transport-transportmode#PEDESTRIAN"><code>TransportMode.PEDESTRIAN</code></a></td><td><a href="sdk-for-android-navigate-timingprofile#SLOW_SPEED"><code>TimingProfile.SLOW_SPEED</code></a></td><td>20</td></tr>
