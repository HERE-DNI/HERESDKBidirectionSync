...
slug: "sdk-for-android-navigate-trackingcamerabehavior-speedbasedzoompolicyoptions"
---
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#delayBetweenThresholdChanges">delayBetweenThresholdChanges</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#roadClassificationToSpeedThreshold">roadClassificationToSpeedThreshold</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">SpeedBasedZoomPolicyOptions</a>()</code></div>
<div class="col-last even-row-color">
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-navigate-time-duration" title="class in com.here.time">Duration</a></span> <span class="element-name">delayBetweenThresholdChanges</span></div>
