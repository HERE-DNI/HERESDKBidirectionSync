...
slug: "sdk-for-android-navigate-trackingcamerabehavior-maneuvermodeconfiguration"
---
...
<div class="block"><p>Configuration that defines how <a href="sdk-for-android-navigate-trackingcamerabehavior" title="class in com.here.sdk.navigation"><code>TrackingCameraBehavior</code></a> reacts to nearby maneuvers.
 ...
 checks for a match against the <a href="#maneuverRules"><code>maneuverRules</code></a> in the order they are listed. If a match is
 ...
 <p>For correct default initialization, use <a href="sdk-for-android-navigate-trackingcamerabehavior#defaultManeuverModeConfiguration()"><code>TrackingCameraBehavior.defaultManeuverModeConfiguration()</code></a>.</p></p></p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#bearingThresholdInDegrees">bearingThresholdInDegrees</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#maneuverRules">maneuverRules</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ManeuverModeConfiguration</a>()</code></div>
<div class="col-last even-row-color">
