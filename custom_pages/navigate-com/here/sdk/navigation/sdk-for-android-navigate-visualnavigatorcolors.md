...
slug: "sdk-for-android-navigate-visualnavigatorcolors"
---
...
<div class="block"><p>Gets the color used to draw maneuver arrows on the route.
 <p>The object containing color used to draw maneuver arrows on the route to highlight lane directions at the end of a street.
 The alpha channel is ignored. The color is interpreted as fully opaque.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
