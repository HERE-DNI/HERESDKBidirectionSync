...
<div class="block"><p>Gets an id of the drawing.
 <p>This describes the identifier for drawing.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Checks if this is a root drawing of the venue.
 <p>This can be used to check if this is top level
 drawing in venue.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets a parent venue model.
 <p>It can be used to get the <a href="sdk-for-android-navigate-venuemodel" title="class in com.here.sdk.venue.data"><code>VenueModel</code></a>
 where this Drawing belong.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets levels of the drawing.
 <p>This describes for which all level this
 drawing belongs.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets a center of the drawing.
 <p>It can be used to get center coordinates of drawing.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets a bounding box of the drawing.
 <p>This is used to check if at certain zoom level
 and inside view this GeoBox belongs, then need to render.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets properties of the drawing.
 <p>This can be used to get different properties
 like name belonging to Drawing.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets geometries ordered by a name in an ascending order.
 <p>This can be used to search geometries by name.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets geometries mapped by icon names.
 <p>This can be used to search the geometries by icon names.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Gets a list of topologies of the drawing.
 <p>This can be used to check for which
 all topologies are realted to Drawing.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
