---
title: "IndoorRouteOptions (API Reference)"
slug: "sdk-for-android-navigate-indoorrouteoptions"
---
...
<div class="inheritance">com.here.sdk.venue.routing.IndoorRouteOptions</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public final class </span><span class="element-name type-name-label">IndoorRouteOptions</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block"><p>All the options to specify how an indoor route should be calculated.</p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#indoorAvoidanceOptions">indoorAvoidanceOptions</a></code></div>
<div class="col-last even-row-color">
<div class="block">Options to specify restrictions for indoor route calculations.</div>
</div>
<div class="col-first odd-row-color"><code><a href="sdk-for-android-navigate-routing-routeoptions" title="class in com.here.sdk.routing">RouteOptions</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#speedInMetersPerSecond">speedInMetersPerSecond</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">IndoorRouteOptions</a>()</code></div>
<div class="col-last even-row-color">
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-navigate-routing-routeoptions" title="class in com.here.sdk.routing">RouteOptions</a></span> <span class="element-name">routeOptions</span></div>
<div class="block"><p>Specifies the common route calculation options.
 <p><strong>Note:</strong> Currently, only <a href="sdk-for-android-navigate-routing-routeoptions#optimizationMode"><code>RouteOptions.optimizationMode</code></a> parameter is
 utilized for indoor route calculation.</p></p></div>
</section>
</li>
<li>
...
<div class="block"><p>The transport mode for route calculation.
 ...
 This option will affect only outdoor route sections.</p></p></div>
</section>
</li>
<li>
...
<h3>IndoorRouteOptions</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">IndoorRouteOptions</span>()</div>
<div class="block"><p>Creates an object and assign default values for route options.</p></div>
</section>
</li>
</ul>
</section>
