...
slug: "sdk-for-android-navigate-roadusages"
---
...
<div class="block"><p>Road Usages of the segment.
 <p><em><strong>Note</strong></em> a road can have more than one attribute at the same time.
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#isPriorityRoad">isPriorityRoad</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Indicates road stretches that have signs indicating priority on the road.</div>
</div>
<div class="col-first even-row-color"><code>boolean</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#isRamp">isRamp</a></code></div>
<div class="col-last even-row-color">
<div class="block">Range is a ramp: connects roads that do not intersect at grade.</div>
</div>
<div class="col-first odd-row-color"><code>boolean</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#isTollway">isTollway</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">RoadUsages</a>()</code></div>
<div class="col-last even-row-color">
