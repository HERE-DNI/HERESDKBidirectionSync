...
slug: "sdk-for-android-navigate-vehiclespecification"
---
...
<div class="block"><p>Vehicle height in centimeters. The provided value must be in the range [0, 5000].
 ...
 <p><strong>Note:</strong> Supported in <a href="sdk-for-android-navigate-transportmode#TRUCK"><code>TransportMode.TRUCK</code></a>, <a href="sdk-for-android-navigate-transportmode#BUS"><code>TransportMode.BUS</code></a>, <a href="sdk-for-android-navigate-transportmode#PRIVATE_BUS"><code>TransportMode.PRIVATE_BUS</code></a>,
 <a href="sdk-for-android-navigate-transportmode#CAR"><code>TransportMode.CAR</code></a> (Beta), <a href="sdk-for-android-navigate-transportmode#TAXI"><code>TransportMode.TAXI</code></a> (Beta) transport modes.</p></p></div>
</section>
</li>
<li>
...
<div class="block"><p>Allowed payload capacity, including trailers, specified in kilograms. The provided value
 ...
 By default, it is not set.
 <p><strong>Note:</strong> Supported in <a href="sdk-for-android-navigate-transportmode#TRUCK"><code>TransportMode.TRUCK</code></a>, <a href="sdk-for-android-navigate-transportmode#CAR"><code>TransportMode.CAR</code></a> (Beta), <a href="sdk-for-android-navigate-transportmode#TAXI"><code>TransportMode.TAXI</code></a> (Beta)
...
<div class="block"><p>Defines total number of axles across all the trailers attached to the vehicle.
 ...
 By default, it is not set.
 <p><strong>Note:</strong>: This parameter is currently used only for the calculation of tolls in regions where it is applicable.</p></p></div>
</section>
</li>
<li>
...
<div class="block"><p>The total number of tires the vehicle has, i.e., the tires on the base vehicle and any attached trailers.
 ...
 <p><strong>Note</strong>: This parameter is not supported in isoline routing.</p></p></div>
</section>
</li>
<li>
