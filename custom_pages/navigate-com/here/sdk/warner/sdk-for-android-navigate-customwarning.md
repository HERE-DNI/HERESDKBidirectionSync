...
slug: "sdk-for-android-navigate-customwarning"
---
...
<div class="inheritance">com.here.sdk.warner.CustomWarning</div>
</div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#endOffsetInMeters">endOffsetInMeters</a></code></div>
...
<div class="col-first odd-row-color"><code><a href="sdk-for-android-navigate-core-metadata" title="class in com.here.sdk.core">Metadata</a></code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#payload">payload</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">CustomWarning</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Identifier of the warning.
 The ID is unique only within its specific <a href="#customWarningType"><code>customWarningType</code></a> and can be used
...
<div class="block"><p>Identifier of the custom warning type.
 ...
 registry should be used to retrieve additional warning details.</p></p></div>
</section>
</li>
<li>
...
<div class="block"><p>End offset of the warning range along the segment.
 ...
 longer applicable.
 <p>May be <code>null</code>. In this case, the value is automatically considered
 to be equal to <code>startOffsetInMeters</code>.</p></p></p></div>
</section>
</li>
<li>
...
<h3>payload</h3>
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-navigate-core-metadata" title="class in com.here.sdk.core">Metadata</a></span> <span class="element-name">payload</span></div>
<div class="block"><p>Custom warning payload.
 <p>Contains warning-specific payload data.
 A value of <code>null</code> indicates that no additional data is associated with the warning.</p></p></div>
</section>
</li>
</ul>
</section>
...
<h3>CustomWarning</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">CustomWarning</span>()</div>
