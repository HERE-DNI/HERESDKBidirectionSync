...
class="external-link"
title="class or interface in java.lang"><code>Comparable</code></a>`<`[`MapSceneLights.Category`](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")`>`,
<a
...
light and Rim light. These lights are directional lights. The properties
of all lights have an impact on the shading of 3D objects, for instance,
extruded buildings within the scene. However, shadow casting is only
affected by the direction of the main light. Category primarily serves
as an identifier type for managing the lights.
...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category#BACK"
  class="member-name-link"><code>BACK</code></a></td>
  <td><div class="block">
  Back light
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category#MAIN"
  class="member-name-link"><code>MAIN</code></a></td>
  <td><div class="block">
  Main light
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category#RIM"
  class="member-name-link"><code>RIM</code></a></td>
  <td><div class="block">
  Rim light
  </div></td>
  </tr>
...
- <div id="method-summary" class="section method-summary">
  ...
  <td><code>static </code><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category"
  title="enum class in com.here.sdk.mapview"><code>MapSceneLights.Category</code></a><code>[]</code></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="MAIN" class="section detail">
    ...
    final</span> <span class="return-type">[MapSceneLights.Category](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")</span> <span class="element-name">MAIN</span>
  ...
  - <div id="BACK" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[MapSceneLights.Category](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")</span> <span class="element-name">BACK</span>
  ...
  - <div id="RIM" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[MapSceneLights.Category](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")</span> <span class="element-name">RIM</span>
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[MapSceneLights.Category](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")\[\]</span> <span class="element-name">values</span>()
  ...
  - <div id="valueOf(java.lang.String)" class="section detail">
    ...
    <span class="modifiers">public
    static</span> <span class="return-type">[MapSceneLights.Category](sdk-for-android-explore-com-here-sdk-mapview-mapscenelights-category "enum class in com.here.sdk.mapview")</span> <span class="element-name">valueOf</span><span class="parameters">(<a
