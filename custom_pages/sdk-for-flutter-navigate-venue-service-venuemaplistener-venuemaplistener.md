...
<li class="self-crumb">VenueMapListener factory constructor</li>
</ol>
...
VenueMapListener(<wbr/><ol class="parameter-list single-line"> <li>void onGetVenueCompletedLambda(<ol class="parameter-list"> <li>String, </li>
