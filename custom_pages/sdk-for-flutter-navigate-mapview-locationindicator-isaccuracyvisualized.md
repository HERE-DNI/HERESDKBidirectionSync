...
<section class="desc markdown">
<p>Whether the horizontal accuracy is visualized by scaling the accuracy indicator halo.
Sets whether /sdk-for-flutter-navigate-core-location-horizontalaccuracyinmeters is used to scale the accuracy indicator halo.
Default is <code>false</code>, in which case the halo has a fixed and zoom level independent size.</p>
<p>When set to <code>true</code>, the radius of the halo corresponds to the value of
/sdk-for-flutter-navigate-core-location-horizontalaccuracyinmeters passed to /sdk-for-flutter-navigate-mapview-locationindicator-updatelocation
...
<p>If the location indicator is set to inactive (which can be checked via /sdk-for-flutter-navigate-mapview-locationindicator-isactive flag),
...
/sdk-for-flutter-navigate-core-location-horizontalaccuracyinmeters in world coordinates.</li>
