...
slug: "sdk-for-ios-navigate-emobilityserviceprovider"
---
...
<html lang="en">
  <head>
    <title>EMobilityServiceProvider Structure Reference</title>
...
It may change but the respective <code><a href="sdk-for-ios-explore-emobilityserviceprovider#/s:7heresdk24EMobilityServiceProviderV9partnerIdSSSgvp">partnerId</a></code> will remain stable.</p>
...
It can be used for filtering when searching for EV charging stations.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(name:partnerId:)" class="dashAnchor"></a>
