...
slug: "sdk-for-ios-navigate-regionid"
---
...
<html lang="en">
  <head>
    <title>RegionId Structure Reference</title>
  ...
  <body>
    ...
    <a title="RegionId Structure Reference"></a>
    <header>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk8RegionIdV2ids5Int64Vvp"></a>
                    <a name="//apple_ref/swift/Property/id" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk8RegionIdV2ids5Int64Vvp">id</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>A unique region ID to identify a region.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">let</span> <span class="nv">id</span><span class="p">:</span> <span class="kt">Int64</span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk8RegionIdV2idACs5Int64V_tcfc"></a>
                    <a name="//apple_ref/swift/Method/init(id:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk8RegionIdV2idACs5Int64V_tcfc">init(id:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">id</span><span class="p">:</span> <span class="kt">Int64</span><span class="p">)</span></code></pre>
