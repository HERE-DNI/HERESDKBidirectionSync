...
and sizes.</p>
<p>The geometry to be visualized is represented by an instance of /sdk-for-flutter-navigate-core-geopolygon-class.
To display circular areas (for example, a position accuracy indicator) use a GeoPolygon
created from a /sdk-for-flutter-navigate-core-geocircle-class using /sdk-for-flutter-navigate-core-geopolygon-geopolygon-withgeocircle.</p>
<p>Note:</p>
<ul>
...
/sdk-for-flutter-navigate-mapview-mappolygon-mappolygon(/sdk-for-flutter-navigate-core-geopolygon-class geometry, Color color)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-mappolygon-withoutlinecolorandoutlinewidthinpixels(/sdk-for-flutter-navigate-core-geopolygon-class geometry, Color color, Color outlineColor, double outlineWidthInPixels)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-draworder
↔ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-fillcolor
↔ Color
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-geometry
...
/sdk-for-flutter-navigate-mapview-mappolygon-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mappolygon-metadata
...
/sdk-for-flutter-navigate-mapview-mappolygon-outlinecolor
↔ Color
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-outlinewidth
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolygon-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mappolygon-visibilityranges
...
/sdk-for-flutter-navigate-mapview-mappolygon-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mappolygon-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mappolygon-operator-equals(<wbr/>Object other)
    → bool
