...
searchByAddress(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-search-addressquery-class query, </li>
...
<p>Performs an asynchronous address query search for /sdk-for-flutter-navigate-search-place-class instances.</p>
