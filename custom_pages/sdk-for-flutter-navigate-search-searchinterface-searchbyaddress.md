...
searchByAddress(<ol class="parameter-list single-line"> <li><a href="/sdk-for-flutter-navigate-search-addressquery-class">AddressQuery</a> query, </li>
...
<p>Performs an asynchronous address query search for <a href="/sdk-for-flutter-navigate-search-place-class">Place</a> instances.</p>
...
belong to more than one <a href="/sdk-for-flutter-navigate-search-place-class">Place</a> result, although all found places will
