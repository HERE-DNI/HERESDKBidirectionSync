...
<p>Supports only one mode: <a href="sdk-for-flutter-explore-mapview-mapfeaturemodes-shadowsall">MapFeatureModes.shadowsAll</a>.</p>
<p>A <a href="sdk-for-flutter-explore-mapview-shadowquality">ShadowQuality</a> must be set on the MapContext through a MapView or the feature has no
effect.</p>
