---
title: "startAnimationWithListener method - MapCamera class - mapview library - Dart API"
...
# <span class="kind-method">startAnimationWithListener</span> abstract method

</div>

<div class="section multi-line-signature">

<span class="returntype">void</span> <span class="name">startAnimationWithListener</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-startAnimationWithListener-param-cameraAnimation" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-mapview-mapcameraanimation-class">MapCameraAnimation</a></span> <span class="parameter-name">cameraAnimation</span>, </span>
2.  <span id="sdk-for-flutter-navigate-startAnimationWithListener-param-animationListener" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-animation-animationlistener-class">AnimationListener</a></span> <span class="parameter-name">animationListener</span></span>
