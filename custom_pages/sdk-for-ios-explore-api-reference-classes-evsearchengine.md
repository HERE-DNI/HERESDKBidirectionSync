...
public func search(ids: [String], completion: @escaping EVCP3SearchCompletionHandler) -&gt; TaskHandle</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public func setOptions(options: EVSearchOptions)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
