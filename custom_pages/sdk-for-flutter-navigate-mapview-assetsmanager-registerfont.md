...
1.  <span id="sdk-for-flutter-navigate-registerFont-param-fontName" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">fontName</span>, </span>
2.  <span id="sdk-for-flutter-navigate-registerFont-param-fontPath" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">fontPath</span></span>
