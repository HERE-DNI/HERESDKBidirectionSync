...
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-routing-charging-station"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.routing/ChargingStation///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.routing</a><span class="delimiter">/</span><span class="current">ChargingStation</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Charging</span><wbr></wbr><span><span>Station</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">ChargingStation</a></div><p class="paragraph">Data for an electric vehicle charging station.</p></div></div>
  </div>
      ...
      <div data-togglable="PROPERTY">
        ...
        <div class="table"><a data-name="-1024815824%2FProperties%2F1617540583" anchor-label="brand" id="-1024815824%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="brand.html"><span><span>brand</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1024815824%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="brand.html">brand</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-name-i-d/index.html">NameID</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Charging station brand. <a href="../../com.here.sdk.core/-name-i-d/name.html">com.here.sdk.core.NameID.name</a> reflect to charging station brand name. <a href="../../com.here.sdk.core/-name-i-d/id.html">com.here.sdk.core.NameID.id</a> reflect to charging station brand unique ID.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-878098089%2FProperties%2F1617540583" anchor-label="chargePointOperator" id="-878098089%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="charge-point-operator.html"><span>charge</span><wbr></wbr><span>Point</span><wbr></wbr><span><span>Operator</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-878098089%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="charge-point-operator.html">chargePointOperator</a><span class="token operator">: </span><a href="../../com.here.sdk.core/-name-i-d/index.html">NameID</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Charging station charge-point-operator. <a href="../../com.here.sdk.core/-name-i-d/name.html">com.here.sdk.core.NameID.name</a> reflect to charge-point-operator name. <a href="../../com.here.sdk.core/-name-i-d/id.html">com.here.sdk.core.NameID.id</a> reflect to charge-point-operator ID.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="938044499%2FProperties%2F1617540583" anchor-label="connectorAttributes" id="938044499%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="connector-attributes.html"><span>connector</span><wbr></wbr><span><span>Attributes</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="938044499%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="connector-attributes.html">connectorAttributes</a><span class="token operator">: </span><a href="../-charging-connector-attributes/index.html">ChargingConnectorAttributes</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Details of the connector suggested to be used.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-543287657%2FProperties%2F1617540583" anchor-label="matchingEMobilityServiceProviders" id="-543287657%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="matching-e-mobility-service-providers.html"><span>matching</span><wbr></wbr><span>EMobility</span><wbr></wbr><span>Service</span><wbr></wbr><span><span>Providers</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-543287657%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="matching-e-mobility-service-providers.html">matchingEMobilityServiceProviders</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.collections/-list/index.html">List</a><span class="token operator">&lt;</span><a href="../../com.here.sdk.core/-name-i-d/index.html">NameID</a><span class="token operator">&gt;</span></div><div class="brief "><p class="paragraph">List of matched E-Mobility Service Providers. Populated only when <a href="../-electric-vehicle-options/ev-mobility-service-provider-preferences.html">com.here.sdk.routing.ElectricVehicleOptions.evMobilityServiceProviderPreferences</a> was set. This list reflects the subset of E-Mobility Service Providers supported by the charging station, from the list specified in the request parameter <a href="../-electric-vehicle-options/ev-mobility-service-provider-preferences.html">com.here.sdk.routing.ElectricVehicleOptions.evMobilityServiceProviderPreferences</a>. <a href="../../com.here.sdk.core/-name-i-d/name.html">com.here.sdk.core.NameID.name</a> in each list item reflect to E-Mobility Service Provider name. <a href="../../com.here.sdk.core/-name-i-d/id.html">com.here.sdk.core.NameID.id</a> in each list item reflect to E-Mobility Service Provider id.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
