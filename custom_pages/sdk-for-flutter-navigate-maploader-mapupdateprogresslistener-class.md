---
title: "MapUpdateProgressListener class - maploader library - Dart API"
...
<div id="sdk-for-flutter-navigate-dartdoc-main-content" class="main-content" data-above-sidebar="maploader/maploader-library-sidebar.html" data-below-sidebar="maploader/MapUpdateProgressListener-class-sidebar.html">

<div>

# <span class="kind-class">MapUpdateProgressListener</span> class <a href="https://dart.dev/language/class-modifiers#abstract" class="feature feature-abstract" title="This type can not be directly constructed.">abstract</a>
...
<span class="name"><a href="sdk-for-flutter-navigate-maploader-mapupdateprogresslistener-hashcode">hashCode</a></span> <span class="signature">→ int</span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-maploader-mapupdateprogresslistener-runtimetype">runtimeType</a></span> <span class="signature">→ Type</span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-maploader-mapupdateprogresslistener-oncomplete">onComplete</a></span><span class="signature">(<wbr></wbr><span id="sdk-for-flutter-navigate-onComplete-param-error" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-maploader-maploadererror">MapLoaderError</a>?</span> <span class="parameter-name">error</span></span>) <span class="returntype parameter">→ void</span> </span>  
...
<span class="name"><a href="sdk-for-flutter-navigate-maploader-mapupdateprogresslistener-onresume">onResume</a></span><span class="signature">(<wbr></wbr>) <span class="returntype parameter">→ void</span> </span>  
Called when a paused map update is resumed.

<span class="name"><a href="sdk-for-flutter-navigate-maploader-mapupdateprogresslistener-tostring">toString</a></span><span class="signature">(<wbr></wbr>) <span class="returntype parameter">→ String</span> </span>  
