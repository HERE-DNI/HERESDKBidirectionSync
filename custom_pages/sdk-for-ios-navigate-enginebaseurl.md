...
slug: "sdk-for-ios-navigate-enginebaseurl"
---
...
<html lang="en">
  <head>
    <title>EngineBaseURL Enumeration Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/searchEngine" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>Indicates a <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code> endpoint.
Note that the provided string value will replace the base URL.
The endpoint names for this engine are &ldquo;v1/discover&rdquo;, &ldquo;v1/geocode&rdquo;, &ldquo;v1/revgeocode&rdquo;,
&ldquo;v1/autosuggest&rdquo;, &ldquo;v1/lookup&rdquo; and &ldquo;v1/browse&rdquo;. A valid base string value
could look like &ldquo;<a href="http://www.my-company.com">www.my-company.com</a>&rdquo;. An example of the resulting URL for the first
endpoint looks like this: &ldquo;<a href="https://www.my-company.com/v1/discover">https://www.my-company.com/v1/discover</a>&rdquo; appended with
query data. You need to ensure that the provided base URL supports all required endpoints.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/routingEngine" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Indicates a <code><a href="sdk-for-ios-explore-routingengine">RoutingEngine</a></code> endpoint.
Note that the provided string value will replace the base URL.
The endpoint names for this engine are &ldquo;v8/routes&rdquo;, &ldquo;v8/import&rdquo;. A valid base string value
could look like &ldquo;<a href="http://www.my-company.com">www.my-company.com</a>&rdquo;. An example of the resulting URL for the first
endpoint looks like this: &ldquo;<a href="https://www.my-company.com/v8/routes">https://www.my-company.com/v8/routes</a>&rdquo; appended with
query data. You need to ensure that the provided base URL supports all required endpoints.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/authentication" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Indicates base url for <code><a href="sdk-for-ios-explore-authentication">Authentication</a></code>.
Note that the provided string value will replace the base URL.
The endpoint name for this base url is &ldquo;oauth2/token&rdquo;. A valid base string value
could look like &ldquo;<a href="http://www.my-company.com">www.my-company.com</a>&rdquo;. An example of the resulting URL for the
endpoint looks like this: &ldquo;<a href="https://www.my-company.com/oauth2/token">https://www.my-company.com/oauth2/token</a>&rdquo; appended with
query data. You need to ensure that the provided base URL supports required endpoint.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/dsProxy" class="dashAnchor"></a>
...
should be loaded.
By default, the data Service proxy, in short <code>EngineBaseURL.dsProxy</code>, is set to &ldquo;<a href="https://direct.data.api.platform.here.com/direct/v1">https://direct.data.api.platform.here.com/direct/v1</a>&rdquo;.
...
&ldquo;<a href="https://data.api.platform.yourcompany.com/direct/v1">https://data.api.platform.yourcompany.com/direct/v1</a>&rdquo;.
...
If you do not load a custom catalog configuration, you can ignore this setting.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/trafficData" class="dashAnchor"></a>
...
please use <code><a href="sdk-for-ios-explore-enginebaseurl#/s:7heresdk13EngineBaseURLO24trafficVectorTileServiceyA2CmF">EngineBaseURL.trafficVectorTileService</a></code>.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/trafficVectorTileService" class="dashAnchor"></a>
...
Note that the provided string value will replace the base URL.
This is only relevant for traffic presented in the map view. For the TrafficEngine, please use <code><a href="sdk-for-ios-explore-enginebaseurl#/s:7heresdk13EngineBaseURLO11trafficDatayA2CmF">EngineBaseURL.trafficData</a></code>.</p>
...
The endpoint name for this engine is &ldquo;v2/traffictiles&rdquo;. A valid base string value
could look like &ldquo;<a href="http://www.my-company.com">www.my-company.com</a>&rdquo;. The resulting URL looks like this:
&ldquo;<a href="https://www.my-company.com/v2/traffictiles/%7Blayer%7D/mc/%7Bz%7D/%7Bx%7D/%7By%7D/omv">https://www.my-company.com/v2/traffictiles/{layer}/mc/{z}/{x}/{y}/omv</a>&rdquo;, with concrete tile
...
You need to ensure that the provided base URL supports all required endpoints.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/rasterTileService" class="dashAnchor"></a>
...
could look like:
&ldquo;<a href="https://www.my-company.com/satellite.day/%7Bz%7D/%7Bx%7D/%7By%7D/512/jpg">https://www.my-company.com/satellite.day/{z}/{x}/{y}/512/jpg</a>&rdquo;</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/isolineRoutingEngine" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Indicates a <code><a href="sdk-for-ios-explore-isolineroutingengine">IsolineRoutingEngine</a></code> endpoint.
Note that the provided string value will replace the base URL.
The endpoint names for this engine are &ldquo;v8/isolines&rdquo;. A valid base string value
could look like &ldquo;<a href="http://www.my-company.com">www.my-company.com</a>&rdquo;. An example of the resulting URL for the first
endpoint looks like this: &ldquo;<a href="https://www.my-company.com/v8/isolines">https://www.my-company.com/v8/isolines</a>&rdquo; appended with
query data. You need to ensure that the provided base URL supports all required endpoints.</p>
