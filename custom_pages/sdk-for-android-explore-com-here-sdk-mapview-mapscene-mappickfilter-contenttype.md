...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  class="member-name-link"><code>CUSTOM_LAYER_DATA</code></a></td>
  <td><div class="block">
  ...
  class="member-name-link"><code>MAP_CONTENT</code></a></td>
  <td><div class="block">
  ...
  MapFeatures.TRAFFIC_INCIDENTS . Vehicle restrictions are only available
  for the Navigate license.
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype#MAP_ITEMS"
  class="member-name-link"><code>MAP_ITEMS</code></a></td>
  <td><div class="block">
  Map items added through a MapScene like MapMarker , MapPolyline ,
  MapPolygon .
  </div></td>
  </tr>
  </tbody>
...
- <div id="method-summary" class="section method-summary">
  ...
  <td><code>static </code><a
  href="sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype"
  title="enum class in com.here.sdk.mapview"><code>MapScene.MapPickFilter.ContentType</code></a><code>[]</code></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="MAP_ITEMS" class="section detail">
    ...
    final</span> <span class="return-type">[MapScene.MapPickFilter.ContentType](sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype "enum class in com.here.sdk.mapview")</span> <span class="element-name">MAP_ITEMS</span>
  ...
  - <div id="MAP_CONTENT" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[MapScene.MapPickFilter.ContentType](sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype "enum class in com.here.sdk.mapview")</span> <span class="element-name">MAP_CONTENT</span>
  ...
  - <div id="CUSTOM_LAYER_DATA" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[MapScene.MapPickFilter.ContentType](sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype "enum class in com.here.sdk.mapview")</span> <span class="element-name">CUSTOM_LAYER_DATA</span>
    ...
    Custom user map content added using custom datasources e.g.
    LineDataSource , PolygonDataSource and layers.
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[MapScene.MapPickFilter.ContentType](sdk-for-android-explore-com-here-sdk-mapview-mapscene-mappickfilter-contenttype "enum class in com.here.sdk.mapview")\[\]</span> <span class="element-name">values</span>()
