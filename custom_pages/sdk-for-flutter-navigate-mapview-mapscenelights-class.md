...
/sdk-for-flutter-navigate-mapview-mapscenelights-mapscenelights()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-mapview-mapscenelights-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapscenelights-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapscenelights-getcolor(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category)
    → Color?
...
/sdk-for-flutter-navigate-mapview-mapscenelights-getdirection(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category)
...
/sdk-for-flutter-navigate-mapview-mapscenelights-getintensity(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category)
    → double?
...
/sdk-for-flutter-navigate-mapview-mapscenelights-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mapscenelights-reset(<wbr/>)
    → void
...
/sdk-for-flutter-navigate-mapview-mapscenelights-setcolor(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category, Color color, /sdk-for-flutter-navigate-mapview-mapscenelightsattributesettingcallback? callback)
    → void
...
/sdk-for-flutter-navigate-mapview-mapscenelights-setdirection(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category, /sdk-for-flutter-navigate-mapview-mapscenelightsdirection-class direction, /sdk-for-flutter-navigate-mapview-mapscenelightsattributesettingcallback? callback)
    → void
...
/sdk-for-flutter-navigate-mapview-mapscenelights-setintensity(<wbr/>/sdk-for-flutter-navigate-mapview-mapscenelightscategory category, double intensity, /sdk-for-flutter-navigate-mapview-mapscenelightsattributesettingcallback? callback)
    → void
...
/sdk-for-flutter-navigate-mapview-mapscenelights-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mapscenelights-operator-equals(<wbr/>Object other)
    → bool
