...
<p>A /sdk-for-flutter-navigate-search-addressquery-query can consist of parts of an address or full addresses,
optionally comma separated. /sdk-for-flutter-navigate-search-addressquery-class should only be used to search for parts of the address,
...
/sdk-for-flutter-navigate-search-textquery-class instead. /sdk-for-flutter-navigate-search-searchoptions-languagecode specifies the language of the
/sdk-for-flutter-navigate-search-addressquery-query and determines the preferred language of the results.</p>
</section>
<section>
...
/sdk-for-flutter-navigate-search-addressquery-addressquery(String query)
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-addressquery-addressquery-withareacenter(String query, /sdk-for-flutter-navigate-core-geocoordinates-class areaCenter)
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-addressquery-addressquery-withareacenterincountries(String query, /sdk-for-flutter-navigate-core-geocoordinates-class areaCenter, List&lt;<wbr/>/sdk-for-flutter-navigate-core-countrycode&gt; countries)
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-addressquery-areacenter
...
For Offline Search null value will result in /sdk-for-flutter-navigate-search-searcherror
<div class="features">final</div>
</dd>
<dt class="property" id="countries">
/sdk-for-flutter-navigate-search-addressquery-countries
...
/sdk-for-flutter-navigate-search-addressquery-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-addressquery-query
→ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-addressquery-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-addressquery-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-search-addressquery-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-search-addressquery-operator-equals(<wbr/>Object other)
    → bool
