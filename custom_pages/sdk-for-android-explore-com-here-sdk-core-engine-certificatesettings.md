...
- <div id="field-summary" class="section field-summary">
  ...
  class="member-name-link"><code>certFileBlob</code></a></td>
  <td><div class="block">
  The CA file as blob (https://curl.se/libcurl/c/CURLOPT_CAINFO_BLOB.html)
  Binary data of PEM encoded content holding one or more certificates to
  verify the HTTPS server with.
  </div></td>
  </tr>
  <tr>
  <td><a
  ...
  class="member-name-link"><code>clientCertFileBlob</code></a></td>
  <td><div class="block">
  The client certificate file as blob
  (https://curl.se/libcurl/c/CURLOPT_SSLCERT_BLOB.html) The format must be
  "P12" or "PEM" on OpenSSL.
  </div></td>
  </tr>
  <tr>
  <td><a
  ...
  class="member-name-link"><code>clientKeyFileBlob</code></a></td>
  <td><div class="block">
...
- <div id="constructor-summary" class="section constructor-summary">
  ...
  <tbody>
  <tr>
  <td><pre><code>CertificateSettings(String clientCertFileBlob,
   String clientKeyFileBlob)</code></pre></td>
  <td><div class="block">
...
- <div id="field-detail" class="section field-details">
  ...
  - <div id="clientCertFileBlob" class="section detail">
  ...
  - <div id="clientKeyFileBlob" class="section detail">
  ...
  - <div id="certFileBlob" class="section detail">
