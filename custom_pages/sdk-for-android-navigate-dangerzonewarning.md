...
<title>DangerZoneWarning (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.navigation, class: DangerZoneWarning">
...
<h1 title="Class DangerZoneWarning" class="title">Class DangerZoneWarning</h1>
</div>
...
<div class="block"><p>Represents danger zones. A danger zone refers to areas where there is an increased risk of
 ...
 danger zones are only available in selected countries, such as France.</div>
</section>
...
<div class="col-second odd-row-color"><code><a href="#isZoneStart" class="member-name-link">isZoneStart</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(boolean,double,com.here.sdk.navigation.DistanceType)" class="member-name-link">DangerZoneWarning</a><wbr>(boolean&nbsp;isZoneStart,
...
<div class="block"><p>The distance from the current location to the Danger zone.</div>
</section>
</li>
<li>
...
<dd><code>isZoneStart</code> - <p>A flag indicating whether the Danger Zone officially start in the location the user is
 entering it.</dd>
<dd><code>distanceInMeters</code> - <p>The distance from the current location to the Danger zone.</dd>
