...
- <a href="sdk-for-flutter-navigate-transport-busspecifications-lengthincentimeters">BusSpecifications.lengthInCentimeters</a> must be in the range \[0, 30000\]. The validation of the range is done in the method that takes `BusOptions` as parameter.
