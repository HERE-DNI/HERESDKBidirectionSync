...
<title>OfflineSearchIndexListener (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.search, interface: OfflineSearchIndexListener">
...
<h1 title="Interface OfflineSearchIndexListener" class="title">Interface OfflineSearchIndexListener</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onComplete(com.here.sdk.search.OfflineSearchIndex.Error)" class="member-name-link">onComplete</a><wbr>(<a href="sdk-for-android-explore-offlinesearchindex-error" title="enum class in com.here.sdk.search">OfflineSearchIndex.Error</a>&nbsp;error)</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onProgress(int)" class="member-name-link">onProgress</a><wbr>(int&nbsp;percentage)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
<div class="block">Called multiple times to indicate the progress of index creation or deletion.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onStarted(com.here.sdk.search.OfflineSearchIndex.Operation)" class="member-name-link">onStarted</a><wbr>(<a href="sdk-for-android-explore-offlinesearchindex-operation" title="enum class in com.here.sdk.search">OfflineSearchIndex.Operation</a>&nbsp;operation)</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3">
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onStarted</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-offlinesearchindex-operation" title="enum class in com.here.sdk.search">OfflineSearchIndex.Operation</a>&nbsp;operation)</span></div>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>operation</code> - <p>Shows whether the index is being created or removed.</dd>
</dl>
</section>
</li>
<li>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>percentage</code> - <p>Represents a percentage of work done.</dd>
</dl>
</section>
</li>
<li>
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onComplete</span><wbr><span class="parameters">(@Nullable
 <a href="sdk-for-android-explore-offlinesearchindex-error" title="enum class in com.here.sdk.search">OfflineSearchIndex.Error</a>&nbsp;error)</span></div>
