---
title: "MapMatcher constructor - MapMatcher - mapmatcher library - Dart API"
...
# <span class="kind-constructor">MapMatcher</span> constructor

</div>

<div class="section multi-line-signature">

<span class="name">MapMatcher</span>(<wbr></wbr>)
...
``` dart
factory MapMatcher() => $prototype.$init();
```
