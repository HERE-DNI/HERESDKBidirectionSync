...
Suggestions (please check /sdk-for-flutter-navigate-search-suggestiontype) are either:
Place: /sdk-for-flutter-navigate-search-suggestiontype
Query: /sdk-for-flutter-navigate-search-suggestiontype or /sdk-for-flutter-navigate-search-suggestiontype</p>
...
/sdk-for-flutter-navigate-search-suggestion-suggestion()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-search-suggestion-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-suggestion-href
→ String?
</dt>
<dd>
  Direct URL for precise query.
Available only for /sdk-for-flutter-navigate-search-suggestiontype and /sdk-for-flutter-navigate-search-suggestiontype.
This is not supported in offline search.
Gets the direct link for Discover query.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="id">
/sdk-for-flutter-navigate-search-suggestion-id
→ String?
</dt>
<dd>
  The unique id of suggested item. It can be used to query further information.
For online search, suggestion of type /sdk-for-flutter-navigate-search-suggestiontype
will have Suggestion.id same as Place.id.
For offline search, only suggestion of type /sdk-for-flutter-navigate-search-suggestiontype,
...
For other types, /sdk-for-flutter-navigate-search-suggestiontype and /sdk-for-flutter-navigate-search-suggestiontype
this property will be null.
Gets the suggested item id.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="place">
/sdk-for-flutter-navigate-search-suggestion-place
→ /sdk-for-flutter-navigate-search-place-class?
</dt>
<dd>
  The suggested place.
Available only for /sdk-for-flutter-navigate-search-suggestiontype.
Gets the suggested place item.
  <div class="features">no setter</div>
</dd>
<dt class="property inherited" id="runtimeType">
/sdk-for-flutter-navigate-search-suggestion-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-search-suggestion-title
→ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-search-suggestion-type
...
/sdk-for-flutter-navigate-search-suggestion-gethighlights(<wbr/>)
    → Map&lt;<wbr/>/sdk-for-flutter-navigate-search-highlighttype, List&lt;<wbr/>/sdk-for-flutter-navigate-search-indexrange-class&gt;&gt;
...
/sdk-for-flutter-navigate-search-suggestion-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-search-suggestion-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-search-suggestion-operator-equals(<wbr/>Object other)
    → bool
