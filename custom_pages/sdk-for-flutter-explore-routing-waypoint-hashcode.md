...
that affects /sdk-for-flutter-explore-routing-waypoint-operator-equals comparisons.</p>
<p>All objects have hash codes.
The default hash code implemented by <code>Object</code>
represents only the identity of the object,
the same way as the default /sdk-for-flutter-explore-routing-waypoint-operator-equals implementation only considers objects
equal if they are identical (see <code>identityHashCode</code>).</p>
<p>If /sdk-for-flutter-explore-routing-waypoint-operator-equals is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default <code>Set</code> and <code>Map</code> implementations.</p>
<p>Hash codes must be the same for objects that are equal to each other
according to /sdk-for-flutter-explore-routing-waypoint-operator-equals.
...
<p>If a subclass overrides /sdk-for-flutter-explore-routing-waypoint-hashcode, it should override the
/sdk-for-flutter-explore-routing-waypoint-operator-equals operator as well to maintain consistency.</p>
</section>
