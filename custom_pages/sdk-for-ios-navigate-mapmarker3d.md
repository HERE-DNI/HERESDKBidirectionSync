...
slug: "sdk-for-ios-navigate-mapmarker3d"
---
...
<html lang="en">
  <head>
    <title>MapMarker3D Class Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:model:)" class="dashAnchor"></a>
...
<p>The origin of the 3D model&rsquo;s local coordinate system is placed at the specified
...
above ground. If not set, the 3D marker is placed at ground level.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">at</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">model</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarker3dmodel">MapMarker3DModel</a></span><span class="p">)</span></code></pre>
...
3D model&rsquo;s local coordinate system.</p>
                                </div>
                              </td>
                            </tr>
                            <tr>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:image:scale:unit:)" class="dashAnchor"></a>
...
<p>Only bitmap images are supported, using a <code><a href="sdk-for-ios-explore-mapimage">MapImage</a></code> created from SVG data
...
<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO6pixelsyA2EmF">RenderSize.Unit.pixels</a></code>, the flat marker will cover <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> * image&rsquo;s width pixels
horizontally and <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> * image&rsquo;s height pixels vertically. The size of the flat marker
remains constant on the screen.</p>

<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO24densityIndependentPixelsyA2EmF">RenderSize.Unit.densityIndependentPixels</a></code> the flat marker will cover <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> *
image&rsquo;s width density independent pixels horizontally and <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> * image&rsquo;s height
density independent pixels vertically. The size of the flat marker remains constant on
the screen.</p>

<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO6metersyA2EmF">RenderSize.Unit.meters</a></code> the flat marker will cover <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> * image&rsquo;s width meters
horizontally and <code>MapMarker3D.init(GeoCoordinates, MapImage, Double, RenderSize.Unit).scale</code> * image&rsquo;s height meters vertically. Unlike with pixels or
...
with regular map content like streets or buildings.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">at</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">image</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapimage">MapImage</a></span><span class="p">,</span> <span class="nv">scale</span><span class="p">:</span> <span class="kt">Double</span><span class="p">,</span> <span class="nv">unit</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-rendersize">RenderSize</a></span><span class="o">.</span><span class="kt">Unit</span><span class="p">)</span></code></pre>
...
provided map image.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:model:scale:)" class="dashAnchor"></a>
...
above ground. If not set, the 3D marker is placed at ground level.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">at</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">model</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarker3dmodel">MapMarker3DModel</a></span><span class="p">,</span> <span class="nv">scale</span><span class="p">:</span> <span class="kt">Double</span><span class="p">)</span></code></pre>
...
3D model&rsquo;s local coordinate system.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(at:model:scale:unit:)" class="dashAnchor"></a>
...
<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO6pixelsyA2EmF">RenderSize.Unit.pixels</a></code> one unit of the 3D marker model will cover <code>MapMarker3D.init(GeoCoordinates, MapMarker3DModel, Double, RenderSize.Unit).scale</code> pixels.
The size of the 3D marker remains constant on the screen.</p>

<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO24densityIndependentPixelsyA2EmF">RenderSize.Unit.densityIndependentPixels</a></code> one unit of the 3D marker model will
...
<p>For <code><a href="sdk-for-ios-explore-unit#/s:7heresdk10RenderSizeV4UnitO6metersyA2EmF">RenderSize.Unit.meters</a></code> one unit of the 3D marker model will cover <code>MapMarker3D.init(GeoCoordinates, MapMarker3DModel, Double, RenderSize.Unit).scale</code> meters
...
above ground. If not set, the 3D marker is placed at ground level.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">at</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">model</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-mapmarker3dmodel">MapMarker3DModel</a></span><span class="p">,</span> <span class="nv">scale</span><span class="p">:</span> <span class="kt">Double</span><span class="p">,</span> <span class="nv">unit</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-rendersize">RenderSize</a></span><span class="o">.</span><span class="kt">Unit</span><span class="p">)</span></code></pre>
...
The altitude component of the coordinates, if set, controls 3D marker&rsquo;s elevation
above ground. If not set, the 3D marker is placed at ground level.</p>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The <code><a href="sdk-for-ios-explore-metadata">Metadata</a></code> instance attached to this 3D marker.
The default value is <code>nil</code></p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/bearing" class="dashAnchor"></a>
...
The bearing axis is perpendicular to the ground and passes through the 3D marker&rsquo;s location.
The Z-axis of the model is aligned with bearing axis.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/roll" class="dashAnchor"></a>
...
The roll axis is parallel to the ground, passes through the 3D marker&rsquo;s
...
in the direction of the true North. The Y-axis of the model is aligned with the roll axis.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/pitch" class="dashAnchor"></a>
...
3D marker to lean forward. The X-axis of the model is aligned with pitch axis.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/isDepthCheckEnabled" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Determines whether the depth of the 3D marker&rsquo;s vertices is considered during rendering.
...
<p>Use the altitude of the <code><a href="sdk-for-ios-explore-mapmarker3d#/s:7heresdk11MapMarker3DC11coordinatesAA14GeoCoordinatesVvp">MapMarker3D.coordinates</a></code> to position the 3D marker sufficiently high above the
...
3D model unexpectedly shine through.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/isRenderInternalsEnabled" class="dashAnchor"></a>
...
in <code><a href="sdk-for-ios-explore-mapmarker3dmodel">MapMarker3DModel</a></code>.</p>
...
Only <a href="s">MapMeasureRange</a> of <code><a href="sdk-for-ios-explore-kind#/s:7heresdk10MapMeasureV4KindO9zoomLevelyA2EmF">MapMeasure.Kind.zoomLevel</a></code> type are supported.
