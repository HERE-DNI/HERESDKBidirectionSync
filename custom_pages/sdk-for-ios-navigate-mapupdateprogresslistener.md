...
slug: "sdk-for-ios-navigate-mapupdateprogresslistener"
---
...
<html lang="en">
  <head>
    <title>MapUpdateProgressListener Protocol Reference</title>
  ...
  <body>
    ...
    <a title="MapUpdateProgressListener Protocol Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        MapUpdateProgressListener Protocol Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
      ...
      <article class="main-content">
        <section>
          <section class="section">
            <h1>MapUpdateProgressListener</h1>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk25MapUpdateProgressListenerP02onD06region10percentageyAA8RegionIdV_s5Int32VtF"></a>
                    <a name="//apple_ref/swift/Method/onProgress(region:percentage:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk25MapUpdateProgressListenerP02onD06region10percentageyAA8RegionIdV_s5Int32VtF">onProgress(region:<wbr>percentage:<wbr>)</a>
                    </code>
                  </div>
...
Invoked on the main thread.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">func</span> <span class="nf">onProgress</span><span class="p">(</span><span class="nv">region</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-regionid">RegionId</a></span><span class="p">,</span> <span class="nv">percentage</span><span class="p">:</span> <span class="kt">Int32</span><span class="p">)</span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk25MapUpdateProgressListenerP7onPause5erroryAA0B11LoaderErrorOSg_tF"></a>
                    <a name="//apple_ref/swift/Method/onPause(error:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk25MapUpdateProgressListenerP7onPause5erroryAA0B11LoaderErrorOSg_tF">onPause(error:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Invoked on the main thread.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">func</span> <span class="nf">onPause</span><span class="p">(</span><span class="nv">error</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-maploadererror">MapLoaderError</a></span><span class="p">?)</span></code></pre>
...
It is &lsquo;null&rsquo; when <code>MapUpdateTask.pause(Bool)</code> was called by the user.</p>
                                </div>
                              </td>
                            </tr>
                          </tbody>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk25MapUpdateProgressListenerP10onComplete5erroryAA0B11LoaderErrorOSg_tF"></a>
                    <a name="//apple_ref/swift/Method/onComplete(error:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk25MapUpdateProgressListenerP10onComplete5erroryAA0B11LoaderErrorOSg_tF">onComplete(error:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Invoked on the main thread.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">func</span> <span class="nf">onComplete</span><span class="p">(</span><span class="nv">error</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-maploadererror">MapLoaderError</a></span><span class="p">?)</span></code></pre>
...
It is <code>nil</code> for an operation that succeeds.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk25MapUpdateProgressListenerP8onResumeyyF"></a>
                    <a name="//apple_ref/swift/Method/onResume()" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk25MapUpdateProgressListenerP8onResumeyyF">onResume()</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
