---
title: "importBusRouteWithStops abstract method"
...
<div>
<h1>importBusRouteWithStops abstract method</h1></div>
...
importBusRouteWithStops(<ol class="parameter-list"> <li>List&lt;<a href="sdk-for-flutter-navigate-core-location-class">Location</a>&gt; locations, </li>
<li>List&lt;<a href="sdk-for-flutter-navigate-routing-routestop-class">RouteStop</a>&gt; routeStops, </li>
<li><a class="deprecated" href="sdk-for-flutter-navigate-routing-busoptions-class">BusOptions</a> busOptions, </li>
...
<p>Asynchronously creates a bus route from a sequence of geographic coordinates very close to each other.</p>
...
<p>An <a href="sdk-for-flutter-navigate-routing-routingerror">RoutingError.invalidParameter</a> error is generated when the route stops list
size is not in the range [1,locations.size()-2], any of location_index is &lt; 1 or location_indexes are not unique.</p>
<ul>
<li>
<p><code>busOptions</code> Options specific for bus route calculation, along with
...
TaskHandle importBusRouteWithStops(List&lt;Location&gt; locations, List&lt;RouteStop&gt; routeStops, BusOptions busOptions, CalculateRouteCallback callback);</code></pre>
