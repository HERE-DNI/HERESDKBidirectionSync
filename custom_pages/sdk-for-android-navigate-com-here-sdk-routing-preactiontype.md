...
<div className="inheritance">com.here.sdk.routing.PreActionType</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public enum </span><span className="element-name type-name-label">PreActionType</span>
...
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-preactiontype#BOARD">BOARD</a></code></div>
<div className="col-last even-row-color">
<div className="block">An action to board a ferry.</div>
</div>
<div className="col-first odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-preactiontype#WAIT">WAIT</a></code></div>
...
<li>
<section className="detail" id="BOARD">
<h3>BOARD</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-preactiontype" title="enum class in com.here.sdk.routing">PreActionType</a></span> <span className="element-name">BOARD</span></div>
<div className="block"><p>An action to board a ferry.</p></div>
</section>
</li>
<li>
<section className="detail" id="WAIT">
<h3>WAIT</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-preactiontype" title="enum class in com.here.sdk.routing">PreActionType</a></span> <span className="element-name">WAIT</span></div>
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-preactiontype" title="enum class in com.here.sdk.routing">PreActionType</a>[]</span> <span className="element-name">values</span>()</div>
