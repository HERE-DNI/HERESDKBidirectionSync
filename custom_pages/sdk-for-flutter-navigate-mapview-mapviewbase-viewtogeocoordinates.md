...
<span class="returntype"><a href="sdk-for-flutter-navigate-core-geocoordinates-class">GeoCoordinates</a>?</span> <span class="name">viewToGeoCoordinates</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-viewToGeoCoordinates-param-viewCoordinates" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-core-point2d-class">Point2D</a></span> <span class="parameter-name">viewCoordinates</span></span>
...
Returns <a href="sdk-for-flutter-navigate-core-geocoordinates-class">GeoCoordinates?</a>. The geographical coordinates under specified view point or `null` if there is no render surface attached.
