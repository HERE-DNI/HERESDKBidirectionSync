...
<pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">type</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-enums-farepricetype">FarePriceType</a></span></code></pre>
</div>
</div>
</section>
</div>
...
<p><strong>Note:</strong> When the ticket validity period starts depends on the <code><a href="sdk-for-ios-explore-structs-agency">Agency</a></code> providing the service.
