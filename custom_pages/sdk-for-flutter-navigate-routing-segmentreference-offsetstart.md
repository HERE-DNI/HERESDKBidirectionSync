...
<li class="self-crumb">offsetStart property</li>
</ol>
<div class="self-name">offsetStart</div>
...
<div>
<h1>offsetStart property</h1></div>
...
<pre class="language-dart"><code class="language-dart">double offsetStart;</code></pre>
</section>
</div>
