...
<div className="inheritance">com.here.sdk.mapview.datasource.PointDataAccessor</div>
</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">PointDataAccessor</span>
<span className="extends-implements">extends <a href="sdk-for-android-navigate-com-here-nativebase" title="class in com.here">NativeBase</a></span></div>
<div className="block"><p>Point data accessor used for manipulating points that are part of a PointDataSource.
...
<div className="block"><p>Gets point coordinates.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<div className="block"><p>Gets point attributes accessor.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<div className="block"><p>Updates point coordinates.</p></div>
<dl className="notes">
<dt>Parameters:</dt>
...
<div className="block"><p>Replaces point attributes.</p></div>
<dl className="notes">
<dt>Parameters:</dt>
