...
<pre class="highlight swift"><code><span class="kd">public</span> <span class="kd">typealias</span> <span class="kt">InstantiationError</span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-mapmarkeranimation-instantiationerrorcode">InstantiationErrorCode</a></span></code></pre>
</div>
</div>
</section>
</div>
...
<div class="pointer"></div>
<div class="abstract">
<p>Creates an animation of <code><a href="sdk-for-ios-navigate-classes-mapmarker">MapMarker</a></code> based on provided keyframe track.</p>
<p>Supports tracks created with <code><a href="sdk-for-ios-navigate-classes-mapitemkeyframetrack">MapItemKeyFrameTrack</a></code> ‘moveTo*’ methods.</p>
...
<code><a href="../Classes/MapMarkerAnimation.html#/s:7heresdk18MapMarkerAnimationC18InstantiationErrora">MapMarkerAnimation.InstantiationError</a></code> If the specified keyframe track cannot be used to create animation of a <code><a href="sdk-for-ios-navigate-classes-mapmarker">MapMarker</a></code>.
...
<div class="pointer"></div>
<div class="abstract">
<p>Describes a reason for failing to create a <code><a href="sdk-for-ios-navigate-classes-mapmarkeranimation">MapMarkerAnimation</a></code>.</p>
<a class="slightly-smaller" href="sdk-for-ios-navigate-classes-mapmarkeranimation-instantiationerrorcode">See more</a>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
...
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-mapmarkeranimation">MapMarkerAnimation</a></span><span class="o">.</span><span class="kt">InstantiationErrorCode</span> <span class="p">:</span> <span class="kt">Error</span></code></pre>
</div>
</div>
</section>
</div>
