...
A range is half open - \<a href="sdk-for-flutter-explore-mapview-mapmeasurekind">minimumZoomLevel, maximumZoomLevel), the given maximum value is not contained in the range. The map marker is visible only inside these map measure ranges.
