...
<li class="self-crumb">VenueLoadErrorCallback typedef</li>
</ol>
<div class="self-name">VenueLoadErrorCallback</div>
...
<p>A method which is called on the main thread when /sdk-for-flutter-navigate-venue-control-venuemap-selectvenueasyncwitherrorsstr has been completed.</p>
<ul>
