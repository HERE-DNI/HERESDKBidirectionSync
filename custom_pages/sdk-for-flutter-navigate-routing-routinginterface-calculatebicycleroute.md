...
<div>
<h1>calculateBicycleRoute abstract method</h1></div>
...
calculateBicycleRoute(<ol class="parameter-list single-line"> <li>List&lt;<a href="/sdk-for-flutter-navigate-routing-waypoint-class">Waypoint</a>&gt; waypoints, </li>
...
common route options. Note that <a href="/sdk-for-flutter-navigate-routing-optimizationmode">OptimizationMode.shortest</a> is
...
TaskHandle calculateBicycleRoute(List&lt;Waypoint&gt; waypoints, BicycleOptions bicycleOptions, CalculateRouteCallback callback);</code></pre>
