...
slug: "sdk-for-ios-navigate-rastertilesource"
---
...
<html lang="en">
  <head>
    <title>RasterTileSource Protocol Reference</title>
  ...
  <body>
    ...
    <a title="RasterTileSource Protocol Reference"></a>
    <header>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP12tilingSchemeAA06TilingF0Ovp"></a>
                    <a name="//apple_ref/swift/Property/tilingScheme" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP12tilingSchemeAA06TilingF0Ovp">tilingScheme</a>
                    </code>
                  </div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP13storageLevelsSays5Int32VGvp"></a>
                    <a name="//apple_ref/swift/Property/storageLevels" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP13storageLevelsSays5Int32VGvp">storageLevels</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP14getDataVersion7tileKeyAA0cdfG0VAA0cI0V_tF"></a>
                    <a name="//apple_ref/swift/Method/getDataVersion(tileKey:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP14getDataVersion7tileKeyAA0cdfG0VAA0cI0V_tF">getDataVersion(tileKey:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP11addDelegateyyAA0cdF0_pF"></a>
                    <a name="//apple_ref/swift/Method/addDelegate(_:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP11addDelegateyyAA0cdF0_pF">addDelegate(_:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP14removeDelegateyyAA0cdF0_pF"></a>
                    <a name="//apple_ref/swift/Method/removeDelegate(_:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP14removeDelegateyyAA0cdF0_pF">removeDelegate(_:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk16RasterTileSourceP04loadC07tileKey17completionHandlerAA0cd4LoadC13RequestHandle_pSgAA0cG0V_AA0bcdj6ResultI0_ptF"></a>
                    <a name="//apple_ref/swift/Method/loadTile(tileKey:completionHandler:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk16RasterTileSourceP04loadC07tileKey17completionHandlerAA0cd4LoadC13RequestHandle_pSgAA0cG0V_AA0bcdj6ResultI0_ptF">loadTile(tileKey:<wbr>completionHandler:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Upon completion, the handler gets informed.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">func</span> <span class="nf">loadTile</span><span class="p">(</span><span class="nv">tileKey</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-tilekey">TileKey</a></span><span class="p">,</span> <span class="nv">completionHandler</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-rastertilesourceloadresulthandler">RasterTileSourceLoadResultHandler</a></span><span class="p">)</span> <span class="o">-&gt;</span> <span class="kt"><a href="sdk-for-ios-explore-tilesourceloadtilerequesthandle">TileSourceLoadTileRequestHandle</a></span><span class="p">?</span></code></pre>
