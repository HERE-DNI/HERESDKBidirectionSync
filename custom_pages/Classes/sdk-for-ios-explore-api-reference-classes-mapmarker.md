...
<pre><code>public init(at coordinates: GeoCoordinates, image: MapImage)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public init(at coordinates: GeoCoordinates, image: MapImage, text: String)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public init(at coordinates: GeoCoordinates, image: MapImage, anchor: Anchor2D)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<div class="pointer"></div>
<div class="abstract">
<p>The Metadata instance attached to this marker, see <code><a href="../Classes/Metadata.html">Metadata</a></code>.
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var isOverlapAllowed: Bool { get set }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var isTextOptional: Bool { get set }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var fadeDuration: TimeInterval { get set }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var text: String { get set }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="pointer"></div>
<div class="abstract">
<p>The <code><a href="../Classes/MapMarker/TextStyle.html">TextStyle</a></code> applied to the text of the <code>MapMarker</code>.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var textStyle: MapMarker.TextStyle { get set }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="pointer"></div>
<div class="abstract">
<p>Styling options for the text of a <code><a href="../Classes/MapMarker.html">MapMarker</a></code>.</p>
<a class="slightly-smaller" href="../Classes/MapMarker/TextStyle.html">See more</a>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
...
<div class="pointer"></div>
<div class="abstract">
<p>Starts animation of this map marker according to provided <code><a href="../Classes/MapMarkerAnimation.html">MapMarkerAnimation</a></code>.</p>
<p>The <code><a href="../Classes/MapMarkerAnimation.html">MapMarkerAnimation</a></code> may be shared between multiple instances of <code>MapMarker</code>.</p>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public func startAnimation(_ animation: MapMarkerAnimation, animationDelegate: AnimationDelegate?)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<p>Does not cancel other animations if the same <code><a href="../Classes/MapMarkerAnimation.html">MapMarkerAnimation</a></code> object was applied to multiple <code>MapMarker</code>s.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public func cancelAnimation(_ animation: MapMarkerAnimation)</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
