...
When this representation is already set on any <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>, values will be applied on that <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code> right away.
If this representation is not set on any <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>, values will be applied once representation is set on a <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>.</p>
<p>Note: This is a beta release of this feature, so there could be a few bugs and unexpected
behavior. Related APIs may change for new releases without a deprecation process.</p>
</div>
<div class="declaration">
...
When this representation is already set on any <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>, value will be applied on that <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code> right away.
If this representation is not set on any <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>, value will be applied once representation is set on a <code><a href="../../Classes/MapPolyline.html">MapPolyline</a></code>.</p>
<p>Note: This is a beta release of this feature, so there could be a few bugs and unexpected
behavior. Related APIs may change for new releases without a deprecation process.</p>
</div>
<div class="declaration">
