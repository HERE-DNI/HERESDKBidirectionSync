...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous text query search for <code><a href="../Classes/Place.html">Place</a></code> instances within a given <code><a href="../Structs/TextQuery/Area.html">TextQuery.Area</a></code>.
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous address query search for <code><a href="../Classes/Place.html">Place</a></code> instances.
...
belong to more than one <code><a href="../Classes/Place.html">Place</a></code> result, although all found places will
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous category search for <code><a href="../Classes/Place.html">Place</a></code> instances.
A list containing at least one <code><a href="../Classes/PlaceCategory.html">PlaceCategory</a></code> must be provided
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous search for <code><a href="../Classes/Place.html">Place</a></code> instances based on the given
geographic coordinates.
This is the same search type as reverse geocoding, except that more data is returned
than just the <code><a href="../Structs/Address.html">Address</a></code> related to the given coordinates.
Note that more than one <code><a href="../Classes/Place.html">Place</a></code> can be related to the given coordinates.
The returned places are sorted by relevance.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous search for a <code><a href="../Classes/Place.html">Place</a></code> based on its ID and
<code><a href="../Enums/LanguageCode.html">LanguageCode</a></code>.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous search for a <code><a href="../Classes/Place.html">Place</a></code> based on the content found in <code><a href="../Structs/PickedPlace.html">PickedPlace</a></code>.
If <code><a href="../Structs/PickedPlace.html">PickedPlace</a></code> data is obtained from the offline map, it may happen that the newer version
...
Complete details can be obtained by searching with <code><a href="../Structs/PlaceIdQuery.html">PlaceIdQuery</a></code>.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous request to do a text query search for <code><a href="../Classes/Place.html">Place</a></code> instances.
Optionally, search along a polyline, such as a route, by specifying a <code><a href="../Structs/GeoCorridor.html">GeoCorridor</a></code>.
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous request to search for a <code><a href="../Classes/Place.html">Place</a></code> based on its ID and
<code><a href="../Enums/LanguageCode.html">LanguageCode</a></code>.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
...
than just the <code><a href="../Structs/Address.html">Address</a></code> that belongs to given coordinates. Note that coordinates
can belong to more than one <code><a href="../Classes/Place.html">Place</a></code> result.
Provides candidate places sorted by relevance.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
...
Passed in form of <code><a href="../Structs/GeoCircle.html">GeoCircle</a></code>.</p>
</div>
</td>
</tr>
<tr>
...
The href value can be obtained from <code><a href="../Classes/Suggestion.html">Suggestion</a></code> objects,
...
<div class="pointer"></div>
<div class="abstract">
<p>Performs an asynchronous request to do a category search for <code><a href="../Classes/Place.html">Place</a></code> instances.
A list containing at least one <code><a href="../Classes/PlaceCategory.html">PlaceCategory</a></code> must be provided
...
enables balanced distribution of results for search in <code><a href="../Structs/GeoCorridor.html">GeoCorridor</a></code>.
Constraint: using this parameter when searching an area that is not a <code><a href="../Structs/GeoCorridor.html">GeoCorridor</a></code> generates
