...
<div class="abstract">
<p>The <code><a href="../Structs/GeoPolyline.html">GeoPolyline</a></code> object representing the polyline of this span.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var geometry: GeoPolyline { get }</code></pre>
</div>
</div>
</section>
</div>
...
In case the list is not empty, the user must judge all the indexed <code><a href="../Structs/SectionNotice.html">SectionNotice</a></code>s
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var noticeIndexes: [Int32] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var segmentReference: SegmentReference { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="pointer"></div>
<div class="abstract">
<p>The indexes of traffic incidents from the field <code><a href="../Classes/Section.html#/s:7heresdk7SectionC16trafficIncidentsSayAA22TrafficIncidentOnRouteCGvp">Section.trafficIncidents</a></code> of the parent <code><a href="../Classes/Section.html">Section</a></code>.
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var trafficIncidentIndexes: [Int32] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var sectionPolylineOffset: Int32 { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var dynamicSpeedInfo: DynamicSpeedInfo? { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var streetAttributes: [StreetAttributes] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var carAttributes: [AccessAttributes] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var truckAttributes: [AccessAttributes] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var scooterAttributes: [AccessAttributes] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var walkAttributes: [WalkAttributes] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var streetNames: LocalizedTexts { get }</code></pre>
</div>
</div>
</section>
</div>
...
of a road such as I-10, US-50, or A3, and cardinal direction, if available, and a road level classification (<code><a href="../Enums/RouteType.html">RouteType</a></code>).</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var roadNumbers: LocalizedRoadNumbers { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var speedLimitInMetersPerSecond: Double? { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var functionalRoadClass: FunctionalRoadClass? { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var baseDuration: TimeInterval { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var stateCode: String? { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public var noThroughRestrictionsIndexes: [Int32] { get }</code></pre>
</div>
</div>
</section>
</div>
...
<div class="language">
<p class="aside-title">Swift</p>
<pre><code>public func getShieldText(roadNumber: LocalizedRoadNumber) -&gt; String</code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
