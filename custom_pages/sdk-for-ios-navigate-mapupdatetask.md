...
slug: "sdk-for-ios-navigate-mapupdatetask"
---
...
<html lang="en">
  <head>
    <title>MapUpdateTask Class Reference</title>
  ...
  <body>
    ...
    <a title="MapUpdateTask Class Reference"></a>
    <header>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13MapUpdateTaskC6cancelyyF"></a>
                    <a name="//apple_ref/swift/Method/cancel()" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13MapUpdateTaskC6cancelyyF">cancel()</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>Cancels the ongoing map update operation. Operation cannot be resumed afterwards.
...
<code><a href="sdk-for-ios-explore-maploadererror#/s:7heresdk14MapLoaderErrorO18operationCancelledyA2CmF">MapLoaderError.operationCancelled</a></code> will be reported for a successful cancel operation.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13MapUpdateTaskC5pauseyyF"></a>
                    <a name="//apple_ref/swift/Method/pause()" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13MapUpdateTaskC5pauseyyF">pause()</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Status of the call will be reported via <code>onPause(...)</code>.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk13MapUpdateTaskC6resumeyyF"></a>
                    <a name="//apple_ref/swift/Method/resume()" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk13MapUpdateTaskC6resumeyyF">resume()</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
