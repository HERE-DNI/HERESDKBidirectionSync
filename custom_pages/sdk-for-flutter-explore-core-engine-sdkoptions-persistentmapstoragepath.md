...
<p>Note: If the persistent map storage location has the read only permission, then the <a href="sdk-for-flutter-explore-core-engine-sdkoptions-datapath">SDKOptions.dataPath</a> must be configured.</p>
