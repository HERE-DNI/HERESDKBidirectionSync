...
slug: "sdk-for-ios-navigate-postaction"
---
...
<html lang="en">
  <head>
    <title>PostAction Structure Reference</title>
  ...
  <body>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        PostAction Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk10PostActionV6actionAA0bC4TypeOvp"></a>
                    <a name="//apple_ref/swift/Property/action" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk10PostActionV6actionAA0bC4TypeOvp">action</a>
                    </code>
                  </div>
...
Defaults to <code><a href="sdk-for-ios-explore-postactiontype#/s:7heresdk14PostActionTypeO13chargingSetupyA2CmF">PostActionType.chargingSetup</a></code>.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">action</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-postactiontype">PostActionType</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk10PostActionV8durationSdvp"></a>
                    <a name="//apple_ref/swift/Property/duration" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk10PostActionV8durationSdvp">duration</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
...
Defaults to 0 seconds.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk10PostActionV15chargingDetailsAA08ChargingcE0VSgvp"></a>
                    <a name="//apple_ref/swift/Property/chargingDetails" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk10PostActionV15chargingDetailsAA08ChargingcE0VSgvp">chargingDetails</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The additional information that is available if the action is of type charging.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">chargingDetails</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-chargingactiondetails">ChargingActionDetails</a></span><span class="p">?</span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk10PostActionV6action8duration15chargingDetailsAcA0bC4TypeO_SdAA08ChargingcG0VSgtcfc"></a>
                    <a name="//apple_ref/swift/Method/init(action:duration:chargingDetails:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk10PostActionV6action8duration15chargingDetailsAcA0bC4TypeO_SdAA08ChargingcG0VSgtcfc">init(action:<wbr>duration:<wbr>chargingDetails:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">action</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-postactiontype">PostActionType</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-postactiontype">PostActionType</a></span><span class="o">.</span><span class="n">chargingSetup</span><span class="p">,</span> <span class="nv">duration</span><span class="p">:</span> <span class="kt">TimeInterval</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span> <span class="nv">chargingDetails</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-chargingactiondetails">ChargingActionDetails</a></span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">)</span></code></pre>
