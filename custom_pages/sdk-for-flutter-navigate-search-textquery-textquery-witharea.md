...
1.  <span id="sdk-for-flutter-navigate-withArea-param-query" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">query</span>, </span>
2.  <span id="sdk-for-flutter-navigate-withArea-param-area" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-search-textqueryarea-class">TextQueryArea</a></span> <span class="parameter-name">area</span></span>
