...
slug: "sdk-for-android-explore-api-reference-evsepaymentsupport"
---
...
<title>EVSEPaymentSupport (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.ev, enum: EVSEPaymentSupport">
...
<h1 title="Enum Class EVSEPaymentSupport" class="title">Enum Class EVSEPaymentSupport</h1>
</div>
<div class="inheritance" title="Inheritance Tree"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang" class="external-link">java.lang.Object</a>
<div class="inheritance"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" class="external-link">java.lang.Enum</a>&lt;<a href="sdk-for-android-explore-evsepaymentsupport" title="enum class in com.here.sdk.ev">EVSEPaymentSupport</a>&gt;
...
<dd><code><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html" title="class or interface in java.io" class="external-link">Serializable</a></code>, <code><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html" title="class or interface in java.lang" class="external-link">Comparable</a>&lt;<a href="sdk-for-android-explore-evsepaymentsupport" title="enum class in com.here.sdk.ev">EVSEPaymentSupport</a>&gt;</code>, <code><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/constant/Constable.html" title="class or interface in java.lang.constant" class="external-link">Constable</a></code></dd>
</dl>
<hr>
...
<span class="extends-implements">extends <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang" class="external-link">Enum</a>&lt;<a href="sdk-for-android-explore-evsepaymentsupport" title="enum class in com.here.sdk.ev">EVSEPaymentSupport</a>&gt;</span></div>
...
<div class="col-first even-row-color"><code><a href="#AUTH_BY_CAR_AUTOCHARGE" class="member-name-link">AUTH_BY_CAR_AUTOCHARGE</a></code></div>
...
<div class="col-first odd-row-color"><code><a href="#AUTH_BY_CAR_PLUG_AND_CHARGE" class="member-name-link">AUTH_BY_CAR_PLUG_AND_CHARGE</a></code></div>
...
<div class="col-first even-row-color"><code><a href="#CHIP_CARD" class="member-name-link">CHIP_CARD</a></code></div>
<div class="col-last even-row-color">
<div class="block">EVSE has a payment terminal that supports chip cards.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#CONTACTLESS_CARD" class="member-name-link">CONTACTLESS_CARD</a></code></div>
<div class="col-last odd-row-color">
<div class="block">EVSE has a payment terminal that supports contactless cards.</div>
</div>
<div class="col-first even-row-color"><code><a href="#CREDIT_CARD" class="member-name-link">CREDIT_CARD</a></code></div>
<div class="col-last even-row-color">
<div class="block">EVSE has a payment terminal that makes it possible to pay for charging using a credit card.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#DEBIT_CARD" class="member-name-link">DEBIT_CARD</a></code></div>
<div class="col-last odd-row-color">
<div class="block">EVSE has a payment terminal that makes it possible to pay for charging using a debit card.</div>
</div>
<div class="col-first even-row-color"><code><a href="#MOBILE_PAYMENT" class="member-name-link">MOBILE_PAYMENT</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code><a href="#ONLINE_APPLE_PAY" class="member-name-link">ONLINE_APPLE_PAY</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Authenticate &amp; pay with Apple Pay.</div>
</div>
<div class="col-first even-row-color"><code><a href="#ONLINE_BANK_PAYMENT" class="member-name-link">ONLINE_BANK_PAYMENT</a></code></div>
<div class="col-last even-row-color">
<div class="block">Authenticate &amp; pay with online bank payment.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#ONLINE_CREDIT_CARD" class="member-name-link">ONLINE_CREDIT_CARD</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Authenticate &amp; pay with credit card online.</div>
</div>
<div class="col-first even-row-color"><code><a href="#ONLINE_GOOGLE_PAY" class="member-name-link">ONLINE_GOOGLE_PAY</a></code></div>
<div class="col-last even-row-color">
<div class="block">Authenticate &amp; pay with Google Pay.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#ONLINE_PAYPAL" class="member-name-link">ONLINE_PAYPAL</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Authenticate &amp; pay with PayPal.</div>
</div>
<div class="col-first even-row-color"><code><a href="#OPERATOR_APP" class="member-name-link">OPERATOR_APP</a></code></div>
<div class="col-last even-row-color">
<div class="block">Authenticate &amp; pay with charge point operator application on mobile phone.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#PED_TERMINAL" class="member-name-link">PED_TERMINAL</a></code></div>
<div class="col-last odd-row-color">
<div class="block">EVSE has a payment terminal with a pin-code entry device.</div>
</div>
<div class="col-first even-row-color"><code><a href="#RFID_READER" class="member-name-link">RFID_READER</a></code></div>
<div class="col-last even-row-color">
<div class="block">Charging at this EVSE can be authorized with an RFID token.</div>
</div>
<div class="col-first odd-row-color"><code><a href="#TERMINAL_QR_CODE" class="member-name-link">TERMINAL_QR_CODE</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Initiate authentication &amp; payment with QR code on the terminal.</div>
</div>
<div class="col-first even-row-color"><code><a href="#TERMINAL_SMS" class="member-name-link">TERMINAL_SMS</a></code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>EVSE has a payment terminal that supports chip cards.</div>
</section>
</li>
<li>
...
<div class="block"><p>EVSE has a payment terminal that supports contactless cards.</div>
</section>
</li>
<li>
...
<div class="block"><p>EVSE has a payment terminal that makes it possible to pay for charging using a credit card.</div>
</section>
</li>
<li>
...
<div class="block"><p>EVSE has a payment terminal that makes it possible to pay for charging using a debit card.</div>
</section>
</li>
<li>
...
<div class="block"><p>EVSE has a payment terminal with a pin-code entry device.</div>
</section>
</li>
<li>
...
<div class="block"><p>Charging at this EVSE can be authorized with an RFID token.</div>
</section>
</li>
<li>
...
<div class="block"><p>ISO 15118 Plug&amp;Charge enables drivers to plug in and charge up instantly using automatic EV-to-charging station authentication technology.</div>
</section>
</li>
<li>
...
<div class="block"><p>Autocharge enables drivers to plug in and charge up instantly using automatic EV-to-charging station authentication technology.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with Apple Pay.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with PayPal.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with credit card online.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with Google Pay.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with online bank payment.</div>
</section>
</li>
<li>
...
<div class="block"><p>Initiate authentication &amp; payment with QR code on the terminal.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with SMS on the terminal.</div>
</section>
</li>
<li>
...
<div class="block"><p>Authenticate &amp; pay with charge point operator application on mobile phone.</div>
</section>
</li>
<li>
...
<div class="block"><p>Used with <a href="#OPERATOR_APP"><code>OPERATOR_APP</code></a>,
 ...
 <a href="#MOBILE_PAYMENT"><code>MOBILE_PAYMENT</code></a> is also specified.</div>
</section>
</li>
</ul>
</section>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span>&nbsp;<span class="return-type"><a href="sdk-for-android-explore-evsepaymentsupport" title="enum class in com.here.sdk.ev">EVSEPaymentSupport</a></span>&nbsp;<span class="element-name">valueOf</span><wbr><span class="parameters">(<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" class="external-link">String</a>&nbsp;name)</span></div>
