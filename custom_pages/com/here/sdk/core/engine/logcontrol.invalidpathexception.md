...
slug: "sdk-for-android-explore-api-reference-latestlogcontrol-invalidpathexception"
hidden: false
---

Package [com.here.sdk.core.engine](sdk-for-android-explore-api-reference-latestpackage-summary)

# Class LogControl.InvalidPathException
...
------------------------------------------------------------------------
public static final class LogControl.InvalidPathException extends [Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)
Invalid file path exception.
See Also:
- [Serialized Form](sdk-for-android-explore-api-reference-latestserialized-form#com.here.sdk.core.engine.LogControl.InvalidPathException)
