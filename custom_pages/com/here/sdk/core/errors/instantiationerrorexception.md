...
slug: "sdk-for-android-explore-api-reference-latestinstantiationerrorexception"
hidden: false
---

Package [com.here.sdk.core.errors](sdk-for-android-explore-api-reference-latestpackage-summary)

# Class InstantiationErrorException
...
------------------------------------------------------------------------
public final class InstantiationErrorException extends [Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)
Instantiation error.
See Also:
- [Serialized Form](sdk-for-android-explore-api-reference-latestserialized-form#com.here.sdk.core.errors.InstantiationErrorException)
