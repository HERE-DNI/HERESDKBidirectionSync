...
<div class="block"><p>New base speed for a segment. Affects route calculation and the ETA. Cannot increase base speed on segment.
 <p><strong>Note:</strong> This option can only be used with the <code>RoutingEngine</code>. The <code>OfflineRoutingEngine</code> is not supported and the option will be ignored. Note that the <code>OfflineRoutingEngine</code> is only available for the Navigate license.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.routing.SegmentReference,double)" class="member-name-link">MaxSpeedOnSegment</a><wbr>(<a href="sdk-for-android-explore-segmentreference" title="class in com.here.sdk.routing">SegmentReference</a>&nbsp;segment,
