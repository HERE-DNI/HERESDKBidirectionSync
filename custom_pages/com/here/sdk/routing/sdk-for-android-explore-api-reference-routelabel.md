...
<div class="block"><p>The main street name or road number for a route. A route can contain more than one such street name or route number.
 To include route labels in the route response, enable it using <a href="sdk-for-android-explore-routeoptions#enableRouteLabels"><code>RouteOptions.enableRouteLabels</code></a>.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.core.LocalizedText)" class="member-name-link">RouteLabel</a><wbr>(<a href="sdk-for-android-explore-localizedtext" title="class in com.here.sdk.core">LocalizedText</a>&nbsp;name)</code></div>
<div class="col-last even-row-color">
