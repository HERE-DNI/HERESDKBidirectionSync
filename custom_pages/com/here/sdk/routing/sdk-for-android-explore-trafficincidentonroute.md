...
<h1 class="title" title="Class TrafficIncidentOnRoute">Class TrafficIncidentOnRoute</h1>
</div>
...
<div class="block"><p>Gets the unique current identifier for a traffic incident.
 ...
 <a href="sdk-for-android-explore-trafficincidentbase#getEndTime()"><code>TrafficIncidentBase.getEndTime()</code></a>. This field will be empty for <code>OfflineRouting</code>.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
