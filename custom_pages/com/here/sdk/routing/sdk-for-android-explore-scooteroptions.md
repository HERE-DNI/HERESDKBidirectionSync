...
slug: "sdk-for-android-explore-scooteroptions"
---
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#allowHighway">allowHighway</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#engineSizeInCubicCentimeters">engineSizeInCubicCentimeters</a></code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E()">ScooterOptions</a>()</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
<div class="block"><p>Specifies whether scooter is allowed on highway or not. <code>True</code> means scooter is
 ...
 Note that there is a similar parameter in <a href="AvoidanceOptions.html" title="class in com.here.sdk.routing"><code>AvoidanceOptions</code></a>, to
 disallow highway usage, see <a href="RoadFeatures.html#CONTROLLED_ACCESS_HIGHWAY"><code>RoadFeatures.CONTROLLED_ACCESS_HIGHWAY</code></a>.
 ...
 In such a case, a <a href="SectionNotice.html" title="class in com.here.sdk.routing"><code>SectionNotice</code></a> will be provided in the related <a href="Section.html" title="class in com.here.sdk.routing"><code>Section</code></a>
