...
slug: "sdk-for-android-explore-api-reference-latestevconsumptionmodel"
hidden: false
---
...
com.here.sdk.routing.EVConsumptionModel
------------------------------------------------------------------------
public final class EVConsumptionModel extends [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html)
Parameters specific for the electric vehicle, which are then used to calculate energy consumption on a given route. At minimum, you must provide [`ascentConsumptionInWattHoursPerMeter`](#ascentConsumptionInWattHoursPerMeter), [`descentRecoveryInWattHoursPerMeter`](#descentRecoveryInWattHoursPerMeter) and a [`freeFlowSpeedTable`](#freeFlowSpeedTable).
