...
slug: "sdk-for-android-explore-api-reference-latestprivatebusoptions"
hidden: false
---
...
------------------------------------------------------------------------
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html) public final class PrivateBusOptions extends [Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html)
Deprecated.
...
@NonNull public [BusSpecifications](sdk-for-android-explore-api-reference-latestbusspecifications "class in com.here.sdk.transport") busSpecifications
    ...
    **Note:** Some members of `bus_specifications` have limited value range.
    ...
    - [`BusSpecifications.lengthInCentimeters`](sdk-for-android-explore-api-reference-latestbusspecifications#lengthInCentimeters) must be in the range \[0, 30000\]. The validation of the range is done in the method that takes `PrivateBusOptions` as parameter.
