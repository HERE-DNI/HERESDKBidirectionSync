...
slug: "sdk-for-android-explore-localizedtextpreference"
---
...
<div class="inheritance"><a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">java.lang.Enum</a>&lt;<a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a>&gt;
...
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html" title="class or interface in java.lang">Enum</a>&lt;<a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a>&gt;</span></div>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#USE_ALWAYS">USE_ALWAYS</a></code></div>
<div class="col-last even-row-color">
<div class="block">Information is included in the notification, if available.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="#USE_IF_LANGUAGE_IS_COMPATIBLE">USE_IF_LANGUAGE_IS_COMPATIBLE</a></code></div>
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="#USE_NEVER">USE_NEVER</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code>static <a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a>[]</code></div>
...
<h3>USE_NEVER</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span class="element-name">USE_NEVER</span></div>
...
<h3>USE_ALWAYS</h3>
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span class="element-name">USE_ALWAYS</span></div>
...
<div class="member-signature"><span class="modifiers">public static final</span> <span class="return-type"><a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span class="element-name">USE_IF_LANGUAGE_IS_COMPATIBLE</span></div>
...
<h3>values</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a>[]</span> <span class="element-name">values</span>()</div>
<div class="block">Returns an array containing the constants of this enum class, in
the order they are declared.</div>
<dl class="notes">
<dt>Returns:</dt>
...
<h3>valueOf</h3>
<div class="member-signature"><span class="modifiers">public static</span> <span class="return-type"><a href="LocalizedTextPreference.html" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span class="element-name">valueOf</span><wbr/><span class="parameters">(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
