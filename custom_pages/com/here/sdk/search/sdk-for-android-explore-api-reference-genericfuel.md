...
<div class="col-first even-row-color"><code><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-fueladditive" title="class in com.here.sdk.search">FuelAdditive</a>&gt;</code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.transport.FuelType)" class="member-name-link">GenericFuel</a><wbr>(<a href="sdk-for-android-explore-fueltype" title="enum class in com.here.sdk.transport">FuelType</a>&nbsp;type)</code></div>
<div class="col-last even-row-color">
