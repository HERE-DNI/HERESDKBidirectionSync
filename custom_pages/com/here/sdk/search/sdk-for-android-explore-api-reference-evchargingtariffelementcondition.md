...
slug: "sdk-for-android-explore-api-reference-evchargingtariffelementcondition"
---
...
<title>EVChargingTariffElementCondition (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.search, class: EVChargingTariffElementCondition">
...
<h1 title="Class EVChargingTariffElementCondition" class="title">Class EVChargingTariffElementCondition</h1>
</div>
...
<div class="col-first odd-row-color"><code><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-dayofweek" title="enum class in com.here.sdk.search">DayOfWeek</a>&gt;</code></div>
<div class="col-second odd-row-color"><code><a href="#days" class="member-name-link">days</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#overstayBatteryLevel" class="member-name-link">overstayBatteryLevel</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">EVChargingTariffElementCondition</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Date range when the tariff element is valid. This is typically used to indicate seasonal
 ...
 spot prices, together with time period.</div>
</section>
</li>
<li>
...
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-dayofweek" title="enum class in com.here.sdk.search">DayOfWeek</a>&gt;</span>&nbsp;<span class="element-name">days</span></div>
<div class="block"><p>Day(s) of the week when the tariff element is valid.
 An example would be to specify lower prices for weekends</div>
</section>
</li>
<li>
...
<div class="block"><p>Time period when the tariff element is valid, in local time. The time period wraps around to
 ...
 is smaller than the beginning <a href="sdk-for-android-explore-timeofdayrange#from"><code>TimeOfDayRange.from</code></a>.</div>
</section>
</li>
<li>
...
<div class="block"><p>Duration of the charging session when the tariff element is valid, in seconds.
 <p>Often only either one of the values is present, indicating the minimum or maximum duration.</div>
</section>
</li>
<li>
...
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span>&nbsp;<span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html" title="class or interface in java.lang" class="external-link">Integer</a></span>&nbsp;<span class="element-name">overstayBatteryLevel</span></div>
<div class="block"><p>Minimum battery level when the tariff element is valid, in percentages. This can be used to
 set additional fees for charging a full or nearly full battery.</div>
</section>
</li>
</ul>
</section>
