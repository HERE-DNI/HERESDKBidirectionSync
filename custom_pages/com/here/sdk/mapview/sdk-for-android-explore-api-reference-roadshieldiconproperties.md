...
slug: "sdk-for-android-explore-api-reference-roadshieldiconproperties"
---
...
<div class="block"><p>Contains the information required to create a road shield image.</div>
</section>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.core.RouteType,java.lang.String,java.lang.String,java.lang.String,java.lang.String)" class="member-name-link">RoadShieldIconProperties</a><wbr>(<a href="sdk-for-android-explore-routetype" title="enum class in com.here.sdk.core">RouteType</a>&nbsp;routeType,
 ...
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" class="external-link">String</a>&nbsp;shieldText)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>The type of route indicating the significance of the road in a range from 0 to 6. A value of
 1 stands for the most major route and 6 the most minor, with 0 being of unknown type.</div>
</section>
</li>
<li>
...
<div class="block"><p>The country code in ISO-3166-1 alpha-3 format, which will determine the type of road shield.</div>
</section>
</li>
<li>
...
<div class="block"><p>The state code for the road. It's a 2-letter code in ISO 3166-2 format. For example
 ...
 not required for the particular country.</div>
</section>
</li>
<li>
...
<div class="block"><p>A string that is used to additionally determine the road shield's visual representation.
 ...
 and without a cardinal direction.</div>
</section>
</li>
<li>
...
<div class="block"><p>The text of the road-shield. This is the text which is displayed on the road-shield
 in reality. It will be in the output road-shield icon.</div>
</section>
</li>
</ul>
</section>
...
<div class="member-signature"><span class="modifiers">public</span>&nbsp;<span class="element-name">RoadShieldIconProperties</span><wbr><span class="parameters">(@NonNull
 ...
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" class="external-link">String</a>&nbsp;routeNumberName,
 @NonNull
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang" class="external-link">String</a>&nbsp;shieldText)</span></div>
...
<dd><code>routeType</code> - <p>The type of route indicating the significance of the road in a range from 0 to 6. A value of
 1 stands for the most major route and 6 the most minor, with 0 being of unknown type.</dd>
<dd><code>countryCode</code> - <p>The country code in ISO-3166-1 alpha-3 format, which will determine the type of road shield.</dd>
<dd><code>stateCode</code> - <p>The state code for the road. It's a 2-letter code in ISO 3166-2 format. For example
 the ones listed for US on this page https://en.wikipedia.org/wiki/ISO_3166-2:US.
 The code &quot;AL&quot; is for Alabama. Another example is the code for autonomous
 communities listed on https://en.wikipedia.org/wiki/ISO_3166-2:ES. Can be empty if
 not required for the particular country.</dd>
