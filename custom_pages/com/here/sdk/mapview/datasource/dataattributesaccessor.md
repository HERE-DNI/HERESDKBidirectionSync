...
slug: "sdk-for-android-explore-api-reference-latestdataattributesaccessor"
hidden: false
---
...
------------------------------------------------------------------------
public final class DataAttributesAccessor extends [NativeBase](sdk-for-android-explore-api-reference-latestnativebase "class in com.here") implements [DataAttributesBase](sdk-for-android-explore-api-reference-latestdataattributesbase "interface in com.here.sdk.mapview.datasource")
...
## Method Summary
  ...
  [addOrReplace](#addOrReplace(java.lang.String,boolean))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, boolean value)`

Adds or replaces a boolean attribute.

`void`

  [addOrReplace](#addOrReplace(java.lang.String,double))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, double value)`

Adds or replaces a double precision floating decimal attribute.

`void`

  [addOrReplace](#addOrReplace(java.lang.String,float))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, float value)`

Adds or replaces a single precision floating decimal attribute.

`void`

  [addOrReplace](#addOrReplace(java.lang.String,long))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, long value)`

Adds or replaces a 64-bits integer attribute.

`void`

  [addOrReplace](#addOrReplace(java.lang.String,com.here.sdk.mapview.datasource.DataAttributeValue))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, `[`DataAttributeValue`](sdk-for-android-explore-api-reference-latestdataattributevalue "class in com.here.sdk.mapview.datasource")` value)`

Adds or replaces an attribute.

`void`

  [addOrReplace](#addOrReplace(java.lang.String,java.lang.String))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name, `[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` value)`
...
`void`
  ...
  [remove](#remove(java.lang.String))`(`[String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html)` name)`
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, @NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) value)
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, long value)
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, float value)
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, double value)
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, boolean value)
...
public void addOrReplace(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name, @NonNull [DataAttributeValue](sdk-for-android-explore-api-reference-latestdataattributevalue "class in com.here.sdk.mapview.datasource") value)
...
public void remove(@NonNull [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html) name)
