...
slug: "sdk-for-android-explore-api-reference-latestpointtilesource"
hidden: false
---

Package [com.here.sdk.mapview.datasource](sdk-for-android-explore-api-reference-latestpackage-summary)

# Interface PointTileSource

All Superinterfaces:
[`TileSource`](sdk-for-android-explore-api-reference-latesttilesource "interface in com.here.sdk.mapview.datasource")

------------------------------------------------------------------------
public interface PointTileSource extends [TileSource](sdk-for-android-explore-api-reference-latesttilesource "interface in com.here.sdk.mapview.datasource")
...
Modifier and Type
  ...
  [PointTileSource.LoadResultHandler](sdk-for-android-explore-api-reference-latestpointtilesource-loadresulthandler)
...
## Method Summary
  ...
  [loadTile](#loadTile(com.here.sdk.mapview.datasource.TileKey,com.here.sdk.mapview.datasource.PointTileSource.LoadResultHandler))`(`[`TileKey`](sdk-for-android-explore-api-reference-latesttilekey "class in com.here.sdk.mapview.datasource")` tileKey, `[`PointTileSource.LoadResultHandler`](sdk-for-android-explore-api-reference-latestpointtilesource-loadresulthandler "interface in com.here.sdk.mapview.datasource")` completionHandler)`
...
@Nullable [TileSource.LoadTileRequestHandle](sdk-for-android-explore-api-reference-latesttilesource-loadtilerequesthandle "interface in com.here.sdk.mapview.datasource") loadTile(@NonNull [TileKey](sdk-for-android-explore-api-reference-latesttilekey "class in com.here.sdk.mapview.datasource") tileKey, @NonNull [PointTileSource.LoadResultHandler](sdk-for-android-explore-api-reference-latestpointtilesource-loadresulthandler "interface in com.here.sdk.mapview.datasource") completionHandler)
