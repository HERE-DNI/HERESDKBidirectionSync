...
<dd><a href="LineDataSource.html" title="class in com.here.sdk.mapview.datasource">LineDataSource</a></dd>
</dl>
<dl class="notes">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#process(com.here.sdk.mapview.datasource.LineDataAccessor)">process</a><wbr/>(<a href="LineDataAccessor.html" title="class in com.here.sdk.mapview.datasource">LineDataAccessor</a> lineAccessor)</code></div>
...
<div class="member-signature"><span class="return-type">boolean</span> <span class="element-name">process</span><wbr/><span class="parameters">(@NonNull
 <a href="LineDataAccessor.html" title="class in com.here.sdk.mapview.datasource">LineDataAccessor</a> lineAccessor)</span></div>
<div class="block"><p>Called for each line, allowing inspection, removal or update of coordinates and attributes.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
