...
slug: "sdk-for-android-explore-api-reference-latestlinetilesource"
hidden: false
---

Package [com.here.sdk.mapview.datasource](sdk-for-android-explore-api-reference-latestpackage-summary)

# Interface LineTileSource

All Superinterfaces:
[`TileSource`](sdk-for-android-explore-api-reference-latesttilesource "interface in com.here.sdk.mapview.datasource")

------------------------------------------------------------------------
public interface LineTileSource extends [TileSource](sdk-for-android-explore-api-reference-latesttilesource "interface in com.here.sdk.mapview.datasource")
...
Modifier and Type
  ...
  [LineTileSource.LoadResultHandler](sdk-for-android-explore-api-reference-latestlinetilesource-loadresulthandler)
...
## Method Summary
  ...
  [loadTile](#loadTile(com.here.sdk.mapview.datasource.TileKey,com.here.sdk.mapview.datasource.LineTileSource.LoadResultHandler))`(`[`TileKey`](sdk-for-android-explore-api-reference-latesttilekey "class in com.here.sdk.mapview.datasource")` tileKey, `[`LineTileSource.LoadResultHandler`](sdk-for-android-explore-api-reference-latestlinetilesource-loadresulthandler "interface in com.here.sdk.mapview.datasource")` completionHandler)`
...
@Nullable [TileSource.LoadTileRequestHandle](sdk-for-android-explore-api-reference-latesttilesource-loadtilerequesthandle "interface in com.here.sdk.mapview.datasource") loadTile(@NonNull [TileKey](sdk-for-android-explore-api-reference-latesttilekey "class in com.here.sdk.mapview.datasource") tileKey, @NonNull [LineTileSource.LoadResultHandler](sdk-for-android-explore-api-reference-latestlinetilesource-loadresulthandler "interface in com.here.sdk.mapview.datasource") completionHandler)
