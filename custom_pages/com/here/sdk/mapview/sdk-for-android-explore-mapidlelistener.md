---
title: "Untitled"
slug: "sdk-for-android-explore-mapidlelistener"
---
...
<h1 class="title" title="Interface MapIdleListener">Interface MapIdleListener</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#onMapBusy()">onMapBusy</a>()</code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#onMapIdle()">onMapIdle</a>()</code></div>
...
<div class="block"><p>Called when map becomes invalidated and is about to be updated. One or more
 redraws will happen afterwards, until <a href="#onMapIdle()"><code>onMapIdle()</code></a> is called.</p></div>
</section>
</li>
<li>
...
<div class="block"><p>Called when map finishes all state updates. No state changes or redraws
 will happen aftrwards until <a href="#onMapBusy()"><code>onMapBusy()</code></a> is called.</p></div>
</section>
</li>
</ul>
</section>
