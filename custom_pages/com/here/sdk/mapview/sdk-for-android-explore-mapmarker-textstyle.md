...
slug: "sdk-for-android-explore-mapmarker-textstyle"
---
...
<dd><a href="MapMarker.html" title="class in com.here.sdk.mapview">MapMarker</a></dd>
</dl>
<hr/>
...
<div class="block"><p>Styling options for the text of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="type-name-link" href="MapMarker.TextStyle.InstantiationErrorCode.html" title="enum class in com.here.sdk.mapview">MapMarker.TextStyle.InstantiationErrorCode</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="type-name-link" href="MapMarker.TextStyle.InstantiationException.html" title="class in com.here.sdk.mapview">MapMarker.TextStyle.InstantiationException</a></code></div>
...
<div class="col-first even-row-color"><code>static enum </code></div>
<div class="col-second even-row-color"><code><a class="type-name-link" href="MapMarker.TextStyle.Placement.html" title="enum class in com.here.sdk.mapview">MapMarker.TextStyle.Placement</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-last even-row-color">
<div class="block">Creates a default set of styling options for the text of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a> that consists of
 ...
 Text placement: <a href="MapMarker.TextStyle.Placement.html#BOTTOM"><code>MapMarker.TextStyle.Placement.BOTTOM</code></a>
</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(double,com.here.sdk.core.Color,double,com.here.sdk.core.Color,java.util.List)">TextStyle</a><wbr/>(double textSize,
 <a href="../core/Color.html" title="class in com.here.sdk.core">Color</a> textColor,
 double textOutlineSize,
 <a href="../core/Color.html" title="class in com.here.sdk.core">Color</a> textOutlineColor,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="MapMarker.TextStyle.Placement.html" title="enum class in com.here.sdk.mapview">MapMarker.TextStyle.Placement</a>&gt; placements)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates a set of styling options for the text of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(double,com.here.sdk.core.Color,double,com.here.sdk.core.Color,java.util.List,java.lang.String)">TextStyle</a><wbr/>(double textSize,
 ...
 double textOutlineSize,
 <a href="../core/Color.html" title="class in com.here.sdk.core">Color</a> textOutlineColor,
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="MapMarker.TextStyle.Placement.html" title="enum class in com.here.sdk.mapview">MapMarker.TextStyle.Placement</a>&gt; placements,
...
<div class="block">Gets the possible text placements relative to the icon of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</div>
</div>
...
<div class="block"><p>Creates a default set of styling options for the text of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a> that consists of
 the following values:
 <ul>
...
<li>Text placement: <a href="MapMarker.TextStyle.Placement.html#BOTTOM"><code>MapMarker.TextStyle.Placement.BOTTOM</code></a></li>
</ul>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">TextStyle</span><wbr/><span class="parameters">(double textSize,
 ...
 <a href="../core/Color.html" title="class in com.here.sdk.core">Color</a> textOutlineColor,
 @NonNull
 <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="MapMarker.TextStyle.Placement.html" title="enum class in com.here.sdk.mapview">MapMarker.TextStyle.Placement</a>&gt; placements)</span>
          throws <span class="exceptions"><a href="MapMarker.TextStyle.InstantiationException.html" title="class in com.here.sdk.mapview">MapMarker.TextStyle.InstantiationException</a></span></div>
<div class="block"><p>Creates a set of styling options for the text of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.
 <p>List of placements is used to specify allowed placement of text relative to the icon.
 When marker overlapping is allowed as set by <a href="MapMarker.html#setOverlapAllowed(boolean)"><code>MapMarker.setOverlapAllowed(boolean)</code></a>,
...
<dd><code>placements</code> - <p>List of allowed placements of the text relative to the icon of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</p></dd>
<dt>Throws:</dt>
<dd><code><a href="MapMarker.TextStyle.InstantiationException.html" title="class in com.here.sdk.mapview">MapMarker.TextStyle.InstantiationException</a></code> - <p>In case of invalid input parameters.</p></dd>
</dl>
</section>
</li>
<li>
...
<h3>getTextColor</h3>
<div class="member-signature"><span class="annotations">@NonNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../core/Color.html" title="class in com.here.sdk.core">Color</a></span> <span class="element-name">getTextColor</span>()</div>
...
<div class="member-signature"><span class="annotations">@NonNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="../core/Color.html" title="class in com.here.sdk.core">Color</a></span> <span class="element-name">getTextOutlineColor</span>()</div>
...
<div class="block"><p>Gets the possible text placements relative to the icon of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd><p>List of possible text placements relative to the icon of a <a href="MapMarker.html" title="class in com.here.sdk.mapview"><code>MapMarker</code></a>.</p></dd>
</dl>
</section>
</li>
</ul>
