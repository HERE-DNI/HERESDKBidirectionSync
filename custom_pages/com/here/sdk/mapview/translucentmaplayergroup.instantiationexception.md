...
slug: "sdk-for-android-explore-api-reference-latesttranslucentmaplayergroup-instantiationexception"
hidden: false
---

Package [com.here.sdk.mapview](sdk-for-android-explore-api-reference-latestpackage-summary)

# Class TranslucentMapLayerGroup.InstantiationException
...
------------------------------------------------------------------------
public static final class TranslucentMapLayerGroup.InstantiationException extends [Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html)
Thrown when failing to build the group.
See Also:
- [Serialized Form](sdk-for-android-explore-api-reference-latestserialized-form#com.here.sdk.mapview.TranslucentMapLayerGroup.InstantiationException)
