...
<div class="block"><p>Represents a 3D shape drawn on the map at specified geodetic coordinates.
 ...
 <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview"><code>MapMarker3DModel</code></a>.
...
<p>Two aspects determine how big the <code>MapMarker3D</code> will be on the screen
 ...
 <p>The first, and most impactful is <a href="RenderSize.Unit.html" title="enum class in com.here.sdk.mapview"><code>RenderSize.Unit</code></a>, which specifies
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.core.GeoCoordinates,com.here.sdk.mapview.MapImage,double,com.here.sdk.mapview.RenderSize.Unit)">MapMarker3D</a><wbr/>(<a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> at,
 <a href="MapImage.html" title="class in com.here.sdk.mapview">MapImage</a> image,
 double scale,
 <a href="RenderSize.Unit.html" title="enum class in com.here.sdk.mapview">RenderSize.Unit</a> unit)</code></div>
<div class="col-last even-row-color">
<div class="block">Creates a flat marker from provided map image.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.core.GeoCoordinates,com.here.sdk.mapview.MapMarker3DModel)">MapMarker3D</a><wbr/>(<a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> at,
 <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview">MapMarker3DModel</a> model)</code></div>
<div class="col-last odd-row-color">
<div class="block">Creates an instance of a 3D marker.</div>
</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.core.GeoCoordinates,com.here.sdk.mapview.MapMarker3DModel,double)">MapMarker3D</a><wbr/>(<a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> at,
...
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.core.GeoCoordinates,com.here.sdk.mapview.MapMarker3DModel,double,com.here.sdk.mapview.RenderSize.Unit)">MapMarker3D</a><wbr/>(<a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> at,
 <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview">MapMarker3DModel</a> model,
 double scale,
 <a href="RenderSize.Unit.html" title="enum class in com.here.sdk.mapview">RenderSize.Unit</a> unit)</code></div>
<div class="col-last odd-row-color">
...
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets the <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.</div>
</div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#setCoordinates(com.here.sdk.core.GeoCoordinates)">setCoordinates</a><wbr/>(<a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> value)</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets the <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MapMarker3D</span><wbr/><span class="parameters">(@NonNull
 <a href="../core/GeoCoordinates.html" title="class in com.here.sdk.core">GeoCoordinates</a> at,
 @NonNull
 <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview">MapMarker3DModel</a> model)</span></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MapMarker3D</span><wbr/><span class="parameters">(@NonNull
 ...
 double scale,
 @NonNull
 <a href="RenderSize.Unit.html" title="enum class in com.here.sdk.mapview">RenderSize.Unit</a> unit)</span></div>
<div class="block"><p>Creates a flat marker from provided map image.
 ...
 <p>Only bitmap images are supported, using a <a href="MapImage.html" title="class in com.here.sdk.mapview"><code>MapImage</code></a> created from SVG data
 ...
 <p>For <a href="RenderSize.Unit.html#PIXELS"><code>RenderSize.Unit.PIXELS</code></a>, the flat marker will cover <code>scale</code> * image's width pixels
 ...
 <p>For <a href="RenderSize.Unit.html#DENSITY_INDEPENDENT_PIXELS"><code>RenderSize.Unit.DENSITY_INDEPENDENT_PIXELS</code></a> the flat marker will cover <code>scale</code> *
 ...
 the screen.
 <p>For <a href="RenderSize.Unit.html#METERS"><code>RenderSize.Unit.METERS</code></a> the flat marker will cover <code>scale</code> * image's width meters
...
<div class="block"><p>Creates a new 3D marker at given world coordinates, using the supplied 3D model.
 ...
 <p>For <a href="RenderSize.Unit.html#PIXELS"><code>RenderSize.Unit.PIXELS</code></a> one unit of the 3D marker model will cover <code>scale</code> pixels.
 The size of the 3D marker remains constant on the screen.
 <p>For <a href="RenderSize.Unit.html#DENSITY_INDEPENDENT_PIXELS"><code>RenderSize.Unit.DENSITY_INDEPENDENT_PIXELS</code></a> one unit of the 3D marker model will
 cover <code>scale</code> density independent pixels. The size of the 3D marker remains constant on
 the screen.
 <p>For <a href="RenderSize.Unit.html#METERS"><code>RenderSize.Unit.METERS</code></a> one unit of the 3D marker model will cover <code>scale</code> meters
...
<div class="block"><p>Gets the <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.
 The default value is <code>null</code>.</p></div>
<dl class="notes">
<dt>Returns:</dt>
<dd><p>The <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.</p></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Sets the <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>value</code> - <p>The <a href="../core/Metadata.html" title="class in com.here.sdk.core"><code>Metadata</code></a> instance attached to this 3D marker.</p></dd>
</dl>
</section>
</li>
<li>
...
<div class="block"><p>Returns an opacity factor which specifies the translucency of a 3D map marker.
 ...
 in <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview"><code>MapMarker3DModel</code></a>.</p></p></div>
<dl class="notes">
<dt>Returns:</dt>
...
<div class="block"><p>Sets an opacity factor which specifies the translucency of a 3D map marker.
 ...
 Default value is 1.0 meaning marker is displayed with the default opacity of the texture image or the
 specified fill color specified
 in <a href="MapMarker3DModel.html" title="class in com.here.sdk.mapview"><code>MapMarker3DModel</code></a>.</p></p></p></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="block"><p>Gets the list of visibility ranges.
 ...
 Only <a href="s">MapMeasureRange</a> of <a href="MapMeasure.Kind.html#ZOOM_LEVEL"><code>MapMeasure.Kind.ZOOM_LEVEL</code></a> type are supported.
