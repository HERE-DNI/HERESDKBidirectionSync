...
slug: "sdk-for-android-explore-api-reference-mapcontext-memorymanagementresult"
---
...
<div class="block"><p>The difference in kibibytes between the limit and the video-memory requirement
 ...
 correct memory limit cannot be calculated, <code>null</code> value is returned.</div>
</section>
</li>
<li>
...
<div class="block"><p>The result code of the memory management request.</div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>resultCode</code> - <p>The result code of the memory management request.</dd>
</dl>
</section>
</li>
</ul>
