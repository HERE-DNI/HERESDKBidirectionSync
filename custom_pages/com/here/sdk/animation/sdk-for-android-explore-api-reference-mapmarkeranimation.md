...
<div class="block"><p>An animation that can be applied to the <a href="sdk-for-android-explore-mapmarker" title="class in com.here.sdk.mapview"><code>MapMarker</code></a> object.</div>
</section>
...
<div class="col-second even-row-color"><code><a href="sdk-for-android-explore-mapmarkeranimation-instantiationerrorcode" class="type-name-link" title="enum class in com.here.sdk.animation">MapMarkerAnimation.InstantiationErrorCode</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="sdk-for-android-explore-mapmarkeranimation-instantiationexception" class="type-name-link" title="class in com.here.sdk.animation">MapMarkerAnimation.InstantiationException</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(com.here.sdk.animation.MapItemKeyFrameTrack)" class="member-name-link">MapMarkerAnimation</a><wbr>(<a href="sdk-for-android-explore-mapitemkeyframetrack" title="class in com.here.sdk.animation">MapItemKeyFrameTrack</a>&nbsp;track)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Creates an animation of <a href="sdk-for-android-explore-mapmarker" title="class in com.here.sdk.mapview"><code>MapMarker</code></a> based on provided keyframe track.
 ...
 <p>For starting the animation see <a href="sdk-for-android-explore-mapmarker#startAnimation(com.here.sdk.animation.MapMarkerAnimation,com.here.sdk.animation.AnimationListener)"><code>MapMarker.startAnimation(com.here.sdk.animation.MapMarkerAnimation, com.here.sdk.animation.AnimationListener)</code></a>.</div>
<dl class="notes">
<dt>Parameters:</dt>
