...
<h1 class="title" title="Class MapItemKeyFrameTrack">Class MapItemKeyFrameTrack</h1>
</div>
...
<div class="block"><p>Creates a keyframe track used to animate the progress of a polyline.
 ...
 (as passed to <a href="sdk-for-android-explore-mappolyline#setProgress(double)"><code>MapPolyline.setProgress(double)</code></a>) at key points of the animation.</p></p></div>
<dl class="notes">
<dt>Parameters:</dt>
