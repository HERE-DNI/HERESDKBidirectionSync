...
/sdk-for-flutter-navigate-routing-waypoint-waypoint(/sdk-for-flutter-navigate-core-geocoordinates-class coordinates, [/sdk-for-flutter-navigate-routing-waypointtype type = WaypointType.stopover, int transitRadiusInMeters = 0, double? headingInDegrees = null, /sdk-for-flutter-navigate-core-geocoordinates-class? sideOfStreetHint = null, /sdk-for-flutter-navigate-core-geocoordinates-class? displayLocation = null, int? minCourseDistanceInMeters = null, String? nameHint = null, /sdk-for-flutter-navigate-routing-matchsideofstreet? matchSideOfStreet = null, Duration duration = const Duration(seconds: 0), /sdk-for-flutter-navigate-routing-segmentreference-class? segmentHint = null, int? onRoadThresholdInMeters = null, /sdk-for-flutter-navigate-routing-chargingstop-class? chargingStop = null, int? currentWeightChangeInKilograms = null])
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="Waypoint.withDefaults">
/sdk-for-flutter-navigate-routing-waypoint-waypoint-withdefaults(/sdk-for-flutter-navigate-core-geocoordinates-class coordinates)
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-routing-waypoint-chargingstop
...
/sdk-for-flutter-navigate-routing-waypoint-coordinates
...
/sdk-for-flutter-navigate-routing-waypoint-currentweightchangeinkilograms
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-displaylocation
↔ /sdk-for-flutter-navigate-core-geocoordinates-class?
</dt>
<dd>
  Optional coordinates to indicate physical location of the Points of Interest (PoI).
It is different from coordinates and /sdk-for-flutter-navigate-routing-waypoint-sideofstreethint which are generally expected to to be
...
/sdk-for-flutter-navigate-routing-waypoint-duration
↔ Duration
</dt>
<dd>
  The duration in seconds that should be spent at a waypoint of type /sdk-for-flutter-navigate-routing-waypointtype.
Impacts time-aware calculations.
Ignored for waypoints of type /sdk-for-flutter-navigate-routing-waypointtype.
The default duration is 0 seconds.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="hashCode">
/sdk-for-flutter-navigate-routing-waypoint-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-headingindegrees
↔ double?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-matchsideofstreet
↔ /sdk-for-flutter-navigate-routing-matchsideofstreet?
</dt>
<dd>
  Specifies how the location set by /sdk-for-flutter-navigate-routing-waypoint-sideofstreethint should be handled. Note that this setting might affect the geometry of the resulting route.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="minCourseDistanceInMeters">
/sdk-for-flutter-navigate-routing-waypoint-mincoursedistanceinmeters
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-namehint
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-onroadthresholdinmeters
↔ int?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-waypoint-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-waypoint-segmenthint
...
/sdk-for-flutter-navigate-routing-waypoint-sideofstreethint
↔ /sdk-for-flutter-navigate-core-geocoordinates-class?
</dt>
<dd>
...
Note that this option is ignored if the user sets /sdk-for-flutter-navigate-routing-waypoint-transitradiusinmeters option with a
value greater than zero.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="transitRadiusInMeters">
/sdk-for-flutter-navigate-routing-waypoint-transitradiusinmeters
↔ int
</dt>
<dd>
...
Note that /sdk-for-flutter-navigate-routing-waypoint-sideofstreethint option is ignored if the user sets this option with a value
greater than zero.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="type">
/sdk-for-flutter-navigate-routing-waypoint-type
↔ /sdk-for-flutter-navigate-routing-waypointtype
</dt>
<dd>
  Defines how a waypoint should be considered for route calculation.
The default waypoint type is /sdk-for-flutter-navigate-routing-waypointtype.
  <div class="features">getter/setter pair</div>
</dd>
</dl>
</section>
...
/sdk-for-flutter-navigate-routing-waypoint-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-waypoint-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-waypoint-operator-equals(<wbr/>Object other)
    → bool
