...
<div className="inheritance">com.here.sdk.navigation.ManeuverNotificationTimingOptions</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">ManeuverNotificationTimingOptions</span>
<span className="extends-implements">extends <a className="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div className="block"><p>A class defining timing and distance thresholds for maneuver notifications.
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#actionNotificationDistanceInMeters">actionNotificationDistanceInMeters</a></code></div>
<div className="col-last even-row-color">
<div className="block">The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#ACTION"><code>ManeuverNotificationType.ACTION</code></a> notification.</div>
</div>
<div className="col-first odd-row-color"><code>int</code></div>
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#actionNotificationTimeInSeconds">actionNotificationTimeInSeconds</a></code></div>
<div className="col-last odd-row-color">
<div className="block">The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#ACTION"><code>ManeuverNotificationType.ACTION</code></a> notification.</div>
</div>
<div className="col-first even-row-color"><code>int</code></div>
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#distanceNotificationDistanceInMeters">distanceNotificationDistanceInMeters</a></code></div>
<div className="col-last even-row-color">
<div className="block">The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#DISTANCE"><code>ManeuverNotificationType.DISTANCE</code></a> notification.</div>
</div>
<div className="col-first odd-row-color"><code>int</code></div>
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#distanceNotificationTimeInSeconds">distanceNotificationTimeInSeconds</a></code></div>
<div className="col-last odd-row-color">
<div className="block">The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#DISTANCE"><code>ManeuverNotificationType.DISTANCE</code></a> notification.</div>
</div>
<div className="col-first even-row-color"><code>int</code></div>
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#doubleNotificationDistanceInMeters">doubleNotificationDistanceInMeters</a></code></div>
<div className="col-last even-row-color">
<div className="block">The default distance setting for double notification.</div>
</div>
<div className="col-first odd-row-color"><code>int</code></div>
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#rangeNotificationDistanceInMeters">rangeNotificationDistanceInMeters</a></code></div>
<div className="col-last odd-row-color">
<div className="block">The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> notification.</div>
</div>
<div className="col-first even-row-color"><code>int</code></div>
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#rangeNotificationTimeInSeconds">rangeNotificationTimeInSeconds</a></code></div>
<div className="col-last even-row-color">
<div className="block">The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> notification.</div>
</div>
<div className="col-first odd-row-color"><code>int</code></div>
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#reminderNotificationDistanceInMeters">reminderNotificationDistanceInMeters</a></code></div>
<div className="col-last odd-row-color">
<div className="block">The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#REMINDER"><code>ManeuverNotificationType.REMINDER</code></a> notification.</div>
</div>
<div className="col-first even-row-color"><code>int</code></div>
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#reminderNotificationTimeInSeconds">reminderNotificationTimeInSeconds</a></code></div>
<div className="col-last even-row-color">
<div className="block">The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#REMINDER"><code>ManeuverNotificationType.REMINDER</code></a> notification.</div>
</div>
</div>
</section>
</li>
...
<div className="col-constructor-name even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#%3Cinit%3E(int,int,int,int,int,int,int,int,int)">ManeuverNotificationTimingOptions</a><wbr/>(int rangeNotificationDistanceInMeters,
...
<li>
<section className="detail" id="rangeNotificationDistanceInMeters">
<h3>rangeNotificationDistanceInMeters</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">rangeNotificationDistanceInMeters</span></div>
<div className="block"><p>The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> notification. A configuration value of 0 is only allowed for
...
<li>
<section className="detail" id="rangeNotificationTimeInSeconds">
<h3>rangeNotificationTimeInSeconds</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">rangeNotificationTimeInSeconds</span></div>
<div className="block"><p>The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> notification. A configuration value of 0 is only allowed for
 <a href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#rangeNotificationDistanceInMeters"><code>rangeNotificationDistanceInMeters</code></a> and <a href="sdk-for-android-navigate-com-here-sdk-navigation-maneuvernotificationtimingoptions#rangeNotificationTimeInSeconds"><code>rangeNotificationTimeInSeconds</code></a>. It means that the maneuver notifications of type
 <a href="sdk-for-android-navigate-maneuvernotificationtype#RANGE"><code>ManeuverNotificationType.RANGE</code></a> should be generated as soon as the maneuver location is known - no matter how far away it may be.
 <table>
<thead>
...
<li>
<section className="detail" id="reminderNotificationDistanceInMeters">
<h3>reminderNotificationDistanceInMeters</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">reminderNotificationDistanceInMeters</span></div>
<div className="block"><p>The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#REMINDER"><code>ManeuverNotificationType.REMINDER</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="reminderNotificationTimeInSeconds">
<h3>reminderNotificationTimeInSeconds</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">reminderNotificationTimeInSeconds</span></div>
<div className="block"><p>The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#REMINDER"><code>ManeuverNotificationType.REMINDER</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="distanceNotificationDistanceInMeters">
<h3>distanceNotificationDistanceInMeters</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">distanceNotificationDistanceInMeters</span></div>
<div className="block"><p>The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#DISTANCE"><code>ManeuverNotificationType.DISTANCE</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="distanceNotificationTimeInSeconds">
<h3>distanceNotificationTimeInSeconds</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">distanceNotificationTimeInSeconds</span></div>
<div className="block"><p>The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#DISTANCE"><code>ManeuverNotificationType.DISTANCE</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="actionNotificationDistanceInMeters">
<h3>actionNotificationDistanceInMeters</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">actionNotificationDistanceInMeters</span></div>
<div className="block"><p>The default distance setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#ACTION"><code>ManeuverNotificationType.ACTION</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="actionNotificationTimeInSeconds">
<h3>actionNotificationTimeInSeconds</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">actionNotificationTimeInSeconds</span></div>
<div className="block"><p>The default time setting for <a href="sdk-for-android-navigate-maneuvernotificationtype#ACTION"><code>ManeuverNotificationType.ACTION</code></a> notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<li>
<section className="detail" id="doubleNotificationDistanceInMeters">
<h3>doubleNotificationDistanceInMeters</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="return-type">int</span> <span className="element-name">doubleNotificationDistanceInMeters</span></div>
<div className="block"><p>The default distance setting for double notification.
 <table>
<thead>
<tr><th>Transport Mode</th><th>Timing Profile</th><th>Default value</th></tr>
</thead>
...
<ul className="member-list">
<li>
<section className="detail" id="&lt;init&gt;(int,int,int,int,int,int,int,int,int)">
<h3>ManeuverNotificationTimingOptions</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="element-name">ManeuverNotificationTimingOptions</span><wbr/><span className="parameters">(int rangeNotificationDistanceInMeters,
 int rangeNotificationTimeInSeconds,
 int reminderNotificationDistanceInMeters,
 int reminderNotificationTimeInSeconds,
 int distanceNotificationDistanceInMeters,
