...
<div id="sdk-for-flutter-navigate-dartdoc-main-content" class="main-content" data-above-sidebar="routing/SegmentReference-class-sidebar.html" data-below-sidebar="">
...
<span class="name">SegmentReference</span>(<wbr></wbr>\<a href="sdk-for-flutter-navigate-routing-traveldirection">

1.  <span id="sdk-for-flutter-navigate-param-segmentId" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">segmentId</span> = <span class="default-value">""</span>, </span>
2.  <span id="sdk-for-flutter-navigate-param-travelDirection" class="parameter"><span class="type-annotation">[TravelDirection</a></span> <span class="parameter-name">travelDirection</span> = <span class="default-value">TravelDirection.bidirectional</span>, </span>
3.  <span id="sdk-for-flutter-navigate-param-offsetStart" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">offsetStart</span> = <span class="default-value">0.0</span>, </span>
4.  <span id="sdk-for-flutter-navigate-param-offsetEnd" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">offsetEnd</span> = <span class="default-value">1.0</span>, </span>
5.  <span id="sdk-for-flutter-navigate-param-tilePartitionId" class="parameter"><span class="type-annotation">int</span> <span class="parameter-name">tilePartitionId</span> = <span class="default-value">0</span>, </span>
6.  <span id="sdk-for-flutter-navigate-param-localId" class="parameter"><span class="type-annotation">int?</span> <span class="parameter-name">localId</span> = <span class="default-value">0</span>, </span>
