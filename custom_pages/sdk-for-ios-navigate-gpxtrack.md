...
slug: "sdk-for-ios-navigate-gpxtrack"
---
...
<html lang="en">
  <head>
    <title>GPXTrack Class Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Class/GPXTrack" class="dashAnchor"></a>
...
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt">GPXTrack</span><span class="p">:</span> <span class="kt">Hashable</span></code></pre>
            ...
            <p>Single track from the <code><a href="sdk-for-ios-explore-gpxdocument">GPXDocument</a></code>. Can be used as an input to the <code><a href="sdk-for-ios-explore-locationsimulator">LocationSimulator</a></code>.
Can be created and modified via <code><a href="sdk-for-ios-explore-gpxtrackwriter">GPXTrackWriter</a></code>.</p>
...
Can be overridden by the user. If nothing was set before, defaults to an empty string.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/getLocations()" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Provides a list of all stored track points converted to a <code><a href="sdk-for-ios-explore-location">Location</a></code> object.
See <a href="https://www.topografix.com/GPX/1/1/#type_wptType">type_wptType</a> for more details on the <code>wptType</code> format that is used for a track point.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="kd">func</span> <span class="nf">getLocations</span><span class="p">()</span> <span class="o">-&gt;</span> <span class="p">[</span><span class="kt"><a href="sdk-for-ios-explore-location">Location</a></span><span class="p">]</span></code></pre>

                        </div>
                      </div>
                      <div>
                        <h4>Return Value</h4>
                        <p>List of <code><a href="sdk-for-ios-explore-location">Location</a></code> objects.</p>
                      </div>
                    </section>
                  </div>
                </li>
