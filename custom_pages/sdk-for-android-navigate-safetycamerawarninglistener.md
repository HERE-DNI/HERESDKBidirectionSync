...
<title>SafetyCameraWarningListener (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.navigation, interface: SafetyCameraWarningListener">
...
<h1 title="Interface SafetyCameraWarningListener" class="title">Interface SafetyCameraWarningListener</h1>
</div>
...
<div class="block"><p>This interface
 ...
 That is a first in first out approach is used when multiple safety cameras are reached or passed on the same location.</div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onSafetyCameraWarningUpdated(com.here.sdk.navigation.SafetyCameraWarning)" class="member-name-link">onSafetyCameraWarningUpdated</a><wbr>(<a href="sdk-for-android-explore-safetycamerawarning" title="class in com.here.sdk.navigation">SafetyCameraWarning</a>&nbsp;safetyCameraWarning)</code></div>
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onSafetyCameraWarningUpdated</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-safetycamerawarning" title="class in com.here.sdk.navigation">SafetyCameraWarning</a>&nbsp;safetyCameraWarning)</span></div>
<div class="block"><p>Called whenever a new <code>SafetyCameraWarning</code> is available.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>safetyCameraWarning</code> - <p>The object that contains details on the safety camera warning.</dd>
</dl>
</section>
</li>
</ul>
