...
slug: "sdk-for-ios-navigate-mapmatchedlocation"
---
...
<html lang="en">
  <head>
    <title>MapMatchedLocation Structure Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Struct/MapMatchedLocation" class="dashAnchor"></a>
...
compass. It means that for going north it&rsquo;s equal to 0, for northeast it&rsquo;s equal to 45,
for east it&rsquo;s equal to 90, and so on.
...
The ratio of <code><a href="sdk-for-ios-explore-mapmatchedlocation#/s:7heresdk18MapMatchedLocationV26segmentOffsetInCentimeterss6UInt32Vvp">MapMatchedLocation.segmentOffsetInCentimeters</a></code> to the segment length is
between <code><a href="sdk-for-ios-explore-segmentreference#/s:7heresdk16SegmentReferenceV11offsetStartSdvp">SegmentReference.offsetStart</a></code> and <code><a href="sdk-for-ios-explore-segmentreference#/s:7heresdk16SegmentReferenceV9offsetEndSdvp">SegmentReference.offsetEnd</a></code>.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">segmentReference</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-segmentreference">SegmentReference</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/segmentOffsetInCentimeters" class="dashAnchor"></a>
...
then, for example, overspeed warnings may be also inaccurate.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/isDrivingInTheWrongWay" class="dashAnchor"></a>
...
Note that the travel direction is determined based on the map-matched location.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/horizontalAccuracyInMeters" class="dashAnchor"></a>
...
Currently this value is not being provided by the Navigator.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/speedInMetersPerSecond" class="dashAnchor"></a>
...
behaviors. Related APIs may change for new releases without a deprecation process.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(coordinates:bearingInDegrees:segmentReference:segmentOffsetInCentimeters:confidence:isDrivingInTheWrongWay:horizontalAccuracyInMeters:speedInMetersPerSecond:timestamp:)" class="dashAnchor"></a>
...
The ratio of <code><a href="sdk-for-ios-explore-mapmatchedlocation#/s:7heresdk18MapMatchedLocationV26segmentOffsetInCentimeterss6UInt32Vvp">MapMatchedLocation.segmentOffsetInCentimeters</a></code> to the segment length is
between <code><a href="sdk-for-ios-explore-segmentreference#/s:7heresdk16SegmentReferenceV11offsetStartSdvp">SegmentReference.offsetStart</a></code> and <code><a href="sdk-for-ios-explore-segmentreference#/s:7heresdk16SegmentReferenceV9offsetEndSdvp">SegmentReference.offsetEnd</a></code>.</li>
...
<p><strong>Note:</strong> This is a beta release of this feature, so there could be a few bugs and unexpected
  behaviors. Related APIs may change for new releases without a deprecation process.</p></li>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">coordinates</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-geocoordinates">GeoCoordinates</a></span><span class="p">,</span> <span class="nv">bearingInDegrees</span><span class="p">:</span> <span class="kt">Double</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">segmentReference</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-segmentreference">SegmentReference</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-segmentreference">SegmentReference</a></span><span class="p">(),</span> <span class="nv">segmentOffsetInCentimeters</span><span class="p">:</span> <span class="kt">UInt32</span> <span class="o">=</span> <span class="mi">0</span><span class="p">,</span> <span class="nv">confidence</span><span class="p">:</span> <span class="kt">Double</span> <span class="o">=</span> <span class="mf">0.0</span><span class="p">,</span> <span class="nv">isDrivingInTheWrongWay</span><span class="p">:</span> <span class="kt">Bool</span> <span class="o">=</span> <span class="kc">false</span><span class="p">,</span> <span class="nv">horizontalAccuracyInMeters</span><span class="p">:</span> <span class="kt">Double</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">speedInMetersPerSecond</span><span class="p">:</span> <span class="kt">Double</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">timestamp</span><span class="p">:</span> <span class="kt">Date</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">)</span></code></pre>
