...
class="external-link"
title="class or interface in java.lang"><code>Comparable</code></a>`<`[`EVChargingVehicleCategory`](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")`>`,
<a
...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory#HEAVY"
  class="member-name-link"><code>HEAVY</code></a></td>
  <td><div class="block">
  The charging location is suitable for heavy vehicle charging, including,
  for example, rigid trucks, semi-trailer trucks, requiring more physical
  space for parking and maneuvering than passenger cars.
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory#REGULAR"
  class="member-name-link"><code>REGULAR</code></a></td>
  <td><div class="block">
  The charging location is suitable for regular passenger cars, and
  optionally also for light commercial vehicles, such as vans, pickups and
  the like, if signaled by truckAccess property.
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory#TWO_WHEELER"
  class="member-name-link"><code>TWO_WHEELER</code></a></td>
  <td><div class="block">
  The charging location is suitable for motor bikes, e-scooters, and the
  like.
  </div></td>
  </tr>
  </tbody>
...
- <div id="method-summary" class="section method-summary">
  ...
  title="enum class in com.here.sdk.search"><code>EVChargingVehicleCategory</code></a></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="REGULAR" class="section detail">
    ...
    final</span> <span class="return-type">[EVChargingVehicleCategory](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")</span> <span class="element-name">REGULAR</span>
    ...
    The charging location is suitable for regular passenger cars, and
    optionally also for light commercial vehicles, such as vans, pickups
    and the like, if signaled by truckAccess property. This is the
    default category, used when there is no explicit information about
  ...
  - <div id="TWO_WHEELER" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[EVChargingVehicleCategory](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")</span> <span class="element-name">TWO_WHEELER</span>

    </div>

    <div class="block">

    The charging location is suitable for motor bikes, e-scooters, and
    the like.
  ...
  - <div id="HEAVY" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[EVChargingVehicleCategory](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")</span> <span class="element-name">HEAVY</span>

    </div>

    <div class="block">

    The charging location is suitable for heavy vehicle charging,
    including, for example, rigid trucks, semi-trailer trucks, requiring
    more physical space for parking and maneuvering than passenger cars.
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[EVChargingVehicleCategory](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")\[\]</span> <span class="element-name">values</span>()
  ...
  - <div id="valueOf(java.lang.String)" class="section detail">
    ...
    <span class="modifiers">public
    static</span> <span class="return-type">[EVChargingVehicleCategory](sdk-for-android-explore-com-here-sdk-search-evchargingvehiclecategory "enum class in com.here.sdk.search")</span> <span class="element-name">valueOf</span><span class="parameters">(<a
