---
title: "operator == method - JunctionViewLaneAssistance class - navigation library - Dart API"
slug: "sdk-for-flutter-navigate-navigation-junctionviewlaneassistance-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-navigate-navigation-junctionviewlaneassistance-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return DeepCollectionEquality().equals(lanesForNextJunction, _other.lanesForNextJunction) &&
      distanceToJunctionInMeters == _other.distanceToJunctionInMeters;
}
```
