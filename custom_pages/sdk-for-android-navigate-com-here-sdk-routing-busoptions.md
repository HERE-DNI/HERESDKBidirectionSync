...
<div className="inheritance">com.here.sdk.routing.BusOptions</div>
</div>
...
</span><span className="modifiers">public final class </span><span className="element-name type-name-label">BusOptions</span>
...
<div className="block"><p>All the options to specify how a bus route should be calculated.</p></div>
</section>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#allowOptions">allowOptions</a></code></div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#avoidanceOptions">avoidanceOptions</a></code></div>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#busSpecifications">busSpecifications</a></code></div>
<div className="col-last even-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#lastCharacterOfLicensePlate">lastCharacterOfLicensePlate</a></code></div>
<div className="col-last odd-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#maxSpeedOnSegments">maxSpeedOnSegments</a></code></div>
<div className="col-last even-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#occupantsNumber">occupantsNumber</a></code></div>
<div className="col-last odd-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#routeOptions">routeOptions</a></code></div>
<div className="col-last even-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#textOptions">textOptions</a></code></div>
<div className="col-last odd-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#tollOptions">tollOptions</a></code></div>
<div className="col-last even-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<div className="col-constructor-name even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-busoptions#%3Cinit%3E()">BusOptions</a>()</code></div>
<div className="col-last even-row-color">
<div className="block"><span className="deprecated-label">Deprecated.</span></div>
...
<h3>BusOptions</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="element-name">BusOptions</span>()</div>
<div className="deprecation-block"><span className="deprecated-label">Deprecated.</span></div>
