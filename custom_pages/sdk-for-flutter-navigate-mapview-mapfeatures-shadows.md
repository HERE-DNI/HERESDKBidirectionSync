---
title: "shadows property - MapFeatures class - mapview library - Dart API"
...
# <span class="kind-property">shadows</span> property

</div>

<div class="section multi-line-signature">

String <span class="name">shadows</span>
...
Supports only one mode: <a href="sdk-for-flutter-navigate-mapview-mapfeaturemodes-shadowsall">MapFeatureModes.shadowsAll</a>.

A <a href="sdk-for-flutter-navigate-mapview-shadowquality">ShadowQuality</a> must be set on the MapContext through a MapView or the feature has no effect.
