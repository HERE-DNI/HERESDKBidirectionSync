...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.routing/RoutingOptions///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.routing</a><span class="delimiter">/</span><span class="current">RoutingOptions</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Routing</span><wbr></wbr><span><span>Options</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">RoutingOptions</a></div><p class="paragraph">The options defines how a route should be calculated.</p><p class="paragraph">The options are used for all transport modes and engines.</p><p class="paragraph">** Electric vehicle specific requirements ** Electric vehicle consumption are estimated when at least one consumption model is defined. Currently two models are supported:</p><ul><li><p class="paragraph">PhysicalConsumptionModel Aside from the values in PhysicalConsumptionModel additionally these values needs to be defined:</p></li><li><p class="paragraph"><a href="../../com.here.sdk.transport/-vehicle-specification/current-weight-in-kilograms.html">com.here.sdk.transport.VehicleSpecification.currentWeightInKilograms</a> from <a href="../../com.here.sdk.transport/-transport-specification/vehicle-specification.html">com.here.sdk.transport.TransportSpecification.vehicleSpecification</a>     from <a href="transport-specification.html">com.here.sdk.routing.RoutingOptions.transportSpecification</a></p></li><li><p class="paragraph">Additionally <a href="../-waypoint/current-weight-change-in-kilograms.html">com.here.sdk.routing.Waypoint.currentWeightChangeInKilograms</a> can be defined.</p></li><li><p class="paragraph">EmpiricalConsumptionModel</p></li></ul><p class="paragraph">By setting <a href="../-electric-vehicle-options/ensure-reachability.html">com.here.sdk.routing.ElectricVehicleOptions.ensureReachability</a> the <code class="lang-kotlin">RoutingEngine</code> inserts additional charging stations to reach the waypoints. This feature requires setting the <a href="../-battery-specifications/index.html">com.here.sdk.routing.BatterySpecifications</a>. By default a vehicle might not reach the waypoint, when the initial charge is not enough to reach all waypoints. See the parameter description below for more details.</p></div></div>
  </div>
...
<a data-name="1880760921%2FProperties%2F1617540583" anchor-label="evOptions" id="1880760921%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="ev-options.html"><span>ev</span><wbr></wbr><span><span>Options</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1880760921%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="ev-options.html">evOptions</a><span class="token operator">: </span><a href="../-electric-vehicle-options/index.html">ElectricVehicleOptions</a><span class="token operator">?</span></div><div class="brief "><p class="paragraph">Defines the electric vehicle (EV) related parameters to calculate the consumption and reachability. When no EV options are defined an internal combustion engine is assumed.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-73619302%2FProperties%2F1617540583"></span>
              ...
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="transport-specification.html">transportSpecification</a><span class="token operator">: </span><a href="../../com.here.sdk.transport/-transport-specification/index.html">TransportSpecification</a></div><div class="brief "><p class="paragraph">Defines the transport specification which contains the transport mode and the vehicle specifications for the transport mode chosen. <strong>Notes:</strong></p></div></div></div>
                </div>
              </div>
            </div>
          </div>
