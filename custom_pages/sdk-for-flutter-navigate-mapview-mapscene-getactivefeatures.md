...
enabled via a call to <a href="sdk-for-flutter-navigate-mapview-mapscene-enablefeatures">MapScene.enableFeatures</a> or that are enabled by default in the scene.</p>
