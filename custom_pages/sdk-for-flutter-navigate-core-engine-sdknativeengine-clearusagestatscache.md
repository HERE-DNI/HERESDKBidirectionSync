...
slug: "sdk-for-flutter-navigate-core-engine-sdknativeengine-clearusagestatscache"
---
...
<div>
<h1>clearUsageStatsCache abstract method</h1></div>
<section class="multi-line-signature">
void
clearUsageStatsCache(<wbr/>)

      

    </section>
<section class="desc markdown">
<p>Clear cache for the HERE SDK /sdk-for-flutter-navigate-core-engine-usagestats-class.</p>
<p>Note: This is a beta release of this feature, so there could be a few bugs and unexpected behaviors.
Related APIs may change for new releases without a deprecation process.</p>
</section>
<section class="summary source-code" id="source">
<h2>Implementation</h2>
<pre class="language-dart"><code class="language-dart">void clearUsageStatsCache();</code></pre>
</section>
</div>
