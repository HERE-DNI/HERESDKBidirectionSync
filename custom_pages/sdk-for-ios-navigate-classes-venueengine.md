...
will be completed. After the initialization, the <code><a href="sdk-for-ios-navigate-classes-venueservice">VenueService</a></code> should
...
<div class="language">
<p class="aside-title">Swift</p>
<pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="n">_</span> <span class="nv">sdkEngine</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-sdknativeengine">SDKNativeEngine</a></span><span class="p">,</span> <span class="nv">callback</span><span class="p">:</span> <span class="kt"><a href="../Venues.html#/s:7heresdk32VenueEngineInitCompletionHandlera">VenueEngineInitCompletionHandler</a></span><span class="p">?)</span> <span class="k">throws</span></code></pre>
</div>
</div>
<div>
<h4>Parameters</h4>
...
<div class="abstract">
<p>The venue service.
Gets the <code><a href="sdk-for-ios-navigate-classes-venueservice">VenueService</a></code>. This service
can be used to load the <code><a href="sdk-for-ios-navigate-classes-venuemodel">VenueModel</a></code> objects.</p>
</div>
<div class="declaration">
<h4>Declaration</h4>
<div class="language">
...
state of the venues on the map. You need to start the <code><a href="sdk-for-ios-navigate-classes-venueservice">VenueService</a></code> to
...
<div class="language">
<p class="aside-title">Swift</p>
<pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">venueMap</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-venuemap">VenueMap</a></span> <span class="p">{</span> <span class="k">get</span> <span class="p">}</span></code></pre>
</div>
</div>
</section>
</div>
...
the <code><a href="sdk-for-ios-navigate-classes-venueservice">VenueService</a></code>. An initialization status of the venue service is
returned to objects registered as <code><a href="sdk-for-ios-navigate-protocols-venueservicedelegate">VenueServiceDelegate</a></code>. If the
