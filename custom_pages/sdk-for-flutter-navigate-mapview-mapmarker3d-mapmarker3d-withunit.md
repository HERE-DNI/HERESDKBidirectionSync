...
MapMarker3D.withUnit(<ol class="parameter-list"> <li><a href="sdk-for-flutter-navigate-core-geocoordinates-class">GeoCoordinates</a> at, </li>
...
<p>For <a href="sdk-for-flutter-navigate-mapview-rendersizeunit">RenderSizeUnit.pixels</a> one unit of the 3D marker model will cover <code>MapMarker3D.withUnit.scale</code> pixels.
The size of the 3D marker remains constant on the screen.</p>
<p>For <a href="sdk-for-flutter-navigate-mapview-rendersizeunit">RenderSizeUnit.densityIndependentPixels</a> one unit of the 3D marker model will
cover <code>MapMarker3D.withUnit.scale</code> density independent pixels. The size of the 3D marker remains constant on
the screen.</p>
<p>For <a href="sdk-for-flutter-navigate-mapview-rendersizeunit">RenderSizeUnit.meters</a> one unit of the 3D marker model will cover <code>MapMarker3D.withUnit.scale</code> meters
