...
slug: "sdk-for-ios-navigate-evchargingstation"
---
...
<html lang="en">
  <head>
    <title>EVChargingStation Structure Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/supplierName" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online search using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it can be null if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/connectorTypeName" class="dashAnchor"></a>
...
May include customer-facing names. In such cases, a &lsquo;customer names&rsquo; label is present.
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/connectorTypeId" class="dashAnchor"></a>
...
For more information on the current connector types, see
<a href="https://www.here.com/docs/bundle/ev-charge-points-api-developer-guide/page/topics/resource-type-connector.html">https://www.here.com/docs/bundle/ev-charge-points-api-developer-guide/page/topics/resource-type-connector.html</a>
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/powerFeedTypeName" class="dashAnchor"></a>
...
In that case label &lsquo;North America (Australia)&rsquo; is present.
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/powerFeedTypeId" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/maxPowerInKilowatts" class="dashAnchor"></a>
...
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/connectorCount" class="dashAnchor"></a>
...
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/availableConnectorCount" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/occupiedConnectorCount" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/outOfServiceConnectorCount" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/reservedConnectorCount" class="dashAnchor"></a>
...
This field is always <code>nil</code> for offline search using the <code><a href="sdk-for-ios-explore-offlinesearchengine">OfflineSearchEngine</a></code>. For online searches using the <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, it may be <code>nil</code> if the data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/chargingMode" class="dashAnchor"></a>
...
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/voltageRangeInVolts" class="dashAnchor"></a>
...
Values are alphanumeric represented by the voltage range followed by &lsquo;V&rsquo; and
by the current type &lsquo;AC&rsquo; or &lsquo;DC&rsquo;, for example: &lsquo;100-120V AC&rsquo;.
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/currentRangeInAmperes" class="dashAnchor"></a>
...
Values are alphanumeric represented by the Ampere value followed by an &lsquo;A&rsquo;,
for example &lsquo;12A-80A&rsquo;.
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/phaseCount" class="dashAnchor"></a>
...
This field can be <code>nil</code> if data is unavailable.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/hasFixedCable" class="dashAnchor"></a>
