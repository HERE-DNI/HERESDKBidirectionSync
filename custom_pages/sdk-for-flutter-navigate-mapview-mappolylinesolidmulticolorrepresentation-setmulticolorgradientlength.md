...
1.  <span id="sdk-for-flutter-navigate-setMultiColorGradientLength-param-length" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">length</span></span>
