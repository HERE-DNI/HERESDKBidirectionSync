...
<li class="self-crumb">searchByAddressElements abstract method</li>
</ol>
<div class="self-name">searchByAddressElements</div>
...
searchByAddressElements(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-search-structuredquery-class query, </li>
...
<p>The user submits a /sdk-for-flutter-navigate-search-structuredquery-class
that returns places adhering to the constraints provided in /sdk-for-flutter-navigate-search-structuredquery-class.
