...
<li class="self-crumb">sizeOnNetworkInBytes property</li>
</ol>
<div class="self-name">sizeOnNetworkInBytes</div>
...
<div>
<h1>sizeOnNetworkInBytes property</h1></div>
...
<pre class="language-dart"><code class="language-dart">int sizeOnNetworkInBytes;</code></pre>
</section>
</div> 
