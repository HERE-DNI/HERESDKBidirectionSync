...
<span id="//apple_ref/swift/Protocol/MapViewBase" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-maps">Maps</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> MapViewBase Protocol Reference
...
- <div>
  ...
  The pixel scale factor used by this <a href="sdk-for-ios-explore-classes-mapview">`MapView`</a>.

  Pixel scale is 0.0 if the map view is not initialized.

  In cases where the <a href="sdk-for-ios-explore-classes-mapview">`MapView`</a> moves in between screens (e.g. from main screen to a CarPlay screen), / the most up-to-date pixel scale value can be obtained after a render target gets attached to the view. / To get notified when a render target gets attached to the <a href="sdk-for-ios-explore-classes-mapview">`MapView`</a>, see <a href="sdk-for-ios-explore-protocols-mapviewlifecycledelegate">`MapViewLifecycleDelegate`</a>.
