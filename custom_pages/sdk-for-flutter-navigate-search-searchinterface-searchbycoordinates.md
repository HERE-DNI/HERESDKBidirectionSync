...
<p>Performs an asynchronous search for <a href="/sdk-for-flutter-navigate-search-place-class">Place</a> instances based on the given
geographic coordinates.</p>
<p>This is the same search type as reverse geocoding, except that more data is returned
than just the <a href="/sdk-for-flutter-navigate-search-address-class">Address</a> related to the given coordinates.
