...
RefreshRouteOptions.withCarOptions(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-explore-routing-caroptions-class carOptions</li>
</ol>)
    </section>
<section class="desc markdown">
<p>Constructs a RefreshRouteOptions object with /sdk-for-flutter-explore-routing-caroptions-class.</p>
<ul>
