---
title: "importEVTruckRouteWithStops abstract method"
...
<div>
<h1>importEVTruckRouteWithStops abstract method</h1></div>
...
importEVTruckRouteWithStops(<ol class="parameter-list"> <li>List&lt;<a href="/sdk-for-flutter-navigate-core-location-class">Location</a>&gt; locations, </li>
<li>List&lt;<a href="/sdk-for-flutter-navigate-routing-routestop-class">RouteStop</a>&gt; routeStops, </li>
<li><a class="deprecated" href="/sdk-for-flutter-navigate-routing-evtruckoptions-class">EVTruckOptions</a> evTruckOptions, </li>
...
<p>Asynchronously creates an electric truck route from a sequence of geographic coordinates very close to each other.</p>
...
TaskHandle importEVTruckRouteWithStops(List&lt;Location&gt; locations, List&lt;RouteStop&gt; routeStops, EVTruckOptions evTruckOptions, CalculateRouteCallback callback);</code></pre>
