...
slug: "sdk-for-ios-navigate-agency"
---
...
<html lang="en">
  <head>
    <title>Agency Structure Reference</title>
  ...
  <body>
    ...
    <a title="Agency Structure Reference"></a>
    <header>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk6AgencyV4nameSSvp"></a>
                    <a name="//apple_ref/swift/Property/name" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk6AgencyV4nameSSvp">name</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>Human readable name of the owner of the transport service.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk6AgencyV7websiteSSSgvp"></a>
                    <a name="//apple_ref/swift/Property/website" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk6AgencyV7websiteSSSgvp">website</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Link to the agency&rsquo;s website.</p>
