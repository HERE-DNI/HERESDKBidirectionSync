...
<div class="inheritance">com.here.sdk.navigation.RoadSignWarningOptions</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public final class </span><span class="element-name type-name-label">RoadSignWarningOptions</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block"><p>A class that provides road sign warning options. Set the options for filtering of road sign notifications.</p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#categoriesFilter">categoriesFilter</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#generalWarningTypesFilter">generalWarningTypesFilter</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#typesFilter">typesFilter</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#vehicleTypesFilter">vehicleTypesFilter</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#%3Cinit%3E()">RoadSignWarningOptions</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>The list of road sign vehicle types for which a warning will be given. If the list is empty,
 ...
 </p><p><strong>Example:</strong> For a filter that contains only bus and trucks you will only receive specific road sign warnings for
 ...
 like cars, then the only option is to set an empty list as filter.</p></div>
</section>
</li>
</ul>
</section>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">RoadSignWarningOptions</span>()</div>
