...
java.lang.Object → com.here.sdk.search.PlaceChain
...
</span><span class="element-name type-name-label">PlaceChain</span>
...
- <div id="sdk-for-android-explore-field-summary"
  ...
  <a href="sdk-for-android-explore-com-here-sdk-search-placechain#id" class="member-name-link"><code>id</code></a>
...
- <div id="sdk-for-android-explore-field-detail"
  ...
  - <div id="sdk-for-android-explore-id" class="section detail">
    ...
    Identifier number for an associated chain. For example, the chain ID
    "8778" corresponds to the chain name "ABC Shop". The complete list
    of supported chain IDs can be found here .
...
- <div id="sdk-for-android-explore-constructor-detail"
  ...
  - <div id="sdk-for-android-explore-<init>(java.lang.String)"
    ...
    <span class="modifiers">public</span> <span class="element-name">PlaceChain</span><span class="parameters">(@NonNull
    ...
    Identifier number for an associated chain. For example, the chain ID
    "8778" corresponds to the chain name "ABC Shop". The complete list
    of supported chain IDs can be found
    [here](https://www.here.com/docs/bundle/geocoding-and-search-api-developer-guide/page/topics-places/places-chain-system-full.html).
