...
slug: "sdk-for-ios-navigate-geocoordinates"
---
...
<html lang="en">
  <head>
    <title>GeoCoordinates Structure Reference</title>
...
This method ignores altitude of both points.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/interpolate(toward:by:)" class="dashAnchor"></a>
...
the altitude, then the altitude is interpolated as well; <code>nil</code> otherwise.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/fromString(input:)" class="dashAnchor"></a>
...
If the latitude value is out of range of [-90.0, 90.0] it&rsquo;s clamped to that range.
If the longitude value is out of range of [-180.0, 180.0] it&rsquo;s replaced with a value
within the range, representing effectively the same meridian.
...
<code>40°26′47″N 79°58′36″W</code></p>
                      ...
                      <div>
                        <h4>Return Value</h4>
                        <p>Created GeoCoordinates, or &lsquo;null&rsquo; if string was not in appropriate format.</p>
                      </div>
                    </section>
                  </div>
                </li>
