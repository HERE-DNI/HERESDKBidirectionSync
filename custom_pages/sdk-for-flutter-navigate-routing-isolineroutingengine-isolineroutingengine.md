...
<div>
<h1>IsolineRoutingEngine constructor</h1></div>
<section class="multi-line-signature">
IsolineRoutingEngine(<wbr/>)
    </section>
...
<pre class="language-dart"><code class="language-dart">factory IsolineRoutingEngine() =&gt; $prototype.$init();</code></pre>
</section>
</div> 
