...
java.lang.Object →
java.lang.Enum<FuelAdditiveType>com.here.sdk.transport.FuelAdditiveType
→ java.lang.Enum → FuelAdditiveType →
com.here.sdk.transport.FuelAdditiveType
...
class="external-link"
title="class or interface in java.lang"><code>Comparable</code></a>`<`[`FuelAdditiveType`](sdk-for-android-explore-com-here-sdk-transport-fueladditivetype "enum class in com.here.sdk.transport")`>`,
<a
...
</span><span class="element-name type-name-label">FuelAdditiveType</span>
<span class="extends-implements">extends <a
href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html"
class="external-link" title="class or interface in java.lang">Enum</a><[FuelAdditiveType](sdk-for-android-explore-com-here-sdk-transport-fueladditivetype "enum class in com.here.sdk.transport")></span>

</div>

<div class="block">

Defines possible fuel additives that a fuel could contain. Note: This is
...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-transport-fueladditivetype#AUS32"
  class="member-name-link"><code>AUS32</code></a></td>
  <td><div class="block">
  A fuel additive.
  </div></td>
  </tr>
...
- <div id="method-summary" class="section method-summary">
  ...
  title="enum class in com.here.sdk.transport"><code>FuelAdditiveType</code></a></td>
  ...
  <td><code>static </code><a
  href="sdk-for-android-explore-com-here-sdk-transport-fueladditivetype"
  title="enum class in com.here.sdk.transport"><code>FuelAdditiveType</code></a><code>[]</code></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="AUS32" class="section detail">
    ...
    final</span> <span class="return-type">[FuelAdditiveType](sdk-for-android-explore-com-here-sdk-transport-fueladditivetype "enum class in com.here.sdk.transport")</span> <span class="element-name">AUS32</span>

    </div>

    <div class="block">

    A fuel additive. AUS 32 (aqueous urea solution) is used as an
    additive to the fuel in diesel vehicles with SCR (Selective
    Catalytic Reduction) technology to reduce the NOx emission. AU 32 is
    also known as ARLA 32 or HWL.
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[FuelAdditiveType](sdk-for-android-explore-com-here-sdk-transport-fueladditivetype "enum class in com.here.sdk.transport")\[\]</span> <span class="element-name">values</span>()
  ...
  - <div id="valueOf(java.lang.String)" class="section detail">
    ...
    <span class="modifiers">public
    static</span> <span class="return-type">[FuelAdditiveType](sdk-for-android-explore-com-here-sdk-transport-fueladditivetype "enum class in com.here.sdk.transport")</span> <span class="element-name">valueOf</span><span class="parameters">(<a
