...
void
add(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-mapview-datasource-polygondata-class polygon</li>
</ol>)
...
<ul>
<li><code>polygon</code> Polygon to add.</li>
</ul>
</section>
