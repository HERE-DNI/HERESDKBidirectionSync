...
<div class="block"><p>Listener that gets notified when MapView is fully initialized and ready to handle all
 ...
 the <code>Activity</code> resumes, <a href="sdk-for-android-explore-index#onMapViewReady()"><code>onMapViewReady()</code></a> should be used for this purpose,
...
<li><a href="sdk-for-android-explore-mapview#setOnReadyListener(com.here.sdk.mapview.MapView.OnReadyListener)"><code>MapView.setOnReadyListener(OnReadyListener)</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="sdk-for-android-explore-index#onMapViewReady()">onMapViewReady</a>()</code></div>
