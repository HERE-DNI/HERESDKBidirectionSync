...
<div class="block"><p>Listener that gets notified when MapView is fully initialized and ready to handle all
 ...
 the <code>Activity</code> resumes, <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-index#onMapViewReady()"><code>onMapViewReady()</code></a> should be used for this purpose,
...
<li>After map is shown for the very first time
             - use <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-mapscene.loadscenecallback" title="interface in com.here.sdk.mapview"><code>MapScene.LoadSceneCallback</code></a> that is passed to
             <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-mapscene#loadScene(com.here.sdk.mapview.MapScheme,com.here.sdk.mapview.MapScene.LoadSceneCallback)"><code>MapScene.loadScene(MapScheme, MapScene.LoadSceneCallback)</code></a>.</li>
<li>After the Activity is resumed
             - use <code>OnReadyListener</code> that is registered from within
             <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-mapscene.loadscenecallback" title="interface in com.here.sdk.mapview"><code>MapScene.LoadSceneCallback</code></a> the first time map scene is loaded.</li>
...
<li><a href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-mapview#setOnReadyListener(com.here.sdk.mapview.MapView.OnReadyListener)"><code>MapView.setOnReadyListener(OnReadyListener)</code></a></li>
</ul>
</dd>
</dl>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-explore-index#onMapViewReady()">onMapViewReady</a>()</code></div>
