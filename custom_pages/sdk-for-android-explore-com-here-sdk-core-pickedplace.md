...
java.lang.Object → com.here.sdk.core.PickedPlace
...
</span><span class="element-name type-name-label">PickedPlace</span>
...
<div id="sdk-for-android-explore-name" class="section detail">
    ...
    The name of the POI localized in the currently selected map
    language.
...
<div id="sdk-for-android-explore-placeCategoryId"
    ...
    <span class="annotations">@NonNull
    </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a></span> <span class="element-name">placeCategoryId</span>
    ...
    PlaceCategory.id that can be obtained from the SearchEngine and the
    OfflineSearchEngine . Note that not all editions include the
    OfflineSearchEngine .
...
<div id="sdk-for-android-explore-<init>(java.lang.String,com.here.sdk.core.GeoCoordinates,java.lang.String)"
    ...
    <span class="modifiers">public</span> <span class="element-name">PickedPlace</span><span class="parameters">(@NonNull
    ...
    @NonNull <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a> placeCategoryId)</span>
    ...
    The place category ID of the POI. This is the same String value as
    `PlaceCategory.id` that can be obtained from the `SearchEngine` and
    the `OfflineSearchEngine`. Note that not all editions include the
    `OfflineSearchEngine`.
