...
Future&lt;<wbr/>void&gt;
makeSharedInstance(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-core-engine-sdkoptions-class options</li>
</ol>)
...
see /sdk-for-flutter-navigate-core-engine-sdknativeengine-sharedinstance.</p>
<p>If there was previously shared instance
then it's disposed (see /sdk-for-flutter-navigate-core-engine-sdknativeengine-dispose)
