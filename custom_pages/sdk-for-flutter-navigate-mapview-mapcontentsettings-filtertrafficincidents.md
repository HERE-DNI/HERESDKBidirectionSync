...
void
filterTrafficIncidents(<wbr/><ol class="parameter-list single-line"> <li>List&lt;<wbr/>/sdk-for-flutter-navigate-traffic-trafficincidenttype&gt; trafficIncidents</li>
</ol>)
...
<p>The display of traffic incidents can be enabled using /sdk-for-flutter-navigate-mapview-mapscene-enablefeatures with
...
If the <code>MapContentSettings.filterTrafficIncidents.trafficIncidents</code> contains /sdk-for-flutter-navigate-traffic-trafficincidenttype, then the
