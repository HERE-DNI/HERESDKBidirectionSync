                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div>
                        <h4>Return Value</h4>
                        <p>The <code><a href="sdk-for-ios-explore-carbuilder">TransportSpecification.CarBuilder</a></code> object with the vehicle specification set to the new value.</p>
                      </div>
                    </section>
                  </div>
                </li>
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Builds the <code><a href="sdk-for-ios-explore-transportspecification">TransportSpecification</a></code> object for a truck with the specifications taken
from the <code>TransportSpecification.TruckBuilder</code> object.</p>
                      ...
                      <div>
                        <h4>Return Value</h4>
                        <p>The <code><a href="sdk-for-ios-explore-transportspecification">TransportSpecification</a></code> object created from the <code>TransportSpecification.TruckBuilder</code> object.</p>
                      </div>
                    </section>
                  </div>
                </li>
