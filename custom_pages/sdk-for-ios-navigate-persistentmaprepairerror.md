...
slug: "sdk-for-ios-navigate-persistentmaprepairerror"
---
...
<html lang="en">
  <head>
    <title>PersistentMapRepairError Enumeration Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/partiallyRestored" class="dashAnchor"></a>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Invalid persistent map path. The provided path to store the persistent map data doesn&rsquo;t own the required Read/Write (RW) permissions.
Try to choose a different path with RW permissions.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/brokenDb" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>The persisted map data can&rsquo;t be recovered and all map data was fully deleted. It is recommended, to ask
the user if they want to try to download the lost regions again.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/noOfflineVersion" class="dashAnchor"></a>
...
After this it is recommended to try to repair the corrupted map data again.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Element/noJournal" class="dashAnchor"></a>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Repair is invoked on object connected to the disposed <code><a href="sdk-for-ios-explore-sdknativeengine">SDKNativeEngine</a></code></p>
