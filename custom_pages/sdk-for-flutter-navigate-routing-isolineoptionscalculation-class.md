...
<p>Setting at least one limit to /sdk-for-flutter-navigate-routing-isolineoptionscalculation-rangevalues is mandatory or the calculation will fail.</p>
</section>
<section class="summary offset-anchor" id="constructors">
<h2>Constructors</h2>
<dl class="constructor-summary-list">
<dt class="callable" id="IsolineOptionsCalculation.withDefaults">
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolineoptionscalculation-withdefaults(/sdk-for-flutter-navigate-routing-isolinerangetype rangeType, List&lt;<wbr/>int&gt; rangeValues)
</dt>
<dd>
<li>
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolineoptionscalculation-withdefaultsandcalculationmode(/sdk-for-flutter-navigate-routing-isolinerangetype rangeType, List&lt;<wbr/>int&gt; rangeValues, /sdk-for-flutter-navigate-routing-isolinecalculationmode isolineCalculationMode)
</dt>
<dd>
<li>
<p><code>rangeType</code> The range type.</p>
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolineoptionscalculation-withdefaultsanddirection(/sdk-for-flutter-navigate-routing-isolinerangetype rangeType, List&lt;<wbr/>int&gt; rangeValues, /sdk-for-flutter-navigate-routing-routeplacedirection isolineDirection)
</dt>
<dd>
<li>
<p><code>rangeType</code> The range type.</p>
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolineoptionscalculation-withnodefaults(/sdk-for-flutter-navigate-routing-isolinerangetype rangeType, List&lt;<wbr/>int&gt; rangeValues, /sdk-for-flutter-navigate-routing-isolinecalculationmode isolineCalculationMode, int? maxPoints, /sdk-for-flutter-navigate-routing-routeplacedirection isolineDirection)
</dt>
<dd>
<li>
<p><code>rangeType</code> The range type.</p>
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolinecalculationmode
↔ /sdk-for-flutter-navigate-routing-isolinecalculationmode
</dt>
<dd>
  Specifies how isoline calculation is optimized.
The default waypoint type is /sdk-for-flutter-navigate-routing-isolinecalculationmode.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="isolineDirection">
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-isolinedirection
↔ /sdk-for-flutter-navigate-routing-routeplacedirection
</dt>
<dd>
  Specifies if calculations will be from or to a specific point.
The default isoline direction is /sdk-for-flutter-navigate-routing-routeplacedirection.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="maxPoints">
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-maxpoints
↔ int?
</dt>
<dd>
...
but the shape of the polygon. Look at /sdk-for-flutter-navigate-routing-isolinecalculationmode parameter
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-rangetype
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-rangevalues
↔ List&lt;<wbr/>int&gt;
</dt>
<dd>
...
For each value an /sdk-for-flutter-navigate-routing-isoline-class is calculated indicating the reachable area.
If empty, /sdk-for-flutter-navigate-routing-isolineoptions-class object is considered invalid.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property inherited" id="runtimeType">
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-isolineoptionscalculation-operator-equals(<wbr/>Object other)
    → bool
