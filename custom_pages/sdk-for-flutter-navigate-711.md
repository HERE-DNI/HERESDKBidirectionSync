...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.electronichorizon/ElectronicHorizonDataLoader///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="sdk-for-flutter-explore-index">API Reference</a><span class="delimiter">/</span><a href="sdk-for-flutter-explore-index">com.here.sdk.electronichorizon</a><span class="delimiter">/</span><span class="current">ElectronicHorizonDataLoader</span></div>
  <div class="cover ">
          ...
          <div class="table-row" data-togglable="CONSTRUCTOR" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-electronic-horizon-data-loader"><span>Electronic</span><wbr></wbr><span>Horizon</span><wbr></wbr><span>Data</span><wbr></wbr><span><span>Loader</span></span></a></div>
      ...
      <div data-togglable="FUNCTION">
        ...
        <div class="table"><a data-name="-1370781946%2FFunctions%2F1617540583" anchor-label="addElectronicHorizonDataLoaderStatusListener" id="-1370781946%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-add-electronic-horizon-data-loader-status-listener"><span>add</span><wbr></wbr><span>Electronic</span><wbr></wbr><span>Horizon</span><wbr></wbr><span>Data</span><wbr></wbr><span>Loader</span><wbr></wbr><span>Status</span><wbr></wbr><span><span>Listener</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1370781946%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-add-electronic-horizon-data-loader-status-listener"><span class="token function">addElectronicHorizonDataLoaderStatusListener</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">electronicHorizonListener<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">ElectronicHorizonDataLoaderStatusListener</a></span></span><span class="token punctuation">)</span></div><div class="brief "><p class="paragraph">Adds an <a href="sdk-for-flutter-explore-index">com.here.sdk.electronichorizon.ElectronicHorizonDataLoaderStatusListener</a> to the subscription list.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="959888160%2FFunctions%2F1617540583" anchor-label="getSegment" id="959888160%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-get-segment"><span>get</span><wbr></wbr><span><span>Segment</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="959888160%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-get-segment"><span class="token function">getSegment</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">segmentId<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">DirectedOCMSegmentId</a></span></span><span class="token punctuation">)</span><span class="token operator">: </span><a href="sdk-for-flutter-explore-index">ElectronicHorizonDataLoaderResult</a></div><div class="brief "><p class="paragraph">Returns loaded data for the given segment identifier. The result contains either the loaded data or an error code.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="1650172729%2FFunctions%2F1617540583" anchor-label="removeElectronicHorizonDataLoaderStatusListener" id="1650172729%2FFunctions%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="sdk-for-flutter-explore-remove-electronic-horizon-data-loader-status-listener"><span>remove</span><wbr></wbr><span>Electronic</span><wbr></wbr><span>Horizon</span><wbr></wbr><span>Data</span><wbr></wbr><span>Loader</span><wbr></wbr><span>Status</span><wbr></wbr><span><span>Listener</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1650172729%2FFunctions%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">external </span><span class="token keyword">fun </span><a href="sdk-for-flutter-explore-remove-electronic-horizon-data-loader-status-listener"><span class="token function">removeElectronicHorizonDataLoaderStatusListener</span></a><span class="token punctuation">(</span><span class="parameters "><span class="parameter ">electronicHorizonListener<span class="token operator">: </span><a href="sdk-for-flutter-explore-index">ElectronicHorizonDataLoaderStatusListener</a></span></span><span class="token punctuation">)</span></div><div class="brief "><p class="paragraph">Removes an <a href="sdk-for-flutter-explore-index">com.here.sdk.electronichorizon.ElectronicHorizonDataLoaderStatusListener</a> from the subscription list.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
