...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#allowDownload">allowDownload</a></code></div>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#cacheExpirationPeriod">cacheExpirationPeriod</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#catalog">catalog</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#patchHrn">patchHrn</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#%3Cinit%3E(com.here.sdk.core.engine.DesiredCatalog)">CatalogConfiguration</a><wbr/>(<a href="sdk-for-android-navigate-desiredcatalog" title="class in com.here.sdk.core.engine">DesiredCatalog</a> catalog)</code></div>
<div class="col-last even-row-color">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab1 method-summary-table-tab4"><code><a class="member-name-link" href="sdk-for-android-navigate-index#getDefault(com.here.sdk.core.engine.CatalogType)">getDefault</a><wbr/>(<a href="sdk-for-android-navigate-catalogtype" title="enum class in com.here.sdk.core.engine">CatalogType</a> catalogType)</code></div>
...
<div class="block"><p>Some catalogs may have additional modifications to their data
 ...
 <a href="sdk-for-android-navigate-index#catalog"><code>catalog</code></a> is merged with data from the patch catalog.
...
<div class="block"><p>A flag to indicate if the data for this catalog is allowed to be stored in persistent storage for use with offline maps.
 ...
 If set to false, the data is not stored in persistent storage and is only retained in the cache for a limited time (see <a href="sdk-for-android-navigate-index#cacheExpirationPeriod"><code>cacheExpirationPeriod</code></a>).
