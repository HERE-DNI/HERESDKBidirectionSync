...
- <div>
  ...
  ` `<span id="/s:7heresdk24LocationSimulatorOptionsV11speedFactorSdvp"></span>` `<span id="//apple_ref/swift/Property/speedFactor" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-structs-locationsimulatoroptions#/s:7heresdk24LocationSimulatorOptionsV11speedFactorSdvp" class="token"><code>speedFactor</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk24LocationSimulatorOptionsV20notificationIntervalSdvp"></span>` `<span id="//apple_ref/swift/Property/notificationInterval" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-structs-locationsimulatoroptions#/s:7heresdk24LocationSimulatorOptionsV20notificationIntervalSdvp" class="token"><code>notificationInterval</code></a>` `
