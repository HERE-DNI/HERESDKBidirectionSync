...
<div className="inheritance">com.here.sdk.routing.TollOptions.VehicleCategory</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public static enum </span><span className="element-name type-name-label">TollOptions.VehicleCategory</span>
...
<div className="block"><p>Supported options of vehicle category for toll calculation.</p></div>
</section>
...
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-tolloptions-vehiclecategory#MINIBUS">MINIBUS</a></code></div>
<div className="col-last even-row-color">
<div className="block">Commercial buses with a seating capacity of 16-25 passengers
...
<li>
<section className="detail" id="MINIBUS">
<h3>MINIBUS</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-tolloptions-vehiclecategory" title="enum class in com.here.sdk.routing">TollOptions.VehicleCategory</a></span> <span className="element-name">MINIBUS</span></div>
<div className="block"><p>Commercial buses with a seating capacity of 16-25 passengers
...
<h3>valueOf</h3>
<div className="member-signature"><span className="modifiers">public static</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-tolloptions-vehiclecategory" title="enum class in com.here.sdk.routing">TollOptions.VehicleCategory</a></span> <span className="element-name">valueOf</span><wbr/><span className="parameters">(<a className="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" title="class or interface in java.lang">String</a> name)</span></div>
