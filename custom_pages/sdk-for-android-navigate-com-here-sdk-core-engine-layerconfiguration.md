...
- <div id="sdk-for-android-navigate-nested-class-summary" class="section nested-class-summary">
  ...
  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" class="type-name-link" title="enum class in com.here.sdk.core.engine"><code>LayerConfiguration.Feature</code></a>
...
- <div id="sdk-for-android-navigate-field-summary" class="section field-summary">
  ...
  <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" class="external-link" title="class or interface in java.util"><code>List</code></a>`<`<a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" title="enum class in com.here.sdk.core.engine">`LayerConfiguration.Feature`</a>`>`

  </div>

  <div class="col-second even-row-color">

  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration#enabledFeatures" class="member-name-link"><code>enabledFeatures</code></a>
  ...
  <a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration#implicitlyPrefetchedFeatures" class="member-name-link"><code>implicitlyPrefetchedFeatures</code></a>
...
- <div id="sdk-for-android-navigate-field-detail" class="section field-details">
  ...
  - <div id="sdk-for-android-navigate-enabledFeatures" class="section detail">
  ...
  - <div id="sdk-for-android-navigate-implicitlyPrefetchedFeatures" class="section detail">

    ### implicitlyPrefetchedFeatures

    <div class="member-signature">

    <span class="annotations">@NonNull </span><span class="modifiers">public</span> <span class="return-type"><a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" class="external-link" title="class or interface in java.util">List</a>\<<a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" title="enum class in com.here.sdk.core.engine">LayerConfiguration.Feature</a>\></span> <span class="element-name">implicitlyPrefetchedFeatures</span>
...
- <div id="sdk-for-android-navigate-constructor-detail" class="section constructor-details">
  ...
  - <div id="sdk-for-android-navigate-init-java-util-List" class="section detail">
    ...
    <span class="modifiers">public</span> <span class="element-name">LayerConfiguration</span><wbr></wbr><span class="parameters">(@NonNull <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" class="external-link" title="class or interface in java.util">List</a>\<<a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" title="enum class in com.here.sdk.core.engine">LayerConfiguration.Feature</a>\> enabledFeatures)</span>
  ...
  - <div id="sdk-for-android-navigate-init-java-util-List-java-util-List" class="section detail">
    ...
    <span class="modifiers">public</span> <span class="element-name">LayerConfiguration</span><wbr></wbr><span class="parameters">(@NonNull <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" class="external-link" title="class or interface in java.util">List</a>\<<a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" title="enum class in com.here.sdk.core.engine">LayerConfiguration.Feature</a>\> enabledFeatures, @NonNull <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" class="external-link" title="class or interface in java.util">List</a>\<<a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature" title="enum class in com.here.sdk.core.engine">LayerConfiguration.Feature</a>\> implicitlyPrefetchedFeatures)</span>
    ...
    - <a href="sdk-for-android-navigate-com-here-sdk-core-engine-layerconfiguration-feature#NAVIGATION">`LayerConfiguration.Feature.NAVIGATION`</a>
