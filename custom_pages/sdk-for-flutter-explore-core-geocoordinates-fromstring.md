...
<span class="returntype"><a href="sdk-for-flutter-explore-core-geocoordinates-class">GeoCoordinates</a>?</span> <span class="name">fromString</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-explore-fromString-param-input" class="parameter"><span class="type-annotation">String</span> <span class="parameter-name">input</span></span>
...
Returns <a href="sdk-for-flutter-explore-core-geocoordinates-class">GeoCoordinates?</a>. Created GeoCoordinates, or 'null' if string was not in appropriate format.
