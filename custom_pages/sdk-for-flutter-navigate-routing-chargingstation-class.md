...
/sdk-for-flutter-navigate-routing-chargingstation-chargingstation(String? id, String? name, /sdk-for-flutter-navigate-routing-chargingconnectorattributes-class? connectorAttributes)
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="ChargingStation.withDetails">
/sdk-for-flutter-navigate-routing-chargingstation-chargingstation-withdetails(String? id, String? name, /sdk-for-flutter-navigate-routing-chargingconnectorattributes-class? connectorAttributes, /sdk-for-flutter-navigate-core-nameid-class? brand, /sdk-for-flutter-navigate-core-nameid-class? chargePointOperator, List&lt;<wbr/>/sdk-for-flutter-navigate-core-nameid-class&gt; matchingEMobilityServiceProviders)
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-routing-chargingstation-brand
↔ /sdk-for-flutter-navigate-core-nameid-class?
</dt>
<dd>
  Charging station brand.
/sdk-for-flutter-navigate-core-nameid-name reflect to charging station brand name.
/sdk-for-flutter-navigate-core-nameid-id reflect to charging station brand unique ID.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="chargePointOperator">
/sdk-for-flutter-navigate-routing-chargingstation-chargepointoperator
↔ /sdk-for-flutter-navigate-core-nameid-class?
</dt>
<dd>
  Charging station charge-point-operator.
/sdk-for-flutter-navigate-core-nameid-name reflect to charge-point-operator name.
/sdk-for-flutter-navigate-core-nameid-id reflect to charge-point-operator ID.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="connectorAttributes">
/sdk-for-flutter-navigate-routing-chargingstation-connectorattributes
...
/sdk-for-flutter-navigate-routing-chargingstation-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-chargingstation-id
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-chargingstation-matchingemobilityserviceproviders
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-core-nameid-class&gt;
</dt>
<dd>
  List of matched E-Mobility Service Providers.
Populated only when /sdk-for-flutter-navigate-routing-electricvehicleoptions-evmobilityserviceproviderpreferences was set.
This list reflects the subset of E-Mobility Service Providers supported by the charging station,
from the list specified in the request parameter /sdk-for-flutter-navigate-routing-electricvehicleoptions-evmobilityserviceproviderpreferences.
/sdk-for-flutter-navigate-core-nameid-name in each list item reflect to E-Mobility Service Provider name.
/sdk-for-flutter-navigate-core-nameid-id in each list item reflect to E-Mobility Service Provider id.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="name">
/sdk-for-flutter-navigate-routing-chargingstation-name
↔ String?
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-chargingstation-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-chargingstation-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-chargingstation-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-chargingstation-operator-equals(<wbr/>Object other)
    → bool
