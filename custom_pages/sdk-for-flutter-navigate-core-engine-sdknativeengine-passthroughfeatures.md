...
By default, reporting of HERE SDK /sdk-for-flutter-navigate-core-engine-usagestats-class will be enabled when at least one pass-through feature is set.</p>
...
<section class="multi-line-signature">
void
passThroughFeatures=(<wbr/>Set&lt;<wbr/>/sdk-for-flutter-navigate-core-engine-passthroughfeature&gt;? value)
</section>
<section class="desc markdown">
<p>The pass through features.
Sets pass through features which are allowed to use online data when HERE SDK is in offline mode.
