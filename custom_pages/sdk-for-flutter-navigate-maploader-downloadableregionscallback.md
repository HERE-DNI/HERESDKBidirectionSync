...
<li class="self-crumb">DownloadableRegionsCallback typedef</li>
</ol>
<div class="self-name">DownloadableRegionsCallback</div>
...
<p>A method which is called on the main thread when /sdk-for-flutter-navigate-maploader-mapdownloader-getdownloadableregionswithlanguagecode has been completed.</p>
