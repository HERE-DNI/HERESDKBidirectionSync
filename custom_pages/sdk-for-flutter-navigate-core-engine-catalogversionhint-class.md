...
desired catalog version to use in /sdk-for-flutter-navigate-core-engine-desiredcatalog-class class.</p>
<p>You can request a specific or latest version of a catalog by calling the
static functions /sdk-for-flutter-navigate-core-engine-catalogversionhint-specific and
/sdk-for-flutter-navigate-core-engine-catalogversionhint-latestwithignoringcacheddata respectively. The HERE platform will make the
best effort to provide an appropriate version for the catalog based on this
version hint.
Please take note that for the API /sdk-for-flutter-navigate-core-engine-catalogversionhint-specific to function properly,
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-catalogversionhint()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-operator-equals(<wbr/>Object other)
    → bool
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-latestwithignoringcacheddata(<wbr/>bool ignoreCachedData)
...
/sdk-for-flutter-navigate-core-engine-catalogversionhint-specific(<wbr/>int version)
    → /sdk-for-flutter-navigate-core-engine-catalogversionhint-class
