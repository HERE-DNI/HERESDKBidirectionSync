---
title: "operator == method - NetworkSettings class - core.engine library - Dart API"
slug: "sdk-for-flutter-navigate-core-engine-networksettings-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-navigate-core-engine-networksettings-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return proxySettings == _other.proxySettings &&
      ...
      diagnosticsOutputPath == _other.diagnosticsOutputPath;
}
```
