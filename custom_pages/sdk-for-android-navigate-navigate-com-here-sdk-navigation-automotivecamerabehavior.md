...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-navigation-automotivecamerabehavior"
---
...
<div class="block"><p>Configures the Area camera to frame the specified points.
 ...
 </p><p>This function does not change <a href="#getActiveCameraType()"><code>getActiveCameraType()</code></a>. To display the configured
 ...
 configured via <a href="#setAreaCameraBehaviorGeobox(com.here.sdk.core.GeoBox)"><code>setAreaCameraBehaviorGeobox(com.here.sdk.core.GeoBox)</code></a>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
...
<div class="block"><p>Configures the Area camera to frame the specified geographic bounding box.
 ...
 via <a href="#setAreaCameraBehaviorVisiblePoints(java.util.List,boolean)"><code>setAreaCameraBehaviorVisiblePoints(java.util.List&lt;com.here.sdk.core.GeoCoordinates&gt;, boolean)</code></a>.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
