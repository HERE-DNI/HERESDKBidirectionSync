...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-navigation-truckrestrictionwarning"
---
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#dimensionRestriction">dimensionRestriction</a></code></div>
...
<div class="col-first even-row-color"><code><a href="sdk-for-android-navigate-..-core-timerule" title="class in com.here.sdk.core">TimeRule</a></code></div>
...
<div class="col-first even-row-color"><code><a href="sdk-for-android-navigate-..-transport-truckroadtype" title="enum class in com.here.sdk.transport">TruckRoadType</a></code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#truckRoadType">truckRoadType</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#weightRestriction">weightRestriction</a></code></div>
<div class="col-last even-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(double,com.here.sdk.navigation.DistanceType)">TruckRestrictionWarning</a><wbr/>(double distanceInMeters,
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>boolean</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="#isGeneral()">isGeneral</a>()</code></div>
...
<div class="block"><p>Indicates if the specified truck restriction is ahead of the vehicle or has just passed by. If it is ahead, then <a href="#distanceInMeters"><code>distanceInMeters</code></a> is greater than 0.</p></div>
</section>
</li>
<li>
...
<h3>truckRoadType</h3>
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-navigate-..-transport-truckroadtype" title="enum class in com.here.sdk.transport">TruckRoadType</a></span> <span class="element-name">truckRoadType</span></div>
...
<div class="member-signature"><span class="annotations">@Nullable
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-navigate-..-transport-tunnelcategory" title="enum class in com.here.sdk.transport">TunnelCategory</a></span> <span class="element-name">tunnelCategory</span></div>
...
<dd><code>distanceType</code> - <p>Indicates if the specified truck restriction is ahead of the vehicle or has just passed by. If it is ahead, then <a href="#distanceInMeters"><code>distanceInMeters</code></a> is greater than 0.</p></dd>
</dl>
</section>
</li>
</ul>
