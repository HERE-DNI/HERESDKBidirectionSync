...
<li class="self-crumb">PrefetchStatusListener factory constructor</li>
</ol>
...
PrefetchStatusListener(<wbr/><ol class="parameter-list single-line"> <li>void onProgressLambda(<ol class="parameter-list single-line"> <li>int</li>
</ol>), </li>
