...
/sdk-for-flutter-navigate-mapview-mapidlelistener-mapidlelistener(void onMapBusyLambda(), void onMapIdleLambda())
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-onmapbusy(<wbr/>)
    → void
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-onmapidle(<wbr/>)
    → void
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mapidlelistener-operator-equals(<wbr/>Object other)
    → bool
