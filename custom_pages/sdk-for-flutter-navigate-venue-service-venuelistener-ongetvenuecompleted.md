...
void
onGetVenueCompleted(<wbr/><ol class="parameter-list"> <li>int venueId, </li>
...
<ul>
<li>
<p><code>venueId</code> The id of the venue.</p>
</li>
<li>
...
<pre class="language-dart"><code class="language-dart">void onGetVenueCompleted(int venueId, VenueModel? venueModel, bool online, VenueStyle? venueStyle);</code></pre>
</section>
</div> 
