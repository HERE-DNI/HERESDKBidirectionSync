...
<li class="self-crumb">closestInRange method</li>
</ol>
<div class="self-name">closestInRange</div>
...
double
closestInRange(<wbr/><ol class="parameter-list single-line"> <li>double angleClockwiseInDegreesFromNorth</li>
</ol>)
