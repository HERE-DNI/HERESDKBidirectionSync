...
calculateTrafficOnRoute(<wbr/><ol class="parameter-list"> <li>/sdk-for-flutter-navigate-routing-route-class route, </li>
...
/sdk-for-flutter-navigate-routing-routehandle-class and the original route calculation options will be used to
