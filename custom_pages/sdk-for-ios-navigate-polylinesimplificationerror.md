...
slug: "sdk-for-ios-navigate-polylinesimplificationerror"
---
...
<html lang="en">
  <head>
    <title>PolylineSimplificationError Enumeration Reference</title>
  ...
  <body>
    ...
    <a title="PolylineSimplificationError Enumeration Reference"></a>
    <header>
      ...
      <article class="main-content">
        <section>
          <section class="section">
            <h1>PolylineSimplificationError</h1>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk27PolylineSimplificationErrorO9cancelledyA2CmF"></a>
                    <a name="//apple_ref/swift/Element/cancelled" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk27PolylineSimplificationErrorO9cancelledyA2CmF">cancelled</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>The task has been cancelled. For example, when an
ongoing task has been cancelled by the user
invoking <code>cancel(...)</code>.</p>
