...
<div className="inheritance">com.here.sdk.search.WebDetails</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">WebDetails</span>
<span className="extends-implements">extends <a className="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div className="block"><p>Contains information about images, editorials, rating and a urls to them.</p></div>
</section>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-search-webdetails#editorials">editorials</a></code></div>
...
<div className="col-second odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-search-webdetails#images">images</a></code></div>
...
<div className="col-second even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-search-webdetails#ratings">ratings</a></code></div>
<div className="col-last even-row-color">
...
<div className="col-constructor-name even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-search-webdetails#%3Cinit%3E()">WebDetails</a>()</code></div>
<div className="col-last even-row-color">
...
<h3>WebDetails</h3>
<div className="member-signature"><span className="modifiers">public</span> <span className="element-name">WebDetails</span>()</div>
