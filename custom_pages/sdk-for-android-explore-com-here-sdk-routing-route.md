...
java.lang.Object → com.here.NativeBasecom.here.sdk.routing.Route →
com.here.NativeBase → com.here.sdk.routing.Route
...
</span><span class="element-name type-name-label">Route</span>
...
that describe potential issues after the route was calculated. If the
list is non-empty, it is recommended to evaluate possible violations
against the requested route options and reject the route if deemed
necessary.
...
- <div id="method-summary" class="section method-summary">
  ...
  href="sdk-for-android-explore-com-here-sdk-routing-route"
  title="class in com.here.sdk.routing"><code>Route</code></a></td>
  <td><pre><code>deserialize(byte[] routeData)</code></pre></td>
  <td><div class="block">
  ...
  <td><div class="block">
  Gets the estimated time in seconds needed to travel along this route,
  ...
  <td><pre><code>getLanguage()</code></pre></td>
  <td><div class="block">
  Gets the language requested for all textual information related to this
  route.
  </div></td>
  </tr>
  <tr>
  ...
  <td><pre><code>getOptimizationMode()</code></pre></td>
  <td><div class="block">
  ...
  title="class in com.here.sdk.routing"><code>RouteRailwayCrossing</code></a><code>&gt;</code></td>
  <td><pre><code>getRailwayCrossings()</code></pre></td>
  <td><div class="block">
  ...
  <td><pre><code>getRequestedTransportMode()</code></pre></td>
  <td><div class="block">
  ...
  <td><pre><code>getRouteHandle()</code></pre></td>
  <td><div class="block">
  ...
  class="external-link"
  title="class or interface in java.util"><code>List</code></a><code>&lt;</code><a
  href="sdk-for-android-explore-com-here-sdk-routing-routelabel"
  title="class in com.here.sdk.routing"><code>RouteLabel</code></a><code>&gt;</code></td>
  <td><pre><code>getRouteLabels()</code></pre></td>
  <td><div class="block">
  Gets route labels.
  </div></td>
  </tr>
  ...
  <td><pre><code>getRoutingOptions()</code></pre></td>
  <td><div class="block">
  ...
  class="external-link"
  title="class or interface in java.util"><code>List</code></a><code>&lt;</code><a
  href="sdk-for-android-explore-com-here-sdk-routing-section"
  title="class in com.here.sdk.routing"><code>Section</code></a><code>&gt;</code></td>
  <td><pre><code>getSections()</code></pre></td>
  <td><div class="block">
  ...
  <tr>
  <td><code>static byte[]</code></td>
  <td><pre><code>serialize(Route route)</code></pre></td>
  <td><div class="block">
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="serialize(com.here.sdk.routing.Route)"
    ...
    static</span> <span class="return-type">byte\[\]</span> <span class="element-name">serialize</span><span class="parameters">(@NonNull
    [Route](sdk-for-android-explore-com-here-sdk-routing-route "class in com.here.sdk.routing") route)</span>

    </div>

    <div class="block">

    Serializes given route to a binary data. Note: This is a beta
  ...
  - <div id="deserialize(byte[])" class="section detail">
    ...
    static</span> <span class="return-type">[Route](sdk-for-android-explore-com-here-sdk-routing-route "class in com.here.sdk.routing")</span> <span class="element-name">deserialize</span><span class="parameters">(@NonNull
    byte\[\] routeData)</span>
    ...
    Creates route from the given binary data. Note: This is a beta
    release of this feature, so there could be a few bugs and unexpected
    behaviors. Related APIs may change for new releases without a
    deprecation process.
  ...
  - <div id="getSections()" class="section detail">
  ...
  - <div id="getGeometry()" class="section detail">
    ...
    Gets the GeoPolyline object representing the polyline of this route.
    It may not contain the original coordinates specified in the request
    for a route.
    ...
    object representing the polyline of this route. It may not contain
  ...
  - <div id="getLanguage()" class="section detail">
    ...
    <span class="annotations">@NonNull
    </span><span class="modifiers">public</span> <span class="return-type">[LanguageCode](sdk-for-android-explore-com-here-sdk-core-languagecode "enum class in com.here.sdk.core")</span> <span class="element-name">getLanguage</span>()

    </div>

    <div class="block">

    Gets the language requested for all textual information related to
    this route.

    </div>

    Returns:  
    Indicates the language requested for all textual information related
    to this route.

    </div>

  - <div id="getOptimizationMode()" class="section detail">
    ...
    <span class="annotations">@NonNull
    </span><span class="modifiers">public</span> <span class="return-type">[OptimizationMode](sdk-for-android-explore-com-here-sdk-routing-optimizationmode "enum class in com.here.sdk.routing")</span> <span class="element-name">getOptimizationMode</span>()
  ...
  - <div id="getRequestedTransportMode()" class="section detail">
    ...
    <span class="annotations">@NonNull
    </span><span class="modifiers">public</span> <span class="return-type">[TransportMode](sdk-for-android-explore-com-here-sdk-transport-transportmode "enum class in com.here.sdk.transport")</span> <span class="element-name">getRequestedTransportMode</span>()
  ...
  - <div id="getRouteHandle()" class="section detail">
    ...
    <span class="annotations">@Nullable
    </span><span class="modifiers">public</span> <span class="return-type">[RouteHandle](sdk-for-android-explore-com-here-sdk-routing-routehandle "class in com.here.sdk.routing")</span> <span class="element-name">getRouteHandle</span>()

    </div>

    <div class="block">

    Gets the route handle of this route. Note that it is provided only
    ...
    [`RouteOptions.enableRouteHandle`](sdk-for-android-explore-com-here-sdk-routing-routeoptions#enableRouteHandle)
  ...
  - <div id="getDuration()" class="section detail">
    ...
    route, including real-time traffic delays if available.

    </div>

    Returns:  
    The estimated time in seconds needed to travel along this route,
    including real-time traffic delays if available.
  ...
  - <div id="getTrafficDelay()" class="section detail">
    ...
    Gets the estimated time in seconds spent in traffic along this
    route. Negative values indicate that the route can be traversed
    faster than usual.

    </div>

    Returns:  
    The estimated time in seconds spent in traffic along this route.
    Negative values indicate that the route can be traversed faster than
    usual.

    </div>

  - <div id="getRoutingOptions()" class="section detail">
    ...
    <span class="annotations">@Nullable
    </span><span class="modifiers">public</span> <span class="return-type">[RoutingOptions](sdk-for-android-explore-com-here-sdk-routing-routingoptions "class in com.here.sdk.routing")</span> <span class="element-name">getRoutingOptions</span>()
  ...
  - <div id="getRailwayCrossings()" class="section detail">
    ...
    Gets railway crossings. Railway crossing information is only
    available for routes created with the online RoutingEngine .
  ...
  - <div id="getRouteLabels()" class="section detail">
    ...
    which the route is going to pass that differentiate it from other
    alternatives routes. The labels are ordered by importance based on
    how much time the route spends on each road segment, not by
    traversal sequence. This helps users quickly identify and
    distinguish between different route alternatives when alternative
    routes have been quested via RouteOptions .

    </div>

    Returns:  
    A collection containing a maximum of 2 `RouteLabel` instances for
    the route. It will return an empty list if no labels are available.
