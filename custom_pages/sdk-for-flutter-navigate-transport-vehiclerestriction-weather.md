...
<li class="self-crumb">weather property</li>
</ol>
<div class="self-name">weather</div>
...
<pre class="language-dart"><code class="language-dart">WeatherType? weather;</code></pre>
</section>
</div> 
