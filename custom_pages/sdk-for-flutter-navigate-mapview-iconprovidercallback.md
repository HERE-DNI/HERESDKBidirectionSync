...
<p>A callback of this type is invoked when an icon is received from the /sdk-for-flutter-navigate-mapview-iconprovider-class in
the <code>ImageInfo</code> format. The callback provides information about the loaded icon, or an
/sdk-for-flutter-navigate-mapview-iconprovidererror if one occurred.</p>
