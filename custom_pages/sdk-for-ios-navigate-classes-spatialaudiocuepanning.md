...
- <div>
  ...
  <td><div>
  <p>Defines a new set of values related to spatial audio panning. When <a href="sdk-for-ios-navigate-structs-custompanningdata"><code>CustomPanningData</code></a> is initialized as <code>nil</code>, the default set of values provided by HERE SDK will be used instead.</p>
  </div></td>
  </tr>
  <tr>
