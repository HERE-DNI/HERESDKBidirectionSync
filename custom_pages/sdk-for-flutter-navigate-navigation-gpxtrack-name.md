...
Gets the value of the name of the element in the trkType. If nothing was set before, defaults to an empty string.</p>
</section>
...
<section class="multi-line-signature">
void
name=(<wbr/>String value)
</section>
<section class="desc markdown">
<p>The value of the name of the element in the trkType.
Can be overridden by the user. If nothing was set before, defaults to an empty string.
Sets the value of the name of the element in the trkType. Can be overridden by the user. Defaults to an empty string.</p>
</section>
<section class="summary source-code" id="source">
<h2>Implementation</h2>
