...
<div class="block"><p>Represents error codes that describe the result of the <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-electronichorizonengine#update(com.here.sdk.navigation.MapMatchedLocation)"><code>ElectronicHorizonEngine.update(com.here.sdk.navigation.MapMatchedLocation)</code></a> method.
...
<div class="col-first even-row-color"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-index#ENGINE_NOT_AVAILABLE">ENGINE_NOT_AVAILABLE</a></code></div>
<div class="col-last even-row-color">
<div class="block">Electronic horizon engine state is not available.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-index#PATH_TREE_INCONSISTENT">PATH_TREE_INCONSISTENT</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Path tree is inconsistent.</div>
</div>
<div class="col-first even-row-color"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-index#POSITION_NOT_FOUND">POSITION_NOT_FOUND</a></code></div>
<div class="col-last even-row-color">
<div class="block">Current position cannot be resolved in the current electronic horizon tree.</div>
</div>
<div class="col-first odd-row-color"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-index#POSITION_OFF_ROAD">POSITION_OFF_ROAD</a></code></div>
<div class="col-last odd-row-color">
