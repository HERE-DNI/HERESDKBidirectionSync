...
The list of visibility ranges. The 3D marker is visible only inside these map measure ranges. A range is half open - \<a href="sdk-for-flutter-navigate-mapview-mapmarker3d-s">minimumZoomLevel, maximumZoomLevel), the given maximum value is not contained in the range.

When empty (the default), the 3D marker is visible without map measure restrictions. Only [MapMeasureRange</a> of <a href="sdk-for-flutter-navigate-mapview-mapmeasurekind">MapMeasureKind.zoomLevel</a> type are supported. <a href="sdk-for-flutter-navigate-mapview-mapmarker3d-s">MapMeasureRange</a> of other unsupported types will be ignored. Gets the list of visibility ranges.
...
When empty (the default), the 3D marker is visible without map measure restrictions. Only [MapMeasureRange</a> of <a href="sdk-for-flutter-navigate-mapview-mapmeasurekind">MapMeasureKind.zoomLevel</a> type are supported. <a href="sdk-for-flutter-navigate-mapview-mapmarker3d-s">MapMeasureRange</a> of other unsupported types will be ignored. Sets visibility ranges for this 3D marker.
