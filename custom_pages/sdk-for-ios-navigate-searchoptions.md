...
slug: "sdk-for-ios-navigate-searchoptions"
---
...
<html lang="en">
  <head>
    <title>SearchOptions Structure Reference</title>
...
results will be returned in their local language.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/maxItems" class="dashAnchor"></a>
...
For location search (reverse geocode) by default results limited to 1.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/highDensityEncodingEnabled" class="dashAnchor"></a>
...
For now, it only affects input parameters of type <code><a href="sdk-for-ios-explore-geocorridor">GeoCorridor</a></code>.
Only supported for search in <code><a href="sdk-for-ios-explore-searchengine">SearchEngine</a></code>, otherwise it is ignored.
...
otherwise, a <code><a href="sdk-for-ios-explore-searcherror#/s:7heresdk11SearchErrorO9forbiddenyA2CmF">SearchError.forbidden</a></code> will be propagated in callbacks.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/distributedResults" class="dashAnchor"></a>
...
<ul>
<li><code>searchByCategory</code> API with <code><a href="sdk-for-ios-explore-area#/s:7heresdk13CategoryQueryV4AreaV08corridorD0AA11GeoCorridorVSgvp">CategoryQuery.Area.corridorArea</a></code> set</li>
<li><code>searchByText</code> API with <code><a href="sdk-for-ios-explore-area#/s:7heresdk9TextQueryV4AreaV08corridorD0AA11GeoCorridorVSgvp">TextQuery.Area.corridorArea</a></code> set
Otherwise, this value is ignored.</li>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(languageCode:maxItems:highDensityEncodingEnabled:distributedResults:)" class="dashAnchor"></a>
...
(see fields description).</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">languageCode</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-languagecode">LanguageCode</a></span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">maxItems</span><span class="p">:</span> <span class="kt">Int32</span><span class="p">?</span> <span class="o">=</span> <span class="kc">nil</span><span class="p">,</span> <span class="nv">highDensityEncodingEnabled</span><span class="p">:</span> <span class="kt">Bool</span> <span class="o">=</span> <span class="kc">false</span><span class="p">,</span> <span class="nv">distributedResults</span><span class="p">:</span> <span class="kt">Bool</span> <span class="o">=</span> <span class="kc">false</span><span class="p">)</span></code></pre>
