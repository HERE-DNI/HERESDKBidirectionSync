...
class="external-link"
title="class or interface in java.lang"><code>Comparable</code></a>`<`[`RenderSize.Unit`](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")`>`,
<a
...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit#DENSITY_INDEPENDENT_PIXELS"
  class="member-name-link"><code>DENSITY_INDEPENDENT_PIXELS</code></a></td>
  <td><div class="block">
  Size expressed in device independent pixels, meaning that on devices
  with different display resolutions and sizes it will represent
  approximately the same physical (in millimeters, inches, etc.) size.
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit#METERS"
  class="member-name-link"><code>METERS</code></a></td>
  <td><div class="block">
  Size expressed in meters, meaning it will stay constant relative to map
  content and change on the screen as the map is zoomed in and out.
  </div></td>
  </tr>
  <tr>
  <td><a
  href="sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit#PIXELS"
  class="member-name-link"><code>PIXELS</code></a></td>
  <td><div class="block">
...
- <div id="method-summary" class="section method-summary">
  ...
  <td><code>static </code><a
  href="sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit"
  title="enum class in com.here.sdk.mapview"><code>RenderSize.Unit</code></a><code>[]</code></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="PIXELS" class="section detail">
    ...
    final</span> <span class="return-type">[RenderSize.Unit](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")</span> <span class="element-name">PIXELS</span>
  ...
  - <div id="DENSITY_INDEPENDENT_PIXELS" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RenderSize.Unit](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")</span> <span class="element-name">DENSITY_INDEPENDENT_PIXELS</span>
  ...
  - <div id="METERS" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RenderSize.Unit](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")</span> <span class="element-name">METERS</span>

    </div>

    <div class="block">

    Size expressed in meters, meaning it will stay constant relative to
    map content and change on the screen as the map is zoomed in and
    out.
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[RenderSize.Unit](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")\[\]</span> <span class="element-name">values</span>()
  ...
  - <div id="valueOf(java.lang.String)" class="section detail">
    ...
    <span class="modifiers">public
    static</span> <span class="return-type">[RenderSize.Unit](sdk-for-android-explore-com-here-sdk-mapview-rendersize-unit "enum class in com.here.sdk.mapview")</span> <span class="element-name">valueOf</span><span class="parameters">(<a
