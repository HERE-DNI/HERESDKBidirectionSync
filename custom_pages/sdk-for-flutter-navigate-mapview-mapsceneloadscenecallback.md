...
<span class="name">MapSceneLoadSceneCallback</span> = <span class="returntype">void Function<span class="signature">(<span id="sdk-for-flutter-navigate-param-loadSceneError" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-mapview-maperror">MapError</a>?</span> <span class="parameter-name">loadSceneError</span></span>)</span></span>
