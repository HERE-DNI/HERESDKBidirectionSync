...
/sdk-for-flutter-navigate-routing-transitroutingengine-transitroutingengine()
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-transitroutingengine-transitroutingengine-withsdkengine(/sdk-for-flutter-navigate-core-engine-sdknativeengine-class sdkEngine)
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-transitroutingengine-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-transitroutingengine-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-transitroutingengine-calculateroute(<wbr/>/sdk-for-flutter-navigate-routing-transitwaypoint-class startingPoint, /sdk-for-flutter-navigate-routing-transitwaypoint-class destination, /sdk-for-flutter-navigate-routing-transitrouteoptions-class routeOptions, /sdk-for-flutter-navigate-routing-calculateroutecallback callback)
...
/sdk-for-flutter-navigate-routing-transitroutingengine-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-transitroutingengine-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-transitroutingengine-operator-equals(<wbr/>Object other)
    → bool
