...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-rasterdatasourceproviderconfiguration-default(/sdk-for-flutter-navigate-mapview-datasource-tileurlprovidercallback urlProvider, /sdk-for-flutter-navigate-mapview-datasource-tilingscheme tilingScheme, List&lt;<wbr/>int&gt; storageLevels, bool hasAlphaChannel, Map&lt;<wbr/>String, String&gt;? headers)
</dt>
<dd>
          Creates a new instance.
        </dd>
<dt class="callable" id="RasterDataSourceProviderConfiguration.withDefaults">
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-rasterdatasourceproviderconfiguration-withdefaults(/sdk-for-flutter-navigate-mapview-datasource-tileurlprovidercallback urlProvider, /sdk-for-flutter-navigate-mapview-datasource-tilingscheme tilingScheme, List&lt;<wbr/>int&gt; storageLevels)
</dt>
<dd>
          Creates a new instance.
        </dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-hasalphachannel
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-headers
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-storagelevels
↔ List&lt;<wbr/>int&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-tilingscheme
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-urlprovider
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-datasource-rasterdatasourceproviderconfiguration-operator-equals(<wbr/>Object other)
    → bool
