...
The location is made available to an instance of this class by calling <a href="sdk-for-android-explore-com-here-sdk-mapview-locationindicator#updateLocation(com.here.sdk.core.Location)"><code>updateLocation(Location)</code></a> or
 ...
 Use <a href="sdk-for-android-explore-com-here-sdk-mapview-locationindicator#enable(com.here.sdk.mapview.MapViewBase)"><code>enable(com.here.sdk.mapview.MapViewBase)</code></a> to add this object to the map and <a href="sdk-for-android-explore-com-here-sdk-mapview-locationindicator#disable()"><code>disable()</code></a> to remove it.
 Take care that the
...
<div class="block"><p>Sets whether <a href="sdk-for-android-explore-location#horizontalAccuracyInMeters"><code>Location.horizontalAccuracyInMeters</code></a> is used to scale the accuracy indicator halo.
 ...
 If the location indicator is set to inactive (which can be checked via <a href="sdk-for-android-explore-com-here-sdk-mapview-locationindicator#isActive()"><code>isActive()</code></a> flag),
