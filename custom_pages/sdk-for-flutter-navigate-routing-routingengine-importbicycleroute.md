---
title: "importBicycleRoute method - RoutingEngine class - routing library - Dart API"
slug: "sdk-for-flutter-navigate-routing-routingengine-importbicycleroute"
---
...
# <span class="kind-method">importBicycleRoute</span> abstract method
...
<span class="returntype"><a href="sdk-for-flutter-navigate-core-threading-taskhandle-class">TaskHandle</a></span> <span class="name deprecated">importBicycleRoute</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-importBicycleRoute-param-locations" class="parameter"><span class="type-annotation">List<span class="signature">\<<wbr></wbr><span class="type-parameter"><a href="sdk-for-flutter-navigate-core-location-class">Location</a></span>\></span></span> <span class="parameter-name">locations</span>, </span>
2.  <span id="sdk-for-flutter-navigate-importBicycleRoute-param-bicycleOptions" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-routing-bicycleoptions-class" class="deprecated">BicycleOptions</a></span> <span class="parameter-name">bicycleOptions</span>, </span>
3.  <span id="sdk-for-flutter-navigate-importBicycleRoute-param-callback" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-routing-calculateroutecallback">CalculateRouteCallback</a></span> <span class="parameter-name">callback</span></span>
