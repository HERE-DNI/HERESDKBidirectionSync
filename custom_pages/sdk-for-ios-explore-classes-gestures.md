...
<span id="//apple_ref/swift/Class/Gestures" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-maps">Maps</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> Gestures Class Reference
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-tapdelegate">`TapDelegate`</a> that notifies when a tap gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-doubletapdelegate">`DoubleTapDelegate`</a> that notifies when a double-tap gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-pinchrotatedelegate">`PinchRotateDelegate`</a> that notifies when a pinch-rotate gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-longpressdelegate">`LongPressDelegate`</a> that notifies when a long-press gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-pandelegate">`PanDelegate`</a> that notifies when a pan gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-twofingertapdelegate">`TwoFingerTapDelegate`</a> that notifies when a two-finger tap gesture occurs. `Gestures` holds a strong reference to the delegate.
...
- <div>
  ...
  <a href="sdk-for-ios-explore-protocols-twofingerpandelegate">`TwoFingerPanDelegate`</a> that notifies when a two-finger pan gesture occurs. `Gestures` holds a strong reference to the delegate.
