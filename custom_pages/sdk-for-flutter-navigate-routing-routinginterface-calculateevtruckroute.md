---
title: "calculateEVTruckRoute method - RoutingInterface class - routing library - Dart API"
slug: "sdk-for-flutter-navigate-routing-routinginterface-calculateevtruckroute"
---
...
# <span class="kind-method">calculateEVTruckRoute</span> abstract method
...
<span class="returntype"><a href="sdk-for-flutter-navigate-core-threading-taskhandle-class">TaskHandle</a></span> <span class="name deprecated">calculateEVTruckRoute</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-calculateEVTruckRoute-param-waypoints" class="parameter"><span class="type-annotation">List<span class="signature">\<<wbr></wbr><span class="type-parameter"><a href="sdk-for-flutter-navigate-routing-waypoint-class">Waypoint</a></span>\></span></span> <span class="parameter-name">waypoints</span>, </span>
2.  <span id="sdk-for-flutter-navigate-calculateEVTruckRoute-param-evTruckOptions" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-routing-evtruckoptions-class" class="deprecated">EVTruckOptions</a></span> <span class="parameter-name">evTruckOptions</span>, </span>
3.  <span id="sdk-for-flutter-navigate-calculateEVTruckRoute-param-callback" class="parameter"><span class="type-annotation"><a href="sdk-for-flutter-navigate-routing-calculateroutecallback">CalculateRouteCallback</a></span> <span class="parameter-name">callback</span></span>
