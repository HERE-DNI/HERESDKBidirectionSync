...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-dynamicspeedinfo(double baseSpeedInMetersPerSecond, double trafficSpeedInMetersPerSecond, int turnTimeInSeconds)
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-basespeedinmeterspersecond
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-hashcode
→ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-trafficspeedinmeterspersecond
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-turntimeinseconds
↔ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-calculatejamfactor(<wbr/>)
    → double
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-routing-dynamicspeedinfo-operator-equals(<wbr/>Object other)
    → bool
