---
title: "SpeedLimitListener (API Reference)"
slug: "sdk-for-android-navigate-navigate-com-here-sdk-navigation-speedlimitlistener"
---
...
<hr/>
<div class="type-signature"><span class="modifiers">public interface </span><span class="element-name type-name-label">SpeedLimitListener</span></div>
<div class="block"><p>This interface
 should be implemented in order to receive the speed limit of the current road.</p></div>
</section>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a class="member-name-link" href="#onSpeedLimitUpdated(com.here.sdk.navigation.SpeedLimit)">onSpeedLimitUpdated</a><wbr/>(<a href="sdk-for-android-navigate-speedlimit" title="class in com.here.sdk.navigation">SpeedLimit</a> speedLimit)</code></div>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>speedLimit</code> - <p>Speed limit of the current road.</p></dd>
</dl>
</section>
</li>
</ul>
