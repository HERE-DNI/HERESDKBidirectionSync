...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-maploader-region"
---
...
<div class="inheritance">com.here.sdk.maploader.Region</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public final class </span><span class="element-name type-name-label">Region</span>
<span class="extends-implements">extends <a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html" title="class or interface in java.lang">Object</a></span></div>
<div class="block"><p>Defines an area, especially part of a country or the world that can be downloaded.</p></div>
</section>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#childRegions">childRegions</a></code></div>
...
<div class="col-second even-row-color"><code><a class="member-name-link" href="#navigability">navigability</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#regionId">regionId</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Unique identifier specifying a region.</div>
</div>
<div class="col-first even-row-color"><code>long</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#sizeOnDiskInBytes">sizeOnDiskInBytes</a></code></div>
<div class="col-last even-row-color">
<div class="block">Represents the total size of the region on disk in bytes, assuming no pre-existing data on the disk.</div>
</div>
<div class="col-first odd-row-color"><code>long</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#sizeOnNetworkInBytes">sizeOnNetworkInBytes</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Region size, for downloading/during network operations, in bytes.</div>
</div>
</div>
</section>
</li>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(com.here.sdk.maploader.RegionId)">Region</a><wbr/>(<a href="sdk-for-android-navigate-regionid" title="class in com.here.sdk.maploader">RegionId</a> regionId)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Name of region. Language is determined by the requested <a href="sdk-for-android-navigate-..-core-languagecode" title="enum class in com.here.sdk.core"><code>LanguageCode</code></a>. By default,
 it is in <a href="sdk-for-android-navigate-..-core-languagecode#EN_US"><code>LanguageCode.EN_US</code></a>.</p></div>
</section>
</li>
<li>
...
<div class="block"><p>Represents the total size of the region on disk in bytes, assuming no pre-existing data on the disk.
...
<li>
<section class="detail" id="sizeOnNetworkInBytes">
<h3>sizeOnNetworkInBytes</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">long</span> <span class="element-name">sizeOnNetworkInBytes</span></div>
<div class="block"><p>Region size, for downloading/during network operations, in bytes. Regions are downloaded in
