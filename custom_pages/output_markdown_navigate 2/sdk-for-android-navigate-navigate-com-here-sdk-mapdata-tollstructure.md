...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-mapdata-tollstructure"
---
...
<div class="inheritance">com.here.sdk.mapdata.TollStructure</div>
</div>
<section class="class-description" id="class-description">
<hr/>
<div class="type-signature"><span class="modifiers">public final class </span><span class="element-name type-name-label">TollStructure</span>
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#structureTypes">structureTypes</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(java.util.List,java.util.List)">TollStructure</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="sdk-for-android-navigate-tollstructuretype" title="enum class in com.here.sdk.mapdata">TollStructureType</a>&gt; structureTypes,
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>structureTypes</code> - <p>Contains available types of toll structures</p></dd>
<dd><code>paymentMethods</code> - <p>Contains available payment methods</p></dd>
</dl>
</section>
</li>
</ul>
