...
<li class="self-crumb">ServerStartedCallback typedef</li>
</ol>
<div class="self-name">ServerStartedCallback</div>
...
<p>This method will be called on the main thread when /sdk-for-flutter-navigate-maploader-remote-connection-externalmapdatasourceserver-start
