...
<li class="self-crumb">utcOffset property</li>
</ol>
<div class="self-name">utcOffset</div>
...
<pre class="language-dart"><code class="language-dart">final Duration utcOffset;</code></pre>
</section>
</div>
