...
slug: "sdk-for-ios-navigate-speedwarningoptions"
---
...
<html lang="en">
  <head>
    <title>SpeedWarningOptions Structure Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Struct/SpeedWarningOptions" class="dashAnchor"></a>
    <a title="SpeedWarningOptions Structure Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        SpeedWarningOptions Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk19SpeedWarningOptionsV16speedLimitOffsetAA0bfG0Vvp"></a>
                    <a name="//apple_ref/swift/Property/speedLimitOffset" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk19SpeedWarningOptionsV16speedLimitOffsetAA0bfG0Vvp">speedLimitOffset</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>The speed limit offsets to be used when notifying about exceeding the speed limit.</p>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">speedLimitOffset</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-speedlimitoffset">SpeedLimitOffset</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk19SpeedWarningOptionsV16speedLimitOffsetAcA0bfG0V_tcfc"></a>
                    <a name="//apple_ref/swift/Method/init(speedLimitOffset:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk19SpeedWarningOptionsV16speedLimitOffsetAcA0bfG0V_tcfc">init(speedLimitOffset:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">speedLimitOffset</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-speedlimitoffset">SpeedLimitOffset</a></span><span class="p">)</span></code></pre>
