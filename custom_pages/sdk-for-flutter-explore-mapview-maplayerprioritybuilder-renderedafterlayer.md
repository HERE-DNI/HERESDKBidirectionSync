...
renderedAfterLayer(<ol class="parameter-list single-line"> <li>String referenceLayer</li>
</ol>)
...
<a href="sdk-for-flutter-explore-mapview-maplayerprioritybuilder-withcategory">MapLayerPriorityBuilder.withCategory</a>.
...
<pre class="language-dart"><code class="language-dart">MapLayerPriorityBuilder renderedAfterLayer(String referenceLayer);</code></pre>
