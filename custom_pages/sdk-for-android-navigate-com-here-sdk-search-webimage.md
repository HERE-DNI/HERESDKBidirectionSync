...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-navigate-index#%3Cinit%3E(com.here.sdk.search.WebSource)">WebImage</a><wbr/>(<a href="sdk-for-android-navigate-websource" title="class in com.here.sdk.search">WebSource</a> source)</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Creates a new instance.
 Sets <a href="sdk-for-android-navigate-index#source"><code>source</code></a> to the given source.</p></div>
<dl class="notes">
<dt>Parameters:</dt>
