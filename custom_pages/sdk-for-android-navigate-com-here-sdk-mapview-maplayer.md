...
<div class="block"><p>Interface for managing a map layer.
 A map layer can be created by using the <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-maplayerbuilder" title="class in com.here.sdk.mapview"><code>MapLayerBuilder</code></a>. At creation, the layer
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a class="member-name-link" href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-index#setEnabled(boolean)">setEnabled</a><wbr/>(boolean enable)</code></div>
