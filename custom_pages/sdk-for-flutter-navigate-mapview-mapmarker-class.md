...
<p>The image to be displayed is represented by /sdk-for-flutter-navigate-mapview-mapimage-class object. For performance reasons,
it is highly recommended to reuse a single instance of the image when creating multiple
identical markers.</p>
<p>To display the map marker, it needs to be added to the scene using /sdk-for-flutter-navigate-mapview-mapscene-addmapmarker.
To stop displaying it, remove it from the scene using /sdk-for-flutter-navigate-mapview-mapscene-removemapmarker.</p>
...
camera viewport using /sdk-for-flutter-navigate-mapview-mapcamera-boundingbox (it may be extended)
and then use the method /sdk-for-flutter-navigate-core-geobox-containsgeocoordinates in combination with
/sdk-for-flutter-navigate-mapview-mapcamerastate-distancetotargetinmeters to determine which MapMarkers are actually visible
...
/sdk-for-flutter-navigate-mapview-mapmarker-mapmarker(/sdk-for-flutter-navigate-core-geocoordinates-class coordinates, /sdk-for-flutter-navigate-mapview-mapimage-class image)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-mapmarker-withanchor(/sdk-for-flutter-navigate-core-geocoordinates-class coordinates, /sdk-for-flutter-navigate-mapview-mapimage-class image, /sdk-for-flutter-navigate-core-anchor2d-class anchor)
</dt>
<dd>
          Creates an instance of a marker at given coordinates, represented by specified image,
...
/sdk-for-flutter-navigate-mapview-mapmarker-mapmarker-withimageandtext(/sdk-for-flutter-navigate-core-geocoordinates-class coordinates, /sdk-for-flutter-navigate-mapview-mapimage-class image, String text)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-anchor
...
/sdk-for-flutter-navigate-mapview-mapmarker-coordinates
...
/sdk-for-flutter-navigate-mapview-mapmarker-draworder
↔ int
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-fadeduration
↔ Duration
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapmarker-image
...
/sdk-for-flutter-navigate-mapview-mapmarker-isoverlapallowed
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-istextoptional
↔ bool
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-metadata
↔ /sdk-for-flutter-navigate-core-metadata-class?
</dt>
<dd>
  The Metadata instance attached to this marker, see /sdk-for-flutter-navigate-core-metadata-class.
...
/sdk-for-flutter-navigate-mapview-mapmarker-opacity
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapmarker-text
↔ String
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker-textstyle
...
/sdk-for-flutter-navigate-mapview-mapmarker-visibilityranges
...
/sdk-for-flutter-navigate-mapview-mapmarker-cancelanimation(<wbr/>/sdk-for-flutter-navigate-animation-mapmarkeranimation-class animation)
    → void
...
/sdk-for-flutter-navigate-mapview-mapmarker-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mapmarker-startanimation(<wbr/>/sdk-for-flutter-navigate-animation-mapmarkeranimation-class animation, /sdk-for-flutter-navigate-animation-animationlistener-class? animationListener)
    → void

</dt>
<dd>
  Starts animation of this map marker according to provided /sdk-for-flutter-navigate-animation-mapmarkeranimation-class.
  

</dd>
<dt class="callable inherited" id="toString">
/sdk-for-flutter-navigate-mapview-mapmarker-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mapmarker-operator-equals(<wbr/>Object other)
    → bool
