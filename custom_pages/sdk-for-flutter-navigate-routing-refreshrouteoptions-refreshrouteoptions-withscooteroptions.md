...
RefreshRouteOptions.withScooterOptions(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-routing-scooteroptions-class scooterOptions</li>
</ol>)
    </section>
<section class="desc markdown">
<p>Constructs a RefreshRouteOptions object with /sdk-for-flutter-navigate-routing-scooteroptions-class.</p>
<ul>
