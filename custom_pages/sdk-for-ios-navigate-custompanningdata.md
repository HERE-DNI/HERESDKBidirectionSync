...
slug: "sdk-for-ios-navigate-custompanningdata"
---
...
<html lang="en">
  <head>
    <title>CustomPanningData Structure Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Struct/CustomPanningData" class="dashAnchor"></a>
...
The orientation in space for <code><a href="sdk-for-ios-explore-custompanningdata#/s:7heresdk17CustomPanningDataV23initialAzimuthInDegreesSdSgvp">CustomPanningData.initialAzimuthInDegrees</a></code> and <code><a href="sdk-for-ios-explore-custompanningdata#/s:7heresdk17CustomPanningDataV21sweepAzimuthInDegreesSdSgvp">CustomPanningData.sweepAzimuthInDegrees</a></code> can
...
the audio cue &lsquo;Now turn right and then turn left&rsquo; will be spatialized as following:
&lsquo;Now turn right&rsquo; will be heard as coming from the right.
&lsquo;and then turn left&rsquo; will be heard as coming from the left.
...
When not used, HERE SDK&rsquo;s estimation will be used instead.</p>
...
as &ldquo;Turn right on&rdquo; (<code>ManeuverAction.RightTurn</code>) we want to create a spatial audio arc
...
on the opposite direction of the maneuver (e.g. slightly starting from &ldquo;front-left&rdquo;)
...
to play the audio cue to avoid unwanted audio &ldquo;jumps&rdquo;.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/sweepAzimuthInDegrees" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Sweep angle of the upcoming audio cue. For example, for a maneuver such as &ldquo;Turn right on&rdquo;
...
and the <code>sweep_azimuth_in_degrees</code> to -95 degrees</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(estimatedAudioCueDuration:initialAzimuthInDegrees:sweepAzimuthInDegrees:)" class="dashAnchor"></a>
