...
<div className="inheritance">com.here.sdk.routing.LocalizedTextPreference</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public enum </span><span className="element-name type-name-label">LocalizedTextPreference</span>
...
<div className="block"><p>Indicates the option of localized text usage.</p></div>
</section>
...
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference#USE_ALWAYS">USE_ALWAYS</a></code></div>
<div className="col-last even-row-color">
<div className="block">Information is included in the notification, if available.</div>
</div>
<div className="col-first odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference#USE_IF_LANGUAGE_IS_COMPATIBLE">USE_IF_LANGUAGE_IS_COMPATIBLE</a></code></div>
<div className="col-last odd-row-color">
<div className="block">Information is included in the notification, if available and its language code is compatible with the voice
 package language.</div>
</div>
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference#USE_NEVER">USE_NEVER</a></code></div>
<div className="col-last even-row-color">
<div className="block">Information is not included in the notification.</div>
</div>
</div>
</section>
</li>
...
<li>
<section className="detail" id="USE_NEVER">
<h3>USE_NEVER</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span className="element-name">USE_NEVER</span></div>
<div className="block"><p>Information is not included in the notification.</p></div>
</section>
</li>
<li>
<section className="detail" id="USE_ALWAYS">
<h3>USE_ALWAYS</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span className="element-name">USE_ALWAYS</span></div>
<div className="block"><p>Information is included in the notification, if available.</p></div>
</section>
</li>
<li>
<section className="detail" id="USE_IF_LANGUAGE_IS_COMPATIBLE">
<h3>USE_IF_LANGUAGE_IS_COMPATIBLE</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a></span> <span className="element-name">USE_IF_LANGUAGE_IS_COMPATIBLE</span></div>
<div className="block"><p>Information is included in the notification, if available and its language code is compatible with the voice
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-localizedtextpreference" title="enum class in com.here.sdk.routing">LocalizedTextPreference</a>[]</span> <span className="element-name">values</span>()</div>
