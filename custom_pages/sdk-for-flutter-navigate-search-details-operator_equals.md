---
title: "operator == method - Details class - search library - Dart API"
slug: "sdk-for-flutter-navigate-search-details-operator_equals"
---
...
If a subclass overrides the equality operator, it should override the <a href="sdk-for-flutter-navigate-search-details-hashcode">hashCode</a> method as well to maintain consistency.
...
bool operator ==(Object other) {
  ...
  return DeepCollectionEquality().equals(contacts, _other.contacts) &&
      ...
      evChargingLocation == _other.evChargingLocation;
}
```
