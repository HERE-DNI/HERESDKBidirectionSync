...
<div className="inheritance">com.here.sdk.maploader.MapUpdateTask</div>
</div>
</div>
<section className="class-description" id="class-description">

<div className="type-signature"><span className="modifiers">public final class </span><span className="element-name type-name-label">MapUpdateTask</span>
<span className="extends-implements">extends <a href="sdk-for-android-navigate-com-here-nativebase" title="class in com.here">NativeBase</a></span></div>
<div className="block"><p>A class to control the map update process.</p></div>
</section>
...
<div className="block"><p>Cancels the ongoing map update operation. Operation cannot be resumed afterwards.
