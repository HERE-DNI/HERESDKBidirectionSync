...
<div class="block"><p>Cancels the ongoing map update operation. Operation cannot be resumed afterwards.
 ...
 Status of the call will be reported via <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-mapupdateprogresslistener#onComplete(com.here.sdk.maploader.MapLoaderError)"><code>MapUpdateProgressListener.onComplete(com.here.sdk.maploader.MapLoaderError)</code></a>.
 <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-maploadererror#OPERATION_CANCELLED"><code>MapLoaderError.OPERATION_CANCELLED</code></a> will be reported for a successful cancel operation.</p></div>
</section>
</li>
<li>
...
<div class="block"><p>Pauses the ongoing map update operation. Operation can be resumed afterwards.
 ...
 Status of the call will be reported via <a href="https://docs.here.com/outing-api-test/page/sdk-for-android-navigate-mapupdateprogresslistener#onPause(com.here.sdk.maploader.MapLoaderError)"><code>MapUpdateProgressListener.onPause(com.here.sdk.maploader.MapLoaderError)</code></a>.</p></div>
</section>
</li>
<li>
