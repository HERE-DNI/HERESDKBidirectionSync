...
slug: "sdk-for-ios-navigate-rdsencryptionkeysrequest"
---
...
<html lang="en">
  <head>
    <title>RDSEncryptionKeysRequest Structure Reference</title>
  ...
  <body>
    ...
    <a title="RDSEncryptionKeysRequest Structure Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        RDSEncryptionKeysRequest Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
      ...
      <article class="main-content">
        <section>
          <section class="section">
            <h1>RDSEncryptionKeysRequest</h1>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk24RDSEncryptionKeysRequestV11countryCodes5UInt8Vvp"></a>
                    <a name="//apple_ref/swift/Property/countryCode" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk24RDSEncryptionKeysRequestV11countryCodes5UInt8Vvp">countryCode</a>
                    </code>
                  </div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk24RDSEncryptionKeysRequestV3sids5UInt8Vvp"></a>
                    <a name="//apple_ref/swift/Property/sid" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk24RDSEncryptionKeysRequestV3sids5UInt8Vvp">sid</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk24RDSEncryptionKeysRequestV19ltnBeforeEncryptions5UInt8Vvp"></a>
                    <a name="//apple_ref/swift/Property/ltnBeforeEncryption" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk24RDSEncryptionKeysRequestV19ltnBeforeEncryptions5UInt8Vvp">ltnBeforeEncryption</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>LTN to which the key refers.</p>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk24RDSEncryptionKeysRequestV11countryCode3sid19ltnBeforeEncryptionACs5UInt8V_A2Htcfc"></a>
                    <a name="//apple_ref/swift/Method/init(countryCode:sid:ltnBeforeEncryption:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk24RDSEncryptionKeysRequestV11countryCode3sid19ltnBeforeEncryptionACs5UInt8V_A2Htcfc">init(countryCode:<wbr>sid:<wbr>ltnBeforeEncryption:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">countryCode</span><span class="p">:</span> <span class="kt">UInt8</span><span class="p">,</span> <span class="nv">sid</span><span class="p">:</span> <span class="kt">UInt8</span><span class="p">,</span> <span class="nv">ltnBeforeEncryption</span><span class="p">:</span> <span class="kt">UInt8</span><span class="p">)</span></code></pre>
