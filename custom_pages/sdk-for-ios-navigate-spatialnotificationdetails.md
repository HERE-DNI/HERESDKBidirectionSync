...
slug: "sdk-for-ios-navigate-spatialnotificationdetails"
---
...
<html lang="en">
  <head>
    <title>SpatialNotificationDetails Structure Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Struct/SpatialNotificationDetails" class="dashAnchor"></a>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/initialAzimuthInDegrees" class="dashAnchor"></a>
...
&ldquo;Turn right on&rdquo; (<code>ManeuverAction.RightTurn</code>) we want to create a spatial audio arc trajectory
...
slightly on the opposite direction of the maneuver (e.g. slightly starting from &ldquo;front-left&rdquo;)
...
the audio cue to avoid unwanted audio &ldquo;jumps&rdquo;.
...
<td style="text-align: center">-90°</td>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/audioCuePanning" class="dashAnchor"></a>
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">audioCuePanning</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-spatialaudiocuepanning">SpatialAudioCuePanning</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Property/estimatedAudioCueDuration" class="dashAnchor"></a>
...
For example the cue &ldquo;Turn right on Name-Of-A-Street&rdquo; will playback over an X number of milliseconds.
...
of sound to the cue (so that audio movement and audio duration match).</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(initialAzimuthInDegrees:audioCuePanning:estimatedAudioCueDuration:)" class="dashAnchor"></a>
...
This azimuth value is needed to set the position of the audio renderer before starting to play
the audio cue to avoid unwanted audio &ldquo;jumps&rdquo;.
The orientation in space for <code><a href="sdk-for-ios-explore-spatialnotificationdetails#/s:7heresdk26SpatialNotificationDetailsV23initialAzimuthInDegreesSdvp">SpatialNotificationDetails.initialAzimuthInDegrees</a></code> can be represented by the
...
of sound to the cue (so that audio movement and audio duration match).</li>
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">initialAzimuthInDegrees</span><span class="p">:</span> <span class="kt">Double</span><span class="p">,</span> <span class="nv">audioCuePanning</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-spatialaudiocuepanning">SpatialAudioCuePanning</a></span><span class="p">,</span> <span class="nv">estimatedAudioCueDuration</span><span class="p">:</span> <span class="kt">TimeInterval</span><span class="p">)</span></code></pre>
