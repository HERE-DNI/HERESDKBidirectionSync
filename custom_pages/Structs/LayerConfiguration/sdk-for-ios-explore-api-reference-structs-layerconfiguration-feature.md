...
<img alt="" id="carat" src="../../img/carat.png"/>
<a href="../../Structs/LayerConfiguration.html">LayerConfiguration</a>
<img alt="" id="carat" src="../../img/carat.png"/>
...
When the <code>landmarks</code> <code>MapFeature</code> is set to be visible for a <code><a href="../../Classes/MapScene.html">MapScene</a></code>, 3D landmarks will still be loaded and
...
<div class="pointer"></div>
<div class="abstract">
<p>Offline map data for <code><a href="../../Structs/EVChargingStation.html">EVChargingStation</a></code>.</p>
<p>Feature enables following OCM layer groups:</p>
<ul>
...
When not set, the <code>OfflineRoutingEngine</code> may not be able to calculate routes with <code><a href="../../Structs/BusOptions.html">BusOptions</a></code>.</p>
<p>Feature enables following OCM layer groups:</p>
<ul>
