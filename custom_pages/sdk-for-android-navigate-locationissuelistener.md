...
<title>LocationIssueListener (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.location, interface: LocationIssueListener">
...
<h1 title="Interface LocationIssueListener" class="title">Interface LocationIssueListener</h1>
</div>
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab3"><code><a href="#onLocationIssueChanged(java.util.List)" class="member-name-link">onLocationIssueChanged</a><wbr>(<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-locationissuetype" title="enum class in com.here.sdk.location">LocationIssueType</a>&gt;&nbsp;issues)</code></div>
...
<div class="member-signature"><span class="return-type">void</span>&nbsp;<span class="element-name">onLocationIssueChanged</span><wbr><span class="parameters">(@NonNull
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util" class="external-link">List</a>&lt;<a href="sdk-for-android-explore-locationissuetype" title="enum class in com.here.sdk.location">LocationIssueType</a>&gt;&nbsp;issues)</span></div>
<div class="block"><p>Called when the snapshot of currently active location issues changes.
 ...
 list with this snapshot.</div>
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>issues</code> - <p>Current snapshot of active location issues. Empty list indicates no active issues.</dd>
</dl>
</section>
</li>
</ul>
