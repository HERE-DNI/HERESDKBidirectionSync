...
1.  <span id="sdk-for-flutter-navigate-param-start" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">start</span>, </span>
2.  <span id="sdk-for-flutter-navigate-param-extent" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">extent</span></span>
