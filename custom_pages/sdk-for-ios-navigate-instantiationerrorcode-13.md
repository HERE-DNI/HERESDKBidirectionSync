            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk26MapSceneLoadOptionsBuilderC22InstantiationErrorCodeO11noSourceSetyA2EmF"></a>
                    <a name="//apple_ref/swift/Element/noSourceSet" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk26MapSceneLoadOptionsBuilderC22InstantiationErrorCodeO11noSourceSetyA2EmF">noSourceSet</a>
                    </code>
                  </div>
                  <div class="height-container">
                    ...
                    <section class="section">
                      ...
                      <div class="abstract">
                        <p>Neither mapScheme nor configurationFile was set.</p>
