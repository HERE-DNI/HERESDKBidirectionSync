...
This should be used by components that perform continuous updates to pause those updates until <a href="sdk-for-flutter-explore-mapview-mapviewlifecyclelistener-onresume">MapViewLifecycleListener.onResume</a> is called.
