...
see /sdk-for-flutter-navigate-animation-mapmarkeranimation-class and /sdk-for-flutter-navigate-animation-mappolylineanimation-class.</p>
</section>
<section class="summary offset-anchor" id="constructors">
<h2>Constructors</h2>
<dl class="constructor-summary-list">
<dt class="callable" id="MapItemKeyFrameTrack">
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-mapitemkeyframetrack()
</dt>
<dd>
</dd>
</dl>
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-operator-equals(<wbr/>Object other)
    → bool
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-movetowitheasing(<wbr/>List&lt;<wbr/>/sdk-for-flutter-navigate-animation-geocoordinateskeyframe-class&gt; keyframes, /sdk-for-flutter-navigate-animation-easing-class easing, /sdk-for-flutter-navigate-animation-keyframeinterpolationmode interpolationMode)
...
/sdk-for-flutter-navigate-animation-mapitemkeyframetrack-polylineprogresswitheasing(<wbr/>List&lt;<wbr/>/sdk-for-flutter-navigate-animation-scalarkeyframe-class&gt; keyframes, /sdk-for-flutter-navigate-animation-easing-class easing, /sdk-for-flutter-navigate-animation-keyframeinterpolationmode interpolationMode)
    → /sdk-for-flutter-navigate-animation-mapitemkeyframetrack-class
