...
void
setMarker3dModelWithRenderSizeUnit(<wbr/><ol class="parameter-list"> <li>/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-class model, </li>
<li>double scale, </li>
<li>/sdk-for-flutter-navigate-mapview-locationindicatormarkertype type, </li>
<li>/sdk-for-flutter-navigate-mapview-rendersizeunit renderSizeUnit, </li>
</ol>)
...
<p>Sets the /sdk-for-flutter-navigate-mapview-mapmarker3dmodel-class asset to be displayed as location indicator for a specified type.</p>
...
positive z axis. Please note that only /sdk-for-flutter-navigate-mapview-mapmarker3dmodel-class created from <code>obj</code> files are
supported. Models created from Mesh will be ignored.</p>
<ul>
<li>
<p><code>model</code> The /sdk-for-flutter-navigate-mapview-mapmarker3dmodel-class object to be displayed for the specified type. Only models
...
<li>
<p><code>renderSizeUnit</code> The /sdk-for-flutter-navigate-mapview-rendersizeunit specifying how the vertex coordinates of the
