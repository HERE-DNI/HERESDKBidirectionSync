---
title: "importCarRouteWithStops abstract method"
...
<div>
<h1>importCarRouteWithStops abstract method</h1></div>
...
importCarRouteWithStops(<ol class="parameter-list"> <li>List&lt;<a href="/sdk-for-flutter-navigate-core-location-class">Location</a>&gt; locations, </li>
...
<p>Asynchronously creates a car route from a sequence of geographic coordinates very close to each other.</p>
...
TaskHandle importCarRouteWithStops(List&lt;Location&gt; locations, List&lt;RouteStop&gt; routeStops, CarOptions carOptions, CalculateRouteCallback callback);</code></pre>
