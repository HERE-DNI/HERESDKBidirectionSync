...
1.  <span id="sdk-for-flutter-explore-param-minimumZoomLevel" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">minimumZoomLevel</span>, </span>
2.  <span id="sdk-for-flutter-explore-param-maximumZoomLevel" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">maximumZoomLevel</span></span>
