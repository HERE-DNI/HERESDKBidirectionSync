...
slug: "sdk-for-ios-navigate-taskhandle"
---
...
<html lang="en">
  <head>
    <title>TaskHandle Protocol Reference</title>
                ...
                <li class="item">
                  ...
                  <div class="height-container">
                    ...
                    <section class="section">
                      <div class="pointer"></div>
                      <div class="abstract">
                        <p>Sets internal state of task to &lsquo;canceled&rsquo;. If the task is still in the queue, it will be
...
to interrupt it.</p>
                      ...
                      <div>
                        <h4>Return Value</h4>
                        <p>True, if the task was canceled. False, if the task can&rsquo;t be canceled due to a
