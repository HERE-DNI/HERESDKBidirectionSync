...
<div className="type-signature"><span className="modifiers">public interface </span><span className="element-name type-name-label">MapViewBase</span></div>
<div className="block"><p>Represents the available public API from  <code>MapView</code>.</p></div>
</section>
...
<div className="col-second even-row-color"><code><a className="type-name-link" href="sdk-for-android-navigate-com-here-sdk-mapview-mapviewbase-mappickcallback" title="interface in com.here.sdk.mapview">MapViewBase.MapPickCallback</a></code></div>
<div className="col-last even-row-color">
<div className="block">Callback for a pick request.</div>
</div>
</div>
</section>
</li>
...
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-geocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a></span> <span className="element-name">viewToGeoCoordinates</span><wbr/><span className="parameters">(@NonNull
...
<div className="block"><p>Converts view coordinates (in pixels) to geographical coordinates.
...
<div className="member-signature"><span className="annotations">@Nullable
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-point2d" title="class in com.here.sdk.core">Point2D</a></span> <span className="element-name">geoToViewCoordinates</span><wbr/><span className="parameters">(@NonNull
...
<div className="block"><p>Converts geographical coordinates to view coordinates (in pixels).
...
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">setWatermarkLocation</span><wbr/><span className="parameters">(@NonNull
...
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">addLifecycleListener</span><wbr/><span className="parameters">(@NonNull
...
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">removeLifecycleListener</span><wbr/><span className="parameters">(@NonNull
 <a href="sdk-for-android-navigate-com-here-sdk-mapview-mapviewlifecyclelistener" title="interface in com.here.sdk.mapview">MapViewLifecycleListener</a> lifecycleListener)</span></div>
...
<h3>pick</h3>
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">pick</span><wbr/><span className="parameters">(@Nullable
...
<h3>isValid</h3>
<div className="member-signature"><span className="return-type">boolean</span> <span className="element-name">isValid</span>()</div>
<div className="block"><p>Returns <code>true</code> if this instance is valid, <code>false</code> otherwise. It will be made
...
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-mapview-mapcamera" title="class in com.here.sdk.mapview">MapCamera</a></span> <span className="element-name">getCamera</span>()</div>
<div className="block"><p>Gets the camera to control the view for the map.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<h3>getGestures</h3>
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-gestures-gestures" title="class in com.here.sdk.gestures">Gestures</a></span> <span className="element-name">getGestures</span>()</div>
<div className="block"><p>Gets the gestures control object.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<h3>getMapScene</h3>
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-mapview-mapscene" title="class in com.here.sdk.mapview">MapScene</a></span> <span className="element-name">getMapScene</span>()</div>
<div className="block"><p>Gets the map scene associated with this map view.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<h3>getMapContext</h3>
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-mapview-mapcontext" title="class in com.here.sdk.mapview">MapContext</a></span> <span className="element-name">getMapContext</span>()</div>
<div className="block"><p>Gets the map context associated with this map view.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<h3>getHereMap</h3>
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-mapview-heremap" title="class in com.here.sdk.mapview">HereMap</a></span> <span className="element-name">getHereMap</span>()</div>
<div className="block"><p>Gets the <a href="sdk-for-android-navigate-com-here-sdk-mapview-heremap" title="class in com.here.sdk.mapview"><code>HereMap</code></a> associated with this map view.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-size2d" title="class in com.here.sdk.core">Size2D</a></span> <span className="element-name">getViewportSize</span>()</div>
<div className="block"><p>Gets the size of this map view in physical pixels.
...
<h3>getFrameRate</h3>
<div className="member-signature"><span className="return-type">int</span> <span className="element-name">getFrameRate</span>()</div>
<div className="block"><p>Gets maximum render frame rate in frames per second.</p></div>
<dl className="notes">
<dt>Returns:</dt>
...
<h3>setFrameRate</h3>
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">setFrameRate</span><wbr/><span className="parameters">(int value)</span></div>
<div className="block"><p>Sets maximum render frame rate in frames per second. Setting to 0 disables automatic rendering for this view.
...
<h3>getPixelScale</h3>
<div className="member-signature"><span className="return-type">double</span> <span className="element-name">getPixelScale</span>()</div>
<div className="block"><p>Gets the pixel scale factor used by this <code>MapView</code>.
...
<div className="member-signature"><span className="annotations">@NonNull
</span><span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-core-size2d" title="class in com.here.sdk.core">Size2D</a></span> <span className="element-name">getWatermarkSize</span>()</div>
