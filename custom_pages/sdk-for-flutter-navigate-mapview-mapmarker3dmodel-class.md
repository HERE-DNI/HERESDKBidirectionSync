...
<p>Represents a 3D model that can be used by a /sdk-for-flutter-navigate-mapview-mapmarker3d-class to be shown on the map.</p>
<p>Geometry of 3D marker can be provided in form of a Wavefront OBJ file as specified in
<a href="http://www.martinreddy.net/gfx/3d/OBJ.spec">http://www.martinreddy.net/gfx/3d/OBJ.spec</a> or as mesh built via /sdk-for-flutter-navigate-mapview-meshbuilder-class.</p>
...
<p>A 3D mesh can be specified programatically using /sdk-for-flutter-navigate-mapview-meshbuilder-class and passed to
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel(String geometryFilePath)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel-frommesh(/sdk-for-flutter-navigate-mapview-mesh-class mesh)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel-frommeshwithtexturefilepath(/sdk-for-flutter-navigate-mapview-mesh-class mesh, String textureFilePath)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel-frommeshwithtexturefilepathandcolor(/sdk-for-flutter-navigate-mapview-mesh-class mesh, String textureFilePath, Color color)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel-withtexturefilepath(String geometryFilePath, String textureFilePath)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-mapmarker3dmodel-withtexturefilepathandcolor(String geometryFilePath, String textureFilePath, Color color)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mapmarker3dmodel-operator-equals(<wbr/>Object other)
    → bool
