...
<title>SchoolZoneWarning (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.navigation, class: SchoolZoneWarning">
...
<h1 title="Class SchoolZoneWarning" class="title">Class SchoolZoneWarning</h1>
</div>
...
<div class="block"><p>A school zone warning which notifies about a school zone presence on road with a speed limit
 ...
 Use <code>SchoolZoneWarningListener</code> to get notifications about school zones.</div>
</section>
...
<div class="col-second even-row-color"><code><a href="#distanceToSchoolZoneInMeters" class="member-name-link">distanceToSchoolZoneInMeters</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(double,double,com.here.sdk.navigation.DistanceType)" class="member-name-link">SchoolZoneWarning</a><wbr>(double&nbsp;distanceToSchoolZoneInMeters,
...
<div class="block"><p>The distance from the current location to the school zone in meters.</div>
</section>
</li>
<li>
...
<div class="block"><p>Speed limit meters/second, which applies to current school zone.</div>
</section>
</li>
<li>
...
<div class="block"><p>Time rule indicating the time periods for which the warning applies.
 If the field is 'null' then the warning is applicable at anytime.</div>
</section>
</li>
</ul>
</section>
...
<dl class="notes">
<dt>Parameters:</dt>
<dd><code>distanceToSchoolZoneInMeters</code> - <p>The distance from the current location to the school zone in meters.</dd>
<dd><code>speedLimitInMetersPerSecond</code> - <p>Speed limit meters/second, which applies to current school zone.</dd>
<dd><code>distanceType</code> - <p>The distance type for the warning, e.g. a warning for a new school zone ahead or a warning
 for passing a school zone.</dd>
</dl>
</section>
</li>
</ul>
