...
- <div>
  ...
  A flag that indicates whether spatial audio details should be triggered when generating voice notifications under <a href="sdk-for-ios-navigate-protocols-eventtextdelegate">`EventTextDelegate`</a>. If enabled, a set of details required to spatialize an audio cue will be generated and exposed.
