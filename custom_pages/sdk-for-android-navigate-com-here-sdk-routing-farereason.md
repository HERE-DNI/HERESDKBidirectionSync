...
<div className="inheritance">com.here.sdk.routing.FareReason</div>
</div>
</div>
...
<div className="type-signature"><span className="modifiers">public enum </span><span className="element-name type-name-label">FareReason</span>
...
<div className="block"><p>Reason for the cost.</p></div>
</section>
...
<div className="col-first even-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-farereason#PARKING">PARKING</a></code></div>
<div className="col-last even-row-color">
<div className="block">Fare for parking.</div>
</div>
<div className="col-first odd-row-color"><code><a className="member-name-link" href="sdk-for-android-navigate-com-here-sdk-routing-farereason#RIDE">RIDE</a></code></div>
<div className="col-last odd-row-color">
<div className="block">Fare for ride.</div>
</div>
</div>
</section>
</li>
...
<li>
<section className="detail" id="RIDE">
<h3>RIDE</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-farereason" title="enum class in com.here.sdk.routing">FareReason</a></span> <span className="element-name">RIDE</span></div>
<div className="block"><p>Fare for ride.</p></div>
</section>
</li>
<li>
<section className="detail" id="PARKING">
<h3>PARKING</h3>
<div className="member-signature"><span className="modifiers">public static final</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-farereason" title="enum class in com.here.sdk.routing">FareReason</a></span> <span className="element-name">PARKING</span></div>
<div className="block"><p>Fare for parking.</p></div>
</section>
</li>
</ul>
</section>
...
<h3>values</h3>
<div className="member-signature"><span className="modifiers">public static</span> <span className="return-type"><a href="sdk-for-android-navigate-com-here-sdk-routing-farereason" title="enum class in com.here.sdk.routing">FareReason</a>[]</span> <span className="element-name">values</span>()</div>
