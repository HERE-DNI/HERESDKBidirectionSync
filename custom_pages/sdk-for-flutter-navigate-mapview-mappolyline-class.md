...
<p>The geometry to be visualized is represented by an instance of /sdk-for-flutter-navigate-core-geopolyline-class.</p>
...
/sdk-for-flutter-navigate-mapview-mappolyline-mappolyline-withrepresentation(/sdk-for-flutter-navigate-core-geopolyline-class geometry, /sdk-for-flutter-navigate-mapview-mappolylinerepresentation-class representation)
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolyline-drawordertype
...
/sdk-for-flutter-navigate-mapview-mappolyline-geometry
...
/sdk-for-flutter-navigate-mapview-mappolyline-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mappolyline-mapcontentcategoriestoblock
↔ List&lt;<wbr/>/sdk-for-flutter-navigate-mapview-mapcontentcategory&gt;
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolyline-metadata
...
/sdk-for-flutter-navigate-mapview-mappolyline-progress
↔ double
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolyline-progresscolor
↔ Color
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolyline-progressgradientlength
...
/sdk-for-flutter-navigate-mapview-mappolyline-progressoutlinecolor
↔ Color
</dt>
<dd>
...
/sdk-for-flutter-navigate-mapview-mappolyline-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-mapview-mappolyline-visibilityranges
...
/sdk-for-flutter-navigate-mapview-mappolyline-cancelanimation(<wbr/>/sdk-for-flutter-navigate-animation-mappolylineanimation-class animation)
    → void
...
/sdk-for-flutter-navigate-mapview-mappolyline-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-mapview-mappolyline-setrepresentation(<wbr/>/sdk-for-flutter-navigate-mapview-mappolylinerepresentation-class representation)
    → void
...
/sdk-for-flutter-navigate-mapview-mappolyline-startanimation(<wbr/>/sdk-for-flutter-navigate-animation-mappolylineanimation-class animation, /sdk-for-flutter-navigate-animation-animationlistener-class listener)
    → void
...
/sdk-for-flutter-navigate-mapview-mappolyline-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-mapview-mappolyline-operator-equals(<wbr/>Object other)
    → bool
