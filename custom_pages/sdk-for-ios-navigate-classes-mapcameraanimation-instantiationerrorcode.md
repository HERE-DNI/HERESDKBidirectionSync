...
<pre class="highlight swift"><code><span class="kd">extension</span> <span class="kt"><a href="sdk-for-ios-navigate-classes-mapcameraanimation">MapCameraAnimation</a></span><span class="o">.</span><span class="kt">InstantiationErrorCode</span> <span class="p">:</span> <span class="kt">Error</span></code></pre>
</div>
</div>
<p>Describes a reason for failing to create a multi-track <code><a href="sdk-for-ios-navigate-classes-mapcameraanimation">MapCameraAnimation</a></code>.</p>
</section>
