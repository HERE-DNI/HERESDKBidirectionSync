...
- <div>
  ...
  ` `<span id="/s:7heresdk20MaterialReflectivityV13ambientFactorSdvp"></span>` `<span id="//apple_ref/swift/Property/ambientFactor" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-structs-materialreflectivity#/s:7heresdk20MaterialReflectivityV13ambientFactorSdvp" class="token"><code>ambientFactor</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk20MaterialReflectivityV13diffuseFactorSdvp"></span>` `<span id="//apple_ref/swift/Property/diffuseFactor" class="dashAnchor"></span>` `<a href="sdk-for-ios-navigate-structs-materialreflectivity#/s:7heresdk20MaterialReflectivityV13diffuseFactorSdvp" class="token"><code>diffuseFactor</code></a>` `
