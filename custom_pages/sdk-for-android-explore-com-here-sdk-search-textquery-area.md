...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E(com.here.sdk.core.GeoBox)">Area</a><wbr/>(<a href="sdk-for-android-explore-geobox" title="class in com.here.sdk.core">GeoBox</a> boxArea)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs a new instance of this class from provided parameters.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E(com.here.sdk.core.GeoCircle)">Area</a><wbr/>(<a href="sdk-for-android-explore-geocircle" title="class in com.here.sdk.core">GeoCircle</a> circleArea)</code></div>
<div class="col-last odd-row-color">
<div class="block">Constructs a new instance of this class from provided parameters.</div>
</div>
...
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="sdk-for-android-explore-index#%3Cinit%3E(java.util.List,com.here.sdk.core.GeoCoordinates)">Area</a><wbr/>(<a class="external-link" href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/List.html" title="class or interface in java.util">List</a>&lt;<a href="sdk-for-android-explore-countrycode" title="enum class in com.here.sdk.core">CountryCode</a>&gt; countries,
 <a href="sdk-for-android-explore-geocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> areaCenter)</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs a new instance of this class from provided parameters.</div>
</div>
...
<div class="block"><p>Geographic coordinates of the center around which to provide the most relevant places.
 For Offline Search, one of <a href="sdk-for-android-explore-index#areaCenter"><code>areaCenter</code></a>, <a href="sdk-for-android-explore-index#boxArea"><code>boxArea</code></a> and <a href="sdk-for-android-explore-index#circleArea"><code>circleArea</code></a> has to be set,
...
<div class="block"><p>Geographic corridor area in which to provide the most relevant places.
 ...
 <a href="sdk-for-android-explore-index#areaCenter"><code>areaCenter</code></a> is ignored when searching.
