...
Indicates the level of significance of a route in a range from 1 to 6. A
value of 1 stands for the most major route and 6 the most minor. The
route type indicates that the road's name is actually a route number and
in many countries is displayed in a shield symbol (e.g., Interstate and
State routes in the U.S.). See
https://developer.here.com/documentation/here-map-content-schema/dev_guide/topics_schema/streetname.routetype.html
...
- <div id="enum-constant-summary" class="section constants-summary">
  ...
  class="member-name-link"><code>LEVEL_1_ROAD</code></a></td>
  <td><div class="block">
  ...
  class="member-name-link"><code>LEVEL_2_ROAD</code></a></td>
  <td><div class="block">
  National road
  </div></td>
  </tr>
  ...
  class="member-name-link"><code>LEVEL_3_ROAD</code></a></td>
  <td><div class="block">
  Primary road
  </div></td>
  </tr>
  ...
  class="member-name-link"><code>LEVEL_4_ROAD</code></a></td>
  <td><div class="block">
  Secondary road
  </div></td>
  </tr>
  ...
  class="member-name-link"><code>LEVEL_5_ROAD</code></a></td>
  <td><div class="block">
  Minor road
  </div></td>
  </tr>
  ...
  class="member-name-link"><code>LEVEL_6_ROAD</code></a></td>
  <td><div class="block">
  Avenue
  </div></td>
  </tr>
  ...
  class="member-name-link"><code>TYPE_UNKNOWN</code></a></td>
  <td><div class="block">
  Unknown
  </div></td>
  </tr>
...
- <div id="method-summary" class="section method-summary">
  ...
  href="sdk-for-android-explore-com-here-sdk-core-routetype"
  ...
  <td><code>static </code><a
  href="sdk-for-android-explore-com-here-sdk-core-routetype"
  title="enum class in com.here.sdk.core"><code>RouteType</code></a><code>[]</code></td>
...
- <div id="enum-constant-detail" class="section constant-details">
  ...
  - <div id="TYPE_UNKNOWN" class="section detail">
    ...
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">TYPE_UNKNOWN</span>
  ...
  - <div id="LEVEL_1_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_1_ROAD</span>
  ...
  - <div id="LEVEL_2_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_2_ROAD</span>
  ...
  - <div id="LEVEL_3_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_3_ROAD</span>
  ...
  - <div id="LEVEL_4_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_4_ROAD</span>
  ...
  - <div id="LEVEL_5_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_5_ROAD</span>
  ...
  - <div id="LEVEL_6_ROAD" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")</span> <span class="element-name">LEVEL_6_ROAD</span>
...
- <div id="method-detail" class="section method-details">
  ...
  - <div id="values()" class="section detail">
    ...
    static</span> <span class="return-type">[RouteType](sdk-for-android-explore-com-here-sdk-core-routetype "enum class in com.here.sdk.core")\[\]</span> <span class="element-name">values</span>()
