...
slug: "sdk-for-ios-navigate-directedocmsegmentid"
---

<HTMLBlock>{`
<div class="sdk-for-android">
<!-- DirectedOCMSegmentId.html -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>DirectedOCMSegmentId Structure Reference</title>
  ...
  <body>
    ...
    <a title="DirectedOCMSegmentId Structure Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        DirectedOCMSegmentId Structure Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk20DirectedOCMSegmentIdV2idAA0cD0Vvp"></a>
                    <a name="//apple_ref/swift/Property/id" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk20DirectedOCMSegmentIdV2idAA0cD0Vvp">id</a>
                    </code>
                  </div>
                    ...
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          ...
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="k">var</span> <span class="nv">id</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-ocmsegmentid">OCMSegmentId</a></span></code></pre>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk20DirectedOCMSegmentIdV15travelDirectionAA06TravelF0Ovp"></a>
                    <a name="//apple_ref/swift/Property/travelDirection" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk20DirectedOCMSegmentIdV15travelDirectionAA06TravelF0Ovp">travelDirection</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                ...
                <li class="item">
                  <div>
                    <code>
                    <a name="/s:7heresdk20DirectedOCMSegmentIdV2id15travelDirectionAcA0cD0V_AA06TravelG0Otcfc"></a>
                    <a name="//apple_ref/swift/Method/init(id:travelDirection:)" class="dashAnchor"></a>
                    <a class="token" href="#/s:7heresdk20DirectedOCMSegmentIdV2id15travelDirectionAcA0cD0V_AA06TravelG0Otcfc">init(id:<wbr>travelDirection:<wbr>)</a>
                    </code>
                  </div>
                  <div class="height-container">
                    <div class="pointer-container"></div>
                    <section class="section">
                      ...
                      <div class="declaration">
                        ...
                        <div class="language">
                          <p class="aside-title">Swift</p>
                          <pre class="highlight swift"><code><span class="kd">public</span> <span class="nf">init</span><span class="p">(</span><span class="nv">id</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-ocmsegmentid">OCMSegmentId</a></span><span class="p">,</span> <span class="nv">travelDirection</span><span class="p">:</span> <span class="kt"><a href="sdk-for-ios-explore-traveldirection">TravelDirection</a></span> <span class="o">=</span> <span class="kt"><a href="sdk-for-ios-explore-traveldirection">TravelDirection</a></span><span class="o">.</span><span class="n">bidirectional</span><span class="p">)</span></code></pre>
