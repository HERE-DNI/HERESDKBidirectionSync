...
<div className="type-signature"><span className="modifiers">public static interface </span><span className="element-name type-name-label">RasterTileSource.LoadResultHandler</span></div>
...
<li>
<section className="detail" id="loaded(com.here.sdk.mapview.datasource.TileKey,byte[],com.here.sdk.mapview.datasource.TileSource.TileMetadata)">
<h3>loaded</h3>
