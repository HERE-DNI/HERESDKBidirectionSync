...
- <div>
  ...
  The standard (type) of the connectors belonging to this group. Should be one of the constants defined in <a href="sdk-for-ios-navigate-structs-evchargingconnectortype">`EVChargingConnectorType`</a>.
