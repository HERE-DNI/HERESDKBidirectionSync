...
<span class="returntype"><a href="sdk-for-flutter-navigate-core-anglerange-class">AngleRange</a></span> <span class="name">fromMinMaxDegreesClockwise</span>(<wbr></wbr>

1.  <span id="sdk-for-flutter-navigate-fromMinMaxDegreesClockwise-param-min" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">min</span>, </span>
2.  <span id="sdk-for-flutter-navigate-fromMinMaxDegreesClockwise-param-max" class="parameter"><span class="type-annotation">double</span> <span class="parameter-name">max</span></span>
...
- `min` Angle where to start the circular sector, running clockwise, in degrees from north. The value will be normalized to \<a href="sdk-for-flutter-navigate-core-anglerange-class">0.0, 360.0).
