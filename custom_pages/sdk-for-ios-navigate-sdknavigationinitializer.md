...
slug: "sdk-for-ios-navigate-sdknavigationinitializer"
---

<HTMLBlock>{`
<div class="sdk-for-android">
<!-- SDKNavigationInitializer.html -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>SDKNavigationInitializer Class Reference</title>
  ...
  <body>
    <a name="//apple_ref/swift/Class/SDKNavigationInitializer" class="dashAnchor"></a>
    <a title="SDKNavigationInitializer Class Reference"></a>
    <header>
    ...
    <div class="content-wrapper">
      <p id="breadcrumbs">
        ...
        <img id="carat" src="../img/carat.png" alt=""/>
        SDKNavigationInitializer Class Reference
      </p>
    </div>
    <div class="content-wrapper">
      <nav class="sidebar">
      ...
      <article class="main-content">
        <section>
          <section class="section">
            <h1>SDKNavigationInitializer</h1>
            ...
            <div class="task-group">
              <ul>
                <li class="item">
                  <div>
                    <code>
                    <a name="/c:@M@heresdk@objc(cs)SDKNavigationInitializer(im)initializeInternalsIfNecessary"></a>
                    <a name="//apple_ref/swift/Method/initializeInternalsIfNecessary()" class="dashAnchor"></a>
                    <a class="token" href="#/c:@M@heresdk@objc(cs)SDKNavigationInitializer(im)initializeInternalsIfNecessary">initializeInternalsIfNecessary()</a>
                    </code>
                  </div>
