...
searchByTextExtended(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-search-textquery-class query, </li>
...
<p>Performs an asynchronous request to do a text query search for /sdk-for-flutter-navigate-search-place-class instances.</p>
<p>Optionally, search along a polyline, such as a route, by specifying a /sdk-for-flutter-navigate-core-geocorridor-class.
