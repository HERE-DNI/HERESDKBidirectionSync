...
slug: "sdk-for-android-navigate-navigate-com-here-sdk-trafficbroadcast-tmcserviceproviderinfo"
---
...
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#encryptionId">encryptionId</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Encryption key index.</div>
</div>
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#encryptionTestMode">encryptionTestMode</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first even-row-color"><code>short</code></div>
<div class="col-second even-row-color"><code><a class="member-name-link" href="#ltnNumber">ltnNumber</a></code></div>
<div class="col-last even-row-color">
<div class="block">Location table number.</div>
</div>
<div class="col-first odd-row-color"><code>short</code></div>
<div class="col-second odd-row-color"><code><a class="member-name-link" href="#sid">sid</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a class="member-name-link" href="#%3Cinit%3E(short,short,short,short,short,short,short)">TMCServiceProviderInfo</a><wbr/>(short status,
 short countryCode,
 short sid,
 short ltnNumber,
