...
RefreshRouteParameters.withRouteHandleAndWaypointAndSectionPosition(<wbr/><ol class="parameter-list"> <li>/sdk-for-flutter-navigate-routing-routehandle-class routeHandle, </li>
...
<p>Create a new instance of /sdk-for-flutter-navigate-routing-refreshrouteparameters-class with the new starting point and the section position on the route.</p>
<ul>
<li>
