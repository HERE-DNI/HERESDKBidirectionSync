...
<li class="self-crumb">getDownloadableRegions abstract method</li>
</ol>
<div class="self-name">getDownloadableRegions</div>
...
getDownloadableRegions(<wbr/><ol class="parameter-list single-line"> <li>/sdk-for-flutter-navigate-maploader-downloadableregionscallback callback</li>
</ol>)
...
<p>Performs an asynchronous request to fetch a list of /sdk-for-flutter-navigate-maploader-region-class objects
for downloading map data in a separate request.</p>
<p>The default language for /sdk-for-flutter-navigate-maploader-region-name is /sdk-for-flutter-navigate-core-languagecode.</p>
<ul>
