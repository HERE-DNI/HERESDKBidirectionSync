...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-sdknativeengine(/sdk-for-flutter-navigate-core-engine-sdkoptions-class options)
</dt>
<dd>
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-hashcode
→ int
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-isofflinemode
↔ bool
</dt>
<dd>
  The offline mode.
...
See /sdk-for-flutter-navigate-core-engine-sdknativeengine-passthroughfeatures.
...
needs to be enabled via /sdk-for-flutter-navigate-core-engine-sdkoptions-offlinemode.
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-options
→ /sdk-for-flutter-navigate-core-engine-sdkoptions-class
</dt>
<dd>
  Options used by this instance of /sdk-for-flutter-navigate-core-engine-sdknativeengine-class.
Gets the options used by this instance of /sdk-for-flutter-navigate-core-engine-sdknativeengine-class.
  <div class="features">no setter</div>
</dd>
<dt class="property" id="passThroughFeatures">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-passthroughfeatures
↔ Set&lt;<wbr/>/sdk-for-flutter-navigate-core-engine-passthroughfeature&gt;?
</dt>
<dd>
...
By default, reporting of HERE SDK /sdk-for-flutter-navigate-core-engine-usagestats-class will be enabled when at least one pass-through feature is set.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property" id="proxySettings">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-proxysettings
...
If proxy is necessary from the start then it's recommended to use /sdk-for-flutter-navigate-core-engine-networksettings-proxysettings in /sdk-for-flutter-navigate-core-engine-sdkoptions-networksettings.
  <div class="features">getter/setter pair</div>
</dd>
<dt class="property inherited" id="runtimeType">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-runtimetype
→ Type
</dt>
<dd class="inherited">
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-sdkusagestats
→ List&lt;<wbr/>/sdk-for-flutter-navigate-core-engine-usagestats-class&gt;
</dt>
<dd>
  Gets a list of usage statistics for all available HERE SDK features.
/sdk-for-flutter-navigate-core-engine-usagestats-class has cache and persistent storage. Reads from the persistent storage happen on <code>SDKNativeEngine</code> creation step.
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-clearpersistentusagestats(<wbr/>)
    → void

</dt>
<dd>
  Clear persistent storage for the HERE SDK /sdk-for-flutter-navigate-core-engine-usagestats-class.
  

</dd>
<dt class="callable" id="clearUsageStatsCache">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-clearusagestatscache(<wbr/>)
    → void

</dt>
<dd>
  Clear cache for the HERE SDK /sdk-for-flutter-navigate-core-engine-usagestats-class.
  

</dd>
<dt class="callable" id="dispose">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-dispose(<wbr/>)
    → Future&lt;<wbr/>void&gt;
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-enableusagestats(<wbr/>bool enabled)
    → void

</dt>
<dd>
  Enable or disable /sdk-for-flutter-navigate-core-engine-usagestats-class for the HERE SDK.
  

</dd>
<dt class="callable" id="getDeviceId">
/sdk-for-flutter-navigate-core-engine-sdknativeengine-getdeviceid(<wbr/>)
    → Future&lt;<wbr/>String&gt;
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-nosuchmethod(<wbr/>Invocation invocation)
    → dynamic
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-purgememorycaches(<wbr/>/sdk-for-flutter-navigate-core-engine-sdknativeenginepurgememorystrategy strategy)
    → void
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-setaccesskeysecret(<wbr/>String accessKeySecret)
    → void
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-setaccessscope(<wbr/>String scope)
    → void
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-tostring(<wbr/>)
    → String
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-operator-equals(<wbr/>Object other)
    → bool
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-parameterconfig
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-sharedinstance
...
/sdk-for-flutter-navigate-core-engine-sdknativeengine-makesharedinstance(<wbr/>/sdk-for-flutter-navigate-core-engine-sdkoptions-class options)
    → Future&lt;<wbr/>void&gt;

</dt>
<dd>
  Makes a new instance of SDKNativeEngine using supplied options and stores it as shared instance
see /sdk-for-flutter-navigate-core-engine-sdknativeengine-sharedinstance.
