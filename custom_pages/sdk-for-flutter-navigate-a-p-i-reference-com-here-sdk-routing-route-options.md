---
title: "RouteOptions"
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-routing-route-options"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.routing/RouteOptions///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../index.html">com.here.sdk.routing</a><span class="delimiter">/</span><span class="current">RouteOptions</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Route</span><wbr></wbr><span><span>Options</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">RouteOptions</a></div><p class="paragraph">The options to specify how the route will be calculated.</p></div></div>
  </div>
...
<a data-name="-1347656677%2FProperties%2F1617540583" anchor-label="enableRouteHandle" id="-1347656677%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="enable-route-handle.html"><span>enable</span><wbr></wbr><span>Route</span><wbr></wbr><span><span>Handle</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-1347656677%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="enable-route-handle.html">enableRouteHandle</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a></div><div class="brief "><p class="paragraph">A flag that indicates whether the resulting route should contain a <a href="../-route-handle/index.html">com.here.sdk.routing.RouteHandle</a>. Defaults to <code class="lang-kotlin">false</code>. Note that a <code class="lang-kotlin">RouteHandle</code> generated by the online <code class="lang-kotlin">RoutingEngine</code> is not compatible with the <code class="lang-kotlin">OfflineRoutingEngine</code> and vice versa.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="-350032780%2FProperties%2F1617540583" anchor-label="enableTolls" id="-350032780%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="enable-tolls.html"><span>enable</span><wbr></wbr><span><span>Tolls</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-350032780%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="enable-tolls.html">enableTolls</a><span class="token operator">: </span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-boolean/index.html">Boolean</a></div><div class="brief "><p class="paragraph">A flag that indicates whether the resulting route <a href="../-section/tolls.html">com.here.sdk.routing.Section.tolls</a> properties should contain tolls data. Defaults to <code class="lang-kotlin">false</code>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="-648750431%2FProperties%2F1617540583" anchor-label="optimizationMode" id="-648750431%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="optimization-mode.html"><span>optimization</span><wbr></wbr><span><span>Mode</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="-648750431%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="optimization-mode.html">optimizationMode</a><span class="token operator">: </span><a href="../-optimization-mode/index.html">OptimizationMode</a></div><div class="brief "><p class="paragraph">The optimization mode to be used for route calculation. By default, it is <a href="../-optimization-mode/-f-a-s-t-e-s-t/index.html">com.here.sdk.routing.OptimizationMode.FASTEST</a>.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
...
<a data-name="1888167804%2FProperties%2F1617540583" anchor-label="trafficOptimizationMode" id="1888167804%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="traffic-optimization-mode.html"><span>traffic</span><wbr></wbr><span>Optimization</span><wbr></wbr><span><span>Mode</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1888167804%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><div class="block"><div class="block"><span class="token annotation builtin">@</span><a href="https://kotlinlang.org/api/core/kotlin-stdlib/kotlin.jvm/-jvm-field/index.html"><span class="token annotation builtin">JvmField</span></a></div></div><span class="token keyword">var </span><a href="traffic-optimization-mode.html">trafficOptimizationMode</a><span class="token operator">: </span><a href="../-traffic-optimization-mode/index.html">TrafficOptimizationMode</a></div><div class="brief "><p class="paragraph">The traffic optimization mode to be used for route calculation. By default, it is <a href="../-traffic-optimization-mode/-t-i-m-e_-d-e-p-e-n-d-e-n-t/index.html">com.here.sdk.routing.TrafficOptimizationMode.TIME_DEPENDENT</a>, which enables traffic-aware routing.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
