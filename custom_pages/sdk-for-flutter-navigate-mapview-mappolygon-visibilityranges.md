---
title: "visibilityRanges property - MapPolygon class - mapview library - Dart API"
slug: "sdk-for-flutter-navigate-mapview-mappolygon-visibilityranges"
---
...
When empty (the default), the map polygon is visible without map measure restrictions. Only `MapMeasureRange`(s) of [MapMeasureKind.zoomLevel</a> type are supported. `MapMeasureRange`(s) of other unsupported types will be ignored.
