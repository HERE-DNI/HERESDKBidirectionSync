...
ranges. When empty (the default), the map polygon is visible without map measure restrictions.</p>
</section>
...
The map polygon is visible only inside these map measure ranges.</p>
