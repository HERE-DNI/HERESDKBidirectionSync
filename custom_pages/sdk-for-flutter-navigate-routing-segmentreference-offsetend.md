...
<li class="self-crumb">offsetEnd property</li>
</ol>
<div class="self-name">offsetEnd</div>
...
<pre class="language-dart"><code class="language-dart">double offsetEnd;</code></pre>
</section>
</div> 
