...
slug: "sdk-for-ios-navigate-roadusages"
---
...
<html lang="en">
  <head>
    <title>RoadUsages Structure Reference</title>
...
On these roads all traffic has priority over the traffic on the incoming roads.</p>
                ...
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/init(isRamp:isControlledAccess:isTollway:isPriorityRoad:)" class="dashAnchor"></a>
