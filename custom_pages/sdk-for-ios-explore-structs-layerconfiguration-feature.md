...
When the <code>landmarks</code> <code>MapFeature</code> is set to be visible for a <code><a href="sdk-for-ios-explore-classes-mapscene">MapScene</a></code>, 3D landmarks will still be loaded and
...
<div class="pointer"></div>
<div class="abstract">
<p>Offline map data for <code><a href="sdk-for-ios-explore-structs-evchargingstation">EVChargingStation</a></code>.</p>
<p>Feature enables following OCM layer groups:</p>
<ul>
...
When not set, the <code>OfflineRoutingEngine</code> may not be able to calculate routes with <code><a href="sdk-for-ios-explore-structs-busoptions">BusOptions</a></code>.</p>
<p>Feature enables following OCM layer groups:</p>
<ul>
