...
slug: "sdk-for-ios-navigate-maplayermapmeasuredependentstoragelevels"
---
...
<html lang="en">
  <head>
    <title>MapLayerMapMeasureDependentStorageLevels Class Reference</title>
              ...
              <ul>
                <li class="item">
                  <div>
                    ...
                    <a name="//apple_ref/swift/Method/withStorageLevelOffset(_:)" class="dashAnchor"></a>
...
This creates a map where the storage level is determined by applying an &ldquo;offset&rdquo; to the zoom level.
