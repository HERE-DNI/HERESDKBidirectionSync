...
slug: "sdk-for-flutter-navigate-a-p-i-reference-com-here-sdk-mapview-map-polyline-solid-representation"
---
...
<div class="main-content" data-page-type="classlike" id="content" pageIds="API Reference::com.here.sdk.mapview/MapPolyline.SolidRepresentation///PointingToDeclaration//1617540583">
  <div class="breadcrumbs"><a href="../../../../index.html">API Reference</a><span class="delimiter">/</span><a href="../../index.html">com.here.sdk.mapview</a><span class="delimiter">/</span><a href="../index.html">MapPolyline</a><span class="delimiter">/</span><span class="current">SolidRepresentation</span></div>
  <div class="cover ">
    <h1 class="cover"><span>Solid</span><wbr></wbr><span><span>Representation</span></span></h1>
    <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">class </span><a href="index.html">SolidRepresentation</a> : <a href="../-representation/index.html">MapPolyline.Representation</a></div><p class="paragraph">Representation for a solid line without outline.</p><p class="paragraph">Can represent polylines that have constant width or width dependent on the map zoom.</p><p class="paragraph">To achieve constant width lines, use <a href="../../-map-measure-dependent-render-size/index.html">com.here.sdk.mapview.MapMeasureDependentRenderSize</a> with a single value.</p><p class="paragraph">To achieve line width dependent on map zoom, use <a href="../../-map-measure-dependent-render-size/index.html">com.here.sdk.mapview.MapMeasureDependentRenderSize</a> with multiple values.</p><p class="paragraph">For <a href="../../-map-measure/-kind/index.html">com.here.sdk.mapview.MapMeasure.Kind</a> only <a href="../../-map-measure/-kind/-z-o-o-m_-l-e-v-e-l/index.html">com.here.sdk.mapview.MapMeasure.Kind.ZOOM_LEVEL</a> is supported.</p><p class="paragraph">For <a href="../../-render-size/-unit/index.html">com.here.sdk.mapview.RenderSize.Unit</a> only <a href="../../-render-size/-unit/-p-i-x-e-l-s/index.html">com.here.sdk.mapview.RenderSize.Unit.PIXELS</a> is supported.</p></div></div>
  </div>
          ...
          <div class="table-row" data-togglable="CONSTRUCTOR" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="-solid-representation.html"><span>Solid</span><wbr></wbr><span><span>Representation</span></span></a></div>
      ...
      <div data-togglable="PROPERTY">
        ...
        <div class="table"><a data-name="815027474%2FProperties%2F1617540583" anchor-label="capShape" id="815027474%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="cap-shape.html"><span>cap</span><wbr></wbr><span><span>Shape</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="815027474%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="cap-shape.html">capShape</a><span class="token operator">: </span><a href="../../-line-cap/index.html">LineCap</a></div><div class="brief "><p class="paragraph">The cap shape applied to both ends of the polyline and its outline.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
<a data-name="1570878954%2FProperties%2F1617540583" anchor-label="lineColor" id="1570878954%2FProperties%2F1617540583" data-filterable-set=":modules:dokkaHtml/release"></a>
          <div class="table-row" data-filterable-current=":modules:dokkaHtml/release" data-filterable-set=":modules:dokkaHtml/release">
            <div class="main-subrow keyValue ">
              <div class=""><span class="inline-flex">
                  <div><a href="line-color.html"><span>line</span><wbr></wbr><span><span>Color</span></span></a></div>
<span class="anchor-wrapper"><span class="anchor-icon" pointing-to="1570878954%2FProperties%2F1617540583"></span>
                    <div class="copy-popup-wrapper "><span class="copy-popup-icon"></span><span>Link copied to clipboard</span></div>
                  </span></span></div>
              <div>
                <div class="title">
                  <div class="platform-hinted " data-platform-hinted="data-platform-hinted"><div class="content sourceset-dependent-content" data-active="" data-togglable=":modules:dokkaHtml/release"><div class="symbol monospace"><span class="token keyword">val </span><a href="line-color.html">lineColor</a><span class="token operator">: </span><a href="../../../com.here.sdk.core/-color/index.html">Color</a></div><div class="brief "><p class="paragraph">The color of the polyline.</p></div></div></div>
                </div>
              </div>
            </div>
          </div>
