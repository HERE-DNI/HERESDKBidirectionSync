...
<div className="type-signature"><span className="modifiers">public interface </span><span className="element-name type-name-label">VenueMapListener</span></div>
...
<li>
<section className="detail" id="onGetVenueCompleted(java.lang.String,com.here.sdk.venue.data.VenueModel,boolean,com.here.sdk.venue.style.VenueStyle)">
<h3>onGetVenueCompleted</h3>
<div className="member-signature"><span className="return-type">void</span> <span className="element-name">onGetVenueCompleted</span><wbr/><span className="parameters">(@NonNull
