...
<li class="self-crumb">setDistanceToTarget abstract method</li>
</ol>
<div class="self-name">setDistanceToTarget</div>
...
void
setDistanceToTarget(<wbr/><ol class="parameter-list single-line"> <li>double distanceInMeters</li>
</ol>)
