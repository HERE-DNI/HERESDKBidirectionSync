...
<li class="self-crumb">trafficMergeWarningListener property</li>
</ol>
...
<section class="multi-line-signature">
void
trafficMergeWarningListener=(<wbr/>/sdk-for-flutter-navigate-navigation-trafficmergewarninglistener-class? value)
</section>
<section class="desc markdown">
<p>Object to receive notifications about merging traffic to the current road.
Setting <code>null</code> value to the listener will unset the listener.
