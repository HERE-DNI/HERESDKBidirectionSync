...
<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html" class="external-link" title="class or interface in java.io"><code>Serializable</code></a>, <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html" class="external-link" title="class or interface in java.lang"><code>Comparable</code></a>`<`[`LocationIndicator.MarkerType`](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")`>`,
...
<div id="sdk-for-android-explore-PEDESTRIAN" class="section detail">
    ...
    final</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")</span> <span class="element-name">PEDESTRIAN</span>
...
<div id="sdk-for-android-explore-PEDESTRIAN_INACTIVE"
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")</span> <span class="element-name">PEDESTRIAN_INACTIVE</span>

    </div>

    <div class="block">

    Pedestrian navigation in inactive state, represented by a gray dot
    by default. It is used when the indicator was set to inactive using
...
<div id="sdk-for-android-explore-NAVIGATION" class="section detail">
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")</span> <span class="element-name">NAVIGATION</span>

    </div>

    <div class="block">

    Vehicle navigation represented by a green triangular arrow by
    default.
...
<div id="sdk-for-android-explore-NAVIGATION_INACTIVE"
    ...
    <span class="modifiers">public static
    final</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")</span> <span class="element-name">NAVIGATION_INACTIVE</span>

    </div>

    <div class="block">

    Vehicle navigation in inactive state, represented by a gray
    triangular arrow by default. It is used when the indicator was set
    to inactive using LocationIndicator.setActive(boolean) in navigation
    mode.
...
<div id="sdk-for-android-explore-values()" class="section detail">
    ...
    static</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")\[\]</span> <span class="element-name">values</span>()
...
<div id="sdk-for-android-explore-valueOf(java.lang.String)"
    ...
    <span class="modifiers">public
    static</span> <span class="return-type">[LocationIndicator.MarkerType](sdk-for-android-explore-com-here-sdk-mapview-locationindicator-markertype "enum class in com.here.sdk.mapview")</span> <span class="element-name">valueOf</span><span class="parameters">(<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html" class="external-link" title="class or interface in java.lang">String</a> name)</span>
