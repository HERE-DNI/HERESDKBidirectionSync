...
<span id="//apple_ref/swift/Struct/LandlinePhone" class="dashAnchor"></span>

<div class="content-wrapper">

<a href="sdk-for-ios-explore-index">heresdk</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> <a href="sdk-for-ios-explore-search">Search</a> <img src="../img/carat.png" id="sdk-for-ios-explore-carat" /> LandlinePhone Structure Reference
...
- <div>
  ...
  ` `<span id="/s:7heresdk13LandlinePhoneV11phoneNumberSSvp"></span>` `<span id="//apple_ref/swift/Property/phoneNumber" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-landlinephone#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp" class="token"><code>phoneNumber</code></a>` `
...
- <div>
  ...
  ` `<span id="/s:7heresdk13LandlinePhoneV10categoriesSayAA13PlaceCategoryCGvp"></span>` `<span id="//apple_ref/swift/Property/categories" class="dashAnchor"></span>` `<a href="sdk-for-ios-explore-structs-landlinephone#/s:7heresdk13LandlinePhoneV10categoriesSayAA13PlaceCategoryCGvp" class="token"><code>categories</code></a>` `
  ...
  Categories associated with phone number. Note: In case `LandlinePhone.categories` are not empty, then <a href="sdk-for-ios-explore-structs-landlinephone#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp">`LandlinePhone.phoneNumber`</a> should be used according to given categories. Otherwise, <a href="sdk-for-ios-explore-structs-landlinephone#/s:7heresdk13LandlinePhoneV11phoneNumberSSvp">`LandlinePhone.phoneNumber`</a> is meant for general use.
