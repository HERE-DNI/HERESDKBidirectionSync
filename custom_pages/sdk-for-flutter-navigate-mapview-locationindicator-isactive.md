...
when inactive version is shown. By default, it is <code>true</code>.</p>
</section>
...
is passed. By default, it is <code>true</code>.</p>
</section>
<section class="summary source-code" id="source">
<h2>Implementation</h2>
<pre class="language-dart"><code class="language-dart">set isActive(bool value);</code></pre>
</section>
</section>
</div>
