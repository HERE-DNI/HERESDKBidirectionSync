...
Easing.withSampledPoints(<wbr/><ol class="parameter-list single-line"> <li>List&lt;<wbr/>/sdk-for-flutter-navigate-core-point2d-class&gt; points</li>
</ol>)
    </section>
<section class="desc markdown">
<p>Creates an instance of customized /sdk-for-flutter-navigate-animation-easing-class using a specified number of points describing an
easing function.</p>
<ul>
...
<p>Throws /sdk-for-flutter-navigate-animation-easinginstantiationexception-class. Instantiation error in case of invalid input parameters.</p>
</section>
