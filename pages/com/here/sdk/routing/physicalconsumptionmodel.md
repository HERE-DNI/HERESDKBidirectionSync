...
<meta name="description" content="declaration: package: com.here.sdk.routing, class: PhysicalConsumptionModel">
...
<h1 title="Class PhysicalConsumptionModel" class="title">Class PhysicalConsumptionModel</h1>
</div>
...
<div class="col-second even-row-color"><code><a href="#airDragCoefficient" class="member-name-link">airDragCoefficient</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#auxiliaryPowerConsumptionInWatts" class="member-name-link">auxiliaryPowerConsumptionInWatts</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Power (in W) consumed by the vehicle's auxiliary systems (for example, air conditioning, lights).</div>
</div>
<div class="col-first even-row-color"><code>double</code></div>
<div class="col-second even-row-color"><code><a href="#driveTrainEfficiency" class="member-name-link">driveTrainEfficiency</a></code></div>
<div class="col-last even-row-color">
<div class="block">The proportion of the energy drawn from the battery that is used to move the vehicle.</div>
</div>
<div class="col-first odd-row-color"><code>double</code></div>
<div class="col-second odd-row-color"><code><a href="#frontalAreaInSquareMeters" class="member-name-link">frontalAreaInSquareMeters</a></code></div>
<div class="col-last odd-row-color">
...
<div class="col-first even-row-color"><code>double</code></div>
<div class="col-second even-row-color"><code><a href="#recuperationEfficiency" class="member-name-link">recuperationEfficiency</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-first odd-row-color"><code>double</code></div>
<div class="col-second odd-row-color"><code><a href="#rollingResistanceCoefficient" class="member-name-link">rollingResistanceCoefficient</a></code></div>
<div class="col-last odd-row-color">
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">PhysicalConsumptionModel</a>()</code></div>
<div class="col-last even-row-color">
...
<div class="block"><p>Frontal area represents the total cross section area of the vehicle as viewed from the front, specified in square meters.
 ...
 As fallback <a href="sdk-for-android-explore-api-reference-latestvehiclespecification#widthInCentimeters"><code>VehicleSpecification.widthInCentimeters</code></a> and <a href="sdk-for-android-explore-api-reference-latestvehiclespecification#heightInCentimeters"><code>VehicleSpecification.heightInCentimeters</code></a> are used.
