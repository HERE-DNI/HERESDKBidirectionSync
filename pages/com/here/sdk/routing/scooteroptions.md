...
<title>ScooterOptions (API Reference)</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description" content="declaration: package: com.here.sdk.routing, class: ScooterOptions">
...
<h1 title="Class ScooterOptions" class="title">Class ScooterOptions</h1>
</div>
...
<div class="col-second even-row-color"><code><a href="#allowHighway" class="member-name-link">allowHighway</a></code></div>
...
<div class="col-second even-row-color"><code><a href="#engineSizeInCubicCentimeters" class="member-name-link">engineSizeInCubicCentimeters</a></code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">ScooterOptions</a>()</code></div>
<div class="col-last even-row-color">
<div class="block"><span class="deprecated-label">Deprecated.</span></div>
...
<div class="block"><p>Specifies whether scooter is allowed on highway or not. <code>True</code> means scooter is
 ...
 Note that there is a similar parameter in <a href="sdk-for-android-explore-api-reference-latestavoidanceoptions" title="class in com.here.sdk.routing"><code>AvoidanceOptions</code></a>, to
 disallow highway usage, see <a href="sdk-for-android-explore-api-reference-latestroadfeatures#CONTROLLED_ACCESS_HIGHWAY"><code>RoadFeatures.CONTROLLED_ACCESS_HIGHWAY</code></a>.
 ...
 In such a case, a <a href="sdk-for-android-explore-api-reference-latestsectionnotice" title="class in com.here.sdk.routing"><code>SectionNotice</code></a> will be provided in the related <a href="sdk-for-android-explore-api-reference-latestsection" title="class in com.here.sdk.routing"><code>Section</code></a>
