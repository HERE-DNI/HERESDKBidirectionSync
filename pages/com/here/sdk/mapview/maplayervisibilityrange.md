...
<meta name="description" content="declaration: package: com.here.sdk.mapview, class: MapLayerVisibilityRange">
...
<h1 title="Class MapLayerVisibilityRange" class="title">Class MapLayerVisibilityRange</h1>
</div>
...
<div class="col-second even-row-color"><code><a href="#maximumZoomLevel" class="member-name-link">maximumZoomLevel</a></code></div>
...
<div class="col-second odd-row-color"><code><a href="#minimumZoomLevel" class="member-name-link">minimumZoomLevel</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E(double,double)" class="member-name-link">MapLayerVisibilityRange</a><wbr>(double minimumZoomLevel,
 double maximumZoomLevel)</wbr></code></div>
<div class="col-last even-row-color">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="element-name">MapLayerVisibilityRange</span><wbr><span class="parameters">(double minimumZoomLevel,
 double maximumZoomLevel)</span></wbr></div>
