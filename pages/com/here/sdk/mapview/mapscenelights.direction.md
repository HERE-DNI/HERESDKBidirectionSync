...
<meta name="description" content="declaration: package: com.here.sdk.mapview, class: MapSceneLights, class: Direction">
...
<h1 title="Class MapSceneLights.Direction" class="title">Class MapSceneLights.Direction</h1>
</div>
...
<div class="col-second odd-row-color"><code><a href="#azimuth" class="member-name-link">azimuth</a></code></div>
...
<div class="table-header col-last">Description</div>
<div class="col-constructor-name even-row-color"><code><a href="#%3Cinit%3E()" class="member-name-link">Direction</a>()</code></div>
<div class="col-last even-row-color">
<div class="block">Constructs a Direction with default values: azimuth = 0.0, altitude = 0.0.</div>
</div>
<div class="col-constructor-name odd-row-color"><code><a href="#%3Cinit%3E(double,double)" class="member-name-link">Direction</a><wbr>(double azimuth,
