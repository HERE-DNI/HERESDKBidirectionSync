...
<meta name="description" content="declaration: package: com.here.sdk.mapview, class: MapCamera">
...
<h1 title="Class MapCamera" class="title">Class MapCamera</h1>
</div>
...
<div class="block"><p>Represents the camera looking onto the map view.
 ...
 e.g. when using <a href="sdk-for-android-explore-api-reference-latestmapcameraupdatefactory#lookAt(com.here.sdk.core.GeoBox)"><code>MapCameraUpdateFactory.lookAt(GeoBox)</code></a> with a view rectangle, whose center does not coincide with the <code>principal point</code>.  In this case, the geo-coordinates of the
 ...
 </p><p>All changes to the camera are encapsulated in camera updates that are created using the methods in the <a href="sdk-for-android-explore-api-reference-latestmapcameraupdatefactory" title="class in com.here.sdk.mapview"><code>MapCameraUpdateFactory</code></a> class.
 </p><p>These updates can then be applied to the <a href="sdk-for-android-explore-api-reference-latestheremap" title="class in com.here.sdk.mapview"><code>HereMap</code></a> using <a href="#applyUpdate(com.here.sdk.mapview.MapCameraUpdate)"><code>applyUpdate(com.here.sdk.mapview.MapCameraUpdate)</code></a>.
 ...
 </p><p>Camera updates can be animated by first creating a camera animation using the methods in the <a href="sdk-for-android-explore-api-reference-latestmapcameraanimationfactory" title="class in com.here.sdk.mapview"><code>MapCameraAnimationFactory</code></a> class and then applying this
 animation to the <a href="sdk-for-android-explore-api-reference-latestheremap" title="class in com.here.sdk.mapview"><code>HereMap</code></a> using <a href="#startAnimation(com.here.sdk.mapview.MapCameraAnimation,com.here.sdk.animation.AnimationListener)"><code>startAnimation(MapCameraAnimation, AnimationListener)</code></a>.
...
<div class="col-second even-row-color"><code><a href="sdk-for-android-explore-api-reference-latestmapcamera-drycameraupdatecallback" class="type-name-link" title="interface in com.here.sdk.mapview">MapCamera.DryCameraUpdateCallback</a></code></div>
<div class="col-last even-row-color">
<div class="block">Used to report back results of dry update application to camera.</div>
</div>
<div class="col-first odd-row-color"><code>static final class </code></div>
<div class="col-second odd-row-color"><code><a href="sdk-for-android-explore-api-reference-latestmapcamera-farplaneconfiguration" class="type-name-link" title="class in com.here.sdk.mapview">MapCamera.FarPlaneConfiguration</a></code></div>
<div class="col-last odd-row-color">
<div class="block">Far plane distance configuration for a zoom level.</div>
</div>
<div class="col-first even-row-color"><code>static final class </code></div>
<div class="col-second even-row-color"><code><a href="sdk-for-android-explore-api-reference-latestmapcamera-state" class="type-name-link" title="class in com.here.sdk.mapview">MapCamera.State</a></code></div>
<div class="col-last even-row-color">
...
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#addListener(com.here.sdk.mapview.MapCameraListener)" class="member-name-link">addListener</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameralistener" title="interface in com.here.sdk.mapview">MapCameraListener</a> listener)</wbr></code></div>
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#applyUpdate(com.here.sdk.mapview.MapCameraUpdate)" class="member-name-link">applyUpdate</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameraupdate" title="class in com.here.sdk.mapview">MapCameraUpdate</a> cameraUpdate)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Applies camera update to the map camera.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#cancelAnimation(com.here.sdk.mapview.MapCameraAnimation)" class="member-name-link">cancelAnimation</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameraanimation" title="class in com.here.sdk.mapview">MapCameraAnimation</a> cameraAnimation)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Cancels an ongoing camera animation.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#cancelAnimations()" class="member-name-link">cancelAnimations</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Cancels any ongoing camera animation.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#dryApplyUpdate(com.here.sdk.mapview.MapCameraUpdate,com.here.sdk.mapview.MapCamera.DryCameraUpdateCallback)" class="member-name-link">dryApplyUpdate</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameraupdate" title="class in com.here.sdk.mapview">MapCameraUpdate</a> cameraUpdate,
 <a href="sdk-for-android-explore-api-reference-latestmapcamera-drycameraupdatecallback" title="interface in com.here.sdk.mapview">MapCamera.DryCameraUpdateCallback</a> callback)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Computes result of applying camera update without changing state of the map camera.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="sdk-for-android-explore-api-reference-latestgeobox" title="class in com.here.sdk.core">GeoBox</a></code></div>
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="sdk-for-android-explore-api-reference-latestmapcameralimits" title="class in com.here.sdk.mapview">MapCameraLimits</a></code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getLimits()" class="member-name-link">getLimits</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#getPrincipalPoint()" class="member-name-link">getPrincipalPoint</a>()</code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Gets the pixel point that determines where the target is placed within the map view.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="sdk-for-android-explore-api-reference-latestmapcamera-state" title="class in com.here.sdk.mapview">MapCamera.State</a></code></div>
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#lookAt(com.here.sdk.core.GeoBox,com.here.sdk.core.GeoOrientationUpdate)" class="member-name-link">lookAt</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeobox" title="class in com.here.sdk.core">GeoBox</a> target,
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Makes the camera look at the specified geodetic area.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#lookAt(com.here.sdk.core.GeoBox,com.here.sdk.core.GeoOrientationUpdate,com.here.sdk.core.Rectangle2D)" class="member-name-link">lookAt</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeobox" title="class in com.here.sdk.core">GeoBox</a> target,
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation,
 <a href="sdk-for-android-explore-api-reference-latestrectangle2d" title="class in com.here.sdk.core">Rectangle2D</a> viewRectangle)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#lookAt(com.here.sdk.core.GeoCoordinates)" class="member-name-link">lookAt</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> target)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#lookAt(com.here.sdk.core.GeoCoordinates,com.here.sdk.core.GeoOrientationUpdate,com.here.sdk.mapview.MapMeasure)" class="member-name-link">lookAt</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> target,
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation,
 <a href="sdk-for-android-explore-api-reference-latestmapmeasure" title="class in com.here.sdk.mapview">MapMeasure</a> zoom)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Makes the camera look at the geodetic target with the given zoom and orientation.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#lookAt(com.here.sdk.core.GeoCoordinates,com.here.sdk.mapview.MapMeasure)" class="member-name-link">lookAt</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> target,
 <a href="sdk-for-android-explore-api-reference-latestmapmeasure" title="class in com.here.sdk.mapview">MapMeasure</a> zoom)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Makes the camera look at the geodetic target with the given zoom.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#orbitBy(com.here.sdk.core.GeoOrientationUpdate,com.here.sdk.core.Point2D)" class="member-name-link">orbitBy</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> delta,
 <a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a> origin)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Orbits the camera around a specified view point by increasing tilt and bearing by specified
 delta values.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#removeListener(com.here.sdk.mapview.MapCameraListener)" class="member-name-link">removeListener</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameralistener" title="interface in com.here.sdk.mapview">MapCameraListener</a> observer)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Removes the listener from the camera.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#removeListeners()" class="member-name-link">removeListeners</a>()</code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Removes all registered listeners.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setDistanceToTarget(double)" class="member-name-link">setDistanceToTarget</a><wbr>(double distanceInMeters)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Makes the camera look at current target from certain distance</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setFarPlaneConfiguration(java.util.Map)" class="member-name-link">setFarPlaneConfiguration</a><wbr>(<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" class="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Double.html" title="class or interface in java.lang" class="external-link">Double</a>,<wbr><a href="sdk-for-android-explore-api-reference-latestmapcamera-farplaneconfiguration" title="class in com.here.sdk.mapview">MapCamera.FarPlaneConfiguration</a>&gt; configs)</wbr></wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets far plane distance configs per zoom level.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setOrientationAtTarget(com.here.sdk.core.GeoOrientationUpdate)" class="member-name-link">setOrientationAtTarget</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Changes camera orientation in relation to target location.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#setPrincipalPoint(com.here.sdk.core.Point2D)" class="member-name-link">setPrincipalPoint</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a> value)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Sets the pixel point that determines where the target appears within the map view.</div>
</div>
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#startAnimation(com.here.sdk.mapview.MapCameraAnimation)" class="member-name-link">startAnimation</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameraanimation" title="class in com.here.sdk.mapview">MapCameraAnimation</a> cameraAnimation)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Starts a given camera animation.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#startAnimation(com.here.sdk.mapview.MapCameraAnimation,com.here.sdk.animation.AnimationListener)" class="member-name-link">startAnimation</a><wbr>(<a href="sdk-for-android-explore-api-reference-latestmapcameraanimation" title="class in com.here.sdk.mapview">MapCameraAnimation</a> cameraAnimation,
...
<div class="col-first odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#zoomBy(double,com.here.sdk.core.Point2D)" class="member-name-link">zoomBy</a><wbr>(double factor,
 <a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a> origin)</wbr></code></div>
<div class="col-last odd-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
<div class="block">Zooms in or out by a specified factor.</div>
</div>
<div class="col-first even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code>void</code></div>
<div class="col-second even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4"><code><a href="#zoomTo(double)" class="member-name-link">zoomTo</a><wbr>(double zoomLevel)</wbr></code></div>
<div class="col-last even-row-color method-summary-table method-summary-table-tab2 method-summary-table-tab4">
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setFarPlaneConfiguration</span><wbr><span class="parameters">(@NonNull
 <a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Map.html" title="class or interface in java.util" class="external-link">Map</a>&lt;<a href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Double.html" title="class or interface in java.lang" class="external-link">Double</a>,<wbr><a href="sdk-for-android-explore-api-reference-latestmapcamera-farplaneconfiguration" title="class in com.here.sdk.mapview">MapCamera.FarPlaneConfiguration</a>&gt; configs)</wbr></span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">addListener</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcameralistener" title="interface in com.here.sdk.mapview">MapCameraListener</a> listener)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">removeListener</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcameralistener" title="interface in com.here.sdk.mapview">MapCameraListener</a> observer)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">dryApplyUpdate</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcameraupdate" title="class in com.here.sdk.mapview">MapCameraUpdate</a> cameraUpdate,
 @NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcamera-drycameraupdatecallback" title="interface in com.here.sdk.mapview">MapCamera.DryCameraUpdateCallback</a> callback)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">startAnimation</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcameraanimation" title="class in com.here.sdk.mapview">MapCameraAnimation</a> cameraAnimation)</span></wbr></div>
...
<h3>startAnimation</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">startAnimation</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapcameraanimation" title="class in com.here.sdk.mapview">MapCameraAnimation</a> cameraAnimation,
 @NonNull
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">orbitBy</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> delta,
 @NonNull
 <a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a> origin)</span></wbr></div>
...
<div class="block"><p>Zooms in or out by a specified factor.
 </p><p>This effectively changes the distance from the camera to the <a href="sdk-for-android-explore-api-reference-latestmapcamera-state#targetCoordinates"><code>MapCamera.State.targetCoordinates</code></a>
 by the specified factor, which changes <a href="sdk-for-android-explore-api-reference-latestmapcamera-state#zoomLevel"><code>MapCamera.State.zoomLevel</code></a> as well.
 </p><p>Values above 1.0 will zoom in and values below will zoom out.
 </p><p>The relation with <a href="sdk-for-android-explore-api-reference-latestmapcamera-state#distanceToTargetInMeters"><code>MapCamera.State.distanceToTargetInMeters</code></a> is inversely linear,
...
<h3>zoomTo</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">zoomTo</span><wbr><span class="parameters">(double zoomLevel)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">lookAt</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestgeocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> target)</span></wbr></div>
...
<h3>lookAt</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">lookAt</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestgeocoordinates" title="class in com.here.sdk.core">GeoCoordinates</a> target,
 @NonNull
 <a href="sdk-for-android-explore-api-reference-latestmapmeasure" title="class in com.here.sdk.mapview">MapMeasure</a> zoom)</span></wbr></div>
...
<h3>lookAt</h3>
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">lookAt</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestgeobox" title="class in com.here.sdk.core">GeoBox</a> target,
 @NonNull
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">lookAt</span><wbr><span class="parameters">(@NonNull
 ...
 <a href="sdk-for-android-explore-api-reference-latestgeoorientationupdate" title="class in com.here.sdk.core">GeoOrientationUpdate</a> orientation,
 @NonNull
 <a href="sdk-for-android-explore-api-reference-latestrectangle2d" title="class in com.here.sdk.core">Rectangle2D</a> viewRectangle)</span></wbr></div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setDistanceToTarget</span><wbr><span class="parameters">(double distanceInMeters)</span></wbr></div>
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-explore-api-reference-latestmapcamera-state" title="class in com.here.sdk.mapview">MapCamera.State</a></span> <span class="element-name">getState</span>()</div>
...
<div class="member-signature"><span class="annotations">@NonNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a></span> <span class="element-name">getPrincipalPoint</span>()</div>
...
<div class="member-signature"><span class="modifiers">public</span> <span class="return-type">void</span> <span class="element-name">setPrincipalPoint</span><wbr><span class="parameters">(@NonNull
 <a href="sdk-for-android-explore-api-reference-latestpoint2d" title="class in com.here.sdk.core">Point2D</a> value)</span></wbr></div>
...
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-explore-api-reference-latestgeobox" title="class in com.here.sdk.core">GeoBox</a></span> <span class="element-name">getBoundingBox</span>()</div>
...
<h3>getLimits</h3>
<div class="member-signature"><span class="annotations">@NonNull
</span><span class="modifiers">public</span> <span class="return-type"><a href="sdk-for-android-explore-api-reference-latestmapcameralimits" title="class in com.here.sdk.mapview">MapCameraLimits</a></span> <span class="element-name">getLimits</span>()</div>
